 ...
 *                                                                            * 
 *   .atpack File: ATmega32C1.atdf                                            * 
 *   .ATDF File:   atdf/ATmega32C1.atdf                                       * 
 *   Version:      2.0.12                                                     * 
 *   Date:         2019-04-26                                                 * 
 *   Device:       ATmega32C1                                                 * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATmega32C1.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_ATmega32C1_H_INCLUDED
#  define _AVR_ATmega32C1_H_INCLUDED
...
#define DAC_DAC_DACH_gc(x) ((x<<8) & 0xFF00)

/* DAC Data Register Low Byte Bits */
#define DAC_DAC_DACL_gc(x) (x & 0xFF)
...
#endif /* #ifdef _AVR_ATmega32C1_H_INCLUDED */
