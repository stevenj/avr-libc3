 ...
 *                                                                            * 
 *   .atpack File: ATmega3250A.atdf                                           * 
 *   .ATDF File:   atdf/ATmega3250A.atdf                                      * 
 *   Version:      2.0.12                                                     * 
 *   Date:         2019-04-26                                                 * 
 *   Device:       ATmega3250A                                                * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATmega3250A.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_ATmega3250A_H_INCLUDED
#  define _AVR_ATmega3250A_H_INCLUDED
...
/* PORTH - I/O Port (0x0000) */
#define PORTHH_BASE      _SFR_MEM8 (0x0000) /* PORTHH Base Address */
#define PORTHH_PINH      _SFR_MEM8 (0x00D8) /* PORT H Input Pins */
#define PORTHH_DDRH      _SFR_MEM8 (0x00D9) /* PORT H Data Direction Register */
#define PORTHH_PORTH     _SFR_MEM8 (0x00DA) /* PORT H Data Register */

/* PORTJ - I/O Port (0x0000) */
#define PORTJJ_BASE      _SFR_MEM8 (0x0000) /* PORTJJ Base Address */
#define PORTJJ_PINJ      _SFR_MEM8 (0x00DB) /* PORT J Input Pins */
#define PORTJJ_DDRJ      _SFR_MEM8 (0x00DC) /* PORT J Data Direction Register */
#define PORTJJ_PORTJ     _SFR_MEM8 (0x00DD) /* PORT J Data Register */
...
#define None_NOT_USED_vect_num     (22)                
#define None_NOT_USED_vect         _VECTOR(22)         /* RESERVED */
...
#endif /* #ifdef _AVR_ATmega3250A_H_INCLUDED */
