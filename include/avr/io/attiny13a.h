 ...
 *                                                                            * 
 *   .atpack File: ATtiny13A.atdf                                             * 
 *   .ATDF File:   atdf/ATtiny13A.atdf                                        * 
 *   Version:      2.0.10                                                     * 
 *   Date:         2019-04-25                                                 * 
 *   Device:       ATtiny13A                                                  * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATtiny13A.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_ATtiny13A_H_INCLUDED
#  define _AVR_ATtiny13A_H_INCLUDED
...
{
    register8_t rsv_0x00[69]; /* RESERVED REGISTER BLOCK */
    ...
    register8_t rsv_0x4F;     /* RESERVED REGISTER */
...
{
    CPU_BODS_CLEAR_gc = (0x00), /* BOD Power-Down in Power-Down Sleep - CLEAR */
    CPU_BODS_SET_gc   = (0x02), /* BOD Power-Down in Power-Down Sleep - SET */
} CPU_BODS_t;

/* BOD Power-Down Sleep Enable */
typedef enum CPU_BODSE_enum
{
    CPU_BODSE_CLEAR_gc = (0x00), /* BOD Power-Down Sleep Enable - CLEAR */
    CPU_BODSE_SET_gc   = (0x01), /* BOD Power-Down Sleep Enable - SET */
} CPU_BODSE_t;
/*
================================================================================
...
/* BOD Power-Down in Power-Down Sleep */
#define CPU_BODS_CLEAR_gc (0x00) /* BOD Power-Down in Power-Down Sleep - CLEAR */
#define CPU_BODS_SET_gc   (0x02) /* BOD Power-Down in Power-Down Sleep - SET */


/* BOD Power-Down Sleep Enable */
#define CPU_BODSE_CLEAR_gc (0x00) /* BOD Power-Down Sleep Enable - CLEAR */
#define CPU_BODSE_SET_gc   (0x01) /* BOD Power-Down Sleep Enable - SET */
...
#endif /* #ifdef _AVR_ATtiny13A_H_INCLUDED */
