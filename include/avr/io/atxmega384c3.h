 ...
 *                                                                            * 
 *   .atpack File: ATxmega384C3.atdf                                          * 
 *   .ATDF File:   atdf/ATxmega384C3.atdf                                     * 
 *   Version:      2.0.9                                                      * 
 *   Date:         2019-07-11                                                 * 
 *   Device:       ATxmega384C3                                               * 
 ...
 *        - Succeeds Atmel.XMEGAC_DFP 1.1.50.                                 * 
 *                                                                            * 
...
#  define _AVR_IOXXX_H_ "ioATxmega384C3.h"
#else
...
typedef enum DMA_PRIMODE_enum
{
    ...
    DMA_PRIMODE_CH01_gc = (0x01), /* Channel 0 > channel 1 */
} DMA_PRIMODE_t;
...
#define DMA_PRIMODE_CH01_gc (0x01) /* Channel 0 > channel 1 */
...
/* Start-up Time */
#define NVM_FUSES_SUT_0MS_gc  (0x03<<2) /* 0 ms */
#define NVM_FUSES_SUT_4MS_gc  (0x01<<2) /* 4 ms */
#define NVM_FUSES_SUT_64MS_gc (0x00<<2) /* 64 ms */
