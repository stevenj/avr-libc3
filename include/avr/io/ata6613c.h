 ...
 *                                                                            * 
 *   .atpack File: ATA6613C.atdf                                              * 
 *   .ATDF File:   atdf/ATA6613C.atdf                                         * 
 *   Version:      2.0.6                                                      * 
 *   Date:         2019-04-16                                                 * 
 *   Device:       ATA6613C                                                   * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATA6613C.h"
#else
...
{
    FUSE_BOOTSZ_128W_1F80_gc  = (0x03<<1), /* Boot Flash size=128 words start address=$1F80 */
    FUSE_BOOTSZ_256W_1F00_gc  = (0x02<<1), /* Boot Flash size=256 words start address=$1F00 */
    FUSE_BOOTSZ_512W_1E00_gc  = (0x01<<1), /* Boot Flash size=512 words start address=$1E00 */
    FUSE_BOOTSZ_1024W_1C00_gc = (0x00<<1), /* Boot Flash size=1024 words start address=$1C00 */
} FUSE_BOOTSZ_t;
...
/* Data Order */
typedef enum USART0_UDORD0_enum
{
    USART0_UDORD0_CLEAR_gc = (0x00), /* Data Order - CLEAR */
    USART0_UDORD0_SET_gc   = (0x04), /* Data Order - SET */
} USART0_UDORD0_t;

/* Clock Phase */
typedef enum USART0_UCPHA0_enum
{
    USART0_UCPHA0_CLEAR_gc = (0x00), /* Clock Phase - CLEAR */
    USART0_UCPHA0_SET_gc   = (0x02), /* Clock Phase - SET */
} USART0_UCPHA0_t;
...
{
    TIMER_COUNTER_1_OCIE1B_CLEAR_gc = (0x00), /* Timer/Counter1 Output CompareB Match Interrupt Enable - CLEAR */
    TIMER_COUNTER_1_OCIE1B_SET_gc   = (0x04), /* Timer/Counter1 Output CompareB Match Interrupt Enable - SET */
} TIMER_COUNTER_1_OCIE1B_t;

/* Timer/Counter1 Output CompareA Match Interrupt Enable */
typedef enum TIMER_COUNTER_1_OCIE1A_enum
{
    TIMER_COUNTER_1_OCIE1A_CLEAR_gc = (0x00), /* Timer/Counter1 Output CompareA Match Interrupt Enable - CLEAR */
    TIMER_COUNTER_1_OCIE1A_SET_gc   = (0x02), /* Timer/Counter1 Output CompareA Match Interrupt Enable - SET */
...
{
    TIMER_COUNTER_1_ICF1_CLEAR_gc = (0x00), /* Input Capture Flag 1 - CLEAR */
    TIMER_COUNTER_1_ICF1_SET_gc   = (0x20), /* Input Capture Flag 1 - SET */
} TIMER_COUNTER_1_ICF1_t;

/* Output Compare Flag 1B */
typedef enum TIMER_COUNTER_1_OCF1B_enum
{
    TIMER_COUNTER_1_OCF1B_CLEAR_gc = (0x00), /* Output Compare Flag 1B - CLEAR */
    TIMER_COUNTER_1_OCF1B_SET_gc   = (0x04), /* Output Compare Flag 1B - SET */
} TIMER_COUNTER_1_OCF1B_t;

/* Output Compare Flag 1A */
typedef enum TIMER_COUNTER_1_OCF1A_enum
{
    TIMER_COUNTER_1_OCF1A_CLEAR_gc = (0x00), /* Output Compare Flag 1A - CLEAR */
    TIMER_COUNTER_1_OCF1A_SET_gc   = (0x02), /* Output Compare Flag 1A - SET */
...
{
    TIMER_COUNTER_1_FOC1A_CLEAR_gc = (0x00), /* Timer/Counter1 Control Register C-FOC1A - CLEAR */
    TIMER_COUNTER_1_FOC1A_SET_gc   = (0x80), /* Timer/Counter1 Control Register C-FOC1A - SET */
} TIMER_COUNTER_1_FOC1A_t;

/* Timer/Counter1 Control Register C-FOC1B */
typedef enum TIMER_COUNTER_1_FOC1B_enum
{
    TIMER_COUNTER_1_FOC1B_CLEAR_gc = (0x00), /* Timer/Counter1 Control Register C-FOC1B - CLEAR */
    TIMER_COUNTER_1_FOC1B_SET_gc   = (0x40), /* Timer/Counter1 Control Register C-FOC1B - SET */
} TIMER_COUNTER_1_FOC1B_t;

/* Timer/Counter Synchronization Mode */
typedef enum TIMER_COUNTER_1_TSM_enum
{
    TIMER_COUNTER_1_TSM_CLEAR_gc = (0x00), /* Timer/Counter Synchronization Mode - CLEAR */
    TIMER_COUNTER_1_TSM_SET_gc   = (0x80), /* Timer/Counter Synchronization Mode - SET */
} TIMER_COUNTER_1_TSM_t;

/* Prescaler Reset Timer/Counter1 and Timer/Counter0 */
typedef enum TIMER_COUNTER_1_PSRSYNC_enum
{
    TIMER_COUNTER_1_PSRSYNC_CLEAR_gc = (0x00), /* Prescaler Reset Timer/Counter1 and Timer/Counter0 - CLEAR */
    TIMER_COUNTER_1_PSRSYNC_SET_gc   = (0x01), /* Prescaler Reset Timer/Counter1 and Timer/Counter0 - SET */
} TIMER_COUNTER_1_PSRSYNC_t;
...
typedef enum TIMER_COUNTER_2_OCIE2B_enum
{
    TIMER_COUNTER_2_OCIE2B_CLEAR_gc = (0x00), /* Timer/Counter2 Output Compare Match B Interrupt Enable - CLEAR */
    TIMER_COUNTER_2_OCIE2B_SET_gc   = (0x04), /* Timer/Counter2 Output Compare Match B Interrupt Enable - SET */
} TIMER_COUNTER_2_OCIE2B_t;

/* Timer/Counter2 Output Compare Match A Interrupt Enable */
typedef enum TIMER_COUNTER_2_OCIE2A_enum
{
    TIMER_COUNTER_2_OCIE2A_CLEAR_gc = (0x00), /* Timer/Counter2 Output Compare Match A Interrupt Enable - CLEAR */
    TIMER_COUNTER_2_OCIE2A_SET_gc   = (0x02), /* Timer/Counter2 Output Compare Match A Interrupt Enable - SET */
} TIMER_COUNTER_2_OCIE2A_t;

/* Timer/Counter2 Overflow Interrupt Enable */
typedef enum TIMER_COUNTER_2_TOIE2_enum
{
    TIMER_COUNTER_2_TOIE2_CLEAR_gc = (0x00), /* Timer/Counter2 Overflow Interrupt Enable - CLEAR */
    TIMER_COUNTER_2_TOIE2_SET_gc   = (0x01), /* Timer/Counter2 Overflow Interrupt Enable - SET */
} TIMER_COUNTER_2_TOIE2_t;

/* Output Compare Flag 2B */
typedef enum TIMER_COUNTER_2_OCF2B_enum
{
    TIMER_COUNTER_2_OCF2B_CLEAR_gc = (0x00), /* Output Compare Flag 2B - CLEAR */
    TIMER_COUNTER_2_OCF2B_SET_gc   = (0x04), /* Output Compare Flag 2B - SET */
} TIMER_COUNTER_2_OCF2B_t;

/* Output Compare Flag 2A */
typedef enum TIMER_COUNTER_2_OCF2A_enum
{
    TIMER_COUNTER_2_OCF2A_CLEAR_gc = (0x00), /* Output Compare Flag 2A - CLEAR */
    TIMER_COUNTER_2_OCF2A_SET_gc   = (0x02), /* Output Compare Flag 2A - SET */
} TIMER_COUNTER_2_OCF2A_t;

/* Timer/Counter2 Overflow Flag */
typedef enum TIMER_COUNTER_2_TOV2_enum
{
    TIMER_COUNTER_2_TOV2_CLEAR_gc = (0x00), /* Timer/Counter2 Overflow Flag - CLEAR */
    TIMER_COUNTER_2_TOV2_SET_gc   = (0x01), /* Timer/Counter2 Overflow Flag - SET */
} TIMER_COUNTER_2_TOV2_t;

/* Compare Output Mode bits */
#define TIMER_COUNTER_2_TCCR2A_COM2A_gc(x) ((x<<6) & 0xC0)

/* Compare Output Mode bits */
#define TIMER_COUNTER_2_TCCR2A_COM2B_gc(x) ((x<<4) & 0x30)

/* Waveform Genration Mode */
#define TIMER_COUNTER_2_TCCR2A_WGM2_gc(x) (x & 0x03)

/* Force Output Compare A */
typedef enum TIMER_COUNTER_2_FOC2A_enum
{
    TIMER_COUNTER_2_FOC2A_CLEAR_gc = (0x00), /* Force Output Compare A - CLEAR */
    TIMER_COUNTER_2_FOC2A_SET_gc   = (0x80), /* Force Output Compare A - SET */
} TIMER_COUNTER_2_FOC2A_t;

/* Force Output Compare B */
typedef enum TIMER_COUNTER_2_FOC2B_enum
{
    TIMER_COUNTER_2_FOC2B_CLEAR_gc = (0x00), /* Force Output Compare B - CLEAR */
    TIMER_COUNTER_2_FOC2B_SET_gc   = (0x40), /* Force Output Compare B - SET */
} TIMER_COUNTER_2_FOC2B_t;

/* Waveform Generation Mode */
typedef enum TIMER_COUNTER_2_WGM22_enum
{
    TIMER_COUNTER_2_WGM22_CLEAR_gc = (0x00), /* Waveform Generation Mode - CLEAR */
    TIMER_COUNTER_2_WGM22_SET_gc   = (0x08), /* Waveform Generation Mode - SET */
} TIMER_COUNTER_2_WGM22_t;

/* Clock Select bits */
typedef enum TIMER_COUNTER_2_CS2_enum
{
    TIMER_COUNTER_2_CS2_VAL_0x00_gc = (0x00), /* No Clock Source (Stopped) */
    TIMER_COUNTER_2_CS2_VAL_0x01_gc = (0x01), /* Running, No Prescaling */
    TIMER_COUNTER_2_CS2_VAL_0x02_gc = (0x02), /* Running, CLK/8 */
    TIMER_COUNTER_2_CS2_VAL_0x03_gc = (0x03), /* Running, CLK/32 */
    TIMER_COUNTER_2_CS2_VAL_0x04_gc = (0x04), /* Running, CLK/64 */
    TIMER_COUNTER_2_CS2_VAL_0x05_gc = (0x05), /* Running, CLK/128 */
    TIMER_COUNTER_2_CS2_VAL_0x06_gc = (0x06), /* Running, CLK/256 */
    TIMER_COUNTER_2_CS2_VAL_0x07_gc = (0x07), /* Running, CLK/1024 */
} TIMER_COUNTER_2_CS2_t;

/* Enable External Clock Input */
typedef enum TIMER_COUNTER_2_EXCLK_enum
{
    TIMER_COUNTER_2_EXCLK_CLEAR_gc = (0x00), /* Enable External Clock Input - CLEAR */
    TIMER_COUNTER_2_EXCLK_SET_gc   = (0x40), /* Enable External Clock Input - SET */
} TIMER_COUNTER_2_EXCLK_t;

/* Asynchronous Timer/Counter2 */
typedef enum TIMER_COUNTER_2_AS2_enum
{
    TIMER_COUNTER_2_AS2_CLEAR_gc = (0x00), /* Asynchronous Timer/Counter2 - CLEAR */
    TIMER_COUNTER_2_AS2_SET_gc   = (0x20), /* Asynchronous Timer/Counter2 - SET */
} TIMER_COUNTER_2_AS2_t;

/* Timer/Counter2 Update Busy */
typedef enum TIMER_COUNTER_2_TCN2UB_enum
{
    TIMER_COUNTER_2_TCN2UB_CLEAR_gc = (0x00), /* Timer/Counter2 Update Busy - CLEAR */
    TIMER_COUNTER_2_TCN2UB_SET_gc   = (0x10), /* Timer/Counter2 Update Busy - SET */
} TIMER_COUNTER_2_TCN2UB_t;

/* Output Compare Register2 Update Busy */
typedef enum TIMER_COUNTER_2_OCR2AUB_enum
{
    TIMER_COUNTER_2_OCR2AUB_CLEAR_gc = (0x00), /* Output Compare Register2 Update Busy - CLEAR */
    TIMER_COUNTER_2_OCR2AUB_SET_gc   = (0x08), /* Output Compare Register2 Update Busy - SET */
} TIMER_COUNTER_2_OCR2AUB_t;

/* Output Compare Register 2 Update Busy */
typedef enum TIMER_COUNTER_2_OCR2BUB_enum
{
    TIMER_COUNTER_2_OCR2BUB_CLEAR_gc = (0x00), /* Output Compare Register 2 Update Busy - CLEAR */
    TIMER_COUNTER_2_OCR2BUB_SET_gc   = (0x04), /* Output Compare Register 2 Update Busy - SET */
} TIMER_COUNTER_2_OCR2BUB_t;

/* Timer/Counter Control Register2 Update Busy */
typedef enum TIMER_COUNTER_2_TCR2AUB_enum
{
    TIMER_COUNTER_2_TCR2AUB_CLEAR_gc = (0x00), /* Timer/Counter Control Register2 Update Busy - CLEAR */
    TIMER_COUNTER_2_TCR2AUB_SET_gc   = (0x02), /* Timer/Counter Control Register2 Update Busy - SET */
} TIMER_COUNTER_2_TCR2AUB_t;

/* Timer/Counter Control Register2 Update Busy */
typedef enum TIMER_COUNTER_2_TCR2BUB_enum
{
    TIMER_COUNTER_2_TCR2BUB_CLEAR_gc = (0x00), /* Timer/Counter Control Register2 Update Busy - CLEAR */
    TIMER_COUNTER_2_TCR2BUB_SET_gc   = (0x01), /* Timer/Counter Control Register2 Update Busy - SET */
} TIMER_COUNTER_2_TCR2BUB_t;

/* Timer/Counter Synchronization Mode */
typedef enum TIMER_COUNTER_2_TSM_enum
{
    TIMER_COUNTER_2_TSM_CLEAR_gc = (0x00), /* Timer/Counter Synchronization Mode - CLEAR */
    TIMER_COUNTER_2_TSM_SET_gc   = (0x80), /* Timer/Counter Synchronization Mode - SET */
} TIMER_COUNTER_2_TSM_t;

/* Prescaler Reset Timer/Counter2 */
typedef enum TIMER_COUNTER_2_PSRASY_enum
{
    TIMER_COUNTER_2_PSRASY_CLEAR_gc = (0x00), /* Prescaler Reset Timer/Counter2 - CLEAR */
    TIMER_COUNTER_2_PSRASY_SET_gc   = (0x02), /* Prescaler Reset Timer/Counter2 - SET */
} TIMER_COUNTER_2_PSRASY_t;
...
{
    AD_CONVERTER_REFS_VAL_0x00_gc = (0x00<<6), /* AREF, Internal Vref turned off */
    AD_CONVERTER_REFS_VAL_0x01_gc = (0x01<<6), /* AVCC with external capacitor at AREF pin */
    AD_CONVERTER_REFS_VAL_0x02_gc = (0x02<<6), /* Reserved */
    AD_CONVERTER_REFS_VAL_0x03_gc = (0x03<<6), /* Internal 1.1V Voltage Reference with external capacitor at AREF pin */
} AD_CONVERTER_REFS_t;
...
#define AD_CONVERTER_ADMUX_MUX_gc(x) (x & 0x0F)
...
typedef enum AD_CONVERTER_ACME_enum
{
    AD_CONVERTER_ACME_CLEAR_gc = (0x00), /* The ADC Control and Status register B-ACME - CLEAR */
    AD_CONVERTER_ACME_SET_gc   = (0x40), /* The ADC Control and Status register B-ACME - SET */
} AD_CONVERTER_ACME_t;
...
typedef enum AD_CONVERTER_ADTS_enum
{
    ...
    AD_CONVERTER_ADTS_VAL_0x03_gc = (0x03), /* Timer/Counter0 Compare Match A */
    AD_CONVERTER_ADTS_VAL_0x04_gc = (0x04), /* Timer/Counter0 Overflow */
    AD_CONVERTER_ADTS_VAL_0x05_gc = (0x05), /* Timer/Counter1 Compare Match B */
    AD_CONVERTER_ADTS_VAL_0x06_gc = (0x06), /* Timer/Counter1 Overflow */
    AD_CONVERTER_ADTS_VAL_0x07_gc = (0x07), /* Timer/Counter1 Capture Event */
} AD_CONVERTER_ADTS_t;

/* Digital Input Disable Register-ADC5D */
typedef enum AD_CONVERTER_ADC5D_enum
{
    AD_CONVERTER_ADC5D_CLEAR_gc = (0x00), /* Digital Input Disable Register-ADC5D - CLEAR */
    AD_CONVERTER_ADC5D_SET_gc   = (0x20), /* Digital Input Disable Register-ADC5D - SET */
} AD_CONVERTER_ADC5D_t;

/* Digital Input Disable Register-ADC4D */
typedef enum AD_CONVERTER_ADC4D_enum
{
    AD_CONVERTER_ADC4D_CLEAR_gc = (0x00), /* Digital Input Disable Register-ADC4D - CLEAR */
    AD_CONVERTER_ADC4D_SET_gc   = (0x10), /* Digital Input Disable Register-ADC4D - SET */
} AD_CONVERTER_ADC4D_t;

/* Digital Input Disable Register-ADC3D */
typedef enum AD_CONVERTER_ADC3D_enum
{
    AD_CONVERTER_ADC3D_CLEAR_gc = (0x00), /* Digital Input Disable Register-ADC3D - CLEAR */
    AD_CONVERTER_ADC3D_SET_gc   = (0x08), /* Digital Input Disable Register-ADC3D - SET */
} AD_CONVERTER_ADC3D_t;

/* Digital Input Disable Register-ADC2D */
typedef enum AD_CONVERTER_ADC2D_enum
{
    AD_CONVERTER_ADC2D_CLEAR_gc = (0x00), /* Digital Input Disable Register-ADC2D - CLEAR */
    AD_CONVERTER_ADC2D_SET_gc   = (0x04), /* Digital Input Disable Register-ADC2D - SET */
} AD_CONVERTER_ADC2D_t;

/* Digital Input Disable Register-ADC1D */
typedef enum AD_CONVERTER_ADC1D_enum
{
    AD_CONVERTER_ADC1D_CLEAR_gc = (0x00), /* Digital Input Disable Register-ADC1D - CLEAR */
    AD_CONVERTER_ADC1D_SET_gc   = (0x02), /* Digital Input Disable Register-ADC1D - SET */
} AD_CONVERTER_ADC1D_t;

/* Digital Input Disable Register-ADC0D */
typedef enum AD_CONVERTER_ADC0D_enum
{
    AD_CONVERTER_ADC0D_CLEAR_gc = (0x00), /* Digital Input Disable Register-ADC0D - CLEAR */
    AD_CONVERTER_ADC0D_SET_gc   = (0x01), /* Digital Input Disable Register-ADC0D - SET */
...
typedef enum ANALOG_COMPARATOR_ACBG_enum
{
    ANALOG_COMPARATOR_ACBG_CLEAR_gc = (0x00), /* Analog Comparator Bandgap Select - CLEAR */
    ANALOG_COMPARATOR_ACBG_SET_gc   = (0x40), /* Analog Comparator Bandgap Select - SET */
} ANALOG_COMPARATOR_ACBG_t;
...
typedef enum ANALOG_COMPARATOR_AIN1D_enum
{
    ANALOG_COMPARATOR_AIN1D_CLEAR_gc = (0x00), /* AIN1 Digital Input Disable - CLEAR */
    ANALOG_COMPARATOR_AIN1D_SET_gc   = (0x02), /* AIN1 Digital Input Disable - SET */
} ANALOG_COMPARATOR_AIN1D_t;

/* AIN0 Digital Input Disable */
typedef enum ANALOG_COMPARATOR_AIN0D_enum
{
    ANALOG_COMPARATOR_AIN0D_CLEAR_gc = (0x00), /* AIN0 Digital Input Disable - CLEAR */
    ANALOG_COMPARATOR_AIN0D_SET_gc   = (0x01), /* AIN0 Digital Input Disable - SET */
} ANALOG_COMPARATOR_AIN0D_t;
...
/* Force Output Compare B */
typedef enum TIMER_COUNTER_0_FOC0B_enum
{
    TIMER_COUNTER_0_FOC0B_CLEAR_gc = (0x00), /* Force Output Compare B - CLEAR */
    TIMER_COUNTER_0_FOC0B_SET_gc   = (0x40), /* Force Output Compare B - SET */
} TIMER_COUNTER_0_FOC0B_t;

/* Timer/Counter Control Register B-WGM02 */
typedef enum TIMER_COUNTER_0_WGM02_enum
{
    TIMER_COUNTER_0_WGM02_CLEAR_gc = (0x00), /* Timer/Counter Control Register B-WGM02 - CLEAR */
    TIMER_COUNTER_0_WGM02_SET_gc   = (0x08), /* Timer/Counter Control Register B-WGM02 - SET */
} TIMER_COUNTER_0_WGM02_t;
...
typedef enum TIMER_COUNTER_0_CS0_enum
{
    ...
    TIMER_COUNTER_0_CS0_VAL_0x03_gc = (0x03), /* Running, CLK/64 */
    TIMER_COUNTER_0_CS0_VAL_0x04_gc = (0x04), /* Running, CLK/256 */
    TIMER_COUNTER_0_CS0_VAL_0x05_gc = (0x05), /* Running, CLK/1024 */
    TIMER_COUNTER_0_CS0_VAL_0x06_gc = (0x06), /* Running, ExtClk Tx Falling Edge */
    TIMER_COUNTER_0_CS0_VAL_0x07_gc = (0x07), /* Running, ExtClk Tx Rising Edge */
...
#define TIMER_COUNTER_0_TCCR0A_COM0B_gc(x) ((x<<4) & 0x30)

/* Waveform Generation Mode */
#define TIMER_COUNTER_0_TCCR0A_WGM0_gc(x) (x & 0x03)

/* Timer/Counter0 Output Compare Match B Interrupt Enable */
typedef enum TIMER_COUNTER_0_OCIE0B_enum
{
    TIMER_COUNTER_0_OCIE0B_CLEAR_gc = (0x00), /* Timer/Counter0 Output Compare Match B Interrupt Enable - CLEAR */
    TIMER_COUNTER_0_OCIE0B_SET_gc   = (0x04), /* Timer/Counter0 Output Compare Match B Interrupt Enable - SET */
} TIMER_COUNTER_0_OCIE0B_t;
...
typedef enum TIMER_COUNTER_0_OCF0B_enum
{
    TIMER_COUNTER_0_OCF0B_CLEAR_gc = (0x00), /* Timer/Counter0 Output Compare Flag 0B - CLEAR */
    TIMER_COUNTER_0_OCF0B_SET_gc   = (0x04), /* Timer/Counter0 Output Compare Flag 0B - SET */
} TIMER_COUNTER_0_OCF0B_t;

/* Timer/Counter0 Output Compare Flag 0A */
typedef enum TIMER_COUNTER_0_OCF0A_enum
{
    TIMER_COUNTER_0_OCF0A_CLEAR_gc = (0x00), /* Timer/Counter0 Output Compare Flag 0A - CLEAR */
    TIMER_COUNTER_0_OCF0A_SET_gc   = (0x02), /* Timer/Counter0 Output Compare Flag 0A - SET */
...
/* Prescaler Reset Timer/Counter1 and Timer/Counter0 */
typedef enum TIMER_COUNTER_0_PSRSYNC_enum
{
    TIMER_COUNTER_0_PSRSYNC_CLEAR_gc = (0x00), /* Prescaler Reset Timer/Counter1 and Timer/Counter0 - CLEAR */
    TIMER_COUNTER_0_PSRSYNC_SET_gc   = (0x01), /* Prescaler Reset Timer/Counter1 and Timer/Counter0 - SET */
} TIMER_COUNTER_0_PSRSYNC_t;
...
typedef enum EXTERNAL_INTERRUPT_ISC1_enum
{
    ...
    EXTERNAL_INTERRUPT_ISC1_VAL_0x01_gc = (0x01<<2), /* Any Logical Change of INTX */
...
typedef enum EXTERNAL_INTERRUPT_ISC0_enum
{
    ...
    EXTERNAL_INTERRUPT_ISC0_VAL_0x01_gc = (0x01), /* Any Logical Change of INTX */
...
/* Select boot size */
#define FUSE_BOOTSZ_128W_1F80_gc  (0x03<<1) /* Boot Flash size=128 words start address=$1F80 */
#define FUSE_BOOTSZ_256W_1F00_gc  (0x02<<1) /* Boot Flash size=256 words start address=$1F00 */
#define FUSE_BOOTSZ_512W_1E00_gc  (0x01<<1) /* Boot Flash size=512 words start address=$1E00 */
#define FUSE_BOOTSZ_1024W_1C00_gc (0x00<<1) /* Boot Flash size=1024 words start address=$1C00 */
...
/* Data Order */
#define USART0_UDORD0_CLEAR_gc (0x00) /* Data Order - CLEAR */
#define USART0_UDORD0_SET_gc   (0x04) /* Data Order - SET */


/* Clock Phase */
#define USART0_UCPHA0_CLEAR_gc (0x00) /* Clock Phase - CLEAR */
#define USART0_UCPHA0_SET_gc   (0x02) /* Clock Phase - SET */
...
/* Timer/Counter1 Output CompareB Match Interrupt Enable */
#define TIMER_COUNTER_1_OCIE1B_CLEAR_gc (0x00) /* Timer/Counter1 Output CompareB Match Interrupt Enable - CLEAR */
#define TIMER_COUNTER_1_OCIE1B_SET_gc   (0x04) /* Timer/Counter1 Output CompareB Match Interrupt Enable - SET */


/* Timer/Counter1 Output CompareA Match Interrupt Enable */
#define TIMER_COUNTER_1_OCIE1A_CLEAR_gc (0x00) /* Timer/Counter1 Output CompareA Match Interrupt Enable - CLEAR */
#define TIMER_COUNTER_1_OCIE1A_SET_gc   (0x02) /* Timer/Counter1 Output CompareA Match Interrupt Enable - SET */
...
/* Input Capture Flag 1 */
#define TIMER_COUNTER_1_ICF1_CLEAR_gc (0x00) /* Input Capture Flag 1 - CLEAR */
#define TIMER_COUNTER_1_ICF1_SET_gc   (0x20) /* Input Capture Flag 1 - SET */


/* Output Compare Flag 1B */
#define TIMER_COUNTER_1_OCF1B_CLEAR_gc (0x00) /* Output Compare Flag 1B - CLEAR */
#define TIMER_COUNTER_1_OCF1B_SET_gc   (0x04) /* Output Compare Flag 1B - SET */


/* Output Compare Flag 1A */
#define TIMER_COUNTER_1_OCF1A_CLEAR_gc (0x00) /* Output Compare Flag 1A - CLEAR */
#define TIMER_COUNTER_1_OCF1A_SET_gc   (0x02) /* Output Compare Flag 1A - SET */
...
/* Timer/Counter1 Control Register C-FOC1A */
#define TIMER_COUNTER_1_FOC1A_CLEAR_gc (0x00) /* Timer/Counter1 Control Register C-FOC1A - CLEAR */
#define TIMER_COUNTER_1_FOC1A_SET_gc   (0x80) /* Timer/Counter1 Control Register C-FOC1A - SET */


/* Timer/Counter1 Control Register C-FOC1B */
#define TIMER_COUNTER_1_FOC1B_CLEAR_gc (0x00) /* Timer/Counter1 Control Register C-FOC1B - CLEAR */
#define TIMER_COUNTER_1_FOC1B_SET_gc   (0x40) /* Timer/Counter1 Control Register C-FOC1B - SET */


/* Timer/Counter Synchronization Mode */
#define TIMER_COUNTER_1_TSM_CLEAR_gc (0x00) /* Timer/Counter Synchronization Mode - CLEAR */
#define TIMER_COUNTER_1_TSM_SET_gc   (0x80) /* Timer/Counter Synchronization Mode - SET */


/* Prescaler Reset Timer/Counter1 and Timer/Counter0 */
#define TIMER_COUNTER_1_PSRSYNC_CLEAR_gc (0x00) /* Prescaler Reset Timer/Counter1 and Timer/Counter0 - CLEAR */
#define TIMER_COUNTER_1_PSRSYNC_SET_gc   (0x01) /* Prescaler Reset Timer/Counter1 and Timer/Counter0 - SET */
...
/* Timer/Counter2 Output Compare Match B Interrupt Enable */
#define TIMER_COUNTER_2_OCIE2B_CLEAR_gc (0x00) /* Timer/Counter2 Output Compare Match B Interrupt Enable - CLEAR */
#define TIMER_COUNTER_2_OCIE2B_SET_gc   (0x04) /* Timer/Counter2 Output Compare Match B Interrupt Enable - SET */


/* Timer/Counter2 Output Compare Match A Interrupt Enable */
#define TIMER_COUNTER_2_OCIE2A_CLEAR_gc (0x00) /* Timer/Counter2 Output Compare Match A Interrupt Enable - CLEAR */
#define TIMER_COUNTER_2_OCIE2A_SET_gc   (0x02) /* Timer/Counter2 Output Compare Match A Interrupt Enable - SET */


/* Timer/Counter2 Overflow Interrupt Enable */
#define TIMER_COUNTER_2_TOIE2_CLEAR_gc (0x00) /* Timer/Counter2 Overflow Interrupt Enable - CLEAR */
#define TIMER_COUNTER_2_TOIE2_SET_gc   (0x01) /* Timer/Counter2 Overflow Interrupt Enable - SET */


/* Output Compare Flag 2B */
#define TIMER_COUNTER_2_OCF2B_CLEAR_gc (0x00) /* Output Compare Flag 2B - CLEAR */
#define TIMER_COUNTER_2_OCF2B_SET_gc   (0x04) /* Output Compare Flag 2B - SET */


/* Output Compare Flag 2A */
#define TIMER_COUNTER_2_OCF2A_CLEAR_gc (0x00) /* Output Compare Flag 2A - CLEAR */
#define TIMER_COUNTER_2_OCF2A_SET_gc   (0x02) /* Output Compare Flag 2A - SET */


/* Timer/Counter2 Overflow Flag */
#define TIMER_COUNTER_2_TOV2_CLEAR_gc (0x00) /* Timer/Counter2 Overflow Flag - CLEAR */
#define TIMER_COUNTER_2_TOV2_SET_gc   (0x01) /* Timer/Counter2 Overflow Flag - SET */
...
/* Force Output Compare A */
#define TIMER_COUNTER_2_FOC2A_CLEAR_gc (0x00) /* Force Output Compare A - CLEAR */
#define TIMER_COUNTER_2_FOC2A_SET_gc   (0x80) /* Force Output Compare A - SET */


/* Force Output Compare B */
#define TIMER_COUNTER_2_FOC2B_CLEAR_gc (0x00) /* Force Output Compare B - CLEAR */
#define TIMER_COUNTER_2_FOC2B_SET_gc   (0x40) /* Force Output Compare B - SET */


/* Waveform Generation Mode */
#define TIMER_COUNTER_2_WGM22_CLEAR_gc (0x00) /* Waveform Generation Mode - CLEAR */
#define TIMER_COUNTER_2_WGM22_SET_gc   (0x08) /* Waveform Generation Mode - SET */


/* Clock Select bits */
#define TIMER_COUNTER_2_CS2_VAL_0x00_gc (0x00) /* No Clock Source (Stopped) */
#define TIMER_COUNTER_2_CS2_VAL_0x01_gc (0x01) /* Running, No Prescaling */
#define TIMER_COUNTER_2_CS2_VAL_0x02_gc (0x02) /* Running, CLK/8 */
#define TIMER_COUNTER_2_CS2_VAL_0x03_gc (0x03) /* Running, CLK/32 */
#define TIMER_COUNTER_2_CS2_VAL_0x04_gc (0x04) /* Running, CLK/64 */
#define TIMER_COUNTER_2_CS2_VAL_0x05_gc (0x05) /* Running, CLK/128 */
#define TIMER_COUNTER_2_CS2_VAL_0x06_gc (0x06) /* Running, CLK/256 */
#define TIMER_COUNTER_2_CS2_VAL_0x07_gc (0x07) /* Running, CLK/1024 */


/* Enable External Clock Input */
#define TIMER_COUNTER_2_EXCLK_CLEAR_gc (0x00) /* Enable External Clock Input - CLEAR */
#define TIMER_COUNTER_2_EXCLK_SET_gc   (0x40) /* Enable External Clock Input - SET */


/* Asynchronous Timer/Counter2 */
#define TIMER_COUNTER_2_AS2_CLEAR_gc (0x00) /* Asynchronous Timer/Counter2 - CLEAR */
#define TIMER_COUNTER_2_AS2_SET_gc   (0x20) /* Asynchronous Timer/Counter2 - SET */


/* Timer/Counter2 Update Busy */
#define TIMER_COUNTER_2_TCN2UB_CLEAR_gc (0x00) /* Timer/Counter2 Update Busy - CLEAR */
#define TIMER_COUNTER_2_TCN2UB_SET_gc   (0x10) /* Timer/Counter2 Update Busy - SET */


/* Output Compare Register2 Update Busy */
#define TIMER_COUNTER_2_OCR2AUB_CLEAR_gc (0x00) /* Output Compare Register2 Update Busy - CLEAR */
#define TIMER_COUNTER_2_OCR2AUB_SET_gc   (0x08) /* Output Compare Register2 Update Busy - SET */


/* Output Compare Register 2 Update Busy */
#define TIMER_COUNTER_2_OCR2BUB_CLEAR_gc (0x00) /* Output Compare Register 2 Update Busy - CLEAR */
#define TIMER_COUNTER_2_OCR2BUB_SET_gc   (0x04) /* Output Compare Register 2 Update Busy - SET */


/* Timer/Counter Control Register2 Update Busy */
#define TIMER_COUNTER_2_TCR2AUB_CLEAR_gc (0x00) /* Timer/Counter Control Register2 Update Busy - CLEAR */
#define TIMER_COUNTER_2_TCR2AUB_SET_gc   (0x02) /* Timer/Counter Control Register2 Update Busy - SET */


/* Timer/Counter Control Register2 Update Busy */
#define TIMER_COUNTER_2_TCR2BUB_CLEAR_gc (0x00) /* Timer/Counter Control Register2 Update Busy - CLEAR */
#define TIMER_COUNTER_2_TCR2BUB_SET_gc   (0x01) /* Timer/Counter Control Register2 Update Busy - SET */


/* Timer/Counter Synchronization Mode */
#define TIMER_COUNTER_2_TSM_CLEAR_gc (0x00) /* Timer/Counter Synchronization Mode - CLEAR */
#define TIMER_COUNTER_2_TSM_SET_gc   (0x80) /* Timer/Counter Synchronization Mode - SET */


/* Prescaler Reset Timer/Counter2 */
#define TIMER_COUNTER_2_PSRASY_CLEAR_gc (0x00) /* Prescaler Reset Timer/Counter2 - CLEAR */
#define TIMER_COUNTER_2_PSRASY_SET_gc   (0x02) /* Prescaler Reset Timer/Counter2 - SET */
...
/* Reference Selection Bits */
#define AD_CONVERTER_REFS_VAL_0x00_gc (0x00<<6) /* AREF, Internal Vref turned off */
#define AD_CONVERTER_REFS_VAL_0x01_gc (0x01<<6) /* AVCC with external capacitor at AREF pin */
#define AD_CONVERTER_REFS_VAL_0x02_gc (0x02<<6) /* Reserved */
#define AD_CONVERTER_REFS_VAL_0x03_gc (0x03<<6) /* Internal 1.1V Voltage Reference with external capacitor at AREF pin */
...
/* The ADC Control and Status register B-ACME */
#define AD_CONVERTER_ACME_CLEAR_gc (0x00) /* The ADC Control and Status register B-ACME - CLEAR */
#define AD_CONVERTER_ACME_SET_gc   (0x40) /* The ADC Control and Status register B-ACME - SET */
...
#define AD_CONVERTER_ADTS_VAL_0x03_gc (0x03) /* Timer/Counter0 Compare Match A */
#define AD_CONVERTER_ADTS_VAL_0x04_gc (0x04) /* Timer/Counter0 Overflow */
#define AD_CONVERTER_ADTS_VAL_0x05_gc (0x05) /* Timer/Counter1 Compare Match B */
#define AD_CONVERTER_ADTS_VAL_0x06_gc (0x06) /* Timer/Counter1 Overflow */
#define AD_CONVERTER_ADTS_VAL_0x07_gc (0x07) /* Timer/Counter1 Capture Event */


/* Digital Input Disable Register-ADC5D */
#define AD_CONVERTER_ADC5D_CLEAR_gc (0x00) /* Digital Input Disable Register-ADC5D - CLEAR */
#define AD_CONVERTER_ADC5D_SET_gc   (0x20) /* Digital Input Disable Register-ADC5D - SET */


/* Digital Input Disable Register-ADC4D */
#define AD_CONVERTER_ADC4D_CLEAR_gc (0x00) /* Digital Input Disable Register-ADC4D - CLEAR */
#define AD_CONVERTER_ADC4D_SET_gc   (0x10) /* Digital Input Disable Register-ADC4D - SET */


/* Digital Input Disable Register-ADC3D */
#define AD_CONVERTER_ADC3D_CLEAR_gc (0x00) /* Digital Input Disable Register-ADC3D - CLEAR */
#define AD_CONVERTER_ADC3D_SET_gc   (0x08) /* Digital Input Disable Register-ADC3D - SET */


/* Digital Input Disable Register-ADC2D */
#define AD_CONVERTER_ADC2D_CLEAR_gc (0x00) /* Digital Input Disable Register-ADC2D - CLEAR */
#define AD_CONVERTER_ADC2D_SET_gc   (0x04) /* Digital Input Disable Register-ADC2D - SET */


/* Digital Input Disable Register-ADC1D */
#define AD_CONVERTER_ADC1D_CLEAR_gc (0x00) /* Digital Input Disable Register-ADC1D - CLEAR */
#define AD_CONVERTER_ADC1D_SET_gc   (0x02) /* Digital Input Disable Register-ADC1D - SET */


/* Digital Input Disable Register-ADC0D */
#define AD_CONVERTER_ADC0D_CLEAR_gc (0x00) /* Digital Input Disable Register-ADC0D - CLEAR */
#define AD_CONVERTER_ADC0D_SET_gc   (0x01) /* Digital Input Disable Register-ADC0D - SET */
...
/* Analog Comparator Bandgap Select */
#define ANALOG_COMPARATOR_ACBG_CLEAR_gc (0x00) /* Analog Comparator Bandgap Select - CLEAR */
#define ANALOG_COMPARATOR_ACBG_SET_gc   (0x40) /* Analog Comparator Bandgap Select - SET */
...
/* AIN1 Digital Input Disable */
#define ANALOG_COMPARATOR_AIN1D_CLEAR_gc (0x00) /* AIN1 Digital Input Disable - CLEAR */
#define ANALOG_COMPARATOR_AIN1D_SET_gc   (0x02) /* AIN1 Digital Input Disable - SET */


/* AIN0 Digital Input Disable */
#define ANALOG_COMPARATOR_AIN0D_CLEAR_gc (0x00) /* AIN0 Digital Input Disable - CLEAR */
#define ANALOG_COMPARATOR_AIN0D_SET_gc   (0x01) /* AIN0 Digital Input Disable - SET */
...
/* Force Output Compare B */
#define TIMER_COUNTER_0_FOC0B_CLEAR_gc (0x00) /* Force Output Compare B - CLEAR */
#define TIMER_COUNTER_0_FOC0B_SET_gc   (0x40) /* Force Output Compare B - SET */


/* Timer/Counter Control Register B-WGM02 */
#define TIMER_COUNTER_0_WGM02_CLEAR_gc (0x00) /* Timer/Counter Control Register B-WGM02 - CLEAR */
#define TIMER_COUNTER_0_WGM02_SET_gc   (0x08) /* Timer/Counter Control Register B-WGM02 - SET */
...
#define TIMER_COUNTER_0_CS0_VAL_0x03_gc (0x03) /* Running, CLK/64 */
#define TIMER_COUNTER_0_CS0_VAL_0x04_gc (0x04) /* Running, CLK/256 */
#define TIMER_COUNTER_0_CS0_VAL_0x05_gc (0x05) /* Running, CLK/1024 */
#define TIMER_COUNTER_0_CS0_VAL_0x06_gc (0x06) /* Running, ExtClk Tx Falling Edge */
#define TIMER_COUNTER_0_CS0_VAL_0x07_gc (0x07) /* Running, ExtClk Tx Rising Edge */
...
/* Timer/Counter0 Output Compare Match B Interrupt Enable */
#define TIMER_COUNTER_0_OCIE0B_CLEAR_gc (0x00) /* Timer/Counter0 Output Compare Match B Interrupt Enable - CLEAR */
#define TIMER_COUNTER_0_OCIE0B_SET_gc   (0x04) /* Timer/Counter0 Output Compare Match B Interrupt Enable - SET */
...
/* Timer/Counter0 Output Compare Flag 0B */
#define TIMER_COUNTER_0_OCF0B_CLEAR_gc (0x00) /* Timer/Counter0 Output Compare Flag 0B - CLEAR */
#define TIMER_COUNTER_0_OCF0B_SET_gc   (0x04) /* Timer/Counter0 Output Compare Flag 0B - SET */


/* Timer/Counter0 Output Compare Flag 0A */
#define TIMER_COUNTER_0_OCF0A_CLEAR_gc (0x00) /* Timer/Counter0 Output Compare Flag 0A - CLEAR */
#define TIMER_COUNTER_0_OCF0A_SET_gc   (0x02) /* Timer/Counter0 Output Compare Flag 0A - SET */
...
/* Prescaler Reset Timer/Counter1 and Timer/Counter0 */
#define TIMER_COUNTER_0_PSRSYNC_CLEAR_gc (0x00) /* Prescaler Reset Timer/Counter1 and Timer/Counter0 - CLEAR */
#define TIMER_COUNTER_0_PSRSYNC_SET_gc   (0x01) /* Prescaler Reset Timer/Counter1 and Timer/Counter0 - SET */
...
#define EXTERNAL_INTERRUPT_ISC1_VAL_0x01_gc (0x01<<2) /* Any Logical Change of INTX */
...
#define EXTERNAL_INTERRUPT_ISC0_VAL_0x01_gc (0x01) /* Any Logical Change of INTX */
...
/* USART0 -  (0x0000) */
#define USART0_BASE               _SFR_MEM8 (0x0000) /* USART0 Base Address */
#define USART0_UCSR0A             _SFR_MEM8 (0x00C0) /* USART Control and Status Register A */
#define USART0_UCSR0B             _SFR_MEM8 (0x00C1) /* USART Control and Status Register B */
#define USART0_UCSR0C             _SFR_MEM8 (0x00C2) /* USART Control and Status Register C */
#define USART0_UBRR0              _SFR_MEM16(0x00C4) /* USART Baud Rate Register  Bytes */
#define USART0_UBRR0L             _SFR_MEM8 (0x00C4) /* USART Baud Rate Register  Bytes LOW BYTE */
#define USART0_UBRR0H             _SFR_MEM8 (0x00C5) /* USART Baud Rate Register  Bytes HIGH BYTE */
#define USART0_UDR0               _SFR_MEM8 (0x00C6) /* USART I/O Data Register */
...
#define TIMER_COUNTER_1_TIFR1     _SFR_MEM8 (0x0036) /* Timer/Counter Interrupt Flag register */
#define TIMER_COUNTER_1_GTCCR     _SFR_MEM8 (0x0043) /* General Timer/Counter Control Register */
#define TIMER_COUNTER_1_TIMSK1    _SFR_MEM8 (0x006F) /* Timer/Counter Interrupt Mask Register */
...
#define TIMER_COUNTER_1_OCR1A     _SFR_MEM16(0x0088) /* Timer/Counter1 Output Compare Register  Bytes */
#define TIMER_COUNTER_1_OCR1AL    _SFR_MEM8 (0x0088) /* Timer/Counter1 Output Compare Register  Bytes LOW BYTE */
#define TIMER_COUNTER_1_OCR1AH    _SFR_MEM8 (0x0089) /* Timer/Counter1 Output Compare Register  Bytes HIGH BYTE */
#define TIMER_COUNTER_1_OCR1B     _SFR_MEM16(0x008A) /* Timer/Counter1 Output Compare Register  Bytes */
#define TIMER_COUNTER_1_OCR1BL    _SFR_MEM8 (0x008A) /* Timer/Counter1 Output Compare Register  Bytes LOW BYTE */
#define TIMER_COUNTER_1_OCR1BH    _SFR_MEM8 (0x008B) /* Timer/Counter1 Output Compare Register  Bytes HIGH BYTE */

/* TIMER_COUNTER_2 -  (0x0000) */
#define TIMER_COUNTER_2_BASE      _SFR_MEM8 (0x0000) /* TIMER_COUNTER_2 Base Address */
#define TIMER_COUNTER_2_TIFR2     _SFR_MEM8 (0x0037) /* Timer/Counter Interrupt Flag Register */
#define TIMER_COUNTER_2_GTCCR     _SFR_MEM8 (0x0043) /* General Timer Counter Control register */
#define TIMER_COUNTER_2_TIMSK2    _SFR_MEM8 (0x0070) /* Timer/Counter Interrupt Mask register */
#define TIMER_COUNTER_2_TCCR2A    _SFR_MEM8 (0x00B0) /* Timer/Counter2 Control Register A */
#define TIMER_COUNTER_2_TCCR2B    _SFR_MEM8 (0x00B1) /* Timer/Counter2 Control Register B */
#define TIMER_COUNTER_2_TCNT2     _SFR_MEM8 (0x00B2) /* Timer/Counter2 */
#define TIMER_COUNTER_2_OCR2A     _SFR_MEM8 (0x00B3) /* Timer/Counter2 Output Compare Register A */
#define TIMER_COUNTER_2_OCR2B     _SFR_MEM8 (0x00B4) /* Timer/Counter2 Output Compare Register B */
#define TIMER_COUNTER_2_ASSR      _SFR_MEM8 (0x00B6) /* Asynchronous Status Register */

/* AD_CONVERTER -  (0x0000) */
#define AD_CONVERTER_BASE         _SFR_MEM16(0x0000) /* AD_CONVERTER Base Address */
...
#define AD_CONVERTER_ADCSRB       _SFR_MEM8 (0x007B) /* The ADC Control and Status register B */
#define AD_CONVERTER_ADMUX        _SFR_MEM8 (0x007C) /* The ADC multiplexer Selection Register */
#define AD_CONVERTER_DIDR0        _SFR_MEM8 (0x007E) /* Digital Input Disable Register */
...
#define ANALOG_COMPARATOR_DIDR1   _SFR_MEM8 (0x007F) /* Digital Input Disable Register 1 */
...
#define TIMER_COUNTER_0_TCCR0A    _SFR_MEM8 (0x0044) /* Timer/Counter  Control Register A */
#define TIMER_COUNTER_0_TCCR0B    _SFR_MEM8 (0x0045) /* Timer/Counter Control Register B */
#define TIMER_COUNTER_0_TCNT0     _SFR_MEM8 (0x0046) /* Timer/Counter0 */
#define TIMER_COUNTER_0_OCR0A     _SFR_MEM8 (0x0047) /* Timer/Counter0 Output Compare Register */
#define TIMER_COUNTER_0_OCR0B     _SFR_MEM8 (0x0048) /* Timer/Counter0 Output Compare Register */
...
#define EXTERNAL_INTERRUPT_PCMSK2 _SFR_MEM8 (0x006D) /* Pin Change Mask Register 2 */
...
#define BOOT_SECTION_1_START     (0x3F00)                                         
...
#define BOOT_SECTION_2_START     (0x3E00)                                         
...
#define BOOT_SECTION_3_START     (0x3C00)                                         
...
#define BOOT_SECTION_4_START     (0x3800)                                         
