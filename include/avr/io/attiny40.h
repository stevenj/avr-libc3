 ...
 *                                                                            * 
 *   .atpack File: ATtiny40.atdf                                              * 
 *   .ATDF File:   atdf/ATtiny40.atdf                                         * 
 *   Version:      2.0.10                                                     * 
 *   Date:         2019-04-25                                                 * 
 *   Device:       ATtiny40                                                   * 
 *   Architecture: AVR8L                                                      * 
...
#  define _AVR_IOXXX_H_ "ioATtiny40.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_ATtiny40_H_INCLUDED
#  define _AVR_ATtiny40_H_INCLUDED
...
#define RAMDR  _SFR_MEM8 (0x1F) /* RAM Data Register */
#define RAMAR  _SFR_MEM8 (0x20) /* RAM Address Register */
...
typedef enum ADC_MUX_enum
{
    ...
    ADC_MUX_ADC8_gc     = (0x08), /* ADC8 */
    ADC_MUX_ADC9_gc     = (0x09), /* ADC9 */
    ADC_MUX_ADC10_gc    = (0x0A), /* ADC10 */
    ADC_MUX_ADC11_gc    = (0x0B), /* ADC11 */
    ADC_MUX_ADC_GND_gc  = (0x0C), /* 0V (AGND) */
    ADC_MUX_ADC_VBG_gc  = (0x0D), /* 1.1V Internal Reference */
    ADC_MUX_TEMPSENS_gc = (0x0E), /* Temperature sensor */
} ADC_MUX_t;
...
{
    register8_t rsv_0x00[31]; /* RESERVED REGISTER BLOCK */
    register8_t RAMDR;        /* RAM Data Register */
    register8_t RAMAR;        /* RAM Address Register */
    register8_t rsv_0x21[17]; /* RESERVED REGISTER BLOCK */
...
typedef struct EXINT_struct
{
    ...
    register8_t rsv_0x0D[13]; /* RESERVED REGISTER BLOCK */
    register8_t PCMSK2;       /* Pin Change Mask Register 2 */
    register8_t rsv_0x1B[31]; /* RESERVED REGISTER BLOCK */
    register8_t MCUCR;        /* MCU Control Register */
} EXINT_t;
...
#define EXINT_GIMSK_PCIE_gc(x) ((x<<4) & 0x70)
...
#define EXINT_GIFR_PCIF_gc(x) ((x<<4) & 0x70)
...
typedef struct PORTC_struct
{
    ...
    register8_t PORTCR;       /* Port Control Register */
    register8_t rsv_0x09[18]; /* RESERVED REGISTER BLOCK */
...
/* Port Control Register-ADC11D */
typedef enum PORTB_ADC11D_enum
{
    PORTB_ADC11D_CLEAR_gc = (0x00), /* Port Control Register-ADC11D - CLEAR */
    PORTB_ADC11D_SET_gc   = (0x80), /* Port Control Register-ADC11D - SET */
} PORTB_ADC11D_t;

/* Port Control Register-ADC10D */
typedef enum PORTB_ADC10D_enum
{
    PORTB_ADC10D_CLEAR_gc = (0x00), /* Port Control Register-ADC10D - CLEAR */
    PORTB_ADC10D_SET_gc   = (0x40), /* Port Control Register-ADC10D - SET */
} PORTB_ADC10D_t;

/* Port Control Register-ADC9D */
typedef enum PORTB_ADC9D_enum
{
    PORTB_ADC9D_CLEAR_gc = (0x00), /* Port Control Register-ADC9D - CLEAR */
    PORTB_ADC9D_SET_gc   = (0x20), /* Port Control Register-ADC9D - SET */
} PORTB_ADC9D_t;

/* Port Control Register-ADC8D */
typedef enum PORTB_ADC8D_enum
{
    PORTB_ADC8D_CLEAR_gc = (0x00), /* Port Control Register-ADC8D - CLEAR */
    PORTB_ADC8D_SET_gc   = (0x10), /* Port Control Register-ADC8D - SET */
} PORTB_ADC8D_t;

/* Break-Before-Make Mode Enable */
typedef enum PORTB_BBMC_enum
{
    PORTB_BBMC_CLEAR_gc = (0x00), /* Break-Before-Make Mode Enable - CLEAR */
    PORTB_BBMC_SET_gc   = (0x04), /* Break-Before-Make Mode Enable - SET */
} PORTB_BBMC_t;
...
/* Break-Before-Make Mode Enable */
typedef enum PORTB_BBMA_enum
{
    PORTB_BBMA_CLEAR_gc = (0x00), /* Break-Before-Make Mode Enable - CLEAR */
    PORTB_BBMA_SET_gc   = (0x01), /* Break-Before-Make Mode Enable - SET */
} PORTB_BBMA_t;

/* Port Control Register-ADC11D */
typedef enum PORTC_ADC11D_enum
{
    PORTC_ADC11D_CLEAR_gc = (0x00), /* Port Control Register-ADC11D - CLEAR */
    PORTC_ADC11D_SET_gc   = (0x80), /* Port Control Register-ADC11D - SET */
} PORTC_ADC11D_t;

/* Port Control Register-ADC10D */
typedef enum PORTC_ADC10D_enum
{
    PORTC_ADC10D_CLEAR_gc = (0x00), /* Port Control Register-ADC10D - CLEAR */
    PORTC_ADC10D_SET_gc   = (0x40), /* Port Control Register-ADC10D - SET */
} PORTC_ADC10D_t;

/* Port Control Register-ADC9D */
typedef enum PORTC_ADC9D_enum
{
    PORTC_ADC9D_CLEAR_gc = (0x00), /* Port Control Register-ADC9D - CLEAR */
    PORTC_ADC9D_SET_gc   = (0x20), /* Port Control Register-ADC9D - SET */
} PORTC_ADC9D_t;

/* Port Control Register-ADC8D */
typedef enum PORTC_ADC8D_enum
{
    PORTC_ADC8D_CLEAR_gc = (0x00), /* Port Control Register-ADC8D - CLEAR */
    PORTC_ADC8D_SET_gc   = (0x10), /* Port Control Register-ADC8D - SET */
} PORTC_ADC8D_t;
...
typedef struct TC0_struct
{
    ...
    register8_t rsv_0x1A[7];  /* RESERVED REGISTER BLOCK */
    register8_t OCR1B;        /* Timer/Counter 1 Output Compare Register B */
    register8_t OCR1A;        /* Timer/Counter 1 Output Compare Register A */
    register8_t TCNT1L;       /* Timer/Counter1 Low */
    ...
    register8_t TCNT1H;       /* Timer/Counter1 High */
} TC0_t;
...
typedef enum TC0_TSM_enum
{
    ...
    TC0_TSM_SET_gc   = (0x20), /* Timer/Counter Synchronization Mode - SET */
} TC0_TSM_t;

/* Prescaler Reset Timer/Counter */
typedef enum TC0_PSR_enum
{
    TC0_PSR_CLEAR_gc = (0x00), /* Prescaler Reset Timer/Counter - CLEAR */
    TC0_PSR_SET_gc   = (0x10), /* Prescaler Reset Timer/Counter - SET */
} TC0_PSR_t;
...
typedef enum TC0_TCW1_enum
{
    TC0_TCW1_CLEAR_gc = (0x00), /* Timer/Counter1 Width - CLEAR */
    TC0_TCW1_SET_gc   = (0x80), /* Timer/Counter1 Width - SET */
} TC0_TCW1_t;

/* Input Capture Mode Enable */
typedef enum TC0_ICEN1_enum
{
    TC0_ICEN1_CLEAR_gc = (0x00), /* Input Capture Mode Enable - CLEAR */
    TC0_ICEN1_SET_gc   = (0x40), /* Input Capture Mode Enable - SET */
} TC0_ICEN1_t;

/* : Input Capture Noise Canceler */
typedef enum TC0_ICNC1_enum
{
    TC0_ICNC1_CLEAR_gc = (0x00), /* : Input Capture Noise Canceler - CLEAR */
    TC0_ICNC1_SET_gc   = (0x20), /* : Input Capture Noise Canceler - SET */
} TC0_ICNC1_t;

/* Input Capture Edge Select */
typedef enum TC0_ICES1_enum
{
    TC0_ICES1_CLEAR_gc = (0x00), /* Input Capture Edge Select - CLEAR */
    TC0_ICES1_SET_gc   = (0x10), /* Input Capture Edge Select - SET */
} TC0_ICES1_t;

/* Waveform Generation Mode */
typedef enum TC0_CTC1_enum
{
    TC0_CTC1_CLEAR_gc = (0x00), /* Waveform Generation Mode - CLEAR */
    TC0_CTC1_SET_gc   = (0x08), /* Waveform Generation Mode - SET */
} TC0_CTC1_t;

/* The Clock Select1 bits 2, 1, and 0 define the prescaling source of Timer1. */
#define TC0_TCCR1A_CS1_gc(x) (x & 0x07)
...
#define ADC_MUX_ADC8_gc     (0x08) /* ADC8 */
#define ADC_MUX_ADC9_gc     (0x09) /* ADC9 */
#define ADC_MUX_ADC10_gc    (0x0A) /* ADC10 */
#define ADC_MUX_ADC11_gc    (0x0B) /* ADC11 */
#define ADC_MUX_ADC_GND_gc  (0x0C) /* 0V (AGND) */
#define ADC_MUX_ADC_VBG_gc  (0x0D) /* 1.1V Internal Reference */
#define ADC_MUX_TEMPSENS_gc (0x0E) /* Temperature sensor */
...
/* Port Control Register-ADC11D */
#define PORTB_ADC11D_CLEAR_gc (0x00) /* Port Control Register-ADC11D - CLEAR */
#define PORTB_ADC11D_SET_gc   (0x80) /* Port Control Register-ADC11D - SET */


/* Port Control Register-ADC10D */
#define PORTB_ADC10D_CLEAR_gc (0x00) /* Port Control Register-ADC10D - CLEAR */
#define PORTB_ADC10D_SET_gc   (0x40) /* Port Control Register-ADC10D - SET */


/* Port Control Register-ADC9D */
#define PORTB_ADC9D_CLEAR_gc (0x00) /* Port Control Register-ADC9D - CLEAR */
#define PORTB_ADC9D_SET_gc   (0x20) /* Port Control Register-ADC9D - SET */


/* Port Control Register-ADC8D */
#define PORTB_ADC8D_CLEAR_gc (0x00) /* Port Control Register-ADC8D - CLEAR */
#define PORTB_ADC8D_SET_gc   (0x10) /* Port Control Register-ADC8D - SET */


/* Break-Before-Make Mode Enable */
#define PORTB_BBMC_CLEAR_gc (0x00) /* Break-Before-Make Mode Enable - CLEAR */
#define PORTB_BBMC_SET_gc   (0x04) /* Break-Before-Make Mode Enable - SET */
...
/* Break-Before-Make Mode Enable */
#define PORTB_BBMA_CLEAR_gc (0x00) /* Break-Before-Make Mode Enable - CLEAR */
#define PORTB_BBMA_SET_gc   (0x01) /* Break-Before-Make Mode Enable - SET */


/* Port Control Register-ADC11D */
#define PORTC_ADC11D_CLEAR_gc (0x00) /* Port Control Register-ADC11D - CLEAR */
#define PORTC_ADC11D_SET_gc   (0x80) /* Port Control Register-ADC11D - SET */


/* Port Control Register-ADC10D */
#define PORTC_ADC10D_CLEAR_gc (0x00) /* Port Control Register-ADC10D - CLEAR */
#define PORTC_ADC10D_SET_gc   (0x40) /* Port Control Register-ADC10D - SET */


/* Port Control Register-ADC9D */
#define PORTC_ADC9D_CLEAR_gc (0x00) /* Port Control Register-ADC9D - CLEAR */
#define PORTC_ADC9D_SET_gc   (0x20) /* Port Control Register-ADC9D - SET */


/* Port Control Register-ADC8D */
#define PORTC_ADC8D_CLEAR_gc (0x00) /* Port Control Register-ADC8D - CLEAR */
#define PORTC_ADC8D_SET_gc   (0x10) /* Port Control Register-ADC8D - SET */
...
#define TC0_TSM_SET_gc   (0x20) /* Timer/Counter Synchronization Mode - SET */


/* Prescaler Reset Timer/Counter */
#define TC0_PSR_CLEAR_gc (0x00) /* Prescaler Reset Timer/Counter - CLEAR */
#define TC0_PSR_SET_gc   (0x10) /* Prescaler Reset Timer/Counter - SET */
...
/* Timer/Counter1 Width */
#define TC0_TCW1_CLEAR_gc (0x00) /* Timer/Counter1 Width - CLEAR */
#define TC0_TCW1_SET_gc   (0x80) /* Timer/Counter1 Width - SET */


/* Input Capture Mode Enable */
#define TC0_ICEN1_CLEAR_gc (0x00) /* Input Capture Mode Enable - CLEAR */
#define TC0_ICEN1_SET_gc   (0x40) /* Input Capture Mode Enable - SET */


/* : Input Capture Noise Canceler */
#define TC0_ICNC1_CLEAR_gc (0x00) /* : Input Capture Noise Canceler - CLEAR */
#define TC0_ICNC1_SET_gc   (0x20) /* : Input Capture Noise Canceler - SET */


/* Input Capture Edge Select */
#define TC0_ICES1_CLEAR_gc (0x00) /* Input Capture Edge Select - CLEAR */
#define TC0_ICES1_SET_gc   (0x10) /* Input Capture Edge Select - SET */


/* Waveform Generation Mode */
#define TC0_CTC1_CLEAR_gc (0x00) /* Waveform Generation Mode - CLEAR */
#define TC0_CTC1_SET_gc   (0x08) /* Waveform Generation Mode - SET */
...
#define CPU_RAMDR       _SFR_MEM8 (0x001F) /* RAM Data Register */
#define CPU_RAMAR       _SFR_MEM8 (0x0020) /* RAM Address Register */
...
#define EXINT_PCMSK2    _SFR_MEM8 (0x001A) /* Pin Change Mask Register 2 */
...
#define PORTCC_PORTCR   _SFR_MEM8 (0x0008) /* Port Control Register */
#define PORTCC_PINC     _SFR_MEM8 (0x001B) /* Port C Input Pins */
#define PORTCC_DDRC     _SFR_MEM8 (0x001C) /* Data Direction Register, Port C */
#define PORTCC_PORTC    _SFR_MEM8 (0x001D) /* Port C Data Register */
#define PORTCC_PUEC     _SFR_MEM8 (0x001E) /* Pull-up Enable Control Register */
...
#define TC8_OCR1B       _SFR_MEM8 (0x0021) /* Timer/Counter 1 Output Compare Register B */
#define TC8_OCR1A       _SFR_MEM8 (0x0022) /* Timer/Counter 1 Output Compare Register A */
#define TC8_TCNT1L      _SFR_MEM8 (0x0023) /* Timer/Counter1 Low */
#define TC8_TCCR1A      _SFR_MEM8 (0x0024) /* Timer/Counter1 Control Register A */
...
#define TC8_TCNT1H      _SFR_MEM8 (0x0027) /* Timer/Counter1 High */
...
#define None_WDT_vect            _VECTOR(5)          /* Watchdog Time-out */
#define None_TIM1_CAPT_vect_num  (6)                 
#define None_TIM1_CAPT_vect      _VECTOR(6)          /* Timer/Counter1 Input Capture */
...
#define None_TIM0_COMPA_vect     _VECTOR(10)         /* Timer/Counter0 Compare Match A */
#define None_TIM0_COMPB_vect_num (11)                
#define None_TIM0_COMPB_vect     _VECTOR(11)         /* Timer/Counter0 Compare Match B */
#define None_TIM0_OVF_vect_num   (12)                
#define None_TIM0_OVF_vect       _VECTOR(12)         /* Timer/Counter0 Overflow */
#define None_ANA_COMP_vect_num   (13)                
#define None_ANA_COMP_vect       _VECTOR(13)         /* Analog Comparator */
#define None_ADC_vect_num        (14)                
#define None_ADC_vect            _VECTOR(14)         /* Conversion Complete */
#define None_TWI_SLAVE_vect_num  (15)                
#define None_TWI_SLAVE_vect      _VECTOR(15)         /* Two-Wire Interface */
#define None_SPI_vect_num        (16)                
#define None_SPI_vect            _VECTOR(16)         /* Serial Peripheral Interface */
#define None_QTRIP_vect_num      (17)                
#define None_QTRIP_vect          _VECTOR(17)         /* Touch Sensing */

/* Vector Table Size */
#define _VECTOR_SIZE             (2)                 /* Size of individual vector. */
#define _VECTORS_SIZE            (18 * _VECTOR_SIZE) /* Size of all vectors */
/*
================================================================================
Constants
================================================================================
...
#define MAPPED_FLASH_SIZE                   (0x1000)                                                               
...
#endif /* #ifdef _AVR_ATtiny40_H_INCLUDED */
