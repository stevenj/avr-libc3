 ...
 *                                                                            * 
 *   .atpack File: ATtiny2313.atdf                                            * 
 *   .ATDF File:   atdf/ATtiny2313.atdf                                       * 
 *   Version:      2.0.10                                                     * 
 *   Date:         2019-04-25                                                 * 
 *   Device:       ATtiny2313                                                 * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATtiny2313.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_ATtiny2313_H_INCLUDED
#  define _AVR_ATtiny2313_H_INCLUDED
...
#define PCMSK  _SFR_MEM8 (0x40) /* Pin-Change Mask register */
...
typedef struct EXINT_struct
{
    ...
    register8_t EIFR;         /* Extended Interrupt Flag Register */
...
#define EXINT_EIFR_INTF_gc(x) ((x<<6) & 0xC0)

/* Extended Interrupt Flag Register-PCIF */
typedef enum EXINT_PCIF_enum
{
    EXINT_PCIF_CLEAR_gc = (0x00), /* Extended Interrupt Flag Register-PCIF - CLEAR */
    EXINT_PCIF_SET_gc   = (0x20), /* Extended Interrupt Flag Register-PCIF - SET */
} EXINT_PCIF_t;
...
typedef struct CPU_struct
{
    ...
    register8_t rsv_0x36[10]; /* RESERVED REGISTER BLOCK */
    register8_t PCMSK;        /* Pin-Change Mask register */
    register8_t rsv_0x41[2];  /* RESERVED REGISTER BLOCK */
...
/* Extended Interrupt Flag Register-PCIF */
#define EXINT_PCIF_CLEAR_gc (0x00) /* Extended Interrupt Flag Register-PCIF - CLEAR */
#define EXINT_PCIF_SET_gc   (0x20) /* Extended Interrupt Flag Register-PCIF - SET */
...
#define EXINT_EIFR      _SFR_MEM8 (0x005A) /* Extended Interrupt Flag Register */
...
#define CPU_PCMSK       _SFR_MEM8 (0x0040) /* Pin-Change Mask register */
...
#define None_PCINT_vect_num        (11)                
#define None_PCINT_vect            _VECTOR(11)         
...
#endif /* #ifdef _AVR_ATtiny2313_H_INCLUDED */
