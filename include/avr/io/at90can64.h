 ...
 *                                                                            * 
 *   .atpack File: AT90CAN64.atdf                                             * 
 *   .ATDF File:   atdf/AT90CAN64.atdf                                        * 
 *   Version:      2.0.12                                                     * 
 *   Date:         2019-04-26                                                 * 
 *   Device:       AT90CAN64                                                  * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioAT90CAN64.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_AT90CAN64_H_INCLUDED
#  define _AVR_AT90CAN64_H_INCLUDED
...
typedef enum FUSE_BODLEVEL_enum
{
    ...
    FUSE_BODLEVEL_4V1_gc      = (0x06<<1), /* Brown-out detection level at VCC=4.1 V */
    FUSE_BODLEVEL_4V0_gc      = (0x05<<1), /* Brown-out detection level at VCC=4.0 V */
    FUSE_BODLEVEL_3V9_gc      = (0x04<<1), /* Brown-out detection level at VCC=3.9 V */
    FUSE_BODLEVEL_3V8_gc      = (0x03<<1), /* Brown-out detection level at VCC=3.8 V */
    FUSE_BODLEVEL_2V7_gc      = (0x02<<1), /* Brown-out detection level at VCC=2.7 V */
    FUSE_BODLEVEL_2V6_gc      = (0x01<<1), /* Brown-out detection level at VCC=2.6 V */
    FUSE_BODLEVEL_2V5_gc      = (0x00<<1), /* Brown-out detection level at VCC=2.5 V */
} FUSE_BODLEVEL_t;
...
{
    FUSE_BOOTSZ_512W_7E00_gc  = (0x03<<1), /* Boot Flash size=512 words start address=$7E00 */
    FUSE_BOOTSZ_1024W_7C00_gc = (0x02<<1), /* Boot Flash size=1024 words start address=$7C00 */
    FUSE_BOOTSZ_2048W_7800_gc = (0x01<<1), /* Boot Flash size=2048 words start address=$7800 */
    FUSE_BOOTSZ_4096W_7000_gc = (0x00<<1), /* Boot Flash size=4096 words start address=$7000 */
} FUSE_BOOTSZ_t;
...
typedef struct EEPROM_struct
{
    ...
    _REGISTER16 (EEAR);       /* EEPROM Read/Write Access Bytes - Only bit 10..8 are used in AT90CAN64 - Only bit 9..8 are used in AT90CAN32 */
} EEPROM_t;
...
#define FUSE_BODLEVEL_4V1_gc      (0x06<<1) /* Brown-out detection level at VCC=4.1 V */
#define FUSE_BODLEVEL_4V0_gc      (0x05<<1) /* Brown-out detection level at VCC=4.0 V */
#define FUSE_BODLEVEL_3V9_gc      (0x04<<1) /* Brown-out detection level at VCC=3.9 V */
#define FUSE_BODLEVEL_3V8_gc      (0x03<<1) /* Brown-out detection level at VCC=3.8 V */
#define FUSE_BODLEVEL_2V7_gc      (0x02<<1) /* Brown-out detection level at VCC=2.7 V */
#define FUSE_BODLEVEL_2V6_gc      (0x01<<1) /* Brown-out detection level at VCC=2.6 V */
#define FUSE_BODLEVEL_2V5_gc      (0x00<<1) /* Brown-out detection level at VCC=2.5 V */
...
/* Select Boot Size */
#define FUSE_BOOTSZ_512W_7E00_gc  (0x03<<1) /* Boot Flash size=512 words start address=$7E00 */
#define FUSE_BOOTSZ_1024W_7C00_gc (0x02<<1) /* Boot Flash size=1024 words start address=$7C00 */
#define FUSE_BOOTSZ_2048W_7800_gc (0x01<<1) /* Boot Flash size=2048 words start address=$7800 */
#define FUSE_BOOTSZ_4096W_7000_gc (0x00<<1) /* Boot Flash size=4096 words start address=$7000 */
...
#define EEPROM_EEAR      _SFR_MEM16(0x0041) /* EEPROM Read/Write Access Bytes - Only bit 10..8 are used in AT90CAN64 - Only bit 9..8 are used in AT90CAN32 */
#define EEPROM_EEARL     _SFR_MEM8 (0x0041) /* EEPROM Read/Write Access Bytes - Only bit 10..8 are used in AT90CAN64 - Only bit 9..8 are used in AT90CAN32 LOW BYTE */
#define EEPROM_EEARH     _SFR_MEM8 (0x0042) /* EEPROM Read/Write Access Bytes - Only bit 10..8 are used in AT90CAN64 - Only bit 9..8 are used in AT90CAN32 HIGH BYTE */
...
#endif /* #ifdef _AVR_AT90CAN64_H_INCLUDED */
