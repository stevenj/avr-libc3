 ...
 *                                                                            * 
 *   .atpack File: ATmega164A.atdf                                            * 
 *   .ATDF File:   atdf/ATmega164A.atdf                                       * 
 *   Version:      2.0.12                                                     * 
 *   Date:         2019-04-26                                                 * 
 *   Device:       ATmega164A                                                 * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATmega164A.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_ATmega164A_H_INCLUDED
#  define _AVR_ATmega164A_H_INCLUDED
...
typedef enum SPI_SPR01_enum
{
    SPI_SPR01_CLEAR_gc = (0x00), /* SPI Clock Rate Select 1 - CLEAR */
    SPI_SPR01_SET_gc   = (0x02), /* SPI Clock Rate Select 1 - SET */
} SPI_SPR01_t;
...
/* SPI Clock Rate Select 1 */
#define SPI_SPR01_CLEAR_gc (0x00) /* SPI Clock Rate Select 1 - CLEAR */
#define SPI_SPR01_SET_gc   (0x02) /* SPI Clock Rate Select 1 - SET */
...
#endif /* #ifdef _AVR_ATmega164A_H_INCLUDED */
