 ...
 *                                                                            * 
 *   .atpack File: AT90PWM3B.atdf                                             * 
 *   .ATDF File:   atdf/AT90PWM3B.atdf                                        * 
 *   Version:      2.0.12                                                     * 
 *   Date:         2019-04-26                                                 * 
 *   Device:       AT90PWM3B                                                  * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioAT90PWM3B.h"
#else
...
typedef enum FUSE_SUT_CKSEL_enum
{
    ...
    FUSE_SUT_CKSEL_PLLCLK_16MHZ_1KCK_14CK_0MS_gc            = (0x03), /* PLL clock 16 MHz; Rc. Start-up time PWRDWN/RESET: 1K CK/14 CK + 0 ms */
...
typedef struct EUSART_struct
{
    ...
    _REGISTER16 (MUBRR);       /* Manchester Receiver Baud Rate Register */
...
#define ADC_ADCSRB_ADTS_gc(x) (x & 0x0F)
...
typedef struct USART_struct
{
    ...
    _REGISTER16 (UBRR);        /* USART Baud Rate Register */
...
typedef struct PSC0_struct
{
    ...
    _REGISTER16 (OCR0SA);      /* Output Compare 0 SA Register */
    register8_t rsv_0xD3;      /* RESERVED REGISTER */
    _REGISTER16 (OCR0RA);      /* Output Compare 0 RA Register */
    register8_t rsv_0xD5;      /* RESERVED REGISTER */
    _REGISTER16 (OCR0SB);      /* Output Compare 0 SB Register */
    register8_t rsv_0xD7;      /* RESERVED REGISTER */
    _REGISTER16 (OCR0RB);      /* Output Compare 0 RB Register */
...
{
    register8_t rsv_0x00[162]; /* RESERVED REGISTER BLOCK */
    register8_t PIFR1;         /* PSC1 Interrupt Flag Register */
    register8_t PIM1;          /* PSC1 Interrupt Mask Register */
    register8_t rsv_0xA4[60];  /* RESERVED REGISTER BLOCK */
    register8_t PSOC1;         /* PSC1 Synchro and Output Configuration */
    register8_t rsv_0xE1;      /* RESERVED REGISTER */
    _REGISTER16 (OCR1SA);      /* Output Compare SA Register  */
    register8_t rsv_0xE3;      /* RESERVED REGISTER */
    _REGISTER16 (OCR1RA);      /* Output Compare RA Register  */
    register8_t rsv_0xE5;      /* RESERVED REGISTER */
    _REGISTER16 (OCR1SB);      /* Output Compare SB Register  */
    register8_t rsv_0xE7;      /* RESERVED REGISTER */
    _REGISTER16 (OCR1RB);      /* Output Compare RB Register  */
    register8_t rsv_0xE9;      /* RESERVED REGISTER */
    register8_t PCNF1;         /* PSC 1 Configuration Register */
...
typedef struct PSC2_struct
{
    ...
    _REGISTER16 (OCR2SA);      /* Output Compare 2 SA Register */
    register8_t rsv_0xF3;      /* RESERVED REGISTER */
    _REGISTER16 (OCR2RA);      /* Output Compare 2 RA Register */
    register8_t rsv_0xF5;      /* RESERVED REGISTER */
    _REGISTER16 (OCR2SB);      /* Output Compare 2 SB Register */
    register8_t rsv_0xF7;      /* RESERVED REGISTER */
    _REGISTER16 (OCR2RB);      /* Output Compare 2 RB Register */
...
typedef enum PSC1_PCST1_enum
{
    PSC1_PCST1_CLEAR_gc = (0x00)  , /* PSC 1 Input Capture Software Trig - CLEAR */
    PSC1_PCST1_SET_gc   = (0x8000), /* PSC 1 Input Capture Software Trig - SET */
} PSC1_PCST1_t;

/* PSC 1 Input Capture Bytes */
#define PSC1_PICR1_PICR1_gc(x) (x & 0xFFF)
...
#define PSC1_PFRC1B_PRFM1B_gc(x) (x & 0x0F)
...
#define PSC1_PFRC1A_PRFM1A_gc(x) (x & 0x0F)

/* PSC 1 Prescaler Selects */
#define PSC1_PCTL1_PPRE1_gc(x) ((x<<6) & 0xC0)
...
/* PSC 1 Fifty */
typedef enum PSC1_PFIFTY1_enum
{
    PSC1_PFIFTY1_CLEAR_gc = (0x00), /* PSC 1 Fifty - CLEAR */
    PSC1_PFIFTY1_SET_gc   = (0x80), /* PSC 1 Fifty - SET */
} PSC1_PFIFTY1_t;

/* PSC 1 Autolock */
typedef enum PSC1_PALOCK1_enum
{
    PSC1_PALOCK1_CLEAR_gc = (0x00), /* PSC 1 Autolock - CLEAR */
    PSC1_PALOCK1_SET_gc   = (0x40), /* PSC 1 Autolock - SET */
} PSC1_PALOCK1_t;

/* PSC 1 Lock */
typedef enum PSC1_PLOCK1_enum
{
    PSC1_PLOCK1_CLEAR_gc = (0x00), /* PSC 1 Lock - CLEAR */
    PSC1_PLOCK1_SET_gc   = (0x20), /* PSC 1 Lock - SET */
} PSC1_PLOCK1_t;

/* PSC 1 Mode */
#define PSC1_PCNF1_PMODE1_gc(x) ((x<<3) & 0x18)

/* PSC 1 Output Polarity */
typedef enum PSC1_POP1_enum
{
    PSC1_POP1_CLEAR_gc = (0x00), /* PSC 1 Output Polarity - CLEAR */
    PSC1_POP1_SET_gc   = (0x04), /* PSC 1 Output Polarity - SET */
} PSC1_POP1_t;

/* PSC 1 Input Clock Select */
typedef enum PSC1_PCLKSEL1_enum
{
    PSC1_PCLKSEL1_CLEAR_gc = (0x00), /* PSC 1 Input Clock Select - CLEAR */
    PSC1_PCLKSEL1_SET_gc   = (0x02), /* PSC 1 Input Clock Select - SET */
} PSC1_PCLKSEL1_t;

/* Synchronization Out for ADC Selection */
#define PSC1_PSOC1_PSYNC1__gc(x) ((x<<4) & 0x30)
...
typedef enum PSC1_PSEIE1_enum
{
    PSC1_PSEIE1_CLEAR_gc = (0x00), /* PSC 1 Synchro Error Interrupt Enable - CLEAR */
    PSC1_PSEIE1_SET_gc   = (0x20), /* PSC 1 Synchro Error Interrupt Enable - SET */
} PSC1_PSEIE1_t;

/* External Event B Interrupt Enable */
typedef enum PSC1_PEVE1B_enum
{
    PSC1_PEVE1B_CLEAR_gc = (0x00), /* External Event B Interrupt Enable - CLEAR */
    PSC1_PEVE1B_SET_gc   = (0x10), /* External Event B Interrupt Enable - SET */
} PSC1_PEVE1B_t;

/* External Event A Interrupt Enable */
typedef enum PSC1_PEVE1A_enum
{
    PSC1_PEVE1A_CLEAR_gc = (0x00), /* External Event A Interrupt Enable - CLEAR */
    PSC1_PEVE1A_SET_gc   = (0x08), /* External Event A Interrupt Enable - SET */
} PSC1_PEVE1A_t;

/* End of Cycle Interrupt Enable */
typedef enum PSC1_PEOPE1_enum
{
    PSC1_PEOPE1_CLEAR_gc = (0x00), /* End of Cycle Interrupt Enable - CLEAR */
    PSC1_PEOPE1_SET_gc   = (0x01), /* End of Cycle Interrupt Enable - SET */
} PSC1_PEOPE1_t;

/* PSC 1 Output B Activity */
typedef enum PSC1_POAC1B_enum
{
    PSC1_POAC1B_CLEAR_gc = (0x00), /* PSC 1 Output B Activity - CLEAR */
    PSC1_POAC1B_SET_gc   = (0x80), /* PSC 1 Output B Activity - SET */
} PSC1_POAC1B_t;

/* PSC 1 Output A Activity */
typedef enum PSC1_POAC1A_enum
{
    PSC1_POAC1A_CLEAR_gc = (0x00), /* PSC 1 Output A Activity - CLEAR */
    PSC1_POAC1A_SET_gc   = (0x40), /* PSC 1 Output A Activity - SET */
} PSC1_POAC1A_t;

/* PSC 1 Synchro Error Interrupt */
typedef enum PSC1_PSEI1_enum
{
    PSC1_PSEI1_CLEAR_gc = (0x00), /* PSC 1 Synchro Error Interrupt - CLEAR */
    PSC1_PSEI1_SET_gc   = (0x20), /* PSC 1 Synchro Error Interrupt - SET */
} PSC1_PSEI1_t;

/* External Event B Interrupt */
typedef enum PSC1_PEV1B_enum
{
    PSC1_PEV1B_CLEAR_gc = (0x00), /* External Event B Interrupt - CLEAR */
    PSC1_PEV1B_SET_gc   = (0x10), /* External Event B Interrupt - SET */
} PSC1_PEV1B_t;

/* External Event A Interrupt */
typedef enum PSC1_PEV1A_enum
{
    PSC1_PEV1A_CLEAR_gc = (0x00), /* External Event A Interrupt - CLEAR */
    PSC1_PEV1A_SET_gc   = (0x08), /* External Event A Interrupt - SET */
} PSC1_PEV1A_t;

/* Ramp Number */
#define PSC1_PIFR1_PRN1_gc(x) ((x<<1) & 0x06)

/* End of PSC1 Interrupt */
typedef enum PSC1_PEOP1_enum
{
    PSC1_PEOP1_CLEAR_gc = (0x00), /* End of PSC1 Interrupt - CLEAR */
    PSC1_PEOP1_SET_gc   = (0x01), /* End of PSC1 Interrupt - SET */
} PSC1_PEOP1_t;
...
/* Synchronization Out for ADC Selection */
#define PSC2_PSOC2_PSYNC2__gc(x) ((x<<4) & 0x30)
...
#define FUSE_SUT_CKSEL_PLLCLK_16MHZ_1KCK_14CK_0MS_gc            (0x03) /* PLL clock 16 MHz; Rc. Start-up time PWRDWN/RESET: 1K CK/14 CK + 0 ms */
...
/* PSC 1 Input Capture Software Trig */
#define PSC1_PCST1_CLEAR_gc (0x00)   /* PSC 1 Input Capture Software Trig - CLEAR */
#define PSC1_PCST1_SET_gc   (0x8000) /* PSC 1 Input Capture Software Trig - SET */
...
/* PSC 1 Fifty */
#define PSC1_PFIFTY1_CLEAR_gc (0x00) /* PSC 1 Fifty - CLEAR */
#define PSC1_PFIFTY1_SET_gc   (0x80) /* PSC 1 Fifty - SET */


/* PSC 1 Autolock */
#define PSC1_PALOCK1_CLEAR_gc (0x00) /* PSC 1 Autolock - CLEAR */
#define PSC1_PALOCK1_SET_gc   (0x40) /* PSC 1 Autolock - SET */


/* PSC 1 Lock */
#define PSC1_PLOCK1_CLEAR_gc (0x00) /* PSC 1 Lock - CLEAR */
#define PSC1_PLOCK1_SET_gc   (0x20) /* PSC 1 Lock - SET */
...
/* PSC 1 Output Polarity */
#define PSC1_POP1_CLEAR_gc (0x00) /* PSC 1 Output Polarity - CLEAR */
#define PSC1_POP1_SET_gc   (0x04) /* PSC 1 Output Polarity - SET */


/* PSC 1 Input Clock Select */
#define PSC1_PCLKSEL1_CLEAR_gc (0x00) /* PSC 1 Input Clock Select - CLEAR */
#define PSC1_PCLKSEL1_SET_gc   (0x02) /* PSC 1 Input Clock Select - SET */
...
/* PSC 1 Synchro Error Interrupt Enable */
#define PSC1_PSEIE1_CLEAR_gc (0x00) /* PSC 1 Synchro Error Interrupt Enable - CLEAR */
#define PSC1_PSEIE1_SET_gc   (0x20) /* PSC 1 Synchro Error Interrupt Enable - SET */


/* External Event B Interrupt Enable */
#define PSC1_PEVE1B_CLEAR_gc (0x00) /* External Event B Interrupt Enable - CLEAR */
#define PSC1_PEVE1B_SET_gc   (0x10) /* External Event B Interrupt Enable - SET */


/* External Event A Interrupt Enable */
#define PSC1_PEVE1A_CLEAR_gc (0x00) /* External Event A Interrupt Enable - CLEAR */
#define PSC1_PEVE1A_SET_gc   (0x08) /* External Event A Interrupt Enable - SET */


/* End of Cycle Interrupt Enable */
#define PSC1_PEOPE1_CLEAR_gc (0x00) /* End of Cycle Interrupt Enable - CLEAR */
#define PSC1_PEOPE1_SET_gc   (0x01) /* End of Cycle Interrupt Enable - SET */


/* PSC 1 Output B Activity */
#define PSC1_POAC1B_CLEAR_gc (0x00) /* PSC 1 Output B Activity - CLEAR */
#define PSC1_POAC1B_SET_gc   (0x80) /* PSC 1 Output B Activity - SET */


/* PSC 1 Output A Activity */
#define PSC1_POAC1A_CLEAR_gc (0x00) /* PSC 1 Output A Activity - CLEAR */
#define PSC1_POAC1A_SET_gc   (0x40) /* PSC 1 Output A Activity - SET */


/* PSC 1 Synchro Error Interrupt */
#define PSC1_PSEI1_CLEAR_gc (0x00) /* PSC 1 Synchro Error Interrupt - CLEAR */
#define PSC1_PSEI1_SET_gc   (0x20) /* PSC 1 Synchro Error Interrupt - SET */


/* External Event B Interrupt */
#define PSC1_PEV1B_CLEAR_gc (0x00) /* External Event B Interrupt - CLEAR */
#define PSC1_PEV1B_SET_gc   (0x10) /* External Event B Interrupt - SET */


/* External Event A Interrupt */
#define PSC1_PEV1A_CLEAR_gc (0x00) /* External Event A Interrupt - CLEAR */
#define PSC1_PEV1A_SET_gc   (0x08) /* External Event A Interrupt - SET */
...
/* End of PSC1 Interrupt */
#define PSC1_PEOP1_CLEAR_gc (0x00) /* End of PSC1 Interrupt - CLEAR */
#define PSC1_PEOP1_SET_gc   (0x01) /* End of PSC1 Interrupt - SET */
...
#define EUSART_MUBRR     _SFR_MEM16(0x00CC) /* Manchester Receiver Baud Rate Register */
...
#define DAC_DAC          _SFR_MEM16(0x00AB) /* DAC Data Register */
#define DAC_DACL         _SFR_MEM8 (0x00AB) /* DAC Data Register LOW BYTE */
#define DAC_DACH         _SFR_MEM8 (0x00AC) /* DAC Data Register HIGH BYTE */
...
#define USART_UBRR       _SFR_MEM16(0x00C4) /* USART Baud Rate Register */
...
#define PSC00_OCR0SA     _SFR_MEM16(0x00D2) /* Output Compare 0 SA Register */
#define PSC00_OCR0SAL    _SFR_MEM8 (0x00D2) /* Output Compare 0 SA Register LOW BYTE */
#define PSC00_OCR0SAH    _SFR_MEM8 (0x00D3) /* Output Compare 0 SA Register HIGH BYTE */
#define PSC00_OCR0RA     _SFR_MEM16(0x00D4) /* Output Compare 0 RA Register */
#define PSC00_OCR0RAL    _SFR_MEM8 (0x00D4) /* Output Compare 0 RA Register LOW BYTE */
#define PSC00_OCR0RAH    _SFR_MEM8 (0x00D5) /* Output Compare 0 RA Register HIGH BYTE */
#define PSC00_OCR0SB     _SFR_MEM16(0x00D6) /* Output Compare 0 SB Register */
#define PSC00_OCR0SBL    _SFR_MEM8 (0x00D6) /* Output Compare 0 SB Register LOW BYTE */
#define PSC00_OCR0SBH    _SFR_MEM8 (0x00D7) /* Output Compare 0 SB Register HIGH BYTE */
#define PSC00_OCR0RB     _SFR_MEM16(0x00D8) /* Output Compare 0 RB Register */
#define PSC00_OCR0RBL    _SFR_MEM8 (0x00D8) /* Output Compare 0 RB Register LOW BYTE */
#define PSC00_OCR0RBH    _SFR_MEM8 (0x00D9) /* Output Compare 0 RB Register HIGH BYTE */
...
#define PSC11_PIFR1      _SFR_MEM8 (0x00A2) /* PSC1 Interrupt Flag Register */
#define PSC11_PIM1       _SFR_MEM8 (0x00A3) /* PSC1 Interrupt Mask Register */
#define PSC11_PSOC1      _SFR_MEM8 (0x00E0) /* PSC1 Synchro and Output Configuration */
#define PSC11_OCR1SA     _SFR_MEM16(0x00E2) /* Output Compare SA Register  */
#define PSC11_OCR1SAL    _SFR_MEM8 (0x00E2) /* Output Compare SA Register  LOW BYTE */
#define PSC11_OCR1SAH    _SFR_MEM8 (0x00E3) /* Output Compare SA Register  HIGH BYTE */
#define PSC11_OCR1RA     _SFR_MEM16(0x00E4) /* Output Compare RA Register  */
#define PSC11_OCR1RAL    _SFR_MEM8 (0x00E4) /* Output Compare RA Register  LOW BYTE */
#define PSC11_OCR1RAH    _SFR_MEM8 (0x00E5) /* Output Compare RA Register  HIGH BYTE */
#define PSC11_OCR1SB     _SFR_MEM16(0x00E6) /* Output Compare SB Register  */
#define PSC11_OCR1SBL    _SFR_MEM8 (0x00E6) /* Output Compare SB Register  LOW BYTE */
#define PSC11_OCR1SBH    _SFR_MEM8 (0x00E7) /* Output Compare SB Register  HIGH BYTE */
#define PSC11_OCR1RB     _SFR_MEM16(0x00E8) /* Output Compare RB Register  */
#define PSC11_OCR1RBL    _SFR_MEM8 (0x00E8) /* Output Compare RB Register  LOW BYTE */
#define PSC11_OCR1RBH    _SFR_MEM8 (0x00E9) /* Output Compare RB Register  HIGH BYTE */
#define PSC11_PCNF1      _SFR_MEM8 (0x00EA) /* PSC 1 Configuration Register */
...
#define PSC22_OCR2SA     _SFR_MEM16(0x00F2) /* Output Compare 2 SA Register */
#define PSC22_OCR2SAL    _SFR_MEM8 (0x00F2) /* Output Compare 2 SA Register LOW BYTE */
#define PSC22_OCR2SAH    _SFR_MEM8 (0x00F3) /* Output Compare 2 SA Register HIGH BYTE */
#define PSC22_OCR2RA     _SFR_MEM16(0x00F4) /* Output Compare 2 RA Register */
#define PSC22_OCR2RAL    _SFR_MEM8 (0x00F4) /* Output Compare 2 RA Register LOW BYTE */
#define PSC22_OCR2RAH    _SFR_MEM8 (0x00F5) /* Output Compare 2 RA Register HIGH BYTE */
#define PSC22_OCR2SB     _SFR_MEM16(0x00F6) /* Output Compare 2 SB Register */
#define PSC22_OCR2SBL    _SFR_MEM8 (0x00F6) /* Output Compare 2 SB Register LOW BYTE */
#define PSC22_OCR2SBH    _SFR_MEM8 (0x00F7) /* Output Compare 2 SB Register HIGH BYTE */
#define PSC22_OCR2RB     _SFR_MEM16(0x00F8) /* Output Compare 2 RB Register */
#define PSC22_OCR2RBL    _SFR_MEM8 (0x00F8) /* Output Compare 2 RB Register LOW BYTE */
#define PSC22_OCR2RBH    _SFR_MEM8 (0x00F9) /* Output Compare 2 RB Register HIGH BYTE */
