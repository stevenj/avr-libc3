 ...
 *                                                                            * 
 *   .atpack File: ATtiny1604.atdf                                            * 
 *   .ATDF File:   atdf/ATtiny1604.atdf                                       * 
 *   Version:      2.0.10                                                     * 
 *   Date:         2019-04-25                                                 * 
 *   Device:       ATtiny1604                                                 * 
 *   Architecture: AVR8X                                                      * 
...
#  define _AVR_IOXXX_H_ "ioATtiny1604.h"
#else
...
typedef struct EVSYS_struct
{
    ...
    register8_t rsv_0x04[6]; /* RESERVED REGISTER BLOCK */
    register8_t SYNCCH0;     /* Synchronous Channel 0 Generator Selection */
    register8_t rsv_0x0B[7]; /* RESERVED REGISTER BLOCK */
