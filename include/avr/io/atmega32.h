 ...
 *                                                                            * 
 *   .atpack File: ATmega32.atdf                                              * 
 *   .ATDF File:   atdf/ATmega32.atdf                                         * 
 *   Version:      2.0.12                                                     * 
 *   Date:         2019-04-26                                                 * 
 *   Device:       ATmega32                                                   * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATmega32.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_ATmega32_H_INCLUDED
#  define _AVR_ATmega32_H_INCLUDED
...
{
    FUSE_CKOPT_CLEAR_gc = (0x00), /* Oscillator options - CLEAR */
    FUSE_CKOPT_SET_gc   = (0x10), /* Oscillator options - SET */
} FUSE_CKOPT_t;
...
typedef struct TC2_struct
{
    ...
    register8_t rsv_0x46[18]; /* RESERVED REGISTER BLOCK */
    register8_t TIFR;         /* Timer/Counter Interrupt Flag Register */
    register8_t TIMSK;        /* Timer/Counter Interrupt Mask register */
} TC2_t;
...
{
    TC2_WGM20_CLEAR_gc = (0x00), /* Pulse Width Modulator Enable - CLEAR */
    TC2_WGM20_SET_gc   = (0x40), /* Pulse Width Modulator Enable - SET */
} TC2_WGM20_t;
...
{
    TC2_WGM21_CLEAR_gc = (0x00), /* Clear Timer/Counter2 on Compare Match - CLEAR */
    TC2_WGM21_SET_gc   = (0x08), /* Clear Timer/Counter2 on Compare Match - SET */
} TC2_WGM21_t;
...
#define AC_SFIOR_ADTS_gc(x) ((x<<5) & 0xE0)
...
/* Pull-up disable */
typedef enum AC_PUD_enum
{
    AC_PUD_CLEAR_gc = (0x00), /* Pull-up disable - CLEAR */
    AC_PUD_SET_gc   = (0x04), /* Pull-up disable - SET */
} AC_PUD_t;

/* Prescaler Reset Timer/Counter2 */
typedef enum AC_PSR2_enum
{
    AC_PSR2_CLEAR_gc = (0x00), /* Prescaler Reset Timer/Counter2 - CLEAR */
    AC_PSR2_SET_gc   = (0x02), /* Prescaler Reset Timer/Counter2 - SET */
} AC_PSR2_t;

/* Prescaler Reset Timer/Counter1 and Timer/Counter0 */
typedef enum AC_PSR10_enum
{
    AC_PSR10_CLEAR_gc = (0x00), /* Prescaler Reset Timer/Counter1 and Timer/Counter0 - CLEAR */
    AC_PSR10_SET_gc   = (0x01), /* Prescaler Reset Timer/Counter1 and Timer/Counter0 - SET */
} AC_PSR10_t;
...
typedef enum CPU_SM_enum
{
    ...
    CPU_SM_ESTDBY_gc   = (0x07<<4), /* Extended Standby */
} CPU_SM_t;
...
/* Oscillator options */
#define FUSE_CKOPT_CLEAR_gc (0x00) /* Oscillator options - CLEAR */
#define FUSE_CKOPT_SET_gc   (0x10) /* Oscillator options - SET */
...
/* Pulse Width Modulator Enable */
#define TC2_WGM20_CLEAR_gc (0x00) /* Pulse Width Modulator Enable - CLEAR */
#define TC2_WGM20_SET_gc   (0x40) /* Pulse Width Modulator Enable - SET */
...
/* Clear Timer/Counter2 on Compare Match */
#define TC2_WGM21_CLEAR_gc (0x00) /* Clear Timer/Counter2 on Compare Match - CLEAR */
#define TC2_WGM21_SET_gc   (0x08) /* Clear Timer/Counter2 on Compare Match - SET */
...
/* Pull-up disable */
#define AC_PUD_CLEAR_gc (0x00) /* Pull-up disable - CLEAR */
#define AC_PUD_SET_gc   (0x04) /* Pull-up disable - SET */


/* Prescaler Reset Timer/Counter2 */
#define AC_PSR2_CLEAR_gc (0x00) /* Prescaler Reset Timer/Counter2 - CLEAR */
#define AC_PSR2_SET_gc   (0x02) /* Prescaler Reset Timer/Counter2 - SET */


/* Prescaler Reset Timer/Counter1 and Timer/Counter0 */
#define AC_PSR10_CLEAR_gc (0x00) /* Prescaler Reset Timer/Counter1 and Timer/Counter0 - CLEAR */
#define AC_PSR10_SET_gc   (0x01) /* Prescaler Reset Timer/Counter1 and Timer/Counter0 - SET */
...
#define CPU_SM_ESTDBY_gc   (0x07<<4) /* Extended Standby */
...
#define TC8_TCNT0       _SFR_MEM8 (0x0052) /* Timer/Counter Register */
...
#define TC8_OCR0        _SFR_MEM8 (0x005C) /* Output Compare Register */
...
#define None_SPI_STC_vect          _VECTOR(12)         /* Serial Transfer Complete */
...
#define None_ANA_COMP_vect_num     (18)                
#define None_ANA_COMP_vect         _VECTOR(18)         /* Analog Comparator */
#define None_TWI_vect_num          (19)                
#define None_TWI_vect              _VECTOR(19)         /* 2-wire Serial Interface */
...
#define CKOPT   (unsigned char)~_BV(4) /* Oscillator options */
...
#endif /* #ifdef _AVR_ATmega32_H_INCLUDED */
