 ...
 *                                                                            * 
 *   .atpack File: ATmega328PB.atdf                                           * 
 *   .ATDF File:   atdf/ATmega328PB.atdf                                      * 
 *   Version:      2.0.12                                                     * 
 *   Date:         2019-04-26                                                 * 
 *   Device:       ATmega328PB                                                * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATmega328PB.h"
#else
...
typedef struct USART0_struct
{
    ...
    register8_t UDR0;          /* USART I/O Data Register 0 */
} USART0_t;
...
{
    USART0_RXSIE_CLEAR_gc = (0x00), /* USART RX Start Interrupt Enable - CLEAR */
    USART0_RXSIE_SET_gc   = (0x80), /* USART RX Start Interrupt Enable - SET */
} USART0_RXSIE_t;

/* USART RX Start */
typedef enum USART0_RXS_enum
{
    USART0_RXS_CLEAR_gc = (0x00), /* USART RX Start - CLEAR */
    USART0_RXS_SET_gc   = (0x40), /* USART RX Start - SET */
} USART0_RXS_t;
...
/* Character Size - together with UCSZ0 in UCSR1C */
typedef enum USART1_UCSZ12_enum
{
    USART1_UCSZ12_CLEAR_gc = (0x00), /* Character Size - together with UCSZ0 in UCSR1C - CLEAR */
    USART1_UCSZ12_SET_gc   = (0x04), /* Character Size - together with UCSZ0 in UCSR1C - SET */
} USART1_UCSZ12_t;
...
/* Character Size - together with UCSZ12 in UCSR1B */
...
{
    USART1_RXS1_CLEAR_gc = (0x00), /* USART RX Start - CLEAR */
    USART1_RXS1_SET_gc   = (0x40), /* USART RX Start - SET */
} USART1_RXS1_t;

/* Start frame detection enable */
typedef enum USART1_SFDE1_enum
{
    USART1_SFDE1_CLEAR_gc = (0x00), /* Start frame detection enable - CLEAR */
    USART1_SFDE1_SET_gc   = (0x20), /* Start frame detection enable - SET */
} USART1_SFDE1_t;
...
/* TWI Status */
#define TWI0_TWSR0_TWS_gc(x) ((x<<3) & 0xF8)
...
/* TWI Interrupt Flag */
typedef enum TWI1_TWINT1_enum
{
    TWI1_TWINT1_CLEAR_gc = (0x00), /* TWI Interrupt Flag - CLEAR */
    TWI1_TWINT1_SET_gc   = (0x80), /* TWI Interrupt Flag - SET */
} TWI1_TWINT1_t;

/* TWI Enable Acknowledge Bit */
typedef enum TWI1_TWEA1_enum
{
    TWI1_TWEA1_CLEAR_gc = (0x00), /* TWI Enable Acknowledge Bit - CLEAR */
    TWI1_TWEA1_SET_gc   = (0x40), /* TWI Enable Acknowledge Bit - SET */
} TWI1_TWEA1_t;

/* TWI Start Condition Bit */
typedef enum TWI1_TWSTA1_enum
{
    TWI1_TWSTA1_CLEAR_gc = (0x00), /* TWI Start Condition Bit - CLEAR */
    TWI1_TWSTA1_SET_gc   = (0x20), /* TWI Start Condition Bit - SET */
} TWI1_TWSTA1_t;

/* TWI Stop Condition Bit */
typedef enum TWI1_TWSTO1_enum
{
    TWI1_TWSTO1_CLEAR_gc = (0x00), /* TWI Stop Condition Bit - CLEAR */
    TWI1_TWSTO1_SET_gc   = (0x10), /* TWI Stop Condition Bit - SET */
} TWI1_TWSTO1_t;

/* TWI Write Collition Flag */
typedef enum TWI1_TWWC1_enum
{
    TWI1_TWWC1_CLEAR_gc = (0x00), /* TWI Write Collition Flag - CLEAR */
    TWI1_TWWC1_SET_gc   = (0x08), /* TWI Write Collition Flag - SET */
} TWI1_TWWC1_t;

/* TWI Enable Bit */
typedef enum TWI1_TWEN1_enum
{
    TWI1_TWEN1_CLEAR_gc = (0x00), /* TWI Enable Bit - CLEAR */
    TWI1_TWEN1_SET_gc   = (0x04), /* TWI Enable Bit - SET */
} TWI1_TWEN1_t;

/* TWI Interrupt Enable */
typedef enum TWI1_TWIE1_enum
{
    TWI1_TWIE1_CLEAR_gc = (0x00), /* TWI Interrupt Enable - CLEAR */
    TWI1_TWIE1_SET_gc   = (0x01), /* TWI Interrupt Enable - SET */
} TWI1_TWIE1_t;

/* TWI Status */
#define TWI1_TWSR1_TWS1_gc(x) ((x<<3) & 0xF8)

/* TWI Prescaler */
typedef enum TWI1_TWPS1_enum
{
    TWI1_TWPS1_VAL_0x00_gc = (0x00), /* 1 */
    TWI1_TWPS1_VAL_0x01_gc = (0x01), /* 4 */
    TWI1_TWPS1_VAL_0x02_gc = (0x02), /* 16 */
    TWI1_TWPS1_VAL_0x03_gc = (0x03), /* 64 */
} TWI1_TWPS1_t;
...
typedef struct TC4_struct
{
    ...
    _REGISTER16 (OCR4A);      /* Timer/Counter4 Output Compare Register Bytes */
    register8_t rsv_0xA9;     /* RESERVED REGISTER */
    _REGISTER16 (OCR4B);      /* Timer/Counter4 Output Compare Register Bytes */
} TC4_t;
...
/* Timer/Counter3 Output Compare Match B Interrupt Enable */
typedef enum TC3_OCIE3B_enum
{
    TC3_OCIE3B_CLEAR_gc = (0x00), /* Timer/Counter3 Output Compare Match B Interrupt Enable - CLEAR */
    TC3_OCIE3B_SET_gc   = (0x04), /* Timer/Counter3 Output Compare Match B Interrupt Enable - SET */
} TC3_OCIE3B_t;

/* Timer/Counter3 Output Compare Match A Interrupt Enable */
typedef enum TC3_OCIE3A_enum
{
    TC3_OCIE3A_CLEAR_gc = (0x00), /* Timer/Counter3 Output Compare Match A Interrupt Enable - CLEAR */
    TC3_OCIE3A_SET_gc   = (0x02), /* Timer/Counter3 Output Compare Match A Interrupt Enable - SET */
} TC3_OCIE3A_t;
...
{
    TC3_ICNC3_CLEAR_gc = (0x00), /* Input Capture Noise Canceler - CLEAR */
    TC3_ICNC3_SET_gc   = (0x80), /* Input Capture Noise Canceler - SET */
} TC3_ICNC3_t;

/* Input Capture Edge Select */
typedef enum TC3_ICES3_enum
{
    TC3_ICES3_CLEAR_gc = (0x00), /* Input Capture Edge Select - CLEAR */
    TC3_ICES3_SET_gc   = (0x40), /* Input Capture Edge Select - SET */
} TC3_ICES3_t;

/* Waveform Generation Mode bit 3 */
typedef enum TC3_WGM33_enum
{
    TC3_WGM33_CLEAR_gc = (0x00), /* Waveform Generation Mode bit 3 - CLEAR */
    TC3_WGM33_SET_gc   = (0x10), /* Waveform Generation Mode bit 3 - SET */
} TC3_WGM33_t;

/* Waveform Generation Mode bit 2 */
typedef enum TC3_WGM32_enum
{
    TC3_WGM32_CLEAR_gc = (0x00), /* Waveform Generation Mode bit 2 - CLEAR */
    TC3_WGM32_SET_gc   = (0x08), /* Waveform Generation Mode bit 2 - SET */
} TC3_WGM32_t;
...
typedef enum TC3_CS3_enum
{
    ...
    TC3_CS3_VAL_0x03_gc = (0x03), /* Running, CLK/32 */
    TC3_CS3_VAL_0x04_gc = (0x04), /* Running, CLK/64 */
    TC3_CS3_VAL_0x05_gc = (0x05), /* Running, CLK/128 */
    TC3_CS3_VAL_0x06_gc = (0x06), /* Running, CLK/256 */
    TC3_CS3_VAL_0x07_gc = (0x07), /* Running, CLK/1024 */
} TC3_CS3_t;
...
/* Timer/Counter4 Output Compare Match B Interrupt Enable */
typedef enum TC4_OCIE4B_enum
{
    TC4_OCIE4B_CLEAR_gc = (0x00), /* Timer/Counter4 Output Compare Match B Interrupt Enable - CLEAR */
    TC4_OCIE4B_SET_gc   = (0x04), /* Timer/Counter4 Output Compare Match B Interrupt Enable - SET */
} TC4_OCIE4B_t;

/* Timer/Counter4 Output Compare Match A Interrupt Enable */
typedef enum TC4_OCIE4A_enum
{
    TC4_OCIE4A_CLEAR_gc = (0x00), /* Timer/Counter4 Output Compare Match A Interrupt Enable - CLEAR */
    TC4_OCIE4A_SET_gc   = (0x02), /* Timer/Counter4 Output Compare Match A Interrupt Enable - SET */
} TC4_OCIE4A_t;
...
{
    TC4_ICNC4_CLEAR_gc = (0x00), /* Input Capture Noise Canceler - CLEAR */
    TC4_ICNC4_SET_gc   = (0x80), /* Input Capture Noise Canceler - SET */
} TC4_ICNC4_t;

/* Input Capture Edge Select */
typedef enum TC4_ICES4_enum
{
    TC4_ICES4_CLEAR_gc = (0x00), /* Input Capture Edge Select - CLEAR */
    TC4_ICES4_SET_gc   = (0x40), /* Input Capture Edge Select - SET */
} TC4_ICES4_t;

/* Waveform Generation Mode bit 3 */
typedef enum TC4_WGM43_enum
{
    TC4_WGM43_CLEAR_gc = (0x00), /* Waveform Generation Mode bit 3 - CLEAR */
    TC4_WGM43_SET_gc   = (0x10), /* Waveform Generation Mode bit 3 - SET */
} TC4_WGM43_t;

/* Waveform Generation Mode bit 2 */
typedef enum TC4_WGM42_enum
{
    TC4_WGM42_CLEAR_gc = (0x00), /* Waveform Generation Mode bit 2 - CLEAR */
    TC4_WGM42_SET_gc   = (0x08), /* Waveform Generation Mode bit 2 - SET */
} TC4_WGM42_t;
...
typedef enum TC4_CS4_enum
{
    ...
    TC4_CS4_VAL_0x03_gc = (0x03), /* Running, CLK/32 */
    TC4_CS4_VAL_0x04_gc = (0x04), /* Running, CLK/64 */
    TC4_CS4_VAL_0x05_gc = (0x05), /* Running, CLK/128 */
    TC4_CS4_VAL_0x06_gc = (0x06), /* Running, CLK/256 */
    TC4_CS4_VAL_0x07_gc = (0x07), /* Running, CLK/1024 */
} TC4_CS4_t;
...
typedef struct AC_struct
{
    ...
    register8_t rsv_0x51[-1]; /* RESERVED REGISTER BLOCK */
...
/* SPI Interrupt Flag */
typedef enum SPI1_SPIF1_enum
{
    SPI1_SPIF1_CLEAR_gc = (0x00), /* SPI Interrupt Flag - CLEAR */
    SPI1_SPIF1_SET_gc   = (0x80), /* SPI Interrupt Flag - SET */
} SPI1_SPIF1_t;

/* Write Collision Flag */
typedef enum SPI1_WCOL1_enum
{
    SPI1_WCOL1_CLEAR_gc = (0x00), /* Write Collision Flag - CLEAR */
    SPI1_WCOL1_SET_gc   = (0x40), /* Write Collision Flag - SET */
} SPI1_WCOL1_t;

/* Double SPI Speed Bit */
typedef enum SPI1_SPI2X1_enum
{
    SPI1_SPI2X1_CLEAR_gc = (0x00), /* Double SPI Speed Bit - CLEAR */
    SPI1_SPI2X1_SET_gc   = (0x01), /* Double SPI Speed Bit - SET */
} SPI1_SPI2X1_t;

/* SPI Interrupt Enable */
typedef enum SPI1_SPIE1_enum
{
    SPI1_SPIE1_CLEAR_gc = (0x00), /* SPI Interrupt Enable - CLEAR */
    SPI1_SPIE1_SET_gc   = (0x80), /* SPI Interrupt Enable - SET */
} SPI1_SPIE1_t;

/* SPI Enable */
typedef enum SPI1_SPE1_enum
{
    SPI1_SPE1_CLEAR_gc = (0x00), /* SPI Enable - CLEAR */
    SPI1_SPE1_SET_gc   = (0x40), /* SPI Enable - SET */
} SPI1_SPE1_t;

/* Data Order */
typedef enum SPI1_DORD1_enum
{
    SPI1_DORD1_CLEAR_gc = (0x00), /* Data Order - CLEAR */
    SPI1_DORD1_SET_gc   = (0x20), /* Data Order - SET */
} SPI1_DORD1_t;

/* Master/Slave Select */
typedef enum SPI1_MSTR1_enum
{
    SPI1_MSTR1_CLEAR_gc = (0x00), /* Master/Slave Select - CLEAR */
    SPI1_MSTR1_SET_gc   = (0x10), /* Master/Slave Select - SET */
} SPI1_MSTR1_t;

/* Clock polarity */
typedef enum SPI1_CPOL1_enum
{
    SPI1_CPOL1_CLEAR_gc = (0x00), /* Clock polarity - CLEAR */
    SPI1_CPOL1_SET_gc   = (0x08), /* Clock polarity - SET */
} SPI1_CPOL1_t;

/* Clock Phase */
typedef enum SPI1_CPHA1_enum
{
    SPI1_CPHA1_CLEAR_gc = (0x00), /* Clock Phase - CLEAR */
    SPI1_CPHA1_SET_gc   = (0x04), /* Clock Phase - SET */
} SPI1_CPHA1_t;

/* SPI Clock Rate Selects */
typedef enum SPI1_SPR1_enum
{
    SPI1_SPR1_VAL_0x00_gc = (0x00), /* fosc/4 */
    SPI1_SPR1_VAL_0x01_gc = (0x01), /* fosc/16 */
    SPI1_SPR1_VAL_0x02_gc = (0x02), /* fosc/64 */
    SPI1_SPR1_VAL_0x03_gc = (0x03), /* fosc/128 */
    SPI1_SPR1_VAL_0x04_gc = (0x04), /* fosc/2 */
    SPI1_SPR1_VAL_0x05_gc = (0x05), /* fosc/8 */
    SPI1_SPR1_VAL_0x06_gc = (0x06), /* fosc/32 */
    SPI1_SPR1_VAL_0x07_gc = (0x07), /* fosc/64 */
} SPI1_SPR1_t;
...
{
    CPU_PRSPI0_CLEAR_gc = (0x00), /* Power Reduction Serial Peripheral Interface 1 - CLEAR */
    CPU_PRSPI0_SET_gc   = (0x04), /* Power Reduction Serial Peripheral Interface 1 - SET */
} CPU_PRSPI0_t;
...
typedef enum CPU_PRTWI1_enum
{
    ...
    CPU_PRTWI1_SET_gc   = (0x20), /* Power Reduction TWI1 - SET */
} CPU_PRTWI1_t;
...
typedef enum CPU_PRPTC_enum
{
    ...
    CPU_PRPTC_SET_gc   = (0x10), /* Power Reduction Peripheral Touch Controller - SET */
} CPU_PRPTC_t;
...
typedef enum CPU_PRTIM4_enum
{
    ...
    CPU_PRTIM4_SET_gc   = (0x08), /* Power Reduction Timer/Counter4 - SET */
} CPU_PRTIM4_t;
...
typedef enum CPU_PRSPI1_enum
{
    ...
    CPU_PRSPI1_SET_gc   = (0x04), /* Power Reduction Serial Peripheral Interface 1 - SET */
} CPU_PRSPI1_t;
...
#define USART0  (*(USART0_t *) 0x0000)  
#define USART1  (*(USART1_t *) 0x0000)  
#define TWI0    (*(TWI0_t *) 0x0000)    
#define TWI1    (*(TWI1_t *) 0x0000)    
#define TC1     (*(TC1_t *) 0x0000)     
#define TC3     (*(TC3_t *) 0x0000)     
#define TC4     (*(TC4_t *) 0x0000)     
#define TC2     (*(TC2_t *) 0x0000)     
#define ADC     (*(ADC_t *) 0x0000)     
#define AC      (*(AC_t *) 0x0000)      
#define PORTB   (*(PORTB_t *) 0x0000)   
#define PORTC   (*(PORTC_t *) 0x0000)   
#define PORTD   (*(PORTD_t *) 0x0000)   
#define PORTE   (*(PORTE_t *) 0x0000)   
#define TC0     (*(TC0_t *) 0x0000)     
#define EXINT   (*(EXINT_t *) 0x0000)   
#define SPI0    (*(SPI0_t *) 0x0000)    
#define SPI1    (*(SPI1_t *) 0x0000)    
#define WDT     (*(WDT_t *) 0x0000)     
#define CPU     (*(CPU_t *) 0x0000)     
#define EEPROM  (*(EEPROM_t *) 0x0000)  
#define FUSE    (*(FUSE_t *) 0x0000)    
#define LOCKBIT (*(LOCKBIT_t *) 0x0000) 
#define CFD     (*(CFD_t *) 0x0000)     
#else
/*
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
ASM LANGUAGE - ONLY
...
/* USART RX Start Interrupt Enable */
#define USART0_RXSIE_CLEAR_gc (0x00) /* USART RX Start Interrupt Enable - CLEAR */
#define USART0_RXSIE_SET_gc   (0x80) /* USART RX Start Interrupt Enable - SET */


/* USART RX Start */
#define USART0_RXS_CLEAR_gc (0x00) /* USART RX Start - CLEAR */
#define USART0_RXS_SET_gc   (0x40) /* USART RX Start - SET */
...
/* Character Size - together with UCSZ0 in UCSR1C */
#define USART1_UCSZ12_CLEAR_gc (0x00) /* Character Size - together with UCSZ0 in UCSR1C - CLEAR */
#define USART1_UCSZ12_SET_gc   (0x04) /* Character Size - together with UCSZ0 in UCSR1C - SET */
...
/* USART RX Start */
#define USART1_RXS1_CLEAR_gc (0x00) /* USART RX Start - CLEAR */
#define USART1_RXS1_SET_gc   (0x40) /* USART RX Start - SET */


/* Start frame detection enable */
#define USART1_SFDE1_CLEAR_gc (0x00) /* Start frame detection enable - CLEAR */
#define USART1_SFDE1_SET_gc   (0x20) /* Start frame detection enable - SET */
...
/* TWI Interrupt Flag */
#define TWI1_TWINT1_CLEAR_gc (0x00) /* TWI Interrupt Flag - CLEAR */
#define TWI1_TWINT1_SET_gc   (0x80) /* TWI Interrupt Flag - SET */


/* TWI Enable Acknowledge Bit */
#define TWI1_TWEA1_CLEAR_gc (0x00) /* TWI Enable Acknowledge Bit - CLEAR */
#define TWI1_TWEA1_SET_gc   (0x40) /* TWI Enable Acknowledge Bit - SET */


/* TWI Start Condition Bit */
#define TWI1_TWSTA1_CLEAR_gc (0x00) /* TWI Start Condition Bit - CLEAR */
#define TWI1_TWSTA1_SET_gc   (0x20) /* TWI Start Condition Bit - SET */


/* TWI Stop Condition Bit */
#define TWI1_TWSTO1_CLEAR_gc (0x00) /* TWI Stop Condition Bit - CLEAR */
#define TWI1_TWSTO1_SET_gc   (0x10) /* TWI Stop Condition Bit - SET */


/* TWI Write Collition Flag */
#define TWI1_TWWC1_CLEAR_gc (0x00) /* TWI Write Collition Flag - CLEAR */
#define TWI1_TWWC1_SET_gc   (0x08) /* TWI Write Collition Flag - SET */


/* TWI Enable Bit */
#define TWI1_TWEN1_CLEAR_gc (0x00) /* TWI Enable Bit - CLEAR */
#define TWI1_TWEN1_SET_gc   (0x04) /* TWI Enable Bit - SET */


/* TWI Interrupt Enable */
#define TWI1_TWIE1_CLEAR_gc (0x00) /* TWI Interrupt Enable - CLEAR */
#define TWI1_TWIE1_SET_gc   (0x01) /* TWI Interrupt Enable - SET */
...
/* TWI Prescaler */
#define TWI1_TWPS1_VAL_0x00_gc (0x00) /* 1 */
#define TWI1_TWPS1_VAL_0x01_gc (0x01) /* 4 */
#define TWI1_TWPS1_VAL_0x02_gc (0x02) /* 16 */
#define TWI1_TWPS1_VAL_0x03_gc (0x03) /* 64 */
...
/* Timer/Counter3 Output Compare Match B Interrupt Enable */
#define TC3_OCIE3B_CLEAR_gc (0x00) /* Timer/Counter3 Output Compare Match B Interrupt Enable - CLEAR */
#define TC3_OCIE3B_SET_gc   (0x04) /* Timer/Counter3 Output Compare Match B Interrupt Enable - SET */


/* Timer/Counter3 Output Compare Match A Interrupt Enable */
#define TC3_OCIE3A_CLEAR_gc (0x00) /* Timer/Counter3 Output Compare Match A Interrupt Enable - CLEAR */
#define TC3_OCIE3A_SET_gc   (0x02) /* Timer/Counter3 Output Compare Match A Interrupt Enable - SET */
...
/* Input Capture Noise Canceler */
#define TC3_ICNC3_CLEAR_gc (0x00) /* Input Capture Noise Canceler - CLEAR */
#define TC3_ICNC3_SET_gc   (0x80) /* Input Capture Noise Canceler - SET */


/* Input Capture Edge Select */
#define TC3_ICES3_CLEAR_gc (0x00) /* Input Capture Edge Select - CLEAR */
#define TC3_ICES3_SET_gc   (0x40) /* Input Capture Edge Select - SET */


/* Waveform Generation Mode bit 3 */
#define TC3_WGM33_CLEAR_gc (0x00) /* Waveform Generation Mode bit 3 - CLEAR */
#define TC3_WGM33_SET_gc   (0x10) /* Waveform Generation Mode bit 3 - SET */


/* Waveform Generation Mode bit 2 */
#define TC3_WGM32_CLEAR_gc (0x00) /* Waveform Generation Mode bit 2 - CLEAR */
#define TC3_WGM32_SET_gc   (0x08) /* Waveform Generation Mode bit 2 - SET */
...
#define TC3_CS3_VAL_0x03_gc (0x03) /* Running, CLK/32 */
#define TC3_CS3_VAL_0x04_gc (0x04) /* Running, CLK/64 */
#define TC3_CS3_VAL_0x05_gc (0x05) /* Running, CLK/128 */
#define TC3_CS3_VAL_0x06_gc (0x06) /* Running, CLK/256 */
#define TC3_CS3_VAL_0x07_gc (0x07) /* Running, CLK/1024 */
...
/* Timer/Counter4 Output Compare Match B Interrupt Enable */
#define TC4_OCIE4B_CLEAR_gc (0x00) /* Timer/Counter4 Output Compare Match B Interrupt Enable - CLEAR */
#define TC4_OCIE4B_SET_gc   (0x04) /* Timer/Counter4 Output Compare Match B Interrupt Enable - SET */


/* Timer/Counter4 Output Compare Match A Interrupt Enable */
#define TC4_OCIE4A_CLEAR_gc (0x00) /* Timer/Counter4 Output Compare Match A Interrupt Enable - CLEAR */
#define TC4_OCIE4A_SET_gc   (0x02) /* Timer/Counter4 Output Compare Match A Interrupt Enable - SET */
...
/* Input Capture Noise Canceler */
#define TC4_ICNC4_CLEAR_gc (0x00) /* Input Capture Noise Canceler - CLEAR */
#define TC4_ICNC4_SET_gc   (0x80) /* Input Capture Noise Canceler - SET */


/* Input Capture Edge Select */
#define TC4_ICES4_CLEAR_gc (0x00) /* Input Capture Edge Select - CLEAR */
#define TC4_ICES4_SET_gc   (0x40) /* Input Capture Edge Select - SET */


/* Waveform Generation Mode bit 3 */
#define TC4_WGM43_CLEAR_gc (0x00) /* Waveform Generation Mode bit 3 - CLEAR */
#define TC4_WGM43_SET_gc   (0x10) /* Waveform Generation Mode bit 3 - SET */


/* Waveform Generation Mode bit 2 */
#define TC4_WGM42_CLEAR_gc (0x00) /* Waveform Generation Mode bit 2 - CLEAR */
#define TC4_WGM42_SET_gc   (0x08) /* Waveform Generation Mode bit 2 - SET */
...
#define TC4_CS4_VAL_0x03_gc (0x03) /* Running, CLK/32 */
#define TC4_CS4_VAL_0x04_gc (0x04) /* Running, CLK/64 */
#define TC4_CS4_VAL_0x05_gc (0x05) /* Running, CLK/128 */
#define TC4_CS4_VAL_0x06_gc (0x06) /* Running, CLK/256 */
#define TC4_CS4_VAL_0x07_gc (0x07) /* Running, CLK/1024 */
...
/* SPI Interrupt Flag */
#define SPI1_SPIF1_CLEAR_gc (0x00) /* SPI Interrupt Flag - CLEAR */
#define SPI1_SPIF1_SET_gc   (0x80) /* SPI Interrupt Flag - SET */


/* Write Collision Flag */
#define SPI1_WCOL1_CLEAR_gc (0x00) /* Write Collision Flag - CLEAR */
#define SPI1_WCOL1_SET_gc   (0x40) /* Write Collision Flag - SET */


/* Double SPI Speed Bit */
#define SPI1_SPI2X1_CLEAR_gc (0x00) /* Double SPI Speed Bit - CLEAR */
#define SPI1_SPI2X1_SET_gc   (0x01) /* Double SPI Speed Bit - SET */


/* SPI Interrupt Enable */
#define SPI1_SPIE1_CLEAR_gc (0x00) /* SPI Interrupt Enable - CLEAR */
#define SPI1_SPIE1_SET_gc   (0x80) /* SPI Interrupt Enable - SET */


/* SPI Enable */
#define SPI1_SPE1_CLEAR_gc (0x00) /* SPI Enable - CLEAR */
#define SPI1_SPE1_SET_gc   (0x40) /* SPI Enable - SET */


/* Data Order */
#define SPI1_DORD1_CLEAR_gc (0x00) /* Data Order - CLEAR */
#define SPI1_DORD1_SET_gc   (0x20) /* Data Order - SET */


/* Master/Slave Select */
#define SPI1_MSTR1_CLEAR_gc (0x00) /* Master/Slave Select - CLEAR */
#define SPI1_MSTR1_SET_gc   (0x10) /* Master/Slave Select - SET */


/* Clock polarity */
#define SPI1_CPOL1_CLEAR_gc (0x00) /* Clock polarity - CLEAR */
#define SPI1_CPOL1_SET_gc   (0x08) /* Clock polarity - SET */


/* Clock Phase */
#define SPI1_CPHA1_CLEAR_gc (0x00) /* Clock Phase - CLEAR */
#define SPI1_CPHA1_SET_gc   (0x04) /* Clock Phase - SET */


/* SPI Clock Rate Selects */
#define SPI1_SPR1_VAL_0x00_gc (0x00) /* fosc/4 */
#define SPI1_SPR1_VAL_0x01_gc (0x01) /* fosc/16 */
#define SPI1_SPR1_VAL_0x02_gc (0x02) /* fosc/64 */
#define SPI1_SPR1_VAL_0x03_gc (0x03) /* fosc/128 */
#define SPI1_SPR1_VAL_0x04_gc (0x04) /* fosc/2 */
#define SPI1_SPR1_VAL_0x05_gc (0x05) /* fosc/8 */
#define SPI1_SPR1_VAL_0x06_gc (0x06) /* fosc/32 */
#define SPI1_SPR1_VAL_0x07_gc (0x07) /* fosc/64 */
...
/* Power Reduction Serial Peripheral Interface 1 */
#define CPU_PRSPI0_CLEAR_gc (0x00) /* Power Reduction Serial Peripheral Interface 1 - CLEAR */
#define CPU_PRSPI0_SET_gc   (0x04) /* Power Reduction Serial Peripheral Interface 1 - SET */
...
#define CPU_PRTWI1_SET_gc   (0x20) /* Power Reduction TWI1 - SET */


/* Power Reduction Peripheral Touch Controller */
#define CPU_PRPTC_CLEAR_gc (0x00) /* Power Reduction Peripheral Touch Controller - CLEAR */
#define CPU_PRPTC_SET_gc   (0x10) /* Power Reduction Peripheral Touch Controller - SET */


/* Power Reduction Timer/Counter4 */
#define CPU_PRTIM4_CLEAR_gc (0x00) /* Power Reduction Timer/Counter4 - CLEAR */
#define CPU_PRTIM4_SET_gc   (0x08) /* Power Reduction Timer/Counter4 - SET */


/* Power Reduction Serial Peripheral Interface 1 */
#define CPU_PRSPI1_CLEAR_gc (0x00) /* Power Reduction Serial Peripheral Interface 1 - CLEAR */
#define CPU_PRSPI1_SET_gc   (0x04) /* Power Reduction Serial Peripheral Interface 1 - SET */
...
#define USART00_UDR0     _SFR_MEM8 (0x00C6) /* USART I/O Data Register 0 */
...
/* TC4 -  (0x0000) */
/* TC16_BASE ALREADY DEFINED */
#define TC16_TIFR4       _SFR_MEM8 (0x0039) /* Timer/Counter4 Interrupt Flag register */
...
#define TC16_OCR4A       _SFR_MEM16(0x00A8) /* Timer/Counter4 Output Compare Register Bytes */
#define TC16_OCR4AL      _SFR_MEM8 (0x00A8) /* Timer/Counter4 Output Compare Register Bytes LOW BYTE */
#define TC16_OCR4AH      _SFR_MEM8 (0x00A9) /* Timer/Counter4 Output Compare Register Bytes HIGH BYTE */
#define TC16_OCR4B       _SFR_MEM16(0x00AA) /* Timer/Counter4 Output Compare Register Bytes */
#define TC16_OCR4BL      _SFR_MEM8 (0x00AA) /* Timer/Counter4 Output Compare Register Bytes LOW BYTE */
#define TC16_OCR4BH      _SFR_MEM8 (0x00AB) /* Timer/Counter4 Output Compare Register Bytes HIGH BYTE */
...
#define CPU_PRR1         _SFR_MEM8 (0x0065) /* Power Reduction Register 1 */
...
#define None_TIMER2_COMPB_vect     _VECTOR(8)          /* Timer/Counter2 Compare Match B */
...
#define None_SPI0_STC_vect_num     (17)                
#define None_SPI0_STC_vect         _VECTOR(17)         /* SPI Serial Transfer Complete */
...
#define None_TWI0_vect_num         (24)                
#define None_TWI0_vect             _VECTOR(24)         /* Two-wire Serial Interface */
#define None_SPM_Ready_vect_num    (25)                
#define None_SPM_Ready_vect        _VECTOR(25)         /* Store Program Memory Read */
#define None_USART0_START_vect_num (26)                
#define None_USART0_START_vect     _VECTOR(26)         /* USART0 Start frame detection */
#define None_PCINT3_vect_num       (27)                
#define None_PCINT3_vect           _VECTOR(27)         /* Pin Change Interrupt Request 3 */
...
#define None_USART1_START_vect_num (31)                
#define None_USART1_START_vect     _VECTOR(31)         /* USART1 Start frame detection */
#define None_TIMER3_CAPT_vect_num  (32)                
#define None_TIMER3_CAPT_vect      _VECTOR(32)         /* Timer/Counter3 Capture Event */
#define None_TIMER3_COMPA_vect_num (33)                
#define None_TIMER3_COMPA_vect     _VECTOR(33)         /* Timer/Counter3 Compare Match A */
#define None_TIMER3_COMPB_vect_num (34)                
#define None_TIMER3_COMPB_vect     _VECTOR(34)         /* Timer/Counter3 Compare Match B */
#define None_TIMER3_OVF_vect_num   (35)                
#define None_TIMER3_OVF_vect       _VECTOR(35)         /* Timer/Counter3 Overflow */
#define None_CFD_vect_num          (36)                
#define None_CFD_vect              _VECTOR(36)         /* Clock failure detection interrupt */
#define None_PTC_EOC_vect_num      (37)                
#define None_PTC_EOC_vect          _VECTOR(37)         /* PTC End of conversion */
#define None_PTC_WCOMP_vect_num    (38)                
#define None_PTC_WCOMP_vect        _VECTOR(38)         /* PTC Window comparator mode */
#define None_SPI1_STC_vect_num     (39)                
#define None_SPI1_STC_vect         _VECTOR(39)         /* SPI1 Serial Transfer Complete */
#define None_TWI1_vect_num         (40)                
#define None_TWI1_vect             _VECTOR(40)         /* TWI Transfer Complete */
...
#define None_TIMER4_OVF_vect_num   (44)                
#define None_TIMER4_OVF_vect       _VECTOR(44)         /* Timer/Counter4 Overflow */

/* Vector Table Size */
#define _VECTOR_SIZE               (4)                 /* Size of individual vector. */
#define _VECTORS_SIZE              (45 * _VECTOR_SIZE) /* Size of all vectors */
/*
================================================================================
Constants
================================================================================
