 ...
 *                                                                            * 
 *   .atpack File: ATxmega256A3B.atdf                                         * 
 *   .ATDF File:   atdf/ATxmega256A3B.atdf                                    * 
 *   Version:      2.0.11                                                     * 
 *   Date:         2019-07-11                                                 * 
...
#  define _AVR_IOXXX_H_ "ioATxmega256A3B.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_ATxmega256A3B_H_INCLUDED
#  define _AVR_ATxmega256A3B_H_INCLUDED
...
typedef enum NVM_CMD_enum
{
    ...
    NVM_CMD_FLASH_RANGE_CRC_gc         = (0x78), /* Generate Flash Range CRC */
} NVM_CMD_t;
...
typedef struct RTC32_struct
{
    ...
    register8_t INTFLAGS;    /* Interrupt Flags */
    _REGISTER32 (CNT);       /* Count Register */
    register8_t rsv_0x05[3]; /* RESERVED REGISTER BLOCK */
    _REGISTER32 (PER);       /* Period Register */
    register8_t rsv_0x09[3]; /* RESERVED REGISTER BLOCK */
    _REGISTER32 (COMP);      /* Compare Register */
} RTC32_t;


/* RTC enable */
typedef enum RTC32_ENABLE_enum
{
    RTC32_ENABLE_CLEAR_gc = (0x00), /* RTC enable - CLEAR */
    RTC32_ENABLE_SET_gc   = (0x01), /* RTC enable - SET */
} RTC32_ENABLE_t;

/* Synchronization Busy Flag */
typedef enum RTC32_SYNCCNT_enum
{
    RTC32_SYNCCNT_CLEAR_gc = (0x00), /* Synchronization Busy Flag - CLEAR */
    RTC32_SYNCCNT_SET_gc   = (0x10), /* Synchronization Busy Flag - SET */
} RTC32_SYNCCNT_t;

/* Synchronization Busy Flag */
typedef enum RTC32_SYNCBUSY_enum
{
    RTC32_SYNCBUSY_CLEAR_gc = (0x00), /* Synchronization Busy Flag - CLEAR */
    RTC32_SYNCBUSY_SET_gc   = (0x01), /* Synchronization Busy Flag - SET */
} RTC32_SYNCBUSY_t;
...
{
    RTC32_OVFINTLVL_OFF_gc = (0x00), /* Interrupt Disabled */
    RTC32_OVFINTLVL_LO_gc  = (0x01), /* Low Level */
    RTC32_OVFINTLVL_MED_gc = (0x02), /* Medium Level */
    RTC32_OVFINTLVL_HI_gc  = (0x03), /* High Level */
} RTC32_OVFINTLVL_t;

/* Compare Match Interrupt Flag */
typedef enum RTC32_COMPIF_enum
{
    RTC32_COMPIF_CLEAR_gc = (0x00), /* Compare Match Interrupt Flag - CLEAR */
    RTC32_COMPIF_SET_gc   = (0x02), /* Compare Match Interrupt Flag - SET */
} RTC32_COMPIF_t;

/* Overflow Interrupt Flag */
typedef enum RTC32_OVFIF_enum
{
    RTC32_OVFIF_CLEAR_gc = (0x00), /* Overflow Interrupt Flag - CLEAR */
    RTC32_OVFIF_SET_gc   = (0x01), /* Overflow Interrupt Flag - SET */
} RTC32_OVFIF_t;
...
typedef enum VBAT_HIGHESR_enum
{
    VBAT_HIGHESR_CLEAR_gc = (0x00), /* 32-kHz Crystal Oscillator High Power Mode - CLEAR */
    VBAT_HIGHESR_SET_gc   = (0x20), /* 32-kHz Crystal Oscillator High Power Mode - SET */
} VBAT_HIGHESR_t;

/* 32-kHz Crystal Oscillator Output Selection */
typedef enum VBAT_XOSCSEL_enum
{
    VBAT_XOSCSEL_CLEAR_gc = (0x00), /* 32-kHz Crystal Oscillator Output Selection - CLEAR */
    VBAT_XOSCSEL_SET_gc   = (0x10), /* 32-kHz Crystal Oscillator Output Selection - SET */
} VBAT_XOSCSEL_t;

/* Crystal Oscillator Enable */
typedef enum VBAT_XOSCEN_enum
{
    VBAT_XOSCEN_CLEAR_gc = (0x00), /* Crystal Oscillator Enable - CLEAR */
    VBAT_XOSCEN_SET_gc   = (0x08), /* Crystal Oscillator Enable - SET */
} VBAT_XOSCEN_t;

/* Crystal Oscillator Failure Detection Monitor Enable */
typedef enum VBAT_XOSCFDEN_enum
{
    VBAT_XOSCFDEN_CLEAR_gc = (0x00), /* Crystal Oscillator Failure Detection Monitor Enable - CLEAR */
    VBAT_XOSCFDEN_SET_gc   = (0x04), /* Crystal Oscillator Failure Detection Monitor Enable - SET */
} VBAT_XOSCFDEN_t;

/* Access Enable */
typedef enum VBAT_ACCEN_enum
{
    VBAT_ACCEN_CLEAR_gc = (0x00), /* Access Enable - CLEAR */
    VBAT_ACCEN_SET_gc   = (0x02), /* Access Enable - SET */
} VBAT_ACCEN_t;

/* Reset */
typedef enum VBAT_RESET_enum
{
    VBAT_RESET_CLEAR_gc = (0x00), /* Reset - CLEAR */
    VBAT_RESET_SET_gc   = (0x01), /* Reset - SET */
} VBAT_RESET_t;

/* Battery backup Power */
typedef enum VBAT_BBPWR_enum
{
    VBAT_BBPWR_CLEAR_gc = (0x00), /* Battery backup Power - CLEAR */
    VBAT_BBPWR_SET_gc   = (0x80), /* Battery backup Power - SET */
} VBAT_BBPWR_t;

/* Crystal Oscillator Ready */
typedef enum VBAT_XOSCRDY_enum
{
    VBAT_XOSCRDY_CLEAR_gc = (0x00), /* Crystal Oscillator Ready - CLEAR */
    VBAT_XOSCRDY_SET_gc   = (0x08), /* Crystal Oscillator Ready - SET */
} VBAT_XOSCRDY_t;

/* Crystal Oscillator Failure */
typedef enum VBAT_XOSCFAIL_enum
{
    VBAT_XOSCFAIL_CLEAR_gc = (0x00), /* Crystal Oscillator Failure - CLEAR */
    VBAT_XOSCFAIL_SET_gc   = (0x04), /* Crystal Oscillator Failure - SET */
} VBAT_XOSCFAIL_t;

/* Battery Backup Brown-Out Reset Flag */
typedef enum VBAT_BBBORF_enum
{
    VBAT_BBBORF_CLEAR_gc = (0x00), /* Battery Backup Brown-Out Reset Flag - CLEAR */
    VBAT_BBBORF_SET_gc   = (0x02), /* Battery Backup Brown-Out Reset Flag - SET */
} VBAT_BBBORF_t;

/* Battery Backup Power-On Reset Flag */
typedef enum VBAT_BBPORF_enum
{
    VBAT_BBPORF_CLEAR_gc = (0x00), /* Battery Backup Power-On Reset Flag - CLEAR */
    VBAT_BBPORF_SET_gc   = (0x01), /* Battery Backup Power-On Reset Flag - SET */
} VBAT_BBPORF_t;
/*
================================================================================
...
#define NVM_CMD_FLASH_RANGE_CRC_gc         (0x78) /* Generate Flash Range CRC */
...
/* RTC enable */
#define RTC32_ENABLE_CLEAR_gc (0x00) /* RTC enable - CLEAR */
#define RTC32_ENABLE_SET_gc   (0x01) /* RTC enable - SET */


/* Synchronization Busy Flag */
#define RTC32_SYNCCNT_CLEAR_gc (0x00) /* Synchronization Busy Flag - CLEAR */
#define RTC32_SYNCCNT_SET_gc   (0x10) /* Synchronization Busy Flag - SET */


/* Synchronization Busy Flag */
#define RTC32_SYNCBUSY_CLEAR_gc (0x00) /* Synchronization Busy Flag - CLEAR */
#define RTC32_SYNCBUSY_SET_gc   (0x01) /* Synchronization Busy Flag - SET */
...
/* Overflow Interrupt Level */
#define RTC32_OVFINTLVL_OFF_gc (0x00) /* Interrupt Disabled */
#define RTC32_OVFINTLVL_LO_gc  (0x01) /* Low Level */
#define RTC32_OVFINTLVL_MED_gc (0x02) /* Medium Level */
#define RTC32_OVFINTLVL_HI_gc  (0x03) /* High Level */


/* Compare Match Interrupt Flag */
#define RTC32_COMPIF_CLEAR_gc (0x00) /* Compare Match Interrupt Flag - CLEAR */
#define RTC32_COMPIF_SET_gc   (0x02) /* Compare Match Interrupt Flag - SET */


/* Overflow Interrupt Flag */
#define RTC32_OVFIF_CLEAR_gc (0x00) /* Overflow Interrupt Flag - CLEAR */
#define RTC32_OVFIF_SET_gc   (0x01) /* Overflow Interrupt Flag - SET */
...
/* 32-kHz Crystal Oscillator High Power Mode */
#define VBAT_HIGHESR_CLEAR_gc (0x00) /* 32-kHz Crystal Oscillator High Power Mode - CLEAR */
#define VBAT_HIGHESR_SET_gc   (0x20) /* 32-kHz Crystal Oscillator High Power Mode - SET */


/* 32-kHz Crystal Oscillator Output Selection */
#define VBAT_XOSCSEL_CLEAR_gc (0x00) /* 32-kHz Crystal Oscillator Output Selection - CLEAR */
#define VBAT_XOSCSEL_SET_gc   (0x10) /* 32-kHz Crystal Oscillator Output Selection - SET */


/* Crystal Oscillator Enable */
#define VBAT_XOSCEN_CLEAR_gc (0x00) /* Crystal Oscillator Enable - CLEAR */
#define VBAT_XOSCEN_SET_gc   (0x08) /* Crystal Oscillator Enable - SET */


/* Crystal Oscillator Failure Detection Monitor Enable */
#define VBAT_XOSCFDEN_CLEAR_gc (0x00) /* Crystal Oscillator Failure Detection Monitor Enable - CLEAR */
#define VBAT_XOSCFDEN_SET_gc   (0x04) /* Crystal Oscillator Failure Detection Monitor Enable - SET */


/* Access Enable */
#define VBAT_ACCEN_CLEAR_gc (0x00) /* Access Enable - CLEAR */
#define VBAT_ACCEN_SET_gc   (0x02) /* Access Enable - SET */


/* Reset */
#define VBAT_RESET_CLEAR_gc (0x00) /* Reset - CLEAR */
#define VBAT_RESET_SET_gc   (0x01) /* Reset - SET */


/* Battery backup Power */
#define VBAT_BBPWR_CLEAR_gc (0x00) /* Battery backup Power - CLEAR */
#define VBAT_BBPWR_SET_gc   (0x80) /* Battery backup Power - SET */


/* Crystal Oscillator Ready */
#define VBAT_XOSCRDY_CLEAR_gc (0x00) /* Crystal Oscillator Ready - CLEAR */
#define VBAT_XOSCRDY_SET_gc   (0x08) /* Crystal Oscillator Ready - SET */


/* Crystal Oscillator Failure */
#define VBAT_XOSCFAIL_CLEAR_gc (0x00) /* Crystal Oscillator Failure - CLEAR */
#define VBAT_XOSCFAIL_SET_gc   (0x04) /* Crystal Oscillator Failure - SET */


/* Battery Backup Brown-Out Reset Flag */
#define VBAT_BBBORF_CLEAR_gc (0x00) /* Battery Backup Brown-Out Reset Flag - CLEAR */
#define VBAT_BBBORF_SET_gc   (0x02) /* Battery Backup Brown-Out Reset Flag - SET */


/* Battery Backup Power-On Reset Flag */
#define VBAT_BBPORF_CLEAR_gc (0x00) /* Battery Backup Power-On Reset Flag - CLEAR */
#define VBAT_BBPORF_SET_gc   (0x01) /* Battery Backup Power-On Reset Flag - SET */
...
/* VBAT - Battery Backup Module (0x00F0) */
#define VBAT_BASE                                   _SFR_MEM8 (0x00F0) /* VBAT Base Address */
#define VBAT_CTRL                                   _SFR_MEM8 (0x00F0) /* Control Register */
#define VBAT_STATUS                                 _SFR_MEM8 (0x00F1) /* Status Register */
#define VBAT_BACKUP0                                _SFR_MEM8 (0x00F2) /* Backup Register 0 */
#define VBAT_BACKUP1                                _SFR_MEM8 (0x00F3) /* Backup Register 1 */
...
/* RTC32 - 32-bit Real-Time Counter (0x0420) */
#define RTC32_BASE                                  _SFR_MEM8 (0x0420) /* RTC32 Base Address */
#define RTC32_CTRL                                  _SFR_MEM8 (0x0420) /* Control Register */
#define RTC32_SYNCCTRL                              _SFR_MEM8 (0x0421) /* Synchronization Control/Status Register */
#define RTC32_INTCTRL                               _SFR_MEM8 (0x0422) /* Interrupt Control Register */
#define RTC32_INTFLAGS                              _SFR_MEM8 (0x0423) /* Interrupt Flags */
#define RTC32_CNT                                   _SFR_MEM32(0x0424) /* Count Register */
#define RTC32_CNTL                                  _SFR_MEM16(0x0424) /* Count Register LOW WORD */
#define RTC32_CNT0                                  _SFR_MEM8 (0x0424) /* Count Register LOW BYTE */
#define RTC32_CNT1                                  _SFR_MEM8 (0x0425) /* Count Register 2nd BYTE */
#define RTC32_CNTH                                  _SFR_MEM16(0x0426) /* Count Register HIGH WORD */
#define RTC32_CNT2                                  _SFR_MEM8 (0x0426) /* Count Register 3rd BYTE */
#define RTC32_CNT3                                  _SFR_MEM8 (0x0427) /* Count Register HIGH BYTE */
#define RTC32_PER                                   _SFR_MEM32(0x0428) /* Period Register */
#define RTC32_PERL                                  _SFR_MEM16(0x0428) /* Period Register LOW WORD */
#define RTC32_PER0                                  _SFR_MEM8 (0x0428) /* Period Register LOW BYTE */
#define RTC32_PER1                                  _SFR_MEM8 (0x0429) /* Period Register 2nd BYTE */
#define RTC32_PERH                                  _SFR_MEM16(0x042A) /* Period Register HIGH WORD */
#define RTC32_PER2                                  _SFR_MEM8 (0x042A) /* Period Register 3rd BYTE */
#define RTC32_PER3                                  _SFR_MEM8 (0x042B) /* Period Register HIGH BYTE */
#define RTC32_COMP                                  _SFR_MEM32(0x042C) /* Compare Register */
#define RTC32_COMPL                                 _SFR_MEM16(0x042C) /* Compare Register LOW WORD */
#define RTC32_COMP0                                 _SFR_MEM8 (0x042C) /* Compare Register LOW BYTE */
#define RTC32_COMP1                                 _SFR_MEM8 (0x042D) /* Compare Register 2nd BYTE */
#define RTC32_COMPH                                 _SFR_MEM16(0x042E) /* Compare Register HIGH WORD */
#define RTC32_COMP2                                 _SFR_MEM8 (0x042E) /* Compare Register 3rd BYTE */
#define RTC32_COMP3                                 _SFR_MEM8 (0x042F) /* Compare Register HIGH BYTE */
...
#define RTC32_OVF_vect       _VECTOR(10)          /* RTC32 - OVF Interrupt */
#define RTC32_COMP_vect_num  (11)                 
#define RTC32_COMP_vect      _VECTOR(11)          /* RTC32 - COMP Interrupt */
...
#define _VECTORS_SIZE        (122 * _VECTOR_SIZE) /* Size of all vectors */
/*
================================================================================
Constants
================================================================================
...
#endif /* #ifdef _AVR_ATxmega256A3B_H_INCLUDED */
