 ...
 *                                                                            * 
 *   .atpack File: ATA6612C.atdf                                              * 
 *   .ATDF File:   atdf/ATA6612C.atdf                                         * 
 *   Version:      2.0.6                                                      * 
 *   Date:         2019-04-16                                                 * 
 *   Device:       ATA6612C                                                   * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATA6612C.h"
#else
...
{
    CPU_SE_CLEAR_gc = (0x00), /* -SE - CLEAR */
    CPU_SE_SET_gc   = (0x01), /* -SE - SET */
} CPU_SE_t;
...
/* -SE */
#define CPU_SE_CLEAR_gc (0x00) /* -SE - CLEAR */
#define CPU_SE_SET_gc   (0x01) /* -SE - SET */
...
#define CPU_SMCR                  _SFR_MEM8 (0x0053) 
