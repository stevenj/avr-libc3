 ...
 *                                                                            * 
 *   .atpack File: ATtiny861.atdf                                             * 
 *   .ATDF File:   atdf/ATtiny861.atdf                                        * 
 *   Version:      2.0.10                                                     * 
 *   Date:         2019-04-25                                                 * 
 *   Device:       ATtiny861                                                  * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATtiny861.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_ATtiny861_H_INCLUDED
#  define _AVR_ATtiny861_H_INCLUDED
...
{
    ADC_REFS2_CLEAR_gc = (0x00), /* Reference Selection Bit - CLEAR */
    ADC_REFS2_SET_gc   = (0x10), /* Reference Selection Bit - SET */
} ADC_REFS2_t;

/* Analog Channel and Gain Selection Bit 5 */
typedef enum ADC_MUX5_enum
{
    ADC_MUX5_CLEAR_gc = (0x00), /* Analog Channel and Gain Selection Bit 5 - CLEAR */
    ADC_MUX5_SET_gc   = (0x08), /* Analog Channel and Gain Selection Bit 5 - SET */
} ADC_MUX5_t;
...
/* Reference Selection Bit */
#define ADC_REFS2_CLEAR_gc (0x00) /* Reference Selection Bit - CLEAR */
#define ADC_REFS2_SET_gc   (0x10) /* Reference Selection Bit - SET */


/* Analog Channel and Gain Selection Bit 5 */
#define ADC_MUX5_CLEAR_gc (0x00) /* Analog Channel and Gain Selection Bit 5 - CLEAR */
#define ADC_MUX5_SET_gc   (0x08) /* Analog Channel and Gain Selection Bit 5 - SET */
...
#define TC16_TCCR1E      _SFR_MEM8 (0x0020) /* Timer/Counter1 Control Register E */
#define TC16_DT1         _SFR_MEM8 (0x0044) /* Timer/Counter 1 Dead Time Value */
#define TC16_TC1H        _SFR_MEM8 (0x0045) /* Timer/Counter 1 Register High */
#define TC16_TCCR1D      _SFR_MEM8 (0x0046) /* Timer/Counter Control Register D */
#define TC16_TCCR1C      _SFR_MEM8 (0x0047) /* Timer/Counter Control Register C */
#define TC16_OCR1D       _SFR_MEM8 (0x004A) /* Output compare register */
#define TC16_OCR1C       _SFR_MEM8 (0x004B) /* Output compare register */
#define TC16_OCR1B       _SFR_MEM8 (0x004C) /* Output Compare Register */
#define TC16_OCR1A       _SFR_MEM8 (0x004D) /* Output Compare Register */
#define TC16_TCNT1       _SFR_MEM8 (0x004E) /* Timer/Counter Register */
#define TC16_TCCR1B      _SFR_MEM8 (0x004F) /* Timer/Counter Control Register B */
#define TC16_TCCR1A      _SFR_MEM8 (0x0050) /* Timer/Counter Control Register A */
...
#endif /* #ifdef _AVR_ATtiny861_H_INCLUDED */
