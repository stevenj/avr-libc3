 ...
 *                                                                            * 
 *   .atpack File: ATxmega128A1.atdf                                          * 
 *   .ATDF File:   atdf/ATxmega128A1.atdf                                     * 
 *   Version:      2.0.11                                                     * 
 *   Date:         2019-07-11                                                 * 
 *   Device:       ATxmega128A1                                               * 
...
#  define _AVR_IOXXX_H_ "ioATxmega128A1.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_ATxmega128A1_H_INCLUDED
#  define _AVR_ATxmega128A1_H_INCLUDED
...
typedef enum PR_EBI_enum
{
    PR_EBI_CLEAR_gc = (0x00), /* External Bus Interface - CLEAR */
    PR_EBI_SET_gc   = (0x08), /* External Bus Interface - SET */
} PR_EBI_t;
...
typedef enum NVM_FUSES_BODLEVEL_enum
{
    ...
    NVM_FUSES_BODLEVEL_2V6_gc = (0x03), /* 2.6 V */
    NVM_FUSES_BODLEVEL_2V9_gc = (0x02), /* 2.9 V */
    NVM_FUSES_BODLEVEL_3V2_gc = (0x01), /* 3.2 V */
    NVM_FUSES_BODLEVEL_3V4_gc = (0x00), /* 3.4 V */
...
typedef struct EBI_CS_struct
{
    ...
    _REGISTER16 (BASEADDR); /* Base Address */
} EBI_CS_t;
...
typedef struct EBI_struct
{
    ...
    _REGISTER16 (REFRESH);   /* SDRAM Refresh Period */
    register8_t rsv_0x05;    /* RESERVED REGISTER */
    _REGISTER16 (INITDLY);   /* SDRAM Initialization Delay */
    register8_t rsv_0x07;    /* RESERVED REGISTER */
...
{
    EBI_CS_MODE_DISABLED_gc = (0x00), /* Chip Select Disabled */
    EBI_CS_MODE_SRAM_gc     = (0x01), /* Chip Select in SRAM mode */
    EBI_CS_MODE_LPC_gc      = (0x02), /* Chip Select in SRAM LPC mode */
    EBI_CS_MODE_SDRAM_gc    = (0x03), /* Chip Select in SDRAM mode */
} EBI_CS_MODE_t;

/* SRAM Wait State Cycles */
typedef enum EBI_CS_SRWS_enum
{
    EBI_CS_SRWS_0CLK_gc = (0x00), /* 0 cycles */
    EBI_CS_SRWS_1CLK_gc = (0x01), /* 1 cycle */
    EBI_CS_SRWS_2CLK_gc = (0x02), /* 2 cycles */
    EBI_CS_SRWS_3CLK_gc = (0x03), /* 3 cycles */
    EBI_CS_SRWS_4CLK_gc = (0x04), /* 4 cycles */
    EBI_CS_SRWS_5CLK_gc = (0x05), /* 5 cycles */
    EBI_CS_SRWS_6CLK_gc = (0x06), /* 6 cycles */
    EBI_CS_SRWS_7CLK_gc = (0x07), /* 7 cycles */
} EBI_CS_SRWS_t;

/* SDRAM Initialization Done */
typedef enum EBI_CS_SDINITDONE_enum
{
    EBI_CS_SDINITDONE_CLEAR_gc = (0x00), /* SDRAM Initialization Done - CLEAR */
    EBI_CS_SDINITDONE_SET_gc   = (0x80), /* SDRAM Initialization Done - SET */
} EBI_CS_SDINITDONE_t;

/* SDRAM Self-refresh Enable */
typedef enum EBI_CS_SDSREN_enum
{
    EBI_CS_SDSREN_CLEAR_gc = (0x00), /* SDRAM Self-refresh Enable - CLEAR */
    EBI_CS_SDSREN_SET_gc   = (0x04), /* SDRAM Self-refresh Enable - SET */
} EBI_CS_SDSREN_t;

/* SDRAM Mode */
typedef enum EBI_CS_SDMODE_enum
{
    EBI_CS_SDMODE_NORMAL_gc = (0x00), /* Normal mode */
    EBI_CS_SDMODE_LOAD_gc   = (0x01), /* Load Mode Register command mode */
} EBI_CS_SDMODE_t;
...
{
    EBI_IFMODE_DISABLED_gc = (0x00), /* EBI Disabled */
    EBI_IFMODE_3PORT_gc    = (0x01), /* 3-port mode */
    EBI_IFMODE_4PORT_gc    = (0x02), /* 4-port mode */
    EBI_IFMODE_2PORT_gc    = (0x03), /* 2-port mode */
} EBI_IFMODE_t;

/* SDRAM CAS Latency Setting */
typedef enum EBI_SDCAS_enum
{
    EBI_SDCAS_CLEAR_gc = (0x00), /* SDRAM CAS Latency Setting - CLEAR */
    EBI_SDCAS_SET_gc   = (0x08), /* SDRAM CAS Latency Setting - SET */
} EBI_SDCAS_t;

/* SDRAM ROW Bits Setting */
typedef enum EBI_SDROW_enum
{
    EBI_SDROW_CLEAR_gc = (0x00), /* SDRAM ROW Bits Setting - CLEAR */
    EBI_SDROW_SET_gc   = (0x04), /* SDRAM ROW Bits Setting - SET */
} EBI_SDROW_t;

/* SDRAM Column Bits Setting */
typedef enum EBI_SDCOL_enum
{
    EBI_SDCOL_8BIT_gc  = (0x00), /* 8 column bits */
    EBI_SDCOL_9BIT_gc  = (0x01), /* 9 column bits */
    EBI_SDCOL_10BIT_gc = (0x02), /* 10 column bits */
    EBI_SDCOL_11BIT_gc = (0x03), /* 11 column bits */
} EBI_SDCOL_t;

/* SDRAM Mode Register Delay */
...
{
    EBI_RPDLY_0CLK_gc = (0x00), /* 0 cycles */
    EBI_RPDLY_1CLK_gc = (0x01), /* 1 cycle */
    EBI_RPDLY_2CLK_gc = (0x02), /* 2 cycles */
    EBI_RPDLY_3CLK_gc = (0x03), /* 3 cycles */
    EBI_RPDLY_4CLK_gc = (0x04), /* 4 cycles */
    EBI_RPDLY_5CLK_gc = (0x05), /* 5 cycles */
    EBI_RPDLY_6CLK_gc = (0x06), /* 6 cycles */
    EBI_RPDLY_7CLK_gc = (0x07), /* 7 cycles */
} EBI_RPDLY_t;
...
{
    EBI_ROWCOLDLY_0CLK_gc = (0x00), /* 0 cycles */
    EBI_ROWCOLDLY_1CLK_gc = (0x01), /* 1 cycle */
    EBI_ROWCOLDLY_2CLK_gc = (0x02), /* 2 cycles */
    EBI_ROWCOLDLY_3CLK_gc = (0x03), /* 3 cycles */
    EBI_ROWCOLDLY_4CLK_gc = (0x04), /* 4 cycles */
    EBI_ROWCOLDLY_5CLK_gc = (0x05), /* 5 cycles */
    EBI_ROWCOLDLY_6CLK_gc = (0x06), /* 6 cycles */
    EBI_ROWCOLDLY_7CLK_gc = (0x07), /* 7 cycles */
} EBI_ROWCOLDLY_t;
...
/* External Bus Interface */
#define PR_EBI_CLEAR_gc (0x00) /* External Bus Interface - CLEAR */
#define PR_EBI_SET_gc   (0x08) /* External Bus Interface - SET */
...
#define NVM_FUSES_BODLEVEL_2V6_gc (0x03) /* 2.6 V */
#define NVM_FUSES_BODLEVEL_2V9_gc (0x02) /* 2.9 V */
#define NVM_FUSES_BODLEVEL_3V2_gc (0x01) /* 3.2 V */
#define NVM_FUSES_BODLEVEL_3V4_gc (0x00) /* 3.4 V */
...
/* SRAM Wait State Cycles */
#define EBI_CS_SRWS_0CLK_gc (0x00) /* 0 cycles */
#define EBI_CS_SRWS_1CLK_gc (0x01) /* 1 cycle */
#define EBI_CS_SRWS_2CLK_gc (0x02) /* 2 cycles */
#define EBI_CS_SRWS_3CLK_gc (0x03) /* 3 cycles */
#define EBI_CS_SRWS_4CLK_gc (0x04) /* 4 cycles */
#define EBI_CS_SRWS_5CLK_gc (0x05) /* 5 cycles */
#define EBI_CS_SRWS_6CLK_gc (0x06) /* 6 cycles */
#define EBI_CS_SRWS_7CLK_gc (0x07) /* 7 cycles */


/* SDRAM Initialization Done */
#define EBI_CS_SDINITDONE_CLEAR_gc (0x00) /* SDRAM Initialization Done - CLEAR */
#define EBI_CS_SDINITDONE_SET_gc   (0x80) /* SDRAM Initialization Done - SET */


/* SDRAM Self-refresh Enable */
#define EBI_CS_SDSREN_CLEAR_gc (0x00) /* SDRAM Self-refresh Enable - CLEAR */
#define EBI_CS_SDSREN_SET_gc   (0x04) /* SDRAM Self-refresh Enable - SET */
...
/* SDRAM CAS Latency Setting */
#define EBI_SDCAS_CLEAR_gc (0x00) /* SDRAM CAS Latency Setting - CLEAR */
#define EBI_SDCAS_SET_gc   (0x08) /* SDRAM CAS Latency Setting - SET */


/* SDRAM ROW Bits Setting */
#define EBI_SDROW_CLEAR_gc (0x00) /* SDRAM ROW Bits Setting - CLEAR */
#define EBI_SDROW_SET_gc   (0x04) /* SDRAM ROW Bits Setting - SET */
...
#define EBI_ROWCYCDLY_5CLK_gc (0x05<<3) /* 5 cycles */
...
#define EBI_RPDLY_5CLK_gc (0x05) /* 5 cycles */
...
#define EBI_ESRDLY_5CLK_gc (0x05<<3) /* 5 cycles */
...
#define EBI_ROWCOLDLY_5CLK_gc (0x05) /* 5 cycles */
...
#define PROD_SIGNATURES_PROD_SIGNATURES_DACAOFFCAL  _SFR_MEM8 (0x0030) /* DACA Calibration Byte 0 */
#define PROD_SIGNATURES_PROD_SIGNATURES_DACAGAINCAL _SFR_MEM8 (0x0031) /* DACA Calibration Byte 1 */
#define PROD_SIGNATURES_PROD_SIGNATURES_DACBOFFCAL  _SFR_MEM8 (0x0032) /* DACB Calibration Byte 0 */
#define PROD_SIGNATURES_PROD_SIGNATURES_DACBGAINCAL _SFR_MEM8 (0x0033) /* DACB Calibration Byte 1 */
...
#define DACA_TIMCTRL                                _SFR_MEM8 (0x0304) /* Timing Control */
#define DACA_STATUS                                 _SFR_MEM8 (0x0305) /* Status */
#define DACA_GAINCAL                                _SFR_MEM8 (0x0308) /* Gain Calibration */
#define DACA_OFFSETCAL                              _SFR_MEM8 (0x0309) /* Offset Calibration */
...
/* EBI - External Bus Interface (0x0440) */
#define EBI_BASE                                    _SFR_MEM8 (0x0440) /* EBI Base Address */
#define EBI_CTRL                                    _SFR_MEM8 (0x0440) /* Control */
#define EBI_SDRAMCTRLA                              _SFR_MEM8 (0x0441) /* SDRAM Control Register A */
#define EBI_REFRESH                                 _SFR_MEM16(0x0444) /* SDRAM Refresh Period */
#define EBI_REFRESHL                                _SFR_MEM8 (0x0444) /* SDRAM Refresh Period LOW BYTE */
#define EBI_REFRESHH                                _SFR_MEM8 (0x0445) /* SDRAM Refresh Period HIGH BYTE */
#define EBI_INITDLY                                 _SFR_MEM16(0x0446) /* SDRAM Initialization Delay */
#define EBI_INITDLYL                                _SFR_MEM8 (0x0446) /* SDRAM Initialization Delay LOW BYTE */
#define EBI_INITDLYH                                _SFR_MEM8 (0x0447) /* SDRAM Initialization Delay HIGH BYTE */
#define EBI_SDRAMCTRLB                              _SFR_MEM8 (0x0448) /* SDRAM Control Register B */
#define EBI_SDRAMCTRLC                              _SFR_MEM8 (0x0449) /* SDRAM Control Register C */
...
/* TWID - Two-Wire Interface (0x0490) */
#define TWID_BASE                                   _SFR_MEM8 (0x0490) /* TWID Base Address */
#define TWID_CTRL                                   _SFR_MEM8 (0x0490) /* TWI Common Control Register */
...
/* TWIF - Two-Wire Interface (0x04B0) */
#define TWIF_BASE                                   _SFR_MEM8 (0x04B0) /* TWIF Base Address */
#define TWIF_CTRL                                   _SFR_MEM8 (0x04B0) /* TWI Common Control Register */
...
/* PORTH - I/O Ports (0x06E0) */
#define PORTH_BASE                                  _SFR_MEM8 (0x06E0) /* PORTH Base Address */
#define PORTH_DIR                                   _SFR_MEM8 (0x06E0) /* I/O Port Data Direction */
#define PORTH_DIRSET                                _SFR_MEM8 (0x06E1) /* I/O Port Data Direction Set */
#define PORTH_DIRCLR                                _SFR_MEM8 (0x06E2) /* I/O Port Data Direction Clear */
#define PORTH_DIRTGL                                _SFR_MEM8 (0x06E3) /* I/O Port Data Direction Toggle */
#define PORTH_OUT                                   _SFR_MEM8 (0x06E4) /* I/O Port Output */
#define PORTH_OUTSET                                _SFR_MEM8 (0x06E5) /* I/O Port Output Set */
#define PORTH_OUTCLR                                _SFR_MEM8 (0x06E6) /* I/O Port Output Clear */
#define PORTH_OUTTGL                                _SFR_MEM8 (0x06E7) /* I/O Port Output Toggle */
#define PORTH_IN                                    _SFR_MEM8 (0x06E8) /* I/O port Input */
#define PORTH_INTCTRL                               _SFR_MEM8 (0x06E9) /* Interrupt Control Register */
#define PORTH_INT0MASK                              _SFR_MEM8 (0x06EA) /* Port Interrupt 0 Mask */
#define PORTH_INT1MASK                              _SFR_MEM8 (0x06EB) /* Port Interrupt 1 Mask */
#define PORTH_INTFLAGS                              _SFR_MEM8 (0x06EC) /* Interrupt Flag Register */
#define PORTH_PIN0CTRL                              _SFR_MEM8 (0x06F0) /* Pin 0 Control Register */
#define PORTH_PIN1CTRL                              _SFR_MEM8 (0x06F1) /* Pin 1 Control Register */
#define PORTH_PIN2CTRL                              _SFR_MEM8 (0x06F2) /* Pin 2 Control Register */
#define PORTH_PIN3CTRL                              _SFR_MEM8 (0x06F3) /* Pin 3 Control Register */
#define PORTH_PIN4CTRL                              _SFR_MEM8 (0x06F4) /* Pin 4 Control Register */
#define PORTH_PIN5CTRL                              _SFR_MEM8 (0x06F5) /* Pin 5 Control Register */
#define PORTH_PIN6CTRL                              _SFR_MEM8 (0x06F6) /* Pin 6 Control Register */
#define PORTH_PIN7CTRL                              _SFR_MEM8 (0x06F7) /* Pin 7 Control Register */

/* PORTJ - I/O Ports (0x0700) */
#define PORTJ_BASE                                  _SFR_MEM8 (0x0700) /* PORTJ Base Address */
#define PORTJ_DIR                                   _SFR_MEM8 (0x0700) /* I/O Port Data Direction */
#define PORTJ_DIRSET                                _SFR_MEM8 (0x0701) /* I/O Port Data Direction Set */
#define PORTJ_DIRCLR                                _SFR_MEM8 (0x0702) /* I/O Port Data Direction Clear */
#define PORTJ_DIRTGL                                _SFR_MEM8 (0x0703) /* I/O Port Data Direction Toggle */
#define PORTJ_OUT                                   _SFR_MEM8 (0x0704) /* I/O Port Output */
#define PORTJ_OUTSET                                _SFR_MEM8 (0x0705) /* I/O Port Output Set */
#define PORTJ_OUTCLR                                _SFR_MEM8 (0x0706) /* I/O Port Output Clear */
#define PORTJ_OUTTGL                                _SFR_MEM8 (0x0707) /* I/O Port Output Toggle */
#define PORTJ_IN                                    _SFR_MEM8 (0x0708) /* I/O port Input */
#define PORTJ_INTCTRL                               _SFR_MEM8 (0x0709) /* Interrupt Control Register */
#define PORTJ_INT0MASK                              _SFR_MEM8 (0x070A) /* Port Interrupt 0 Mask */
#define PORTJ_INT1MASK                              _SFR_MEM8 (0x070B) /* Port Interrupt 1 Mask */
#define PORTJ_INTFLAGS                              _SFR_MEM8 (0x070C) /* Interrupt Flag Register */
#define PORTJ_PIN0CTRL                              _SFR_MEM8 (0x0710) /* Pin 0 Control Register */
#define PORTJ_PIN1CTRL                              _SFR_MEM8 (0x0711) /* Pin 1 Control Register */
#define PORTJ_PIN2CTRL                              _SFR_MEM8 (0x0712) /* Pin 2 Control Register */
#define PORTJ_PIN3CTRL                              _SFR_MEM8 (0x0713) /* Pin 3 Control Register */
#define PORTJ_PIN4CTRL                              _SFR_MEM8 (0x0714) /* Pin 4 Control Register */
#define PORTJ_PIN5CTRL                              _SFR_MEM8 (0x0715) /* Pin 5 Control Register */
#define PORTJ_PIN6CTRL                              _SFR_MEM8 (0x0716) /* Pin 6 Control Register */
#define PORTJ_PIN7CTRL                              _SFR_MEM8 (0x0717) /* Pin 7 Control Register */

/* PORTK - I/O Ports (0x0720) */
#define PORTK_BASE                                  _SFR_MEM8 (0x0720) /* PORTK Base Address */
#define PORTK_DIR                                   _SFR_MEM8 (0x0720) /* I/O Port Data Direction */
#define PORTK_DIRSET                                _SFR_MEM8 (0x0721) /* I/O Port Data Direction Set */
#define PORTK_DIRCLR                                _SFR_MEM8 (0x0722) /* I/O Port Data Direction Clear */
#define PORTK_DIRTGL                                _SFR_MEM8 (0x0723) /* I/O Port Data Direction Toggle */
#define PORTK_OUT                                   _SFR_MEM8 (0x0724) /* I/O Port Output */
#define PORTK_OUTSET                                _SFR_MEM8 (0x0725) /* I/O Port Output Set */
#define PORTK_OUTCLR                                _SFR_MEM8 (0x0726) /* I/O Port Output Clear */
#define PORTK_OUTTGL                                _SFR_MEM8 (0x0727) /* I/O Port Output Toggle */
#define PORTK_IN                                    _SFR_MEM8 (0x0728) /* I/O port Input */
#define PORTK_INTCTRL                               _SFR_MEM8 (0x0729) /* Interrupt Control Register */
#define PORTK_INT0MASK                              _SFR_MEM8 (0x072A) /* Port Interrupt 0 Mask */
#define PORTK_INT1MASK                              _SFR_MEM8 (0x072B) /* Port Interrupt 1 Mask */
#define PORTK_INTFLAGS                              _SFR_MEM8 (0x072C) /* Interrupt Flag Register */
#define PORTK_PIN0CTRL                              _SFR_MEM8 (0x0730) /* Pin 0 Control Register */
#define PORTK_PIN1CTRL                              _SFR_MEM8 (0x0731) /* Pin 1 Control Register */
#define PORTK_PIN2CTRL                              _SFR_MEM8 (0x0732) /* Pin 2 Control Register */
#define PORTK_PIN3CTRL                              _SFR_MEM8 (0x0733) /* Pin 3 Control Register */
#define PORTK_PIN4CTRL                              _SFR_MEM8 (0x0734) /* Pin 4 Control Register */
#define PORTK_PIN5CTRL                              _SFR_MEM8 (0x0735) /* Pin 5 Control Register */
#define PORTK_PIN6CTRL                              _SFR_MEM8 (0x0736) /* Pin 6 Control Register */
#define PORTK_PIN7CTRL                              _SFR_MEM8 (0x0737) /* Pin 7 Control Register */

/* PORTQ - I/O Ports (0x07C0) */
#define PORTQ_BASE                                  _SFR_MEM8 (0x07C0) /* PORTQ Base Address */
#define PORTQ_DIR                                   _SFR_MEM8 (0x07C0) /* I/O Port Data Direction */
#define PORTQ_DIRSET                                _SFR_MEM8 (0x07C1) /* I/O Port Data Direction Set */
#define PORTQ_DIRCLR                                _SFR_MEM8 (0x07C2) /* I/O Port Data Direction Clear */
#define PORTQ_DIRTGL                                _SFR_MEM8 (0x07C3) /* I/O Port Data Direction Toggle */
#define PORTQ_OUT                                   _SFR_MEM8 (0x07C4) /* I/O Port Output */
#define PORTQ_OUTSET                                _SFR_MEM8 (0x07C5) /* I/O Port Output Set */
#define PORTQ_OUTCLR                                _SFR_MEM8 (0x07C6) /* I/O Port Output Clear */
#define PORTQ_OUTTGL                                _SFR_MEM8 (0x07C7) /* I/O Port Output Toggle */
#define PORTQ_IN                                    _SFR_MEM8 (0x07C8) /* I/O port Input */
#define PORTQ_INTCTRL                               _SFR_MEM8 (0x07C9) /* Interrupt Control Register */
#define PORTQ_INT0MASK                              _SFR_MEM8 (0x07CA) /* Port Interrupt 0 Mask */
#define PORTQ_INT1MASK                              _SFR_MEM8 (0x07CB) /* Port Interrupt 1 Mask */
#define PORTQ_INTFLAGS                              _SFR_MEM8 (0x07CC) /* Interrupt Flag Register */
#define PORTQ_PIN0CTRL                              _SFR_MEM8 (0x07D0) /* Pin 0 Control Register */
#define PORTQ_PIN1CTRL                              _SFR_MEM8 (0x07D1) /* Pin 1 Control Register */
#define PORTQ_PIN2CTRL                              _SFR_MEM8 (0x07D2) /* Pin 2 Control Register */
#define PORTQ_PIN3CTRL                              _SFR_MEM8 (0x07D3) /* Pin 3 Control Register */
#define PORTQ_PIN4CTRL                              _SFR_MEM8 (0x07D4) /* Pin 4 Control Register */
#define PORTQ_PIN5CTRL                              _SFR_MEM8 (0x07D5) /* Pin 5 Control Register */
#define PORTQ_PIN6CTRL                              _SFR_MEM8 (0x07D6) /* Pin 6 Control Register */
#define PORTQ_PIN7CTRL                              _SFR_MEM8 (0x07D7) /* Pin 7 Control Register */
...
/* WARNING: TC_BASE ALREADY DEFINED as '_SFR_MEM8 (0x0880)' NOT '_SFR_MEM8 (0x0A80)' */
/* WARNING: TC_CTRL ALREADY DEFINED as '_SFR_MEM8 (0x0880)' NOT '_SFR_MEM8 (0x0A80)' */
/* WARNING: TC_FDEMASK ALREADY DEFINED as '_SFR_MEM8 (0x0882)' NOT '_SFR_MEM8 (0x0A82)' */
/* WARNING: TC_FDCTRL ALREADY DEFINED as '_SFR_MEM8 (0x0883)' NOT '_SFR_MEM8 (0x0A83)' */
/* WARNING: TC_STATUS ALREADY DEFINED as '_SFR_MEM8 (0x0884)' NOT '_SFR_MEM8 (0x0A84)' */
/* WARNING: TC_DTBOTH ALREADY DEFINED as '_SFR_MEM8 (0x0886)' NOT '_SFR_MEM8 (0x0A86)' */
/* WARNING: TC_DTBOTHBUF ALREADY DEFINED as '_SFR_MEM8 (0x0887)' NOT '_SFR_MEM8 (0x0A87)' */
/* WARNING: TC_DTLS ALREADY DEFINED as '_SFR_MEM8 (0x0888)' NOT '_SFR_MEM8 (0x0A88)' */
/* WARNING: TC_DTHS ALREADY DEFINED as '_SFR_MEM8 (0x0889)' NOT '_SFR_MEM8 (0x0A89)' */
/* WARNING: TC_DTLSBUF ALREADY DEFINED as '_SFR_MEM8 (0x088A)' NOT '_SFR_MEM8 (0x0A8A)' */
/* WARNING: TC_DTHSBUF ALREADY DEFINED as '_SFR_MEM8 (0x088B)' NOT '_SFR_MEM8 (0x0A8B)' */
/* WARNING: TC_OUTOVEN ALREADY DEFINED as '_SFR_MEM8 (0x088C)' NOT '_SFR_MEM8 (0x0A8C)' */
...
/* TCF1 - 16-bit Timer/Counter 1 (0x0B40) */
#define TCF11_BASE                                  _SFR_MEM8 (0x0B40) /* TCF11 Base Address */
#define TCF11_CTRLA                                 _SFR_MEM8 (0x0B40) /* Control  Register A */
#define TCF11_CTRLB                                 _SFR_MEM8 (0x0B41) /* Control Register B */
#define TCF11_CTRLC                                 _SFR_MEM8 (0x0B42) /* Control register C */
#define TCF11_CTRLD                                 _SFR_MEM8 (0x0B43) /* Control Register D */
#define TCF11_CTRLE                                 _SFR_MEM8 (0x0B44) /* Control Register E */
#define TCF11_INTCTRLA                              _SFR_MEM8 (0x0B46) /* Interrupt Control Register A */
#define TCF11_INTCTRLB                              _SFR_MEM8 (0x0B47) /* Interrupt Control Register B */
#define TCF11_CTRLFCLR                              _SFR_MEM8 (0x0B48) /* Control Register F Clear */
#define TCF11_CTRLFSET                              _SFR_MEM8 (0x0B49) /* Control Register F Set */
#define TCF11_CTRLGCLR                              _SFR_MEM8 (0x0B4A) /* Control Register G Clear */
#define TCF11_CTRLGSET                              _SFR_MEM8 (0x0B4B) /* Control Register G Set */
#define TCF11_INTFLAGS                              _SFR_MEM8 (0x0B4C) /* Interrupt Flag Register */
#define TCF11_TEMP                                  _SFR_MEM8 (0x0B4F) /* Temporary Register For 16-bit Access */
#define TCF11_CNT                                   _SFR_MEM16(0x0B60) /* Count */
#define TCF11_CNTL                                  _SFR_MEM8 (0x0B60) /* Count LOW BYTE */
#define TCF11_CNTH                                  _SFR_MEM8 (0x0B61) /* Count HIGH BYTE */
#define TCF11_PER                                   _SFR_MEM16(0x0B66) /* Period */
#define TCF11_PERL                                  _SFR_MEM8 (0x0B66) /* Period LOW BYTE */
#define TCF11_PERH                                  _SFR_MEM8 (0x0B67) /* Period HIGH BYTE */
#define TCF11_CCA                                   _SFR_MEM16(0x0B68) /* Compare or Capture A */
#define TCF11_CCAL                                  _SFR_MEM8 (0x0B68) /* Compare or Capture A LOW BYTE */
#define TCF11_CCAH                                  _SFR_MEM8 (0x0B69) /* Compare or Capture A HIGH BYTE */
#define TCF11_CCB                                   _SFR_MEM16(0x0B6A) /* Compare or Capture B */
#define TCF11_CCBL                                  _SFR_MEM8 (0x0B6A) /* Compare or Capture B LOW BYTE */
#define TCF11_CCBH                                  _SFR_MEM8 (0x0B6B) /* Compare or Capture B HIGH BYTE */
#define TCF11_PERBUF                                _SFR_MEM16(0x0B76) /* Period Buffer */
#define TCF11_PERBUFL                               _SFR_MEM8 (0x0B76) /* Period Buffer LOW BYTE */
#define TCF11_PERBUFH                               _SFR_MEM8 (0x0B77) /* Period Buffer HIGH BYTE */
#define TCF11_CCABUF                                _SFR_MEM16(0x0B78) /* Compare Or Capture A Buffer */
#define TCF11_CCABUFL                               _SFR_MEM8 (0x0B78) /* Compare Or Capture A Buffer LOW BYTE */
#define TCF11_CCABUFH                               _SFR_MEM8 (0x0B79) /* Compare Or Capture A Buffer HIGH BYTE */
#define TCF11_CCBBUF                                _SFR_MEM16(0x0B7A) /* Compare Or Capture B Buffer */
#define TCF11_CCBBUFL                               _SFR_MEM8 (0x0B7A) /* Compare Or Capture B Buffer LOW BYTE */
#define TCF11_CCBBUFH                               _SFR_MEM8 (0x0B7B) /* Compare Or Capture B Buffer HIGH BYTE */

/* HIRESF - High-Resolution Extension (0x0B90) */
/* WARNING: TC_BASE ALREADY DEFINED as '_SFR_MEM8 (0x0880)' NOT '_SFR_MEM8 (0x0B90)' */
/* WARNING: TC_CTRLA ALREADY DEFINED as '_SFR_MEM8 (0x0890)' NOT '_SFR_MEM8 (0x0B90)' */
...
/* USARTF1 - Universal Synchronous/Asynchronous Receiver/Transmitter (0x0BB0) */
#define USARTF1_BASE                                _SFR_MEM8 (0x0BB0) /* USARTF1 Base Address */
#define USARTF1_DATA                                _SFR_MEM8 (0x0BB0) /* Data Register */
#define USARTF1_STATUS                              _SFR_MEM8 (0x0BB1) /* Status Register */
#define USARTF1_CTRLA                               _SFR_MEM8 (0x0BB3) /* Control Register A */
#define USARTF1_CTRLB                               _SFR_MEM8 (0x0BB4) /* Control Register B */
#define USARTF1_CTRLC                               _SFR_MEM8 (0x0BB5) /* Control Register C */
#define USARTF1_BAUDCTRLA                           _SFR_MEM8 (0x0BB6) /* Baud Rate Control Register A */
#define USARTF1_BAUDCTRLB                           _SFR_MEM8 (0x0BB7) /* Baud Rate Control Register B */

/* SPIF - Serial Peripheral Interface (0x0BC0) */
#define SPIF_BASE                                   _SFR_MEM8 (0x0BC0) /* SPIF Base Address */
#define SPIF_CTRL                                   _SFR_MEM8 (0x0BC0) /* Control Register */
#define SPIF_INTCTRL                                _SFR_MEM8 (0x0BC1) /* Interrupt Control Register */
#define SPIF_STATUS                                 _SFR_MEM8 (0x0BC2) /* Status Register */
#define SPIF_DATA                                   _SFR_MEM8 (0x0BC3) /* Data Register */
...
#define TWID_TWIS_vect       _VECTOR(75)          /* TWID - TWIS Interrupt */
#define TWID_TWIM_vect_num   (76)                 
#define TWID_TWIM_vect       _VECTOR(76)          /* TWID - TWIM Interrupt */
...
#define PORTQ_INT0_vect      _VECTOR(94)          /* PORTQ - INT0 Interrupt */
#define PORTQ_INT1_vect_num  (95)                 
#define PORTQ_INT1_vect      _VECTOR(95)          /* PORTQ - INT1 Interrupt */

/* PORTH interrupt vectors */
#define PORTH_INT0_vect_num  (96)                 
#define PORTH_INT0_vect      _VECTOR(96)          /* PORTH - INT0 Interrupt */
#define PORTH_INT1_vect_num  (97)                 
#define PORTH_INT1_vect      _VECTOR(97)          /* PORTH - INT1 Interrupt */

/* PORTJ interrupt vectors */
#define PORTJ_INT0_vect_num  (98)                 
#define PORTJ_INT0_vect      _VECTOR(98)          /* PORTJ - INT0 Interrupt */
#define PORTJ_INT1_vect_num  (99)                 
#define PORTJ_INT1_vect      _VECTOR(99)          /* PORTJ - INT1 Interrupt */

/* PORTK interrupt vectors */
#define PORTK_INT0_vect_num  (100)                
#define PORTK_INT0_vect      _VECTOR(100)         /* PORTK - INT0 Interrupt */
#define PORTK_INT1_vect_num  (101)                
#define PORTK_INT1_vect      _VECTOR(101)         /* PORTK - INT1 Interrupt */
...
#define TWIF_TWIS_vect       _VECTOR(106)         /* TWIF - TWIS Interrupt */
#define TWIF_TWIM_vect_num   (107)                
#define TWIF_TWIM_vect       _VECTOR(107)         /* TWIF - TWIM Interrupt */
...
#define TCF1_OVF_vect        _VECTOR(114)         /* TCF1 - OVF Interrupt */
#define TCF1_ERR_vect_num    (115)                
#define TCF1_ERR_vect        _VECTOR(115)         /* TCF1 - ERR Interrupt */
#define TCF1_CCA_vect_num    (116)                
#define TCF1_CCA_vect        _VECTOR(116)         /* TCF1 - CCA Interrupt */
#define TCF1_CCB_vect_num    (117)                
#define TCF1_CCB_vect        _VECTOR(117)         /* TCF1 - CCB Interrupt */

/* SPIF interrupt vectors */
#define SPIF_INT_vect_num    (118)                
#define SPIF_INT_vect        _VECTOR(118)         /* SPIF - INT Interrupt */
...
#define USARTF1_RXC_vect     _VECTOR(122)         /* USARTF1 - RXC Interrupt */
#define USARTF1_DRE_vect_num (123)                
#define USARTF1_DRE_vect     _VECTOR(123)         /* USARTF1 - DRE Interrupt */
#define USARTF1_TXC_vect_num (124)                
#define USARTF1_TXC_vect     _VECTOR(124)         /* USARTF1 - TXC Interrupt */

/* Vector Table Size */
#define _VECTOR_SIZE         (4)                  /* Size of individual vector. */
#define _VECTORS_SIZE        (125 * _VECTOR_SIZE) /* Size of all vectors */
/*
================================================================================
Constants
================================================================================
...
#define EXTERNAL_SRAM_SIZE      (0xFFBFFF)                                     
#define EXTERNAL_SRAM_PAGE_SIZE (0x0001)                                       
...
#endif /* #ifdef _AVR_ATxmega128A1_H_INCLUDED */
