 ...
 *                                                                            * 
 *   .atpack File: ATA6614Q.atdf                                              * 
 *   .ATDF File:   atdf/ATA6614Q.atdf                                         * 
 *   Version:      2.0.6                                                      * 
 *   Date:         2019-04-16                                                 * 
 *   Device:       ATA6614Q                                                   * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATA6614Q.h"
#else
...
/* USART Control and Status Register C-UDORD0 */
typedef enum USART0_UDORD0_enum
{
    USART0_UDORD0_CLEAR_gc = (0x00), /* USART Control and Status Register C-UDORD0 - CLEAR */
    USART0_UDORD0_SET_gc   = (0x04), /* USART Control and Status Register C-UDORD0 - SET */
} USART0_UDORD0_t;

/* USART Control and Status Register C-UCPHA0 */
typedef enum USART0_UCPHA0_enum
{
    USART0_UCPHA0_CLEAR_gc = (0x00), /* USART Control and Status Register C-UCPHA0 - CLEAR */
    USART0_UCPHA0_SET_gc   = (0x02), /* USART Control and Status Register C-UCPHA0 - SET */
} USART0_UCPHA0_t;
...
/* USART Control and Status Register C-UDORD0 */
#define USART0_UDORD0_CLEAR_gc (0x00) /* USART Control and Status Register C-UDORD0 - CLEAR */
#define USART0_UDORD0_SET_gc   (0x04) /* USART Control and Status Register C-UDORD0 - SET */


/* USART Control and Status Register C-UCPHA0 */
#define USART0_UCPHA0_CLEAR_gc (0x00) /* USART Control and Status Register C-UCPHA0 - CLEAR */
#define USART0_UCPHA0_SET_gc   (0x02) /* USART Control and Status Register C-UCPHA0 - SET */
