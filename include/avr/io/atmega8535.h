 ...
 *                                                                            * 
 *   .atpack File: ATmega8535.atdf                                            * 
 *   .ATDF File:   atdf/ATmega8535.atdf                                       * 
 *   Version:      2.0.12                                                     * 
 *   Date:         2019-04-26                                                 * 
 *   Device:       ATmega8535                                                 * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATmega8535.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_ATmega8535_H_INCLUDED
#  define _AVR_ATmega8535_H_INCLUDED
...
/* AT90S4434/8535 compatibility mode */
typedef enum FUSE_S8535C_enum
{
    FUSE_S8535C_CLEAR_gc = (0x00), /* AT90S4434/8535 compatibility mode - CLEAR */
    FUSE_S8535C_SET_gc   = (0x80), /* AT90S4434/8535 compatibility mode - SET */
} FUSE_S8535C_t;
...
/* Interrupt Sense Control 1 Bits */
#define CPU_MCUCR_ISC1_gc(x) ((x<<2) & 0x0C)
...
/* Anlog Comparator Multiplexer Enable */
typedef enum CPU_ACME_enum
{
    CPU_ACME_CLEAR_gc = (0x00), /* Anlog Comparator Multiplexer Enable - CLEAR */
    CPU_ACME_SET_gc   = (0x08), /* Anlog Comparator Multiplexer Enable - SET */
} CPU_ACME_t;
...
/* AT90S4434/8535 compatibility mode */
#define FUSE_S8535C_CLEAR_gc (0x00) /* AT90S4434/8535 compatibility mode - CLEAR */
#define FUSE_S8535C_SET_gc   (0x80) /* AT90S4434/8535 compatibility mode - SET */
...
/* Anlog Comparator Multiplexer Enable */
#define CPU_ACME_CLEAR_gc (0x00) /* Anlog Comparator Multiplexer Enable - CLEAR */
#define CPU_ACME_SET_gc   (0x08) /* Anlog Comparator Multiplexer Enable - SET */
...
#define CPU_SPMCR       _SFR_MEM8 (0x0057) 
...
#define None_INT1_vect             _VECTOR(2)          /* External Interrupt 1 */
...
#define None_SPI_STC_vect          _VECTOR(10)         /* SPI Serial Transfer Complete */
#define None_USART_RX_vect_num     (11)                
#define None_USART_RX_vect         _VECTOR(11)         /* USART, RX Complete */
#define None_USART_UDRE_vect_num   (12)                
#define None_USART_UDRE_vect       _VECTOR(12)         /* USART Data Register Empty */
#define None_USART_TX_vect_num     (13)                
#define None_USART_TX_vect         _VECTOR(13)         /* USART, TX Complete */
...
#define None_TWI_vect              _VECTOR(17)         /* Two-wire Serial Interface */
...
#define None_TIMER0_COMP_vect      _VECTOR(19)         /* TimerCounter0 Compare Match */
#define None_SPM_RDY_vect_num      (20)                
#define None_SPM_RDY_vect          _VECTOR(20)         /* Store Program Memory Read */
...
#define S8535C  (unsigned char)~_BV(7) /* AT90S4434/8535 compatibility mode */
...
#endif /* #ifdef _AVR_ATmega8535_H_INCLUDED */
