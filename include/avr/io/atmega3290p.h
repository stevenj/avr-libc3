 ...
 *                                                                            * 
 *   .atpack File: ATmega3290P.atdf                                           * 
 *   .ATDF File:   atdf/ATmega3290P.atdf                                      * 
 *   Version:      2.0.12                                                     * 
 *   Date:         2019-04-26                                                 * 
 *   Device:       ATmega3290P                                                * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATmega3290P.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_ATmega3290P_H_INCLUDED
#  define _AVR_ATmega3290P_H_INCLUDED
...
typedef struct LCD_struct
{
    ...
    register8_t LCDCRA;        /* LCD Control and Status Register A */
    ...
    register8_t LCDDR04;       /* LCD Data Register 4 */
    ...
    register8_t LCDDR09;       /* LCD Data Register 9 */
    ...
    register8_t LCDDR14;       /* LCD Data Register 14 */
    ...
    register8_t LCDDR19;       /* LCD Data Register 19 */
} LCD_t;
...
#define TC8_GTCCR        _SFR_MEM8 (0x43) /* General Timer/Control Register */
#define TC8_TCCR0A       _SFR_MEM8 (0x44) /* Timer/Counter0 Control Register */
...
#define TC8_ASYNC_TIFR2  _SFR_MEM8 (0x37) /* Timer/Counter2 Interrupt Flag Register */
#define TC8_ASYNC_GTCCR  _SFR_MEM8 (0x43) /* General Timer/Counter Control Register */
#define TC8_ASYNC_TIMSK2 _SFR_MEM8 (0x70) /* Timer/Counter2 Interrupt Mask register */
#define TC8_ASYNC_TCCR2A _SFR_MEM8 (0xB0) /* Timer/Counter2 Control Register */
#define TC8_ASYNC_TCNT2  _SFR_MEM8 (0xB2) /* Timer/Counter2 */
#define TC8_ASYNC_OCR2A  _SFR_MEM8 (0xB3) /* Timer/Counter2 Output Compare Register */
...
#define WDT_WDTCR        _SFR_MEM8 (0x60) /* Watchdog Timer Control Register */
...
#define EEPROM_EEAR      _SFR_MEM16(0x41) /* EEPROM Read/Write Access  Bytes */
#define EEPROM_EEARL     _SFR_MEM8 (0x41) /* EEPROM Read/Write Access  Bytes LOW BYTE */
#define EEPROM_EEARH     _SFR_MEM8 (0x42) /* EEPROM Read/Write Access  Bytes HIGH BYTE */
...
#define PORTGG_PING      _SFR_MEM8 (0x32) /* Port G Input Pins */
...
#define PORTHH_PINH      _SFR_MEM8 (0xD8) /* PORT H Input Pins */
#define PORTHH_DDRH      _SFR_MEM8 (0xD9) /* PORT H Data Direction Register */
#define PORTHH_PORTH     _SFR_MEM8 (0xDA) /* PORT H Data Register */

/* PORTJ - I/O Port (0x00) */
#define PORTJJ_BASE      _SFR_MEM8 (0x00) /* PORTJJ Base Address */
#define PORTJJ_PINJ      _SFR_MEM8 (0xDB) /* PORT J Input Pins */
#define PORTJJ_DDRJ      _SFR_MEM8 (0xDC) /* PORT J Data Direction Register */
#define PORTJJ_PORTJ     _SFR_MEM8 (0xDD) /* PORT J Data Register */
...
/* LCD - Liquid Crystal Display (0x00) */
#define LCD_BASE         _SFR_MEM8 (0x00) /* LCD Base Address */
#define LCD_LCDCRA       _SFR_MEM8 (0xE4) /* LCD Control and Status Register A */
#define LCD_LCDCRB       _SFR_MEM8 (0xE5) /* LCD Control and Status Register B */
#define LCD_LCDFRR       _SFR_MEM8 (0xE6) /* LCD Frame Rate Register */
#define LCD_LCDCCR       _SFR_MEM8 (0xE7) /* LCD Contrast Control Register */
#define LCD_LCDDR00      _SFR_MEM8 (0xEC) /* LCD Data Register 0 */
#define LCD_LCDDR01      _SFR_MEM8 (0xED) /* LCD Data Register 1 */
#define LCD_LCDDR02      _SFR_MEM8 (0xEE) /* LCD Data Register 2 */
#define LCD_LCDDR03      _SFR_MEM8 (0xEF) /* LCD Data Register 3 */
#define LCD_LCDDR04      _SFR_MEM8 (0xF0) /* LCD Data Register 4 */
#define LCD_LCDDR05      _SFR_MEM8 (0xF1) /* LCD Data Register 5 */
#define LCD_LCDDR06      _SFR_MEM8 (0xF2) /* LCD Data Register 6 */
#define LCD_LCDDR07      _SFR_MEM8 (0xF3) /* LCD Data Register 7 */
#define LCD_LCDDR08      _SFR_MEM8 (0xF4) /* LCD Data Register 8 */
#define LCD_LCDDR09      _SFR_MEM8 (0xF5) /* LCD Data Register 9 */
#define LCD_LCDDR10      _SFR_MEM8 (0xF6) /* LCD Data Register 10 */
#define LCD_LCDDR11      _SFR_MEM8 (0xF7) /* LCD Data Register 11 */
#define LCD_LCDDR12      _SFR_MEM8 (0xF8) /* LCD Data Register 12 */
#define LCD_LCDDR13      _SFR_MEM8 (0xF9) /* LCD Data Register 13 */
#define LCD_LCDDR14      _SFR_MEM8 (0xFA) /* LCD Data Register 14 */
#define LCD_LCDDR15      _SFR_MEM8 (0xFB) /* LCD Data Register 15 */
#define LCD_LCDDR16      _SFR_MEM8 (0xFC) /* LCD Data Register 16 */
#define LCD_LCDDR17      _SFR_MEM8 (0xFD) /* LCD Data Register 17 */
#define LCD_LCDDR18      _SFR_MEM8 (0xFE) /* LCD Data Register 18 */
#define LCD_LCDDR19      _SFR_MEM8 (0xFF) /* LCD Data Register 19 */
...
#define EXINT_PCMSK3     _SFR_MEM8 (0x73) /* Pin Change Mask Register 3 */
...
#define CPU_PRR          _SFR_MEM8 (0x64) /* Power Reduction Register */
#define CPU_OSCCAL       _SFR_MEM8 (0x66) /* Oscillator Calibration Value */

/* USI - Universal Serial Interface (0x00) */
#define USI_BASE         _SFR_MEM8 (0x00) /* USI Base Address */
#define USI_USICR        _SFR_MEM8 (0xB8) /* USI Control Register */
#define USI_USISR        _SFR_MEM8 (0xB9) /* USI Status Register */
#define USI_USIDR        _SFR_MEM8 (0xBA) /* USI Data Register */
...
#define ADC_ADCSRA       _SFR_MEM8 (0x7A) /* The ADC Control and Status register */
#define ADC_ADCSRB       _SFR_MEM8 (0x7B) /* ADC Control and Status Register B */
...
#define None_USART_RX_vect_num     (13)                
#define None_USART_RX_vect         _VECTOR(13)         /* USART, Rx Complete */
#define None_USART_UDRE_vect_num   (14)                
#define None_USART_UDRE_vect       _VECTOR(14)         /* USART Data register Empty */
...
#define None_PCINT2_vect_num       (23)                
#define None_PCINT2_vect           _VECTOR(23)         /* Pin Change Interrupt Request 2 */
#define None_PCINT3_vect_num       (24)                
#define None_PCINT3_vect           _VECTOR(24)         /* Pin Change Interrupt Request 3 */
...
#endif /* #ifdef _AVR_ATmega3290P_H_INCLUDED */
