 ...
 *                                                                            * 
 *   .atpack File: ATmega168P.atdf                                            * 
 *   .ATDF File:   atdf/ATmega168P.atdf                                       * 
 *   Version:      2.0.12                                                     * 
 *   Date:         2019-04-26                                                 * 
 *   Device:       ATmega168P                                                 * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATmega168P.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_ATmega168P_H_INCLUDED
#  define _AVR_ATmega168P_H_INCLUDED
...
/* Character Size - together with UCSZ0 in UCSRnC */
typedef enum USART0_UCSZ02_enum
{
    USART0_UCSZ02_CLEAR_gc = (0x00), /* Character Size - together with UCSZ0 in UCSRnC - CLEAR */
    USART0_UCSZ02_SET_gc   = (0x04), /* Character Size - together with UCSZ0 in UCSRnC - SET */
} USART0_UCSZ02_t;
...
/* Character Size - together with UCSZ2 in UCSRnB */
...
/* Character Size - together with UCSZ0 in UCSRnC */
#define USART0_UCSZ02_CLEAR_gc (0x00) /* Character Size - together with UCSZ0 in UCSRnC - CLEAR */
#define USART0_UCSZ02_SET_gc   (0x04) /* Character Size - together with UCSZ0 in UCSRnC - SET */
...
#endif /* #ifdef _AVR_ATmega168P_H_INCLUDED */
