 ...
 *                                                                            * 
 *   .atpack File: ATmega8515.atdf                                            * 
 *   .ATDF File:   atdf/ATmega8515.atdf                                       * 
 *   Version:      2.0.12                                                     * 
 *   Date:         2019-04-26                                                 * 
 *   Device:       ATmega8515                                                 * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATmega8515.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_ATmega8515_H_INCLUDED
#  define _AVR_ATmega8515_H_INCLUDED
...
typedef enum FUSE_S8515C_enum
{
    FUSE_S8515C_CLEAR_gc = (0x00), /* AT90S4414/8515 compatibility mode - CLEAR */
    FUSE_S8515C_SET_gc   = (0x80), /* AT90S4414/8515 compatibility mode - SET */
} FUSE_S8515C_t;
...
{
    FUSE_BOOTSZ_128W_0F80_gc  = (0x03<<1), /* Boot Flashsize=128 words Boot address=$0F80 */
...
{
    USART_UCSZ2_CLEAR_gc = (0x00), /* Character Size Bit 2 - CLEAR */
    USART_UCSZ2_SET_gc   = (0x04), /* Character Size Bit 2 - SET */
} USART_UCSZ2_t;
...
#define USART_UBRRH_UBRR1_gc(x) ((x<<2) & 0x0C)

/* USART Baud Rate Register bits */
#define USART_UBRRH_UBRR_gc(x) (x & 0x03)
...
{
    CPU_SRW11_CLEAR_gc = (0x00), /* Wait State Select Bits for Upper Sector, bit 1 - CLEAR */
    CPU_SRW11_SET_gc   = (0x02), /* Wait State Select Bits for Upper Sector, bit 1 - SET */
} CPU_SRW11_t;
...
{
    CPU_SRE_CLEAR_gc = (0x00), /* External SRAM/XMEM Enable - CLEAR */
    CPU_SRE_SET_gc   = (0x80), /* External SRAM/XMEM Enable - SET */
} CPU_SRE_t;

/* Wait State Select Bits for Upper Sector, bit 0 */
typedef enum CPU_SRW10_enum
{
    CPU_SRW10_CLEAR_gc = (0x00), /* Wait State Select Bits for Upper Sector, bit 0 - CLEAR */
    CPU_SRW10_SET_gc   = (0x40), /* Wait State Select Bits for Upper Sector, bit 0 - SET */
} CPU_SRW10_t;
...
{
    CPU_SM1_CLEAR_gc = (0x00), /* Sleep Mode Select Bit 1 - CLEAR */
    CPU_SM1_SET_gc   = (0x10), /* Sleep Mode Select Bit 1 - SET */
} CPU_SM1_t;
...
{
    CPU_PSR10_CLEAR_gc = (0x00), /* Prescaler Reset Timer / Counter 1 and Timer / Counter 0 - CLEAR */
    CPU_PSR10_SET_gc   = (0x01), /* Prescaler Reset Timer / Counter 1 and Timer / Counter 0 - SET */
} CPU_PSR10_t;
...
/* AT90S4414/8515 compatibility mode */
#define FUSE_S8515C_CLEAR_gc (0x00) /* AT90S4414/8515 compatibility mode - CLEAR */
#define FUSE_S8515C_SET_gc   (0x80) /* AT90S4414/8515 compatibility mode - SET */
...
/* Select Boot Size */
#define FUSE_BOOTSZ_128W_0F80_gc  (0x03<<1) /* Boot Flashsize=128 words Boot address=$0F80 */
...
/* Character Size Bit 2 */
#define USART_UCSZ2_CLEAR_gc (0x00) /* Character Size Bit 2 - CLEAR */
#define USART_UCSZ2_SET_gc   (0x04) /* Character Size Bit 2 - SET */
...
/* Register Select */
/* USART_URSEL_CLEAR_gc ALREADY DEFINED */
/* USART_URSEL_SET_gc ALREADY DEFINED */
...
/* Wait State Select Bits for Upper Sector, bit 1 */
#define CPU_SRW11_CLEAR_gc (0x00) /* Wait State Select Bits for Upper Sector, bit 1 - CLEAR */
#define CPU_SRW11_SET_gc   (0x02) /* Wait State Select Bits for Upper Sector, bit 1 - SET */
...
/* External SRAM/XMEM Enable */
#define CPU_SRE_CLEAR_gc (0x00) /* External SRAM/XMEM Enable - CLEAR */
#define CPU_SRE_SET_gc   (0x80) /* External SRAM/XMEM Enable - SET */


/* Wait State Select Bits for Upper Sector, bit 0 */
#define CPU_SRW10_CLEAR_gc (0x00) /* Wait State Select Bits for Upper Sector, bit 0 - CLEAR */
#define CPU_SRW10_SET_gc   (0x40) /* Wait State Select Bits for Upper Sector, bit 0 - SET */
...
/* Sleep Mode Select Bit 1 */
#define CPU_SM1_CLEAR_gc (0x00) /* Sleep Mode Select Bit 1 - CLEAR */
#define CPU_SM1_SET_gc   (0x10) /* Sleep Mode Select Bit 1 - SET */
...
/* Prescaler Reset Timer / Counter 1 and Timer / Counter 0 */
#define CPU_PSR10_CLEAR_gc (0x00) /* Prescaler Reset Timer / Counter 1 and Timer / Counter 0 - CLEAR */
#define CPU_PSR10_SET_gc   (0x01) /* Prescaler Reset Timer / Counter 1 and Timer / Counter 0 - SET */
...
#define USART_UBRRH     _SFR_MEM8 (0x0040) /* USART Baud Rate Register High Byte */
...
#define PORTEE_PINE     _SFR_MEM8 (0x0025) /* Port E Input Pins */
#define PORTEE_DDRE     _SFR_MEM8 (0x0026) /* Port E Data Direction Register */
#define PORTEE_PORTE    _SFR_MEM8 (0x0027) /* Port E Data Register */
...
#define None_TIMER1_COMPB_vect_num (5)                 
#define None_TIMER1_COMPB_vect     _VECTOR(5)          /* Timer/Counter1 Compare MatchB */
#define None_TIMER1_OVF_vect_num   (6)                 
#define None_TIMER1_OVF_vect       _VECTOR(6)          /* Timer/Counter1 Overflow */
#define None_TIMER0_OVF_vect_num   (7)                 
#define None_TIMER0_OVF_vect       _VECTOR(7)          /* Timer/Counter0 Overflow */
#define None_SPI_STC_vect_num      (8)                 
#define None_SPI_STC_vect          _VECTOR(8)          /* Serial Transfer Complete */
#define None_USART_RX_vect_num     (9)                 
#define None_USART_RX_vect         _VECTOR(9)          /* USART, Rx Complete */
#define None_USART_UDRE_vect_num   (10)                
#define None_USART_UDRE_vect       _VECTOR(10)         /* USART Data Register Empty */
#define None_USART_TX_vect_num     (11)                
#define None_USART_TX_vect         _VECTOR(11)         /* USART, Tx Complete */
#define None_ANA_COMP_vect_num     (12)                
#define None_ANA_COMP_vect         _VECTOR(12)         /* Analog Comparator */
#define None_INT2_vect_num         (13)                
#define None_INT2_vect             _VECTOR(13)         /* External Interrupt Request 2 */
#define None_TIMER0_COMP_vect_num  (14)                
#define None_TIMER0_COMP_vect      _VECTOR(14)         /* Timer 0 Compare Match */
#define None_EE_RDY_vect_num       (15)                
#define None_EE_RDY_vect           _VECTOR(15)         /* EEPROM Ready */
#define None_SPM_RDY_vect_num      (16)                
#define None_SPM_RDY_vect          _VECTOR(16)         /* Store Program Memory Ready */
...
#define XRAM_START          (0x0260)                               
#define XRAM_SIZE           (0xFDA0)                               
...
#define S8515C  (unsigned char)~_BV(7) /* AT90S4414/8515 compatibility mode */
...
#endif /* #ifdef _AVR_ATmega8515_H_INCLUDED */
