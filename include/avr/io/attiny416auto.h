 ...
 *                                                                            * 
 *   .atpack File: ATtiny416auto.atdf                                         * 
 *   .ATDF File:   atdf/ATtiny416auto.atdf                                    * 
 *   Version:      2.0.6                                                      * 
 *   Date:         2019-04-16                                                 * 
 *   Device:       ATtiny416auto                                              * 
 *   Architecture: AVR8X                                                      * 
 *                                                                            * 
 *   Changelog:                                                               * 
 *                                                                            * 
...
#  define _AVR_IOXXX_H_ "ioATtiny416auto.h"
#else
...
/* Calibration freq select */
#define CLKCTRL_OSC20MCALIBA_CALSEL20M_gc(x) ((x<<6) & 0xC0)

/* Calibration */
#define CLKCTRL_OSC20MCALIBA_CAL20M_gc(x) (x & 0x3F)
...
/* synchronous User Ch 4 Input Selection - CCL LUT0 Event 1 */
...
{
    PORT_ISC_INTDISABLE_gc    = (0x00), /* Iterrupt disabled but input buffer enabled */
...
/* Input/Sense Configuration */
#define PORT_ISC_INTDISABLE_gc    (0x00) /* Iterrupt disabled but input buffer enabled */
