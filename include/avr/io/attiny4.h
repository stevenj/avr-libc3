 ...
 *                                                                            * 
 *   .atpack File: ATtiny4.atdf                                               * 
 *   .ATDF File:   atdf/ATtiny4.atdf                                          * 
 *   Version:      2.0.10                                                     * 
 *   Date:         2019-04-25                                                 * 
 *   Device:       ATtiny4                                                    * 
 *   Architecture: AVR8L                                                      * 
...
#  define _AVR_IOXXX_H_ "ioATtiny4.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_ATtiny4_H_INCLUDED
#  define _AVR_ATtiny4_H_INCLUDED
...
#endif /* #ifdef _AVR_ATtiny4_H_INCLUDED */
