 ...
 *                                                                            * 
 *   .atpack File: ATmega644PA.atdf                                           * 
 *   .ATDF File:   atdf/ATmega644PA.atdf                                      * 
 *   Version:      2.0.12                                                     * 
 *   Date:         2019-04-26                                                 * 
 *   Device:       ATmega644PA                                                * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATmega644PA.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_ATmega644PA_H_INCLUDED
#  define _AVR_ATmega644PA_H_INCLUDED
...
{
    FUSE_BOOTSZ_512W_7E00_gc  = (0x03<<1), /* Boot Flash size=512 words Boot start address=$7E00 */
...
/* Select Boot Size */
#define FUSE_BOOTSZ_512W_7E00_gc  (0x03<<1) /* Boot Flash size=512 words Boot start address=$7E00 */
...
#endif /* #ifdef _AVR_ATmega644PA_H_INCLUDED */
