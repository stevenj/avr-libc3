 ...
 *                                                                            * 
 *   .atpack File: ATmega16HVB.atdf                                           * 
 *   .ATDF File:   atdf/ATmega16HVB.atdf                                      * 
 *   Version:      2.0.12                                                     * 
 *   Date:         2019-04-26                                                 * 
 *   Device:       ATmega16HVB                                                * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATmega16HVB.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_ATmega16HVB_H_INCLUDED
#  define _AVR_ATmega16HVB_H_INCLUDED
...
{
    FUSE_CKDIV8_CLEAR_gc = (0x00), /* Clock Divide mode - CLEAR */
    FUSE_CKDIV8_SET_gc   = (0x10), /* Clock Divide mode - SET */
} FUSE_CKDIV8_t;
...
#define COULOMB_COUNTER_CADAC1_CADAC_gc(x) ((x<<2) & 0xFC)

/* ADC accumulate current bits */
#define COULOMB_COUNTER_CADAC1_CADAC0_gc(x) (x & 0x03)
...
/* Clock Divide mode */
#define FUSE_CKDIV8_CLEAR_gc (0x00) /* Clock Divide mode - CLEAR */
#define FUSE_CKDIV8_SET_gc   (0x10) /* Clock Divide mode - SET */
...
#define CKDIV8  (unsigned char)~_BV(4) /* Clock Divide mode */
...
#endif /* #ifdef _AVR_ATmega16HVB_H_INCLUDED */
