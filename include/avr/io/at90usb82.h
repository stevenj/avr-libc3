 ...
 *                                                                            * 
 *   .atpack File: AT90USB82.atdf                                             * 
 *   .ATDF File:   atdf/AT90USB82.atdf                                        * 
 *   Version:      2.0.12                                                     * 
 *   Date:         2019-04-26                                                 * 
 *   Device:       AT90USB82                                                  * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioAT90USB82.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_AT90USB82_H_INCLUDED
#  define _AVR_AT90USB82_H_INCLUDED
...
typedef enum USB_DEVICE_RSTCPU_enum
{
    ...
    USB_DEVICE_RSTCPU_SET_gc   = (0x04), /* -RSTCPU - SET */
} USB_DEVICE_RSTCPU_t;
...
/* Regulator Control Register-REGDIS */
typedef enum USB_DEVICE_REGDIS_enum
{
    USB_DEVICE_REGDIS_CLEAR_gc = (0x00), /* Regulator Control Register-REGDIS - CLEAR */
    USB_DEVICE_REGDIS_SET_gc   = (0x01), /* Regulator Control Register-REGDIS - SET */
} USB_DEVICE_REGDIS_t;
...
typedef struct PS2_struct
{
    register8_t rsv_0x00[250]; /* RESERVED REGISTER BLOCK */
    register8_t PS2CON;        /* PS2 Pad Enable register */
    register8_t UPOE;         
} PS2_t;


/* -UPWE */
#define PS2_UPOE_UPWE_gc(x) ((x<<6) & 0xC0)

/* -UPDRV */
#define PS2_UPOE_UPDRV_gc(x) ((x<<4) & 0x30)

/* -SCKI */
typedef enum PS2_SCKI_enum
{
    PS2_SCKI_CLEAR_gc = (0x00), /* -SCKI - CLEAR */
    PS2_SCKI_SET_gc   = (0x08), /* -SCKI - SET */
} PS2_SCKI_t;

/* -DATAI */
typedef enum PS2_DATAI_enum
{
    PS2_DATAI_CLEAR_gc = (0x00), /* -DATAI - CLEAR */
    PS2_DATAI_SET_gc   = (0x04), /* -DATAI - SET */
} PS2_DATAI_t;

/* -DPI */
typedef enum PS2_DPI_enum
{
    PS2_DPI_CLEAR_gc = (0x00), /* -DPI - CLEAR */
    PS2_DPI_SET_gc   = (0x02), /* -DPI - SET */
} PS2_DPI_t;

/* -DMI */
typedef enum PS2_DMI_enum
{
    PS2_DMI_CLEAR_gc = (0x00), /* -DMI - CLEAR */
    PS2_DMI_SET_gc   = (0x01), /* -DMI - SET */
} PS2_DMI_t;

/* Enable */
typedef enum PS2_PS2EN_enum
{
    PS2_PS2EN_CLEAR_gc = (0x00), /* Enable - CLEAR */
    PS2_PS2EN_SET_gc   = (0x01), /* Enable - SET */
} PS2_PS2EN_t;
...
#define PS2        (*(PS2_t *) 0x0000)        /* PS/2 Controller */
...
#define USB_DEVICE_RSTCPU_SET_gc   (0x04) /* -RSTCPU - SET */
...
/* Regulator Control Register-REGDIS */
#define USB_DEVICE_REGDIS_CLEAR_gc (0x00) /* Regulator Control Register-REGDIS - CLEAR */
#define USB_DEVICE_REGDIS_SET_gc   (0x01) /* Regulator Control Register-REGDIS - SET */
...
/* -SCKI */
#define PS2_SCKI_CLEAR_gc (0x00) /* -SCKI - CLEAR */
#define PS2_SCKI_SET_gc   (0x08) /* -SCKI - SET */


/* -DATAI */
#define PS2_DATAI_CLEAR_gc (0x00) /* -DATAI - CLEAR */
#define PS2_DATAI_SET_gc   (0x04) /* -DATAI - SET */


/* -DPI */
#define PS2_DPI_CLEAR_gc (0x00) /* -DPI - CLEAR */
#define PS2_DPI_SET_gc   (0x02) /* -DPI - SET */


/* -DMI */
#define PS2_DMI_CLEAR_gc (0x00) /* -DMI - CLEAR */
#define PS2_DMI_SET_gc   (0x01) /* -DMI - SET */


/* Enable */
#define PS2_PS2EN_CLEAR_gc (0x00) /* Enable - CLEAR */
#define PS2_PS2EN_SET_gc   (0x01) /* Enable - SET */
...
/* PS2 - PS/2 Controller (0x0000) */
#define PS2_BASE           _SFR_MEM8 (0x0000) /* PS2 Base Address */
#define PS2_PS2CON         _SFR_MEM8 (0x00FA) /* PS2 Pad Enable register */
#define PS2_UPOE           _SFR_MEM8 (0x00FB) 
...
#define BOOT_SECTION_1_START     (0x1E00)                                         
...
#define BOOT_SECTION_2_START     (0x1C00)                                         
...
#define BOOT_SECTION_3_START     (0x1800)                                         
...
#define BOOT_SECTION_4_START     (0x1000)                                         
...
#endif /* #ifdef _AVR_AT90USB82_H_INCLUDED */
