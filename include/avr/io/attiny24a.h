 ...
 *                                                                            * 
 *   .atpack File: ATtiny24A.atdf                                             * 
 *   .ATDF File:   atdf/ATtiny24A.atdf                                        * 
 *   Version:      2.0.10                                                     * 
 *   Date:         2019-04-25                                                 * 
 *   Device:       ATtiny24A                                                  * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATtiny24A.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_ATtiny24A_H_INCLUDED
#  define _AVR_ATtiny24A_H_INCLUDED
...
{
    FUSE_RSTDISBL_CLEAR_gc = (0x00), /* Reset Disabled (Enable PB3 as i/o pin) - CLEAR */
    FUSE_RSTDISBL_SET_gc   = (0x80), /* Reset Disabled (Enable PB3 as i/o pin) - SET */
} FUSE_RSTDISBL_t;
...
{
    FUSE_CKOUT_CLEAR_gc = (0x00), /* Clock output on PORTB2 - CLEAR */
    FUSE_CKOUT_SET_gc   = (0x40), /* Clock output on PORTB2 - SET */
} FUSE_CKOUT_t;
...
typedef enum FUSE_SUT_CKSEL_enum
{
    ...
    FUSE_SUT_CKSEL_INTRCOSC_8MHZ_6CK_14CK_64MS_DEFAULT_gc = (0x22), /* Int. RC Osc. 8 MHz; Start-up time PWRDWN/RESET: 6 CK/14 CK + 64 ms; default value */
...
{
    ADC_REFS_VAL_0x00_gc = (0x00<<6), /* VCC used as analog reference, disconnected from PA0 (AREF) */
    ADC_REFS_VAL_0x01_gc = (0x01<<6), /* External voltage reference at PA0 (AREF) pin, internal reference turned off */
    ADC_REFS_VAL_0x02_gc = (0x02<<6), /* Internal 1.1V voltage reference */
    ADC_REFS_VAL_0x03_gc = (0x03<<6), /* Reserved */
} ADC_REFS_t;

/* Analog Channel and Gain Selection Bits */
#define ADC_ADMUX_MUX_gc(x) (x & 0x3F)
...
typedef struct TC1_struct
{
    ...
    register8_t rsv_0x2D[21]; /* RESERVED REGISTER BLOCK */
...
/* Reset Disabled (Enable PB3 as i/o pin) */
#define FUSE_RSTDISBL_CLEAR_gc (0x00) /* Reset Disabled (Enable PB3 as i/o pin) - CLEAR */
#define FUSE_RSTDISBL_SET_gc   (0x80) /* Reset Disabled (Enable PB3 as i/o pin) - SET */
...
/* Clock output on PORTB2 */
#define FUSE_CKOUT_CLEAR_gc (0x00) /* Clock output on PORTB2 - CLEAR */
#define FUSE_CKOUT_SET_gc   (0x40) /* Clock output on PORTB2 - SET */
...
#define FUSE_SUT_CKSEL_INTRCOSC_8MHZ_6CK_14CK_64MS_DEFAULT_gc (0x22) /* Int. RC Osc. 8 MHz; Start-up time PWRDWN/RESET: 6 CK/14 CK + 64 ms; default value */
...
/* Reference Selection Bits */
#define ADC_REFS_VAL_0x00_gc (0x00<<6) /* VCC used as analog reference, disconnected from PA0 (AREF) */
#define ADC_REFS_VAL_0x01_gc (0x01<<6) /* External voltage reference at PA0 (AREF) pin, internal reference turned off */
#define ADC_REFS_VAL_0x02_gc (0x02<<6) /* Internal 1.1V voltage reference */
#define ADC_REFS_VAL_0x03_gc (0x03<<6) /* Reserved */
...
#define TC16_TIFR1       _SFR_MEM8 (0x002B) /* Timer/Counter Interrupt Flag register */
#define TC16_TIMSK1      _SFR_MEM8 (0x002C) /* Timer/Counter1 Interrupt Mask Register */
...
#define None_EXT_INT0_vect_num   (1)                 
#define None_EXT_INT0_vect       _VECTOR(1)          /* External Interrupt Request 0 */
...
#define None_TIM1_CAPT_vect      _VECTOR(5)          /* Timer/Counter1 Capture Event */
...
#define None_USI_STR_vect_num    (15)                
#define None_USI_STR_vect        _VECTOR(15)         /* USI START */
#define None_USI_OVF_vect_num    (16)                
#define None_USI_OVF_vect        _VECTOR(16)         /* USI Overflow */
...
#define CKOUT      (unsigned char)~_BV(6) /* Clock output on PORTB2 */
...
#define RSTDISBL  (unsigned char)~_BV(7) /* Reset Disabled (Enable PB3 as i/o pin) */
...
#endif /* #ifdef _AVR_ATtiny24A_H_INCLUDED */
