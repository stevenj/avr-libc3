 ...
 *                                                                            * 
 *   .atpack File: ATtiny12.atdf                                              * 
 *   .ATDF File:   atdf/ATtiny12.atdf                                         * 
 *   Version:      2.0.10                                                     * 
 *   Date:         2019-04-25                                                 * 
 *   Device:       ATtiny12                                                   * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATtiny12.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_ATtiny12_H_INCLUDED
#  define _AVR_ATtiny12_H_INCLUDED
...
{
    FUSE_BODLEVEL_1V8_gc = (0x01<<7), /* Brown-out detection at VCC=1.8 V */
    FUSE_BODLEVEL_2V7_gc = (0x00<<7), /* Brown-out detection at VCC=2.7 V */
} FUSE_BODLEVEL_t;
...
{
    FUSE_CKSEL_EXTXTALCRES_gc = (0x0F), /* External Crystal / Ceramic Resonator */
    FUSE_CKSEL_EXTXTALCRES_gc = (0x0E), /* External Crystal / Ceramic Resonator */
    FUSE_CKSEL_EXTXTALCRES_gc = (0x0D), /* External Crystal / Ceramic Resonator */
    FUSE_CKSEL_EXTXTALCRES_gc = (0x0C), /* External Crystal / Ceramic Resonator */
    FUSE_CKSEL_EXTXTALCRES_gc = (0x0B), /* External Crystal / Ceramic Resonator */
    FUSE_CKSEL_EXTXTALCRES_gc = (0x0A), /* External Crystal / Ceramic Resonator */
    FUSE_CKSEL_EXTLOFXTAL_gc  = (0x09), /* External Low-Frequency Crystal */
    FUSE_CKSEL_EXTLOFXTAL_gc  = (0x08), /* External Low-Frequency Crystal */
    FUSE_CKSEL_EXTRCOSC_gc    = (0x07), /* External RC Ocsillator */
    FUSE_CKSEL_EXTRCOSC_gc    = (0x06), /* External RC Ocsillator */
    FUSE_CKSEL_EXTRCOSC_gc    = (0x05), /* External RC Ocsillator */
    FUSE_CKSEL_INTRCOSC_gc    = (0x04), /* Internal RC Ocsillator */
    FUSE_CKSEL_INTRCOSC_gc    = (0x03), /* Internal RC Ocsillator */
    FUSE_CKSEL_INTRCOSC_gc    = (0x02), /* Internal RC Ocsillator */
    FUSE_CKSEL_EXTCLK_gc      = (0x01), /* External Clock */
...
typedef enum AC_AINBG_enum
{
    AC_AINBG_CLEAR_gc = (0x00), /* Analog Comparator Bandgap Select - CLEAR */
    AC_AINBG_SET_gc   = (0x40), /* Analog Comparator Bandgap Select - SET */
} AC_AINBG_t;
...
/* Brown-out Detection Level */
#define FUSE_BODLEVEL_1V8_gc (0x01<<7) /* Brown-out detection at VCC=1.8 V */
#define FUSE_BODLEVEL_2V7_gc (0x00<<7) /* Brown-out detection at VCC=2.7 V */
...
/* Clock Select */
#define FUSE_CKSEL_EXTXTALCRES_gc (0x0F) /* External Crystal / Ceramic Resonator */
/* WARNING: FUSE_CKSEL_EXTXTALCRES_gc ALREADY DEFINED as '(0x0F)' NOT '(0x0E)' */
/* WARNING: FUSE_CKSEL_EXTXTALCRES_gc ALREADY DEFINED as '(0x0F)' NOT '(0x0D)' */
/* WARNING: FUSE_CKSEL_EXTXTALCRES_gc ALREADY DEFINED as '(0x0F)' NOT '(0x0C)' */
/* WARNING: FUSE_CKSEL_EXTXTALCRES_gc ALREADY DEFINED as '(0x0F)' NOT '(0x0B)' */
/* WARNING: FUSE_CKSEL_EXTXTALCRES_gc ALREADY DEFINED as '(0x0F)' NOT '(0x0A)' */
#define FUSE_CKSEL_EXTLOFXTAL_gc  (0x09) /* External Low-Frequency Crystal */
/* WARNING: FUSE_CKSEL_EXTLOFXTAL_gc ALREADY DEFINED as '(0x09)' NOT '(0x08)' */
#define FUSE_CKSEL_EXTRCOSC_gc    (0x07) /* External RC Ocsillator */
/* WARNING: FUSE_CKSEL_EXTRCOSC_gc ALREADY DEFINED as '(0x07)' NOT '(0x06)' */
/* WARNING: FUSE_CKSEL_EXTRCOSC_gc ALREADY DEFINED as '(0x07)' NOT '(0x05)' */
#define FUSE_CKSEL_INTRCOSC_gc    (0x04) /* Internal RC Ocsillator */
/* WARNING: FUSE_CKSEL_INTRCOSC_gc ALREADY DEFINED as '(0x04)' NOT '(0x03)' */
/* WARNING: FUSE_CKSEL_INTRCOSC_gc ALREADY DEFINED as '(0x04)' NOT '(0x02)' */
#define FUSE_CKSEL_EXTCLK_gc      (0x01) /* External Clock */
/* WARNING: FUSE_CKSEL_EXTCLK_gc ALREADY DEFINED as '(0x01)' NOT '(0x00)' */
...
/* Analog Comparator Bandgap Select */
#define AC_AINBG_CLEAR_gc (0x00) /* Analog Comparator Bandgap Select - CLEAR */
#define AC_AINBG_SET_gc   (0x40) /* Analog Comparator Bandgap Select - SET */
...
#define _VECTORS_SIZE            (6 * _VECTOR_SIZE) /* Size of all vectors */
/*
================================================================================
Constants
================================================================================
...
#define CKSEL3   (unsigned char)~_BV(3) /* Clock Select bit 3 */
...
#endif /* #ifdef _AVR_ATtiny12_H_INCLUDED */
