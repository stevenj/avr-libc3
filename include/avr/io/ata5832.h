 ...
 *                                                                            * 
 *   .atpack File: ATA5832.atdf                                               * 
 *   .ATDF File:   atdf/ATA5832.atdf                                          * 
 *   Version:      2.0.6                                                      * 
 *   Date:         2019-04-16                                                 * 
 *   Device:       ATA5832                                                    * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATA5832.h"
#else
...
typedef struct FE_struct
{
    ...
    register8_t FEPAC;         /* Front-End Power Amplifier Control Register Pout/dBm LowBand HighBand */
...
typedef enum FE_SDTX_enum
{
    FE_SDTX_CLEAR_gc = (0x00), /* Single Pole Double Throw (SPDT) Switch TX - CLEAR */
    FE_SDTX_SET_gc   = (0x02), /* Single Pole Double Throw (SPDT) Switch TX - SET */
} FE_SDTX_t;
...
typedef enum FREQS_ANTT_enum
{
    FREQS_ANTT_CLEAR_gc = (0x00), /* Antenna Tuning Active - CLEAR */
    FREQS_ANTT_SET_gc   = (0x20), /* Antenna Tuning Active - SET */
} FREQS_ANTT_t;
...
#define FREQS_FSFCR_BTSEL_gc(x) (x & 0x03)
...
typedef struct TXM_struct
{
    ...
    _REGISTER16 (TMTL);        /* Tx Modulator Telegram Length Register */
...
typedef enum TXM_TMMSB_enum
{
    TXM_TMMSB_CLEAR_gc = (0x00), /* Tx Modulator Most Significant Bit First - CLEAR */
    TXM_TMMSB_SET_gc   = (0x40), /* Tx Modulator Most Significant Bit First - SET */
} TXM_TMMSB_t;
...
/* Single Pole Double Throw (SPDT) Switch TX */
#define FE_SDTX_CLEAR_gc (0x00) /* Single Pole Double Throw (SPDT) Switch TX - CLEAR */
#define FE_SDTX_SET_gc   (0x02) /* Single Pole Double Throw (SPDT) Switch TX - SET */
...
/* Antenna Tuning Active */
#define FREQS_ANTT_CLEAR_gc (0x00) /* Antenna Tuning Active - CLEAR */
#define FREQS_ANTT_SET_gc   (0x20) /* Antenna Tuning Active - SET */
...
/* Tx Modulator Most Significant Bit First */
#define TXM_TMMSB_CLEAR_gc (0x00) /* Tx Modulator Most Significant Bit First - CLEAR */
#define TXM_TMMSB_SET_gc   (0x40) /* Tx Modulator Most Significant Bit First - SET */
...
#define FE_FEPAC         _SFR_MEM8 (0x105) /* Front-End Power Amplifier Control Register Pout/dBm LowBand HighBand */
...
#define SUP_SUPCA1       _SFR_MEM8 (0xCC)  /* Supply calibration register 1 */
...
#define TXM_TMCR         _SFR_MEM16(0x121) /* Tx Modulator CRC Result */
#define TXM_TMCRL        _SFR_MEM8 (0x121) /* Tx Modulator CRC Result LOW BYTE */
#define TXM_TMCRH        _SFR_MEM8 (0x122) /* Tx Modulator CRC Result HIGH BYTE */
...
#define TXM_TMTL         _SFR_MEM16(0x129) /* Tx Modulator Telegram Length Register */
#define TXM_TMTLL        _SFR_MEM8 (0x129) /* Tx Modulator Telegram Length Register LOW BYTE */
#define TXM_TMTLH        _SFR_MEM8 (0x12A) /* Tx Modulator Telegram Length Register HIGH BYTE */
...
#define USER_ROM_START           (0x8000)                                         
#define USER_ROM_SIZE            (0x5000)                                         
#define USER_ROM_PAGE_SIZE       (0x0040)                                         
#define USER_ROM_END             (USER_ROM_START + USER_ROM_SIZE - 1)             
