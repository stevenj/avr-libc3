 ...
 *                                                                            * 
 *   .atpack File: ATmega128RFA1.atdf                                         * 
 *   .ATDF File:   atdf/ATmega128RFA1.atdf                                    * 
 *   Version:      2.0.12                                                     * 
 *   Date:         2019-04-26                                                 * 
...
#  define _AVR_IOXXX_H_ "ioATmega128RFA1.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_ATmega128RFA1_H_INCLUDED
#  define _AVR_ATmega128RFA1_H_INCLUDED
...
typedef enum FUSE_CKSEL_SUT_enum
{
    ...
    FUSE_CKSEL_SUT_TRXOSC_258CK_4MS1_gc        = (0x06), /* Tranceiver Oscillator; Start-up time: 258 CK + 4.1 ms */
    FUSE_CKSEL_SUT_TRXOSC_258CK_65MS_gc        = (0x16), /* Tranceiver Oscillator; Start-up time: 258 CK + 65 ms */
    FUSE_CKSEL_SUT_TRXOSC_1KCK_0MS_gc          = (0x26), /* Tranceiver Oscillator; Start-up time: 1K CK + 0 ms */
    FUSE_CKSEL_SUT_TRXOSC_1KCK_4MS1_gc         = (0x36), /* Tranceiver Oscillator; Start-up time: 1K CK + 4.1 ms */
    FUSE_CKSEL_SUT_TRXOSC_1KCK_65MS_gc         = (0x07), /* Tranceiver Oscillator; Start-up time: 1K CK + 65 ms */
    FUSE_CKSEL_SUT_TRXOSC_16KCK_0MS_gc         = (0x17), /* Tranceiver Oscillator; Start-up time: 16K CK + 0 ms */
    FUSE_CKSEL_SUT_TRXOSC_16KCK_4MS1_gc        = (0x27), /* Tranceiver Oscillator; Start-up time: 16K CK + 4.1 ms */
    FUSE_CKSEL_SUT_TRXOSC_16KCK_65MS_gc        = (0x37), /* Tranceiver Oscillator; Start-up time: 16K CK + 65 ms */
} FUSE_CKSEL_SUT_t;
...
{
    register8_t rsv_0x00[316];  /* RESERVED REGISTER BLOCK */
    ...
    register8_t rsv_0x153[2];   /* RESERVED REGISTER BLOCK */
    register8_t RX_SYN;         /* Transceiver Receiver Sensitivity Control Register */
    register8_t rsv_0x156;      /* RESERVED REGISTER */
...
/* Reserved */
#define TRX24_TRX_CTRL_1_Res_gc(x) (x & 0x1F)

/* Power Amplifier Buffer Lead Time */
typedef enum TRX24_PA_BUF_LT_enum
{
    TRX24_PA_BUF_LT_PA_BUF_LT_0US_gc = (0x00<<6), /* 0 us */
    TRX24_PA_BUF_LT_PA_BUF_LT_2US_gc = (0x01<<6), /* 2 us */
    TRX24_PA_BUF_LT_PA_BUF_LT_4US_gc = (0x02<<6), /* 4 us */
    TRX24_PA_BUF_LT_PA_BUF_LT_6US_gc = (0x03<<6), /* 6 us */
} TRX24_PA_BUF_LT_t;

/* Power Amplifier Lead Time */
typedef enum TRX24_PA_LT_enum
{
    TRX24_PA_LT_PA_LT_2US_gc = (0x00<<4), /* 2 us */
    TRX24_PA_LT_PA_LT_4US_gc = (0x01<<4), /* 4 us */
    TRX24_PA_LT_PA_LT_6US_gc = (0x02<<4), /* 6 us */
    TRX24_PA_LT_PA_LT_8US_gc = (0x03<<4), /* 8 us */
} TRX24_PA_LT_t;

/* Transmit Power Setting */
typedef enum TRX24_TX_PWR_enum
{
    TRX24_TX_PWR_VAL_0_gc  = (0x00), /* 3.0 dBm */
    TRX24_TX_PWR_VAL_1_gc  = (0x01), /* 2.8 dBm */
    TRX24_TX_PWR_VAL_2_gc  = (0x02), /* 2.3 dBm */
    TRX24_TX_PWR_VAL_3_gc  = (0x03), /* 1.8 dBm */
    TRX24_TX_PWR_VAL_4_gc  = (0x04), /* 1.3 dBm */
    TRX24_TX_PWR_VAL_5_gc  = (0x05), /* 0.7 dBm */
    TRX24_TX_PWR_VAL_6_gc  = (0x06), /* 0.0 dBm */
    TRX24_TX_PWR_VAL_7_gc  = (0x07), /*  -1 dBm */
    TRX24_TX_PWR_VAL_8_gc  = (0x08), /*  -2 dBm */
    TRX24_TX_PWR_VAL_9_gc  = (0x09), /*  -3 dBm */
    TRX24_TX_PWR_VAL_10_gc = (0x0A), /*  -4 dBm */
    TRX24_TX_PWR_VAL_11_gc = (0x0B), /*  -5 dBm */
    TRX24_TX_PWR_VAL_12_gc = (0x0C), /*  -7 dBm */
    TRX24_TX_PWR_VAL_13_gc = (0x0D), /*  -9 dBm */
    TRX24_TX_PWR_VAL_14_gc = (0x0E), /* -12 dBm */
    TRX24_TX_PWR_VAL_15_gc = (0x0F), /* -17 dBm */
} TRX24_TX_PWR_t;
...
{
    TRX24_BATMON_VTH_VAL_0x0_gc = (0x00), /* 2.550V (BATMON_HR=1) 1.70V (BATMON_HR=0) */
    TRX24_BATMON_VTH_VAL_0x1_gc = (0x01), /* 2.625V (BATMON_HR=1) 1.75V (BATMON_HR=0) */
    TRX24_BATMON_VTH_VAL_0x2_gc = (0x02), /* 2.700V (BATMON_HR=1) 1.80V (BATMON_HR=0) */
    TRX24_BATMON_VTH_VAL_0x3_gc = (0x03), /* 2.775V (BATMON_HR=1) 1.85V (BATMON_HR=0) */
    TRX24_BATMON_VTH_VAL_0x4_gc = (0x04), /* 2.850V (BATMON_HR=1) 1.90V (BATMON_HR=0) */
    TRX24_BATMON_VTH_VAL_0x5_gc = (0x05), /* 2.925V (BATMON_HR=1) 1.95V (BATMON_HR=0) */
    TRX24_BATMON_VTH_VAL_0x6_gc = (0x06), /* 3.000V (BATMON_HR=1) 2.00V (BATMON_HR=0) */
    TRX24_BATMON_VTH_VAL_0x7_gc = (0x07), /* 3.075V (BATMON_HR=1) 2.05V (BATMON_HR=0) */
    TRX24_BATMON_VTH_VAL_0x8_gc = (0x08), /* 3.150V (BATMON_HR=1) 2.10V (BATMON_HR=0) */
    TRX24_BATMON_VTH_VAL_0x9_gc = (0x09), /* 3.225V (BATMON_HR=1) 2.15V (BATMON_HR=0) */
    TRX24_BATMON_VTH_VAL_0xA_gc = (0x0A), /* 3.300V (BATMON_HR=1) 2.20V (BATMON_HR=0) */
    TRX24_BATMON_VTH_VAL_0xB_gc = (0x0B), /* 3.375V (BATMON_HR=1) 2.25V (BATMON_HR=0) */
    TRX24_BATMON_VTH_VAL_0xC_gc = (0x0C), /* 3.450V (BATMON_HR=1) 2.30V (BATMON_HR=0) */
    TRX24_BATMON_VTH_VAL_0xD_gc = (0x0D), /* 3.525V (BATMON_HR=1) 2.35V (BATMON_HR=0) */
    TRX24_BATMON_VTH_VAL_0xE_gc = (0x0E), /* 3.600V (BATMON_HR=1) 2.40V (BATMON_HR=0) */
    TRX24_BATMON_VTH_VAL_0xF_gc = (0x0F), /* 3.675V (BATMON_HR=1) 2.45V (BATMON_HR=0) */
} TRX24_BATMON_VTH_t;
...
/* Reserved */
#define TRX24_RX_SYN_Res_gc(x) ((x<<4) & 0x70)
...
{
    TRX24_VERSION_NUM_REV_A_gc = (0x02), /* Revision A */
    TRX24_VERSION_NUM_REV_B_gc = (0x03), /* Revision B */
} TRX24_VERSION_NUM_t;
...
{
    register8_t rsv_0x00[220]; /* RESERVED REGISTER BLOCK */
...
/* Reserved Bit */
#define SYMCNT_SCCR1_Res_gc(x) ((x<<1) & 0xFE)
...
/* Reserved */
#define CPU_RAMPZ_Res_gc(x) ((x<<2) & 0xFC)
...
typedef struct PWRCTRL_struct
{
    ...
    register8_t DRTRAM3;       /* Data Retention Configuration Register of SRAM 3 */
    register8_t DRTRAM2;       /* Data Retention Configuration Register of SRAM 2 */
    register8_t DRTRAM1;       /* Data Retention Configuration Register of SRAM 1 */
    register8_t DRTRAM0;       /* Data Retention Configuration Register of SRAM 0 */
...
#define FUSE_CKSEL_SUT_TRXOSC_258CK_4MS1_gc        (0x06) /* Tranceiver Oscillator; Start-up time: 258 CK + 4.1 ms */
#define FUSE_CKSEL_SUT_TRXOSC_258CK_65MS_gc        (0x16) /* Tranceiver Oscillator; Start-up time: 258 CK + 65 ms */
#define FUSE_CKSEL_SUT_TRXOSC_1KCK_0MS_gc          (0x26) /* Tranceiver Oscillator; Start-up time: 1K CK + 0 ms */
#define FUSE_CKSEL_SUT_TRXOSC_1KCK_4MS1_gc         (0x36) /* Tranceiver Oscillator; Start-up time: 1K CK + 4.1 ms */
#define FUSE_CKSEL_SUT_TRXOSC_1KCK_65MS_gc         (0x07) /* Tranceiver Oscillator; Start-up time: 1K CK + 65 ms */
#define FUSE_CKSEL_SUT_TRXOSC_16KCK_0MS_gc         (0x17) /* Tranceiver Oscillator; Start-up time: 16K CK + 0 ms */
#define FUSE_CKSEL_SUT_TRXOSC_16KCK_4MS1_gc        (0x27) /* Tranceiver Oscillator; Start-up time: 16K CK + 4.1 ms */
#define FUSE_CKSEL_SUT_TRXOSC_16KCK_65MS_gc        (0x37) /* Tranceiver Oscillator; Start-up time: 16K CK + 65 ms */
...
/* Power Amplifier Buffer Lead Time */
#define TRX24_PA_BUF_LT_PA_BUF_LT_0US_gc (0x00<<6) /* 0 us */
#define TRX24_PA_BUF_LT_PA_BUF_LT_2US_gc (0x01<<6) /* 2 us */
#define TRX24_PA_BUF_LT_PA_BUF_LT_4US_gc (0x02<<6) /* 4 us */
#define TRX24_PA_BUF_LT_PA_BUF_LT_6US_gc (0x03<<6) /* 6 us */


/* Power Amplifier Lead Time */
#define TRX24_PA_LT_PA_LT_2US_gc (0x00<<4) /* 2 us */
#define TRX24_PA_LT_PA_LT_4US_gc (0x01<<4) /* 4 us */
#define TRX24_PA_LT_PA_LT_6US_gc (0x02<<4) /* 6 us */
#define TRX24_PA_LT_PA_LT_8US_gc (0x03<<4) /* 8 us */


/* Transmit Power Setting */
#define TRX24_TX_PWR_VAL_0_gc  (0x00) /* 3.0 dBm */
#define TRX24_TX_PWR_VAL_1_gc  (0x01) /* 2.8 dBm */
#define TRX24_TX_PWR_VAL_2_gc  (0x02) /* 2.3 dBm */
#define TRX24_TX_PWR_VAL_3_gc  (0x03) /* 1.8 dBm */
#define TRX24_TX_PWR_VAL_4_gc  (0x04) /* 1.3 dBm */
#define TRX24_TX_PWR_VAL_5_gc  (0x05) /* 0.7 dBm */
#define TRX24_TX_PWR_VAL_6_gc  (0x06) /* 0.0 dBm */
#define TRX24_TX_PWR_VAL_7_gc  (0x07) /*  -1 dBm */
#define TRX24_TX_PWR_VAL_8_gc  (0x08) /*  -2 dBm */
#define TRX24_TX_PWR_VAL_9_gc  (0x09) /*  -3 dBm */
#define TRX24_TX_PWR_VAL_10_gc (0x0A) /*  -4 dBm */
#define TRX24_TX_PWR_VAL_11_gc (0x0B) /*  -5 dBm */
#define TRX24_TX_PWR_VAL_12_gc (0x0C) /*  -7 dBm */
#define TRX24_TX_PWR_VAL_13_gc (0x0D) /*  -9 dBm */
#define TRX24_TX_PWR_VAL_14_gc (0x0E) /* -12 dBm */
#define TRX24_TX_PWR_VAL_15_gc (0x0F) /* -17 dBm */
...
/* Battery Monitor Threshold Voltage */
#define TRX24_BATMON_VTH_VAL_0x0_gc (0x00) /* 2.550V (BATMON_HR=1) 1.70V (BATMON_HR=0) */
#define TRX24_BATMON_VTH_VAL_0x1_gc (0x01) /* 2.625V (BATMON_HR=1) 1.75V (BATMON_HR=0) */
#define TRX24_BATMON_VTH_VAL_0x2_gc (0x02) /* 2.700V (BATMON_HR=1) 1.80V (BATMON_HR=0) */
#define TRX24_BATMON_VTH_VAL_0x3_gc (0x03) /* 2.775V (BATMON_HR=1) 1.85V (BATMON_HR=0) */
#define TRX24_BATMON_VTH_VAL_0x4_gc (0x04) /* 2.850V (BATMON_HR=1) 1.90V (BATMON_HR=0) */
#define TRX24_BATMON_VTH_VAL_0x5_gc (0x05) /* 2.925V (BATMON_HR=1) 1.95V (BATMON_HR=0) */
#define TRX24_BATMON_VTH_VAL_0x6_gc (0x06) /* 3.000V (BATMON_HR=1) 2.00V (BATMON_HR=0) */
#define TRX24_BATMON_VTH_VAL_0x7_gc (0x07) /* 3.075V (BATMON_HR=1) 2.05V (BATMON_HR=0) */
#define TRX24_BATMON_VTH_VAL_0x8_gc (0x08) /* 3.150V (BATMON_HR=1) 2.10V (BATMON_HR=0) */
#define TRX24_BATMON_VTH_VAL_0x9_gc (0x09) /* 3.225V (BATMON_HR=1) 2.15V (BATMON_HR=0) */
#define TRX24_BATMON_VTH_VAL_0xA_gc (0x0A) /* 3.300V (BATMON_HR=1) 2.20V (BATMON_HR=0) */
#define TRX24_BATMON_VTH_VAL_0xB_gc (0x0B) /* 3.375V (BATMON_HR=1) 2.25V (BATMON_HR=0) */
#define TRX24_BATMON_VTH_VAL_0xC_gc (0x0C) /* 3.450V (BATMON_HR=1) 2.30V (BATMON_HR=0) */
#define TRX24_BATMON_VTH_VAL_0xD_gc (0x0D) /* 3.525V (BATMON_HR=1) 2.35V (BATMON_HR=0) */
#define TRX24_BATMON_VTH_VAL_0xE_gc (0x0E) /* 3.600V (BATMON_HR=1) 2.40V (BATMON_HR=0) */
#define TRX24_BATMON_VTH_VAL_0xF_gc (0x0F) /* 3.675V (BATMON_HR=1) 2.45V (BATMON_HR=0) */
...
/* Version Number */
#define TRX24_VERSION_NUM_REV_A_gc (0x02) /* Revision A */
#define TRX24_VERSION_NUM_REV_B_gc (0x03) /* Revision B */
...
#define PWRCTRL_DRTRAM3     _SFR_MEM8 (0x132) /* Data Retention Configuration Register of SRAM 3 */
#define PWRCTRL_DRTRAM2     _SFR_MEM8 (0x133) /* Data Retention Configuration Register of SRAM 2 */
#define PWRCTRL_DRTRAM1     _SFR_MEM8 (0x134) /* Data Retention Configuration Register of SRAM 1 */
#define PWRCTRL_DRTRAM0     _SFR_MEM8 (0x135) /* Data Retention Configuration Register of SRAM 0 */
...
#define _VECTORS_SIZE                   (72 * _VECTOR_SIZE) /* Size of all vectors */
/*
================================================================================
Constants
================================================================================
...
#endif /* #ifdef _AVR_ATmega128RFA1_H_INCLUDED */
