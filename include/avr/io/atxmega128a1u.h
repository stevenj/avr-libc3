 ...
 *                                                                            * 
 *   .atpack File: ATxmega128A1U.atdf                                         * 
 *   .ATDF File:   atdf/ATxmega128A1U.atdf                                    * 
 *   Version:      2.0.11                                                     * 
 *   Date:         2019-07-11                                                 * 
...
#  define _AVR_IOXXX_H_ "ioATxmega128A1U.h"
#else
...
/* EBI Chip Select Output */
typedef enum PORTCFG_EBICSOUT_enum
{
    PORTCFG_EBICSOUT_PH_gc = (0x00), /* EBI chip select output to PORTH pin 4 to 7 */
    PORTCFG_EBICSOUT_PL_gc = (0x01), /* EBI chip select output to PORTL pin 4 to 7 */
    PORTCFG_EBICSOUT_PF_gc = (0x02), /* EBI chip select output to PORTF pin 4 to 7 */
    PORTCFG_EBICSOUT_PE_gc = (0x03), /* EBI chip select output to PORTE pin 4 to 7 */
} PORTCFG_EBICSOUT_t;
...
/* EBI Chip Select Output */
#define PORTCFG_EBICSOUT_PH_gc (0x00) /* EBI chip select output to PORTH pin 4 to 7 */
#define PORTCFG_EBICSOUT_PL_gc (0x01) /* EBI chip select output to PORTL pin 4 to 7 */
#define PORTCFG_EBICSOUT_PF_gc (0x02) /* EBI chip select output to PORTF pin 4 to 7 */
#define PORTCFG_EBICSOUT_PE_gc (0x03) /* EBI chip select output to PORTE pin 4 to 7 */


/* EBI Address Output */
#define PORTCFG_EBIADROUT_PF_gc  (0x00<<2) /* EBI port 3 address output on PORTF pins 0 to 7 */
#define PORTCFG_EBIADROUT_PE_gc  (0x01<<2) /* EBI port 3 address output on PORTE pins 0 to 7 */
#define PORTCFG_EBIADROUT_PFH_gc (0x02<<2) /* EBI port 3 address output on PORTF pins 4 to 7 */
#define PORTCFG_EBIADROUT_PEH_gc (0x03<<2) /* EBI port 3 address output on PORTE pins 4 to 7 */
...
#define PORTCFG_EBIOUT      _SFR_MEM8 (0x00B5) /* EBI Output register */
...
#define PORTH_REMAP         _SFR_MEM8 (0x06EE) /* I/O Port Pin Remap Register */
...
#define PORTJ_REMAP         _SFR_MEM8 (0x070E) /* I/O Port Pin Remap Register */
...
#define PORTK_REMAP         _SFR_MEM8 (0x072E) /* I/O Port Pin Remap Register */
...
#define PORTQ_REMAP         _SFR_MEM8 (0x07CE) /* I/O Port Pin Remap Register */
