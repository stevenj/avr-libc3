 ...
 *                                                                            * 
 *   .atpack File: ATtiny3216.atdf                                            * 
 *   .ATDF File:   atdf/ATtiny3216.atdf                                       * 
 *   Version:      2.0.10                                                     * 
 *   Date:         2019-04-25                                                 * 
 *   Device:       ATtiny3216                                                 * 
 *   Architecture: AVR8X                                                      * 
...
#  define _AVR_IOXXX_H_ "ioATtiny3216.h"
#else
...
typedef enum ADC_MUXPOS_enum
{
    ...
    ADC_MUXPOS_PTC_gc       = (0x1B), /* PTC/DAC2 */
    ADC_MUXPOS_DAC0_gc      = (0x1C), /* DAC0/DAC0 */
    ADC_MUXPOS_INTREF_gc    = (0x1D), /* Internal Ref */
    ADC_MUXPOS_TEMPSENSE_gc = (0x1E), /* Temp sensor/DAC1 */
...
typedef enum EVSYS_ASYNCCH0_enum
{
    ...
    EVSYS_ASYNCCH0_AC1_OUT_gc      = (0x13), /* Analog Comparator 1 out */
    EVSYS_ASYNCCH0_AC2_OUT_gc      = (0x14), /* Analog Comparator 2 out */
} EVSYS_ASYNCCH0_t;
...
typedef enum EVSYS_ASYNCCH1_enum
{
    ...
    EVSYS_ASYNCCH1_AC1_OUT_gc      = (0x12), /* Analog Comparator 1 out */
    EVSYS_ASYNCCH1_AC2_OUT_gc      = (0x13), /* Analog Comparator 2 out */
} EVSYS_ASYNCCH1_t;
...
typedef enum EVSYS_ASYNCCH2_enum
{
    ...
    EVSYS_ASYNCCH2_AC1_OUT_gc      = (0x10), /* Analog Comparator 1 out */
    EVSYS_ASYNCCH2_AC2_OUT_gc      = (0x11), /* Analog Comparator 2 out */
} EVSYS_ASYNCCH2_t;
...
typedef enum EVSYS_ASYNCCH3_enum
{
    ...
    EVSYS_ASYNCCH3_AC1_OUT_gc      = (0x12), /* Analog Comparator 1 out */
    EVSYS_ASYNCCH3_AC2_OUT_gc      = (0x13), /* Analog Comparator 2 out */
} EVSYS_ASYNCCH3_t;
...
{
    EVSYS_ASYNCUSER11_OFF_gc      = (0x00), /* Off */
    EVSYS_ASYNCUSER11_SYNCCH0_gc  = (0x01), /* Synchronous Event Channel 0 */
    EVSYS_ASYNCUSER11_SYNCCH1_gc  = (0x02), /* Synchronous Event Channel 1 */
    EVSYS_ASYNCUSER11_ASYNCCH0_gc = (0x03), /* Asynchronous Event Channel 0 */
    EVSYS_ASYNCUSER11_ASYNCCH1_gc = (0x04), /* Asynchronous Event Channel 1 */
    EVSYS_ASYNCUSER11_ASYNCCH2_gc = (0x05), /* Asynchronous Event Channel 2 */
    EVSYS_ASYNCUSER11_ASYNCCH3_gc = (0x06), /* Asynchronous Event Channel 3 */
} EVSYS_ASYNCUSER11_t;

/* Asynchronous User Ch 12 Input Selection - ADC0 */
typedef enum EVSYS_ASYNCUSER12_enum
{
    EVSYS_ASYNCUSER12_OFF_gc      = (0x00), /* Off */
    EVSYS_ASYNCUSER12_SYNCCH0_gc  = (0x01), /* Synchronous Event Channel 0 */
    EVSYS_ASYNCUSER12_SYNCCH1_gc  = (0x02), /* Synchronous Event Channel 1 */
    EVSYS_ASYNCUSER12_ASYNCCH0_gc = (0x03), /* Asynchronous Event Channel 0 */
    EVSYS_ASYNCUSER12_ASYNCCH1_gc = (0x04), /* Asynchronous Event Channel 1 */
    EVSYS_ASYNCUSER12_ASYNCCH2_gc = (0x05), /* Asynchronous Event Channel 2 */
    EVSYS_ASYNCUSER12_ASYNCCH3_gc = (0x06), /* Asynchronous Event Channel 3 */
} EVSYS_ASYNCUSER12_t;
...
typedef enum EVSYS_SYNCCH0_enum
{
    ...
    EVSYS_SYNCCH0_TCB1_gc          = (0x15), /* Timer/Counter B1 */
} EVSYS_SYNCCH0_t;
...
typedef enum EVSYS_SYNCCH1_enum
{
    ...
    EVSYS_SYNCCH1_TCB1_gc          = (0x10), /* Timer/Counter B1 */
} EVSYS_SYNCCH1_t;
...
typedef enum VREF_ADC1REFEN_enum
{
    VREF_ADC1REFEN_CLEAR_gc = (0x00), /* ADC1 reference enable - CLEAR */
    VREF_ADC1REFEN_SET_gc   = (0x10), /* ADC1 reference enable - SET */
} VREF_ADC1REFEN_t;
...
typedef enum VREF_DAC1REFEN_enum
{
    VREF_DAC1REFEN_CLEAR_gc = (0x00), /* DAC1/AC1 reference enable - CLEAR */
    VREF_DAC1REFEN_SET_gc   = (0x08), /* DAC1/AC1 reference enable - SET */
} VREF_DAC1REFEN_t;

/* DAC2/AC2 reference enable */
typedef enum VREF_DAC2REFEN_enum
{
    VREF_DAC2REFEN_CLEAR_gc = (0x00), /* DAC2/AC2 reference enable - CLEAR */
    VREF_DAC2REFEN_SET_gc   = (0x20), /* DAC2/AC2 reference enable - SET */
} VREF_DAC2REFEN_t;
...
{
    VREF_DAC1REFSEL_0V55_gc = (0x00), /* Voltage reference at 0.55V */
    VREF_DAC1REFSEL_1V1_gc  = (0x01), /* Voltage reference at 1.1V */
    VREF_DAC1REFSEL_2V5_gc  = (0x02), /* Voltage reference at 2.5V */
    VREF_DAC1REFSEL_4V34_gc = (0x03), /* Voltage reference at 4.34V */
    VREF_DAC1REFSEL_1V5_gc  = (0x04), /* Voltage reference at 1.5V */
} VREF_DAC1REFSEL_t;

/* DAC2/AC2 reference select */
typedef enum VREF_DAC2REFSEL_enum
{
    VREF_DAC2REFSEL_0V55_gc = (0x00), /* Voltage reference at 0.55V */
    VREF_DAC2REFSEL_1V1_gc  = (0x01), /* Voltage reference at 1.1V */
    VREF_DAC2REFSEL_2V5_gc  = (0x02), /* Voltage reference at 2.5V */
    VREF_DAC2REFSEL_4V34_gc = (0x03), /* Voltage reference at 4.34V */
    VREF_DAC2REFSEL_1V5_gc  = (0x04), /* Voltage reference at 1.5V */
} VREF_DAC2REFSEL_t;
...
#define ADC_MUXPOS_PTC_gc       (0x1B) /* PTC/DAC2 */
#define ADC_MUXPOS_DAC0_gc      (0x1C) /* DAC0/DAC0 */
#define ADC_MUXPOS_INTREF_gc    (0x1D) /* Internal Ref */
#define ADC_MUXPOS_TEMPSENSE_gc (0x1E) /* Temp sensor/DAC1 */
...
#define EVSYS_ASYNCCH0_AC1_OUT_gc      (0x13) /* Analog Comparator 1 out */
#define EVSYS_ASYNCCH0_AC2_OUT_gc      (0x14) /* Analog Comparator 2 out */
...
#define EVSYS_ASYNCCH1_AC1_OUT_gc      (0x12) /* Analog Comparator 1 out */
#define EVSYS_ASYNCCH1_AC2_OUT_gc      (0x13) /* Analog Comparator 2 out */
...
#define EVSYS_ASYNCCH2_AC1_OUT_gc      (0x10) /* Analog Comparator 1 out */
#define EVSYS_ASYNCCH2_AC2_OUT_gc      (0x11) /* Analog Comparator 2 out */
...
#define EVSYS_ASYNCCH3_AC1_OUT_gc      (0x12) /* Analog Comparator 1 out */
#define EVSYS_ASYNCCH3_AC2_OUT_gc      (0x13) /* Analog Comparator 2 out */
...
/* Asynchronous User Ch 11 Input Selection - TCB1 */
#define EVSYS_ASYNCUSER11_OFF_gc      (0x00) /* Off */
#define EVSYS_ASYNCUSER11_SYNCCH0_gc  (0x01) /* Synchronous Event Channel 0 */
#define EVSYS_ASYNCUSER11_SYNCCH1_gc  (0x02) /* Synchronous Event Channel 1 */
#define EVSYS_ASYNCUSER11_ASYNCCH0_gc (0x03) /* Asynchronous Event Channel 0 */
#define EVSYS_ASYNCUSER11_ASYNCCH1_gc (0x04) /* Asynchronous Event Channel 1 */
#define EVSYS_ASYNCUSER11_ASYNCCH2_gc (0x05) /* Asynchronous Event Channel 2 */
#define EVSYS_ASYNCUSER11_ASYNCCH3_gc (0x06) /* Asynchronous Event Channel 3 */


/* Asynchronous User Ch 12 Input Selection - ADC0 */
#define EVSYS_ASYNCUSER12_OFF_gc      (0x00) /* Off */
#define EVSYS_ASYNCUSER12_SYNCCH0_gc  (0x01) /* Synchronous Event Channel 0 */
#define EVSYS_ASYNCUSER12_SYNCCH1_gc  (0x02) /* Synchronous Event Channel 1 */
#define EVSYS_ASYNCUSER12_ASYNCCH0_gc (0x03) /* Asynchronous Event Channel 0 */
#define EVSYS_ASYNCUSER12_ASYNCCH1_gc (0x04) /* Asynchronous Event Channel 1 */
#define EVSYS_ASYNCUSER12_ASYNCCH2_gc (0x05) /* Asynchronous Event Channel 2 */
#define EVSYS_ASYNCUSER12_ASYNCCH3_gc (0x06) /* Asynchronous Event Channel 3 */
...
#define EVSYS_SYNCCH0_TCB1_gc          (0x15) /* Timer/Counter B1 */
...
#define EVSYS_SYNCCH1_TCB1_gc          (0x10) /* Timer/Counter B1 */
...
/* ADC1 reference enable */
#define VREF_ADC1REFEN_CLEAR_gc (0x00) /* ADC1 reference enable - CLEAR */
#define VREF_ADC1REFEN_SET_gc   (0x10) /* ADC1 reference enable - SET */
...
/* DAC1/AC1 reference enable */
#define VREF_DAC1REFEN_CLEAR_gc (0x00) /* DAC1/AC1 reference enable - CLEAR */
#define VREF_DAC1REFEN_SET_gc   (0x08) /* DAC1/AC1 reference enable - SET */


/* DAC2/AC2 reference enable */
#define VREF_DAC2REFEN_CLEAR_gc (0x00) /* DAC2/AC2 reference enable - CLEAR */
#define VREF_DAC2REFEN_SET_gc   (0x20) /* DAC2/AC2 reference enable - SET */
...
/* DAC1/AC1 reference select */
#define VREF_DAC1REFSEL_0V55_gc (0x00) /* Voltage reference at 0.55V */
#define VREF_DAC1REFSEL_1V1_gc  (0x01) /* Voltage reference at 1.1V */
#define VREF_DAC1REFSEL_2V5_gc  (0x02) /* Voltage reference at 2.5V */
#define VREF_DAC1REFSEL_4V34_gc (0x03) /* Voltage reference at 4.34V */
#define VREF_DAC1REFSEL_1V5_gc  (0x04) /* Voltage reference at 1.5V */


/* DAC2/AC2 reference select */
#define VREF_DAC2REFSEL_0V55_gc (0x00) /* Voltage reference at 0.55V */
#define VREF_DAC2REFSEL_1V1_gc  (0x01) /* Voltage reference at 1.1V */
#define VREF_DAC2REFSEL_2V5_gc  (0x02) /* Voltage reference at 2.5V */
#define VREF_DAC2REFSEL_4V34_gc (0x03) /* Voltage reference at 4.34V */
#define VREF_DAC2REFSEL_1V5_gc  (0x04) /* Voltage reference at 1.5V */
...
#define VREF_CTRLC           _SFR_MEM8 (0x00A2) /* Control C */
#define VREF_CTRLD           _SFR_MEM8 (0x00A3) /* Control D */
...
#define EVSYS_ASYNCUSER11    _SFR_MEM8 (0x019D) /* Asynchronous User Ch 11 Input Selection - TCB1 */
#define EVSYS_ASYNCUSER12    _SFR_MEM8 (0x019E) /* Asynchronous User Ch 12 Input Selection - ADC1 */
#define EVSYS_SYNCUSER0      _SFR_MEM8 (0x01A2) /* Synchronous User Ch 0 - TCA0 */
#define EVSYS_SYNCUSER1      _SFR_MEM8 (0x01A3) /* Synchronous User Ch 1 - USART0 */
...
/* ADC1 - Analog to Digital Converter (0x0640) */
#define ADC1_BASE            _SFR_MEM8 (0x0640) /* ADC1 Base Address */
#define ADC1_CTRLA           _SFR_MEM8 (0x0640) /* Control A */
#define ADC1_CTRLB           _SFR_MEM8 (0x0641) /* Control B */
#define ADC1_CTRLC           _SFR_MEM8 (0x0642) /* Control C */
#define ADC1_CTRLD           _SFR_MEM8 (0x0643) /* Control D */
#define ADC1_CTRLE           _SFR_MEM8 (0x0644) /* Control E */
#define ADC1_SAMPCTRL        _SFR_MEM8 (0x0645) /* Sample Control */
#define ADC1_MUXPOS          _SFR_MEM8 (0x0646) /* Positive mux input */
#define ADC1_COMMAND         _SFR_MEM8 (0x0648) /* Command */
#define ADC1_EVCTRL          _SFR_MEM8 (0x0649) /* Event Control */
#define ADC1_INTCTRL         _SFR_MEM8 (0x064A) /* Interrupt Control */
#define ADC1_INTFLAGS        _SFR_MEM8 (0x064B) /* Interrupt Flags */
#define ADC1_DBGCTRL         _SFR_MEM8 (0x064C) /* Debug Control */
#define ADC1_TEMP            _SFR_MEM8 (0x064D) /* Temporary Data */
#define ADC1_RES             _SFR_MEM16(0x0650) /* ADC Accumulator Result */
#define ADC1_RESL            _SFR_MEM8 (0x0650) /* ADC Accumulator Result LOW BYTE */
#define ADC1_RESH            _SFR_MEM8 (0x0651) /* ADC Accumulator Result HIGH BYTE */
#define ADC1_WINLT           _SFR_MEM16(0x0652) /* Window comparator low threshold */
#define ADC1_WINLTL          _SFR_MEM8 (0x0652) /* Window comparator low threshold LOW BYTE */
#define ADC1_WINLTH          _SFR_MEM8 (0x0653) /* Window comparator low threshold HIGH BYTE */
#define ADC1_WINHT           _SFR_MEM16(0x0654) /* Window comparator high threshold */
#define ADC1_WINHTL          _SFR_MEM8 (0x0654) /* Window comparator high threshold LOW BYTE */
#define ADC1_WINHTH          _SFR_MEM8 (0x0655) /* Window comparator high threshold HIGH BYTE */
#define ADC1_CALIB           _SFR_MEM8 (0x0656) /* Calibration */
...
/* AC1 - Analog Comparator (0x0688) */
#define AC1_BASE             _SFR_MEM8 (0x0688) /* AC1 Base Address */
#define AC1_CTRLA            _SFR_MEM8 (0x0688) /* Control A */
#define AC1_MUXCTRLA         _SFR_MEM8 (0x068A) /* Mux Control A */
#define AC1_INTCTRL          _SFR_MEM8 (0x068E) /* Interrupt Control */
#define AC1_STATUS           _SFR_MEM8 (0x068F) /* Status */

/* AC2 - Analog Comparator (0x0690) */
#define AC2_BASE             _SFR_MEM8 (0x0690) /* AC2 Base Address */
#define AC2_CTRLA            _SFR_MEM8 (0x0690) /* Control A */
#define AC2_MUXCTRLA         _SFR_MEM8 (0x0692) /* Mux Control A */
#define AC2_INTCTRL          _SFR_MEM8 (0x0696) /* Interrupt Control */
#define AC2_STATUS           _SFR_MEM8 (0x0697) /* Status */

/* DAC0 - Digital to Analog Converter (0x06A0) */
#define DAC0_BASE            _SFR_MEM8 (0x06A0) /* DAC0 Base Address */
#define DAC0_CTRLA           _SFR_MEM8 (0x06A0) /* Control Register A */
#define DAC0_DATA            _SFR_MEM8 (0x06A1) /* DATA Register */

/* DAC1 - Digital to Analog Converter (0x06A8) */
#define DAC1_BASE            _SFR_MEM8 (0x06A8) /* DAC1 Base Address */
#define DAC1_CTRLA           _SFR_MEM8 (0x06A8) /* Control Register A */
#define DAC1_DATA            _SFR_MEM8 (0x06A9) /* DATA Register */

/* DAC2 - Digital to Analog Converter (0x06B0) */
#define DAC2_BASE            _SFR_MEM8 (0x06B0) /* DAC2 Base Address */
#define DAC2_CTRLA           _SFR_MEM8 (0x06B0) /* Control Register A */
#define DAC2_DATA            _SFR_MEM8 (0x06B1) /* DATA Register */
...
/* TCB1 - 16-bit Timer Type B (0x0A50) */
#define TCB1_BASE            _SFR_MEM8 (0x0A50) /* TCB1 Base Address */
#define TCB1_CTRLA           _SFR_MEM8 (0x0A50) /* Control A */
#define TCB1_CTRLB           _SFR_MEM8 (0x0A51) /* Control Register B */
#define TCB1_EVCTRL          _SFR_MEM8 (0x0A54) /* Event Control */
#define TCB1_INTCTRL         _SFR_MEM8 (0x0A55) /* Interrupt Control */
#define TCB1_INTFLAGS        _SFR_MEM8 (0x0A56) /* Interrupt Flags */
#define TCB1_STATUS          _SFR_MEM8 (0x0A57) /* Status */
#define TCB1_DBGCTRL         _SFR_MEM8 (0x0A58) /* Debug Control */
#define TCB1_TEMP            _SFR_MEM8 (0x0A59) /* Temporary Value */
#define TCB1_CNT             _SFR_MEM16(0x0A5A) /* Count */
#define TCB1_CNTL            _SFR_MEM8 (0x0A5A) /* Count LOW BYTE */
#define TCB1_CNTH            _SFR_MEM8 (0x0A5B) /* Count HIGH BYTE */
#define TCB1_CCMP            _SFR_MEM16(0x0A5C) /* Compare or Capture */
#define TCB1_CCMPL           _SFR_MEM8 (0x0A5C) /* Compare or Capture LOW BYTE */
#define TCB1_CCMPH           _SFR_MEM8 (0x0A5D) /* Compare or Capture HIGH BYTE */
...
#define TCB1_INT_vect        _VECTOR(14)         /* TCB1 - INT Interrupt */

/* TCD0 interrupt vectors */
#define TCD0_OVF_vect_num    (15)                
#define TCD0_OVF_vect        _VECTOR(15)         /* TCD0 - OVF Interrupt */
#define TCD0_TRIG_vect_num   (16)                
#define TCD0_TRIG_vect       _VECTOR(16)         /* TCD0 - TRIG Interrupt */

/* AC0 interrupt vectors */
#define AC0_AC_vect_num      (17)                
#define AC0_AC_vect          _VECTOR(17)         /* AC0 - AC Interrupt */

/* AC1 interrupt vectors */
#define AC1_AC_vect_num      (18)                
#define AC1_AC_vect          _VECTOR(18)         /* AC1 - AC Interrupt */

/* AC2 interrupt vectors */
#define AC2_AC_vect_num      (19)                
#define AC2_AC_vect          _VECTOR(19)         /* AC2 - AC Interrupt */

/* ADC0 interrupt vectors */
#define ADC0_RESRDY_vect_num (20)                
#define ADC0_RESRDY_vect     _VECTOR(20)         /* ADC0 - RESRDY Interrupt */
#define ADC0_WCOMP_vect_num  (21)                
#define ADC0_WCOMP_vect      _VECTOR(21)         /* ADC0 - WCOMP Interrupt */

/* ADC1 interrupt vectors */
#define ADC1_RESRDY_vect_num (22)                
#define ADC1_RESRDY_vect     _VECTOR(22)         /* ADC1 - RESRDY Interrupt */
#define ADC1_WCOMP_vect_num  (23)                
#define ADC1_WCOMP_vect      _VECTOR(23)         /* ADC1 - WCOMP Interrupt */

/* TWI0 interrupt vectors */
#define TWI0_TWIS_vect_num   (24)                
#define TWI0_TWIS_vect       _VECTOR(24)         /* TWI0 - TWIS Interrupt */
#define TWI0_TWIM_vect_num   (25)                
#define TWI0_TWIM_vect       _VECTOR(25)         /* TWI0 - TWIM Interrupt */

/* SPI0 interrupt vectors */
#define SPI0_INT_vect_num    (26)                
#define SPI0_INT_vect        _VECTOR(26)         /* SPI0 - INT Interrupt */

/* USART0 interrupt vectors */
#define USART0_RXC_vect_num  (27)                
#define USART0_RXC_vect      _VECTOR(27)         /* USART0 - RXC Interrupt */
#define USART0_DRE_vect_num  (28)                
#define USART0_DRE_vect      _VECTOR(28)         /* USART0 - DRE Interrupt */
#define USART0_TXC_vect_num  (29)                
#define USART0_TXC_vect      _VECTOR(29)         /* USART0 - TXC Interrupt */
