 ...
 *                                                                            * 
 *   .atpack File: AT90PWM161.atdf                                            * 
 *   .ATDF File:   atdf/AT90PWM161.atdf                                       * 
 *   Version:      2.0.12                                                     * 
 *   Date:         2019-04-26                                                 * 
 *   Device:       AT90PWM161                                                 * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioAT90PWM161.h"
#else
...
typedef struct DAC_struct
{
    ...
    register8_t DACL;         /* DAC Data Register Low Byte */
    register8_t DACH;         /* DAC Data Register High Byte */
    register8_t rsv_0x5A[28]; /* RESERVED REGISTER BLOCK */
...
{
    ADC_ADC6D_CLEAR_gc = (0x00), /* ADC7 Digital input Disable - CLEAR */
    ADC_ADC6D_SET_gc   = (0x40), /* ADC7 Digital input Disable - SET */
} ADC_ADC6D_t;
...
/* Digital Input Disable Register 0-ACMP1MD */
typedef enum ADC_ACMP1MD_enum
{
    ADC_ACMP1MD_CLEAR_gc = (0x00), /* Digital Input Disable Register 0-ACMP1MD - CLEAR */
    ADC_ACMP1MD_SET_gc   = (0x08), /* Digital Input Disable Register 0-ACMP1MD - SET */
} ADC_ACMP1MD_t;

/* Digital Input Disable Register 0-AMP0POSD */
typedef enum ADC_AMP0POSD_enum
{
    ADC_AMP0POSD_CLEAR_gc = (0x00), /* Digital Input Disable Register 0-AMP0POSD - CLEAR */
    ADC_AMP0POSD_SET_gc   = (0x04), /* Digital Input Disable Register 0-AMP0POSD - SET */
} ADC_AMP0POSD_t;

/* Digital Input Disable Register 0-ADC10D */
typedef enum ADC_ADC10D_enum
{
    ADC_ADC10D_CLEAR_gc = (0x00), /* Digital Input Disable Register 0-ADC10D - CLEAR */
    ADC_ADC10D_SET_gc   = (0x02), /* Digital Input Disable Register 0-ADC10D - SET */
} ADC_ADC10D_t;

/* Digital Input Disable Register 0-ADC9D */
typedef enum ADC_ADC9D_enum
{
    ADC_ADC9D_CLEAR_gc = (0x00), /* Digital Input Disable Register 0-ADC9D - CLEAR */
    ADC_ADC9D_SET_gc   = (0x01), /* Digital Input Disable Register 0-ADC9D - SET */
} ADC_ADC9D_t;
...
typedef struct PSC2_struct
{
    ...
    register8_t PICR2L;       /* PSC 2 Input Capture Register Low */
    register8_t PICR2H;       /* PSC 2 Input Capture Register High */
...
typedef enum PSC2_PCST2_enum
{
    ...
    PSC2_PCST2_SET_gc   = (0x80), /* PSC 2 Capture Software Trigger Bit - SET */
} PSC2_PCST2_t;

/* PSC 2 Input Capture Register High-PICR21 */
#define PSC2_PICR2H_PICR21_gc(x) ((x<<2) & 0x0C)

/* PSC 2 Input Capture Register High-PICR2 */
#define PSC2_PICR2H_PICR2_gc(x) (x & 0x03)
...
/* ADC7 Digital input Disable */
#define ADC_ADC6D_CLEAR_gc (0x00) /* ADC7 Digital input Disable - CLEAR */
#define ADC_ADC6D_SET_gc   (0x40) /* ADC7 Digital input Disable - SET */
...
/* Digital Input Disable Register 0-ACMP1MD */
#define ADC_ACMP1MD_CLEAR_gc (0x00) /* Digital Input Disable Register 0-ACMP1MD - CLEAR */
#define ADC_ACMP1MD_SET_gc   (0x08) /* Digital Input Disable Register 0-ACMP1MD - SET */


/* Digital Input Disable Register 0-AMP0POSD */
#define ADC_AMP0POSD_CLEAR_gc (0x00) /* Digital Input Disable Register 0-AMP0POSD - CLEAR */
#define ADC_AMP0POSD_SET_gc   (0x04) /* Digital Input Disable Register 0-AMP0POSD - SET */


/* Digital Input Disable Register 0-ADC10D */
#define ADC_ADC10D_CLEAR_gc (0x00) /* Digital Input Disable Register 0-ADC10D - CLEAR */
#define ADC_ADC10D_SET_gc   (0x02) /* Digital Input Disable Register 0-ADC10D - SET */


/* Digital Input Disable Register 0-ADC9D */
#define ADC_ADC9D_CLEAR_gc (0x00) /* Digital Input Disable Register 0-ADC9D - CLEAR */
#define ADC_ADC9D_SET_gc   (0x01) /* Digital Input Disable Register 0-ADC9D - SET */
...
#define PSC2_PCST2_SET_gc   (0x80) /* PSC 2 Capture Software Trigger Bit - SET */
...
#define ADC_DIDR1        _SFR_MEM8 (0x0078) /* Digital Input Disable Register 0 */
...
#define PSC22_PICR2L     _SFR_MEM8 (0x006C) /* PSC 2 Input Capture Register Low */
#define PSC22_PICR2H     _SFR_MEM8 (0x006D) /* PSC 2 Input Capture Register High */
