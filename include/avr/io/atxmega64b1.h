 ...
 *                                                                            * 
 *   .atpack File: ATxmega64B1.atdf                                           * 
 *   .ATDF File:   atdf/ATxmega64B1.atdf                                      * 
 *   Version:      2.0.9                                                      * 
 *   Date:         2019-07-11                                                 * 
 *   Device:       ATxmega64B1                                                * 
 ...
 *        - Succeeds Atmel.XMEGAB_DFP 1.1.55.                                 * 
 *                                                                            * 
...
#  define _AVR_IOXXX_H_ "ioATxmega64B1.h"
#else
...
typedef enum OSC_XOSCSEL_enum
{
    ...
    OSC_XOSCSEL_EXTCLK_C0_gc   = (0x01), /* External Clock on port C0 - 6 CLK */
    OSC_XOSCSEL_EXTCLK_C1_gc   = (0x05), /* External Clock on port C1 - 6 CLK */
    OSC_XOSCSEL_EXTCLK_C2_gc   = (0x09), /* External Clock on port C2 - 6 CLK */
    OSC_XOSCSEL_EXTCLK_C3_gc   = (0x0D), /* External Clock on port C3 - 6 CLK */
    OSC_XOSCSEL_EXTCLK_C4_gc   = (0x11), /* External Clock on port C4 - 6 CLK */
    OSC_XOSCSEL_EXTCLK_C5_gc   = (0x15), /* External Clock on port C5 - 6 CLK */
    OSC_XOSCSEL_EXTCLK_C6_gc   = (0x19), /* External Clock on port C6 - 6 CLK */
    OSC_XOSCSEL_EXTCLK_C7_gc   = (0x1D), /* External Clock on port C7 - 6 CLK */
...
/* LCD Module */
typedef enum PR_LCD_enum
{
    PR_LCD_CLEAR_gc = (0x00), /* LCD Module - CLEAR */
    PR_LCD_SET_gc   = (0x80), /* LCD Module - SET */
} PR_LCD_t;
...
typedef enum PORTCFG_CLKOUT_enum
{
    ...
    PORTCFG_CLKOUT_PC_gc  = (0x01), /* System Clock Output on Port C */
    PORTCFG_CLKOUT_PE_gc  = (0x03), /* System Clock Output on Port E */
} PORTCFG_CLKOUT_t;
...
typedef struct DMA_struct
{
    ...
    register8_t STATUS;      /* Status */
    register8_t rsv_0x05;    /* RESERVED REGISTER */
    _REGISTER16 (TEMP);      /* Temporary Register For 16-bit Access */
} DMA_t;


/* Channel Enable */
typedef enum DMA_CH_CHEN_enum
{
    DMA_CH_CHEN_CLEAR_gc = (0x00), /* Channel Enable - CLEAR */
    DMA_CH_CHEN_SET_gc   = (0x80), /* Channel Enable - SET */
} DMA_CH_CHEN_t;

/* Channel Software Reset */
typedef enum DMA_CH_CHRST_enum
{
    DMA_CH_CHRST_CLEAR_gc = (0x00), /* Channel Software Reset - CLEAR */
    DMA_CH_CHRST_SET_gc   = (0x40), /* Channel Software Reset - SET */
} DMA_CH_CHRST_t;
...
{
    DMA_PRIMODE_RR01_gc   = (0x00), /* Round Robin */
    DMA_PRIMODE_CH0RR1_gc = (0x01), /* Channel 0 > channel 1 */
} DMA_PRIMODE_t;
...
typedef enum EVSYS_CHMUX_enum
{
    ...
    EVSYS_CHMUX_ADCA_CH0_gc        = (0x20), /* ADC A Channel */
    EVSYS_CHMUX_ADCB_CH0_gc        = (0x24), /* ADC B Channel */
...
{
    ADC_CH_INPUTMODE_INTERNAL_gc    = (0x00), /* Internal inputs, no gain (INPUTMODE = 0) */
    ADC_CH_INPUTMODE_SINGLEENDED_gc = (0x01), /* Single-ended input, no gain (INPUTMODE = 1) */
    ADC_CH_INPUTMODE_DIFF_gc        = (0x02), /* Differential input, no gain (INPUTMODE = 2) */
    ADC_CH_INPUTMODE_DIFFWGAIN_gc   = (0x03), /* Differential input, with gain (INPUTMODE = 3) */
} ADC_CH_INPUTMODE_t;
...
{
    ADC_CH_MUXNEG_PIN0_gc         = (0x00), /* Input pin 0 (if INPUTMODE = 2) */
    ADC_CH_MUXNEG_PIN1_gc         = (0x01), /* Input pin 1 (if INPUTMODE = 2) */
    ADC_CH_MUXNEG_PIN2_gc         = (0x02), /* Input pin 2 (if INPUTMODE = 2) */
    ADC_CH_MUXNEG_PIN3_gc         = (0x03), /* Input pin 3 (if INPUTMODE = 2) */
    ADC_CH_MUXNEG_PIN4_gc         = (0x00), /* Input pin 4 (if INPUTMODE = 3) */
    ADC_CH_MUXNEG_PIN5_gc         = (0x01), /* Input pin 5 (if INPUTMODE = 3) */
    ADC_CH_MUXNEG_PIN6_gc         = (0x02), /* Input pin 6 (if INPUTMODE = 3) */
    ADC_CH_MUXNEG_PIN7_gc         = (0x03), /* Input pin 7 (if INPUTMODE = 3) */
    ADC_CH_MUXNEG_GND_MODE3_gc    = (0x05), /* PAD Ground (if INPUTMODE = 2) */
    ADC_CH_MUXNEG_INTGND_MODE3_gc = (0x07), /* Internal Ground (if INPUTMODE = 2) */
    ADC_CH_MUXNEG_INTGND_MODE4_gc = (0x04), /* Internal Ground (if INPUTMODE = 3) */
    ADC_CH_MUXNEG_GND_MODE4_gc    = (0x07), /* PAD Ground (if INPUTMODE = 3) */
} ADC_CH_MUXNEG_t;
...
#define ADC_CH_SCAN_COUNT_gc(x) (x & 0x0F)
...
typedef enum TC0_BYTEM_enum
{
    ...
    TC0_BYTEM_SPLITMODE_gc = (0x02), /* Timer/Counter split into two 8-bit Counters */
} TC0_BYTEM_t;
...
/* LCD Enable */
typedef enum LCD_ENABLE_enum
{
    LCD_ENABLE_CLEAR_gc = (0x00), /* LCD Enable - CLEAR */
    LCD_ENABLE_SET_gc   = (0x80), /* LCD Enable - SET */
} LCD_ENABLE_t;

/* External Register Bias Generation */
typedef enum LCD_XBIAS_enum
{
    LCD_XBIAS_CLEAR_gc = (0x00), /* External Register Bias Generation - CLEAR */
    LCD_XBIAS_SET_gc   = (0x40), /* External Register Bias Generation - SET */
} LCD_XBIAS_t;

/* Data Register Lock */
typedef enum LCD_DATCLK_enum
{
    LCD_DATCLK_CLEAR_gc = (0x00), /* Data Register Lock - CLEAR */
    LCD_DATCLK_SET_gc   = (0x20), /* Data Register Lock - SET */
} LCD_DATCLK_t;

/* Common Bus Swap */
typedef enum LCD_COMSWP_enum
{
    LCD_COMSWP_CLEAR_gc = (0x00), /* Common Bus Swap - CLEAR */
    LCD_COMSWP_SET_gc   = (0x10), /* Common Bus Swap - SET */
} LCD_COMSWP_t;

/* Segment Bus Swap */
typedef enum LCD_SEGSWP_enum
{
    LCD_SEGSWP_CLEAR_gc = (0x00), /* Segment Bus Swap - CLEAR */
    LCD_SEGSWP_SET_gc   = (0x08), /* Segment Bus Swap - SET */
} LCD_SEGSWP_t;

/* Clear Data Register */
typedef enum LCD_CLRDT_enum
{
    LCD_CLRDT_CLEAR_gc = (0x00), /* Clear Data Register - CLEAR */
    LCD_CLRDT_SET_gc   = (0x04), /* Clear Data Register - SET */
} LCD_CLRDT_t;

/* Segments On */
typedef enum LCD_SEGON_enum
{
    LCD_SEGON_CLEAR_gc = (0x00), /* Segments On - CLEAR */
    LCD_SEGON_SET_gc   = (0x02), /* Segments On - SET */
} LCD_SEGON_t;

/* Blanking Display Mode */
typedef enum LCD_BLANK_enum
{
    LCD_BLANK_CLEAR_gc = (0x00), /* Blanking Display Mode - CLEAR */
    LCD_BLANK_SET_gc   = (0x01), /* Blanking Display Mode - SET */
} LCD_BLANK_t;
...
/* Low Power Waveform */
typedef enum LCD_LPWAV_enum
{
    LCD_LPWAV_CLEAR_gc = (0x00), /* Low Power Waveform - CLEAR */
    LCD_LPWAV_SET_gc   = (0x08), /* Low Power Waveform - SET */
} LCD_LPWAV_t;

/* Duty Select */
typedef enum LCD_DUTY_enum
{
    LCD_DUTY_1_4_gc    = (0x00), /* Duty=1/4, Bias=1/3, COM0:3 */
    LCD_DUTY_Static_gc = (0x01), /* Duty=Static, Bias=Static, COM0 */
    LCD_DUTY_1_2_gc    = (0x02), /* Duty=1/2, Bias=1/3, COM0:1 */
    LCD_DUTY_1_3_gc    = (0x03), /* Duty=1/3, Bias=1/3, COM0:2 */
} LCD_DUTY_t;

/* eXtended Interrupt Mode Enable */
#define LCD_INTCTRL_XIME_gc(x) ((x<<3) & 0xF8)

/* Interrupt Level */
typedef enum LCD_FCINTLVL_enum
{
    LCD_FCINTLVL_OFF_gc = (0x00), /* Interrupt disabled */
    LCD_FCINTLVL_LO_gc  = (0x01), /* Low level */
    LCD_FCINTLVL_MED_gc = (0x02), /* Medium level */
    LCD_FCINTLVL_HI_gc  = (0x03), /* High level */
} LCD_FCINTLVL_t;

/* LCD Frame Completed Interrupt Flag */
typedef enum LCD_FCIF_enum
{
    LCD_FCIF_CLEAR_gc = (0x00), /* LCD Frame Completed Interrupt Flag - CLEAR */
    LCD_FCIF_SET_gc   = (0x01), /* LCD Frame Completed Interrupt Flag - SET */
} LCD_FCIF_t;

/* Blink Enable */
typedef enum LCD_BLINKEN_enum
{
    LCD_BLINKEN_CLEAR_gc = (0x00), /* Blink Enable - CLEAR */
    LCD_BLINKEN_SET_gc   = (0x08), /* Blink Enable - SET */
} LCD_BLINKEN_t;

/* LCD Blink Rate */
typedef enum LCD_BLINKRATE_enum
{
    LCD_BLINKRATE_4Hz_gc  = (0x00), /* 4Hz Blink Rate */
    LCD_BLINKRATE_2Hz_gc  = (0x01), /* 2Hz Blink Rate */
    LCD_BLINKRATE_1Hz_gc  = (0x02), /* 1Hz Blink Rate */
    LCD_BLINKRATE_0Hz5_gc = (0x03), /* 0.5Hz Blink Rate */
} LCD_BLINKRATE_t;

/* Blink Pixel Selection 1 */
#define LCD_CTRLE_BPS1_gc(x) ((x<<4) & 0xF0)

/* Blink Pixel Selection 0 */
#define LCD_CTRLE_BPS0_gc(x) (x & 0x0F)
...
/* Start Segment */
#define LCD_CTRLG_STSEG_gc(x) (x & 0x3F)

/* Decrement of Start Segment */
typedef enum LCD_DEC_enum
{
    LCD_DEC_CLEAR_gc = (0x00), /* Decrement of Start Segment - CLEAR */
    LCD_DEC_SET_gc   = (0x80), /* Decrement of Start Segment - SET */
} LCD_DEC_t;

/* Display Code */
#define LCD_CTRLH_DCODE_gc(x) (x & 0x7F)
...
#define OSC_XOSCSEL_EXTCLK_C0_gc   (0x01) /* External Clock on port C0 - 6 CLK */
#define OSC_XOSCSEL_EXTCLK_C1_gc   (0x05) /* External Clock on port C1 - 6 CLK */
#define OSC_XOSCSEL_EXTCLK_C2_gc   (0x09) /* External Clock on port C2 - 6 CLK */
#define OSC_XOSCSEL_EXTCLK_C3_gc   (0x0D) /* External Clock on port C3 - 6 CLK */
#define OSC_XOSCSEL_EXTCLK_C4_gc   (0x11) /* External Clock on port C4 - 6 CLK */
#define OSC_XOSCSEL_EXTCLK_C5_gc   (0x15) /* External Clock on port C5 - 6 CLK */
#define OSC_XOSCSEL_EXTCLK_C6_gc   (0x19) /* External Clock on port C6 - 6 CLK */
#define OSC_XOSCSEL_EXTCLK_C7_gc   (0x1D) /* External Clock on port C7 - 6 CLK */
...
/* LCD Module */
#define PR_LCD_CLEAR_gc (0x00) /* LCD Module - CLEAR */
#define PR_LCD_SET_gc   (0x80) /* LCD Module - SET */
...
#define PORTCFG_CLKOUT_PC_gc  (0x01) /* System Clock Output on Port C */
#define PORTCFG_CLKOUT_PE_gc  (0x03) /* System Clock Output on Port E */
...
#define PORTCFG_EVOUT_PC_gc  (0x01<<4) /* Event Channel 0 Output on Port C */
#define PORTCFG_EVOUT_PE_gc  (0x03<<4) /* Event Channel 0 Output on Port E */
...
/* Event Output Select */
#define PORTCFG_EVOUTSEL_0_gc (0x00<<2) /* Event Channel 0 output to pin */
#define PORTCFG_EVOUTSEL_1_gc (0x01<<2) /* Event Channel 1 output to pin */
#define PORTCFG_EVOUTSEL_2_gc (0x02<<2) /* Event Channel 2 output to pin */
#define PORTCFG_EVOUTSEL_3_gc (0x03<<2) /* Event Channel 3 output to pin */
...
/* Channel Enable */
#define DMA_CH_CHEN_CLEAR_gc (0x00) /* Channel Enable - CLEAR */
#define DMA_CH_CHEN_SET_gc   (0x80) /* Channel Enable - SET */


/* Channel Software Reset */
#define DMA_CH_CHRST_CLEAR_gc (0x00) /* Channel Software Reset - CLEAR */
#define DMA_CH_CHRST_SET_gc   (0x40) /* Channel Software Reset - SET */
...
/* Channel Priority Mode */
#define DMA_PRIMODE_RR01_gc   (0x00) /* Round Robin */
#define DMA_PRIMODE_CH0RR1_gc (0x01) /* Channel 0 > channel 1 */
...
#define EVSYS_CHMUX_ADCA_CH0_gc        (0x20) /* ADC A Channel */
#define EVSYS_CHMUX_ADCB_CH0_gc        (0x24) /* ADC B Channel */
...
/* Input Mode Select */
#define ADC_CH_INPUTMODE_INTERNAL_gc    (0x00) /* Internal inputs, no gain (INPUTMODE = 0) */
#define ADC_CH_INPUTMODE_SINGLEENDED_gc (0x01) /* Single-ended input, no gain (INPUTMODE = 1) */
#define ADC_CH_INPUTMODE_DIFF_gc        (0x02) /* Differential input, no gain (INPUTMODE = 2) */
#define ADC_CH_INPUTMODE_DIFFWGAIN_gc   (0x03) /* Differential input, with gain (INPUTMODE = 3) */
...
/* MUX selection on Negative ADC input */
#define ADC_CH_MUXNEG_PIN0_gc         (0x00) /* Input pin 0 (if INPUTMODE = 2) */
#define ADC_CH_MUXNEG_PIN1_gc         (0x01) /* Input pin 1 (if INPUTMODE = 2) */
#define ADC_CH_MUXNEG_PIN2_gc         (0x02) /* Input pin 2 (if INPUTMODE = 2) */
#define ADC_CH_MUXNEG_PIN3_gc         (0x03) /* Input pin 3 (if INPUTMODE = 2) */
#define ADC_CH_MUXNEG_PIN4_gc         (0x00) /* Input pin 4 (if INPUTMODE = 3) */
#define ADC_CH_MUXNEG_PIN5_gc         (0x01) /* Input pin 5 (if INPUTMODE = 3) */
#define ADC_CH_MUXNEG_PIN6_gc         (0x02) /* Input pin 6 (if INPUTMODE = 3) */
#define ADC_CH_MUXNEG_PIN7_gc         (0x03) /* Input pin 7 (if INPUTMODE = 3) */
#define ADC_CH_MUXNEG_GND_MODE3_gc    (0x05) /* PAD Ground (if INPUTMODE = 2) */
#define ADC_CH_MUXNEG_INTGND_MODE3_gc (0x07) /* Internal Ground (if INPUTMODE = 2) */
#define ADC_CH_MUXNEG_INTGND_MODE4_gc (0x04) /* Internal Ground (if INPUTMODE = 3) */
#define ADC_CH_MUXNEG_GND_MODE4_gc    (0x07) /* PAD Ground (if INPUTMODE = 3) */
...
#define TC0_BYTEM_SPLITMODE_gc (0x02) /* Timer/Counter split into two 8-bit Counters */
...
/* LCD Enable */
#define LCD_ENABLE_CLEAR_gc (0x00) /* LCD Enable - CLEAR */
#define LCD_ENABLE_SET_gc   (0x80) /* LCD Enable - SET */


/* External Register Bias Generation */
#define LCD_XBIAS_CLEAR_gc (0x00) /* External Register Bias Generation - CLEAR */
#define LCD_XBIAS_SET_gc   (0x40) /* External Register Bias Generation - SET */


/* Data Register Lock */
#define LCD_DATCLK_CLEAR_gc (0x00) /* Data Register Lock - CLEAR */
#define LCD_DATCLK_SET_gc   (0x20) /* Data Register Lock - SET */


/* Common Bus Swap */
#define LCD_COMSWP_CLEAR_gc (0x00) /* Common Bus Swap - CLEAR */
#define LCD_COMSWP_SET_gc   (0x10) /* Common Bus Swap - SET */


/* Segment Bus Swap */
#define LCD_SEGSWP_CLEAR_gc (0x00) /* Segment Bus Swap - CLEAR */
#define LCD_SEGSWP_SET_gc   (0x08) /* Segment Bus Swap - SET */


/* Clear Data Register */
#define LCD_CLRDT_CLEAR_gc (0x00) /* Clear Data Register - CLEAR */
#define LCD_CLRDT_SET_gc   (0x04) /* Clear Data Register - SET */


/* Segments On */
#define LCD_SEGON_CLEAR_gc (0x00) /* Segments On - CLEAR */
#define LCD_SEGON_SET_gc   (0x02) /* Segments On - SET */


/* Blanking Display Mode */
#define LCD_BLANK_CLEAR_gc (0x00) /* Blanking Display Mode - CLEAR */
#define LCD_BLANK_SET_gc   (0x01) /* Blanking Display Mode - SET */


/* LCD Prescaler Select */
#define LCD_PRESC_8_gc  (0x00<<7) /* clk_lcd/8 */
#define LCD_PRESC_16_gc (0x01<<7) /* clk_lcd/16 */


/* LCD Clock Divide */
#define LCD_CLKDIV_DivBy1_gc (0x00<<4) /* frame rate of 256 Hz */
#define LCD_CLKDIV_DivBy2_gc (0x01<<4) /* frame rate of 128 Hz */
#define LCD_CLKDIV_DivBy3_gc (0x02<<4) /* frame rate of 83.5 Hz */
#define LCD_CLKDIV_DivBy4_gc (0x03<<4) /* frame rate of 64 Hz */
#define LCD_CLKDIV_DivBy5_gc (0x04<<4) /* frame rate of 51.2 Hz */
#define LCD_CLKDIV_DivBy6_gc (0x05<<4) /* frame rate of 42.7 Hz */
#define LCD_CLKDIV_DivBy7_gc (0x06<<4) /* frame rate of 36.6 Hz */
#define LCD_CLKDIV_DivBy8_gc (0x07<<4) /* frame rate of 32 Hz */


/* Low Power Waveform */
#define LCD_LPWAV_CLEAR_gc (0x00) /* Low Power Waveform - CLEAR */
#define LCD_LPWAV_SET_gc   (0x08) /* Low Power Waveform - SET */


/* Duty Select */
#define LCD_DUTY_1_4_gc    (0x00) /* Duty=1/4, Bias=1/3, COM0:3 */
#define LCD_DUTY_Static_gc (0x01) /* Duty=Static, Bias=Static, COM0 */
#define LCD_DUTY_1_2_gc    (0x02) /* Duty=1/2, Bias=1/3, COM0:1 */
#define LCD_DUTY_1_3_gc    (0x03) /* Duty=1/3, Bias=1/3, COM0:2 */
...
/* Interrupt Level */
#define LCD_FCINTLVL_OFF_gc (0x00) /* Interrupt disabled */
#define LCD_FCINTLVL_LO_gc  (0x01) /* Low level */
#define LCD_FCINTLVL_MED_gc (0x02) /* Medium level */
#define LCD_FCINTLVL_HI_gc  (0x03) /* High level */


/* LCD Frame Completed Interrupt Flag */
#define LCD_FCIF_CLEAR_gc (0x00) /* LCD Frame Completed Interrupt Flag - CLEAR */
#define LCD_FCIF_SET_gc   (0x01) /* LCD Frame Completed Interrupt Flag - SET */


/* Blink Enable */
#define LCD_BLINKEN_CLEAR_gc (0x00) /* Blink Enable - CLEAR */
#define LCD_BLINKEN_SET_gc   (0x08) /* Blink Enable - SET */


/* LCD Blink Rate */
#define LCD_BLINKRATE_4Hz_gc  (0x00) /* 4Hz Blink Rate */
#define LCD_BLINKRATE_2Hz_gc  (0x01) /* 2Hz Blink Rate */
#define LCD_BLINKRATE_1Hz_gc  (0x02) /* 1Hz Blink Rate */
#define LCD_BLINKRATE_0Hz5_gc (0x03) /* 0.5Hz Blink Rate */
...
/* Type of Digit */
#define LCD_TDG_7S_3C_gc  (0x00<<6) /* 7-segment with 3 COMs */
#define LCD_TDG_7S_4C_gc  (0x01<<6) /* 7-segment with 4 COMs */
#define LCD_TDG_14S_4C_gc (0x02<<6) /* 14-segment with 4 COMs */
#define LCD_TDG_16S_3C_gc (0x03<<6) /* 16-segment with 3 COMs */
...
/* Decrement of Start Segment */
#define LCD_DEC_CLEAR_gc (0x00) /* Decrement of Start Segment - CLEAR */
#define LCD_DEC_SET_gc   (0x80) /* Decrement of Start Segment - SET */
...
#define DMA_TEMP          _SFR_MEM16(0x0106) /* Temporary Register For 16-bit Access */
#define DMA_TEMPL         _SFR_MEM8 (0x0106) /* Temporary Register For 16-bit Access LOW BYTE */
#define DMA_TEMPH         _SFR_MEM8 (0x0107) /* Temporary Register For 16-bit Access HIGH BYTE */
...
#define ADCB_SAMPCTRL     _SFR_MEM8 (0x0248) /* ADC Sampling Time Control Register */
...
#define ACB_CURRCTRL      _SFR_MEM8 (0x0398) /* Current Source Control Register */
#define ACB_CURRCALIB     _SFR_MEM8 (0x0399) /* Current Source Calibration Register */
...
/* PORTG - I/O Ports (0x06C0) */
#define PORTG_BASE        _SFR_MEM8 (0x06C0) /* PORTG Base Address */
#define PORTG_DIR         _SFR_MEM8 (0x06C0) /* I/O Port Data Direction */
#define PORTG_DIRSET      _SFR_MEM8 (0x06C1) /* I/O Port Data Direction Set */
#define PORTG_DIRCLR      _SFR_MEM8 (0x06C2) /* I/O Port Data Direction Clear */
#define PORTG_DIRTGL      _SFR_MEM8 (0x06C3) /* I/O Port Data Direction Toggle */
#define PORTG_OUT         _SFR_MEM8 (0x06C4) /* I/O Port Output */
#define PORTG_OUTSET      _SFR_MEM8 (0x06C5) /* I/O Port Output Set */
#define PORTG_OUTCLR      _SFR_MEM8 (0x06C6) /* I/O Port Output Clear */
#define PORTG_OUTTGL      _SFR_MEM8 (0x06C7) /* I/O Port Output Toggle */
#define PORTG_IN          _SFR_MEM8 (0x06C8) /* I/O port Input */
#define PORTG_INTCTRL     _SFR_MEM8 (0x06C9) /* Interrupt Control Register */
#define PORTG_INT0MASK    _SFR_MEM8 (0x06CA) /* Port Interrupt 0 Mask */
#define PORTG_INT1MASK    _SFR_MEM8 (0x06CB) /* Port Interrupt 1 Mask */
#define PORTG_INTFLAGS    _SFR_MEM8 (0x06CC) /* Interrupt Flag Register */
#define PORTG_REMAP       _SFR_MEM8 (0x06CE) /* I/O Port Pin Remap Register */
#define PORTG_PIN0CTRL    _SFR_MEM8 (0x06D0) /* Pin 0 Control Register */
#define PORTG_PIN1CTRL    _SFR_MEM8 (0x06D1) /* Pin 1 Control Register */
#define PORTG_PIN2CTRL    _SFR_MEM8 (0x06D2) /* Pin 2 Control Register */
#define PORTG_PIN3CTRL    _SFR_MEM8 (0x06D3) /* Pin 3 Control Register */
#define PORTG_PIN4CTRL    _SFR_MEM8 (0x06D4) /* Pin 4 Control Register */
#define PORTG_PIN5CTRL    _SFR_MEM8 (0x06D5) /* Pin 5 Control Register */
#define PORTG_PIN6CTRL    _SFR_MEM8 (0x06D6) /* Pin 6 Control Register */
#define PORTG_PIN7CTRL    _SFR_MEM8 (0x06D7) /* Pin 7 Control Register */

/* PORTM - I/O Ports (0x0760) */
#define PORTM_BASE        _SFR_MEM8 (0x0760) /* PORTM Base Address */
#define PORTM_DIR         _SFR_MEM8 (0x0760) /* I/O Port Data Direction */
#define PORTM_DIRSET      _SFR_MEM8 (0x0761) /* I/O Port Data Direction Set */
#define PORTM_DIRCLR      _SFR_MEM8 (0x0762) /* I/O Port Data Direction Clear */
#define PORTM_DIRTGL      _SFR_MEM8 (0x0763) /* I/O Port Data Direction Toggle */
#define PORTM_OUT         _SFR_MEM8 (0x0764) /* I/O Port Output */
#define PORTM_OUTSET      _SFR_MEM8 (0x0765) /* I/O Port Output Set */
#define PORTM_OUTCLR      _SFR_MEM8 (0x0766) /* I/O Port Output Clear */
#define PORTM_OUTTGL      _SFR_MEM8 (0x0767) /* I/O Port Output Toggle */
#define PORTM_IN          _SFR_MEM8 (0x0768) /* I/O port Input */
#define PORTM_INTCTRL     _SFR_MEM8 (0x0769) /* Interrupt Control Register */
#define PORTM_INT0MASK    _SFR_MEM8 (0x076A) /* Port Interrupt 0 Mask */
#define PORTM_INT1MASK    _SFR_MEM8 (0x076B) /* Port Interrupt 1 Mask */
#define PORTM_INTFLAGS    _SFR_MEM8 (0x076C) /* Interrupt Flag Register */
#define PORTM_REMAP       _SFR_MEM8 (0x076E) /* I/O Port Pin Remap Register */
#define PORTM_PIN0CTRL    _SFR_MEM8 (0x0770) /* Pin 0 Control Register */
#define PORTM_PIN1CTRL    _SFR_MEM8 (0x0771) /* Pin 1 Control Register */
#define PORTM_PIN2CTRL    _SFR_MEM8 (0x0772) /* Pin 2 Control Register */
#define PORTM_PIN3CTRL    _SFR_MEM8 (0x0773) /* Pin 3 Control Register */
#define PORTM_PIN4CTRL    _SFR_MEM8 (0x0774) /* Pin 4 Control Register */
#define PORTM_PIN5CTRL    _SFR_MEM8 (0x0775) /* Pin 5 Control Register */
#define PORTM_PIN6CTRL    _SFR_MEM8 (0x0776) /* Pin 6 Control Register */
#define PORTM_PIN7CTRL    _SFR_MEM8 (0x0777) /* Pin 7 Control Register */
...
/* LCD - LCD Controller (0x0D00) */
#define LCD_BASE          _SFR_MEM8 (0x0D00) /* LCD Base Address */
#define LCD_CTRLA         _SFR_MEM8 (0x0D00) /* Control Register A */
#define LCD_CTRLB         _SFR_MEM8 (0x0D01) /* Control Register B */
#define LCD_CTRLC         _SFR_MEM8 (0x0D02) /* Control Register C */
#define LCD_INTCTRL       _SFR_MEM8 (0x0D03) /* Interrupt Enable Register */
#define LCD_INTFLAG       _SFR_MEM8 (0x0D04) /* Interrupt Flag Register */
#define LCD_CTRLD         _SFR_MEM8 (0x0D05) /* Control Register D */
#define LCD_CTRLE         _SFR_MEM8 (0x0D06) /* Control Register E */
#define LCD_CTRLF         _SFR_MEM8 (0x0D07) /* Control Register F */
#define LCD_CTRLG         _SFR_MEM8 (0x0D08) /* Control Register G */
#define LCD_CTRLH         _SFR_MEM8 (0x0D09) /* Control Register H */
#define LCD_DATA0         _SFR_MEM8 (0x0D10) /* LCD Data Register 0 */
#define LCD_DATA1         _SFR_MEM8 (0x0D11) /* LCD Data Register 1 */
#define LCD_DATA2         _SFR_MEM8 (0x0D12) /* LCD Data Register 2 */
#define LCD_DATA3         _SFR_MEM8 (0x0D13) /* LCD Data Register 3 */
#define LCD_DATA4         _SFR_MEM8 (0x0D14) /* LCD Data Register 4 */
#define LCD_DATA5         _SFR_MEM8 (0x0D15) /* LCD Data Register 5 */
#define LCD_DATA6         _SFR_MEM8 (0x0D16) /* LCD Data Register 6 */
#define LCD_DATA7         _SFR_MEM8 (0x0D17) /* LCD Data Register 7 */
#define LCD_DATA8         _SFR_MEM8 (0x0D18) /* LCD Data Register 8 */
#define LCD_DATA9         _SFR_MEM8 (0x0D19) /* LCD Data Register 9 */
#define LCD_DATA10        _SFR_MEM8 (0x0D1A) /* LCD Data Register 10 */
#define LCD_DATA11        _SFR_MEM8 (0x0D1B) /* LCD Data Register 11 */
#define LCD_DATA12        _SFR_MEM8 (0x0D1C) /* LCD Data Register 12 */
#define LCD_DATA13        _SFR_MEM8 (0x0D1D) /* LCD Data Register 13 */
#define LCD_DATA14        _SFR_MEM8 (0x0D1E) /* LCD Data Register 14 */
#define LCD_DATA15        _SFR_MEM8 (0x0D1F) /* LCD Data Register 15 */
#define LCD_DATA16        _SFR_MEM8 (0x0D20) /* LCD Data Register 16 */
#define LCD_DATA17        _SFR_MEM8 (0x0D21) /* LCD Data Register 17 */
#define LCD_DATA18        _SFR_MEM8 (0x0D22) /* LCD Data Register 18 */
#define LCD_DATA19        _SFR_MEM8 (0x0D23) /* LCD Data Register 19 */
...
#define USB_BUSEVENT_vect     _VECTOR(31)         /* USB - BUSEVENT Interrupt */
#define USB_TRNCOMPL_vect_num (32)                
#define USB_TRNCOMPL_vect     _VECTOR(32)         /* USB - TRNCOMPL Interrupt */

/* LCD interrupt vectors */
#define LCD_INT_vect_num      (35)                
#define LCD_INT_vect          _VECTOR(35)         /* LCD - INT Interrupt */

/* AES interrupt vectors */
#define AES_INT_vect_num      (36)                
#define AES_INT_vect          _VECTOR(36)         /* AES - INT Interrupt */

/* NVM interrupt vectors */
#define NVM_EE_vect_num       (37)                
#define NVM_EE_vect           _VECTOR(37)         /* NVM - EE Interrupt */
#define NVM_SPM_vect_num      (38)                
#define NVM_SPM_vect          _VECTOR(38)         /* NVM - SPM Interrupt */

/* PORTB interrupt vectors */
#define PORTB_INT0_vect_num   (39)                
#define PORTB_INT0_vect       _VECTOR(39)         /* PORTB - INT0 Interrupt */
#define PORTB_INT1_vect_num   (40)                
#define PORTB_INT1_vect       _VECTOR(40)         /* PORTB - INT1 Interrupt */

/* ACB interrupt vectors */
#define ACB_AC0_vect_num      (41)                
#define ACB_AC0_vect          _VECTOR(41)         /* ACB - AC0 Interrupt */
#define ACB_AC1_vect_num      (42)                
#define ACB_AC1_vect          _VECTOR(42)         /* ACB - AC1 Interrupt */
#define ACB_ACW_vect_num      (43)                
#define ACB_ACW_vect          _VECTOR(43)         /* ACB - ACW Interrupt */

/* ADCB interrupt vectors */
#define ADCB_CH0_vect_num     (44)                
#define ADCB_CH0_vect         _VECTOR(44)         /* ADCB - CH0 Interrupt */

/* PORTD interrupt vectors */
#define PORTD_INT0_vect_num   (48)                
#define PORTD_INT0_vect       _VECTOR(48)         /* PORTD - INT0 Interrupt */
#define PORTD_INT1_vect_num   (49)                
#define PORTD_INT1_vect       _VECTOR(49)         /* PORTD - INT1 Interrupt */

/* PORTG interrupt vectors */
#define PORTG_INT0_vect_num   (50)                
#define PORTG_INT0_vect       _VECTOR(50)         /* PORTG - INT0 Interrupt */
#define PORTG_INT1_vect_num   (51)                
#define PORTG_INT1_vect       _VECTOR(51)         /* PORTG - INT1 Interrupt */

/* PORTM interrupt vectors */
#define PORTM_INT0_vect_num   (52)                
#define PORTM_INT0_vect       _VECTOR(52)         /* PORTM - INT0 Interrupt */
#define PORTM_INT1_vect_num   (53)                
#define PORTM_INT1_vect       _VECTOR(53)         /* PORTM - INT1 Interrupt */

/* PORTE interrupt vectors */
#define PORTE_INT0_vect_num   (54)                
#define PORTE_INT0_vect       _VECTOR(54)         /* PORTE - INT0 Interrupt */
#define PORTE_INT1_vect_num   (55)                
#define PORTE_INT1_vect       _VECTOR(55)         /* PORTE - INT1 Interrupt */

/* TCE0 interrupt vectors */
#define TCE0_OVF_vect_num     (58)                
#define TCE0_OVF_vect         _VECTOR(58)         /* TCE0 - OVF Interrupt */
#define TCE0_ERR_vect_num     (59)                
#define TCE0_ERR_vect         _VECTOR(59)         /* TCE0 - ERR Interrupt */
#define TCE0_CCA_vect_num     (60)                
#define TCE0_CCA_vect         _VECTOR(60)         /* TCE0 - CCA Interrupt */
#define TCE0_CCB_vect_num     (61)                
#define TCE0_CCB_vect         _VECTOR(61)         /* TCE0 - CCB Interrupt */
#define TCE0_CCC_vect_num     (62)                
#define TCE0_CCC_vect         _VECTOR(62)         /* TCE0 - CCC Interrupt */
#define TCE0_CCD_vect_num     (63)                
#define TCE0_CCD_vect         _VECTOR(63)         /* TCE0 - CCD Interrupt */

/* TCE2 interrupt vectors */
#define TCE2_LUNF_vect_num    (58)                
#define TCE2_LUNF_vect        _VECTOR(58)         /* TCE2 - LUNF Interrupt */
#define TCE2_HUNF_vect_num    (59)                
#define TCE2_HUNF_vect        _VECTOR(59)         /* TCE2 - HUNF Interrupt */
#define TCE2_LCMPA_vect_num   (60)                
#define TCE2_LCMPA_vect       _VECTOR(60)         /* TCE2 - LCMPA Interrupt */
#define TCE2_LCMPB_vect_num   (61)                
#define TCE2_LCMPB_vect       _VECTOR(61)         /* TCE2 - LCMPB Interrupt */
#define TCE2_LCMPC_vect_num   (62)                
#define TCE2_LCMPC_vect       _VECTOR(62)         /* TCE2 - LCMPC Interrupt */
#define TCE2_LCMPD_vect_num   (63)                
#define TCE2_LCMPD_vect       _VECTOR(63)         /* TCE2 - LCMPD Interrupt */

/* USARTE0 interrupt vectors */
#define USARTE0_RXC_vect_num  (69)                
#define USARTE0_RXC_vect      _VECTOR(69)         /* USARTE0 - RXC Interrupt */
#define USARTE0_DRE_vect_num  (70)                
#define USARTE0_DRE_vect      _VECTOR(70)         /* USARTE0 - DRE Interrupt */
#define USARTE0_TXC_vect_num  (71)                
#define USARTE0_TXC_vect      _VECTOR(71)         /* USARTE0 - TXC Interrupt */

/* PORTA interrupt vectors */
#define PORTA_INT0_vect_num   (75)                
#define PORTA_INT0_vect       _VECTOR(75)         /* PORTA - INT0 Interrupt */
#define PORTA_INT1_vect_num   (76)                
#define PORTA_INT1_vect       _VECTOR(76)         /* PORTA - INT1 Interrupt */

/* ACA interrupt vectors */
#define ACA_AC0_vect_num      (77)                
#define ACA_AC0_vect          _VECTOR(77)         /* ACA - AC0 Interrupt */
#define ACA_AC1_vect_num      (78)                
#define ACA_AC1_vect          _VECTOR(78)         /* ACA - AC1 Interrupt */
#define ACA_ACW_vect_num      (79)                
#define ACA_ACW_vect          _VECTOR(79)         /* ACA - ACW Interrupt */

/* ADCA interrupt vectors */
#define ADCA_CH0_vect_num     (80)                
#define ADCA_CH0_vect         _VECTOR(80)         /* ADCA - CH0 Interrupt */

/* Vector Table Size */
#define _VECTOR_SIZE          (4)                 /* Size of individual vector. */
#define _VECTORS_SIZE         (81 * _VECTOR_SIZE) /* Size of all vectors */
/*
================================================================================
Constants
================================================================================
