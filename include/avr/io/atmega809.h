 ...
 *                                                                            * 
 *   .atpack File: ATmega809.atdf                                             * 
 *   .ATDF File:   atdf/ATmega809.atdf                                        * 
 *   Version:      2.0.12                                                     * 
 *   Date:         2019-04-26                                                 * 
 *   Device:       ATmega809                                                  * 
 *   Architecture: AVR8X                                                      * 
...
#  define _AVR_IOXXX_H_ "ioATmega809.h"
#else
...
typedef struct EVSYS_struct
{
    ...
    register8_t rsv_0x18[8];  /* RESERVED REGISTER BLOCK */
...
typedef enum EVSYS_CHANNEL_enum
{
    ...
    EVSYS_CHANNEL_CHANNEL6_gc = (0x07), /* Connect user to event channel 6 */
    EVSYS_CHANNEL_CHANNEL7_gc = (0x08), /* Connect user to event channel 7 */
} EVSYS_CHANNEL_t;
...
typedef enum VREF_AC0REFSEL_enum
{
    ...
    VREF_AC0REFSEL_AVDD_gc = (0x07), /* AVDD as Voltage reference */
} VREF_AC0REFSEL_t;
...
#define EVSYS_CHANNEL_CHANNEL6_gc (0x07) /* Connect user to event channel 6 */
#define EVSYS_CHANNEL_CHANNEL7_gc (0x08) /* Connect user to event channel 7 */
...
/* EVSYS_CHANNEL_CHANNEL6_gc ALREADY DEFINED */
/* EVSYS_CHANNEL_CHANNEL7_gc ALREADY DEFINED */
...
#define VREF_AC0REFSEL_AVDD_gc (0x07) /* AVDD as Voltage reference */
...
#define EVSYS_CHANNEL6       _SFR_MEM8 (0x0196) /* Multiplexer Channel 6 */
#define EVSYS_CHANNEL7       _SFR_MEM8 (0x0197) /* Multiplexer Channel 7 */
...
/* USART3 - Universal Synchronous and Asynchronous Receiver and Transmitter (0x0860) */
#define USART3_BASE          _SFR_MEM8 (0x0860) /* USART3 Base Address */
#define USART3_RXDATAL       _SFR_MEM8 (0x0860) /* Receive Data Low Byte */
#define USART3_RXDATAH       _SFR_MEM8 (0x0861) /* Receive Data High Byte */
#define USART3_TXDATAL       _SFR_MEM8 (0x0862) /* Transmit Data Low Byte */
#define USART3_TXDATAH       _SFR_MEM8 (0x0863) /* Transmit Data High Byte */
#define USART3_STATUS        _SFR_MEM8 (0x0864) /* Status */
#define USART3_CTRLA         _SFR_MEM8 (0x0865) /* Control A */
#define USART3_CTRLB         _SFR_MEM8 (0x0866) /* Control B */
#define USART3_CTRLC         _SFR_MEM8 (0x0867) /* Control C */
#define USART3_BAUD          _SFR_MEM16(0x0868) /* Baud Rate */
#define USART3_BAUDL         _SFR_MEM8 (0x0868) /* Baud Rate LOW BYTE */
#define USART3_BAUDH         _SFR_MEM8 (0x0869) /* Baud Rate HIGH BYTE */
#define USART3_CTRLD         _SFR_MEM8 (0x086A) /* Control D */
#define USART3_DBGCTRL       _SFR_MEM8 (0x086B) /* Debug Control */
#define USART3_EVCTRL        _SFR_MEM8 (0x086C) /* Event Control */
#define USART3_TXPLCTRL      _SFR_MEM8 (0x086D) /* IRCOM Transmitter Pulse Length Control */
#define USART3_RXPLCTRL      _SFR_MEM8 (0x086E) /* IRCOM Receiver Pulse Length Control */
...
/* TCB3 - 16-bit Timer Type B (0x0AB0) */
#define TCB3_BASE            _SFR_MEM8 (0x0AB0) /* TCB3 Base Address */
#define TCB3_CTRLA           _SFR_MEM8 (0x0AB0) /* Control A */
#define TCB3_CTRLB           _SFR_MEM8 (0x0AB1) /* Control Register B */
#define TCB3_EVCTRL          _SFR_MEM8 (0x0AB4) /* Event Control */
#define TCB3_INTCTRL         _SFR_MEM8 (0x0AB5) /* Interrupt Control */
#define TCB3_INTFLAGS        _SFR_MEM8 (0x0AB6) /* Interrupt Flags */
#define TCB3_STATUS          _SFR_MEM8 (0x0AB7) /* Status */
#define TCB3_DBGCTRL         _SFR_MEM8 (0x0AB8) /* Debug Control */
#define TCB3_TEMP            _SFR_MEM8 (0x0AB9) /* Temporary Value */
#define TCB3_CNT             _SFR_MEM16(0x0ABA) /* Count */
#define TCB3_CNTL            _SFR_MEM8 (0x0ABA) /* Count LOW BYTE */
#define TCB3_CNTH            _SFR_MEM8 (0x0ABB) /* Count HIGH BYTE */
#define TCB3_CCMP            _SFR_MEM16(0x0ABC) /* Compare or Capture */
#define TCB3_CCMPL           _SFR_MEM8 (0x0ABC) /* Compare or Capture LOW BYTE */
#define TCB3_CCMPH           _SFR_MEM8 (0x0ABD) /* Compare or Capture HIGH BYTE */
...
#define TCB3_INT_vect        _VECTOR(36)         /* TCB3 - INT Interrupt */

/* USART3 interrupt vectors */
#define USART3_RXC_vect_num  (37)                
#define USART3_RXC_vect      _VECTOR(37)         /* USART3 - RXC Interrupt */
#define USART3_DRE_vect_num  (38)                
#define USART3_DRE_vect      _VECTOR(38)         /* USART3 - DRE Interrupt */
#define USART3_TXC_vect_num  (39)                
#define USART3_TXC_vect      _VECTOR(39)         /* USART3 - TXC Interrupt */

/* Vector Table Size */
#define _VECTOR_SIZE         (2)                 /* Size of individual vector. */
#define _VECTORS_SIZE        (40 * _VECTOR_SIZE) /* Size of all vectors */
/*
================================================================================
Constants
================================================================================
...
#define INTERNAL_SRAM_SIZE        (0x0400)                                           
