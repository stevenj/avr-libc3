 ...
 *                                                                            * 
 *   .atpack File: ATmega48A.atdf                                             * 
 *   .ATDF File:   atdf/ATmega48A.atdf                                        * 
 *   Version:      2.0.12                                                     * 
 *   Date:         2019-04-26                                                 * 
 *   Device:       ATmega48A                                                  * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATmega48A.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_ATmega48A_H_INCLUDED
#  define _AVR_ATmega48A_H_INCLUDED
...
typedef struct EEPROM_struct
{
    ...
    register8_t EEARH;        /* EEPROM Address Register High Byte */
} EEPROM_t;


/* EEPROM Address Register High Byte-EEAR8 */
typedef enum EEPROM_EEAR8_enum
{
    EEPROM_EEAR8_CLEAR_gc = (0x00), /* EEPROM Address Register High Byte-EEAR8 - CLEAR */
    EEPROM_EEAR8_SET_gc   = (0x01), /* EEPROM Address Register High Byte-EEAR8 - SET */
} EEPROM_EEAR8_t;

/* EEPROM Address Register High Byte-EEAR9 */
typedef enum EEPROM_EEAR9_enum
{
    EEPROM_EEAR9_CLEAR_gc = (0x00), /* EEPROM Address Register High Byte-EEAR9 - CLEAR */
    EEPROM_EEAR9_SET_gc   = (0x02), /* EEPROM Address Register High Byte-EEAR9 - SET */
} EEPROM_EEAR9_t;
...
/* EEPROM Address Register High Byte-EEAR8 */
#define EEPROM_EEAR8_CLEAR_gc (0x00) /* EEPROM Address Register High Byte-EEAR8 - CLEAR */
#define EEPROM_EEAR8_SET_gc   (0x01) /* EEPROM Address Register High Byte-EEAR8 - SET */


/* EEPROM Address Register High Byte-EEAR9 */
#define EEPROM_EEAR9_CLEAR_gc (0x00) /* EEPROM Address Register High Byte-EEAR9 - CLEAR */
#define EEPROM_EEAR9_SET_gc   (0x02) /* EEPROM Address Register High Byte-EEAR9 - SET */
...
#define EEPROM_EEARH     _SFR_MEM8 (0x0042) /* EEPROM Address Register High Byte */
...
#endif /* #ifdef _AVR_ATmega48A_H_INCLUDED */
