 ...
 *                                                                            * 
 *   .atpack File: ATmega128A.atdf                                            * 
 *   .ATDF File:   atdf/ATmega128A.atdf                                       * 
 *   Version:      2.0.12                                                     * 
 *   Date:         2019-04-26                                                 * 
 *   Device:       ATmega128A                                                 * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATmega128A.h"
#else
...
#define TC        (*(TC3_t *) 0x0000)       /* Timer/Counter, 16-bit */
/* WARNING: TC ALREADY DEFINED as '(*(TC3_t *) 0x0000)' NOT '(*(TC2_t *) 0x0000)' */
