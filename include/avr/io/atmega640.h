 ...
 *                                                                            * 
 *   .atpack File: ATmega640.atdf                                             * 
 *   .ATDF File:   atdf/ATmega640.atdf                                        * 
 *   Version:      2.0.12                                                     * 
 *   Date:         2019-04-26                                                 * 
 *   Device:       ATmega640                                                  * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATmega640.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_ATmega640_H_INCLUDED
#  define _AVR_ATmega640_H_INCLUDED
...
{
    FUSE_BOOTRST_CLEAR_gc = (0x00), /* Boot Reset vector Enabled (default address=$0000) - CLEAR */
    FUSE_BOOTRST_SET_gc   = (0x01), /* Boot Reset vector Enabled (default address=$0000) - SET */
} FUSE_BOOTRST_t;
...
/* Boot Reset vector Enabled (default address=$0000) */
#define FUSE_BOOTRST_CLEAR_gc (0x00) /* Boot Reset vector Enabled (default address=$0000) - CLEAR */
#define FUSE_BOOTRST_SET_gc   (0x01) /* Boot Reset vector Enabled (default address=$0000) - SET */
...
/* Fuse offset 0x01 */
#define BOOTRST (unsigned char)~_BV(0) /* Boot Reset vector Enabled (default address=$0000) */
...
#endif /* #ifdef _AVR_ATmega640_H_INCLUDED */
