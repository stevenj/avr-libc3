 ...
 *                                                                            * 
 *   .atpack File: ATmega168PB.atdf                                           * 
 *   .ATDF File:   atdf/ATmega168PB.atdf                                      * 
 *   Version:      2.0.12                                                     * 
 *   Date:         2019-04-26                                                 * 
 *   Device:       ATmega168PB                                                * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATmega168PB.h"
#else
...
typedef struct DEVICEID_struct
{
...
/* RX Start Interrupt Enable */
typedef enum USART0_RXSIE_enum
{
    USART0_RXSIE_CLEAR_gc = (0x00), /* RX Start Interrupt Enable - CLEAR */
    USART0_RXSIE_SET_gc   = (0x80), /* RX Start Interrupt Enable - SET */
} USART0_RXSIE_t;

/* RX Start */
typedef enum USART0_RXS_enum
{
    USART0_RXS_CLEAR_gc = (0x00), /* RX Start - CLEAR */
    USART0_RXS_SET_gc   = (0x40), /* RX Start - SET */
} USART0_RXS_t;
...
typedef struct AC_struct
{
    ...
    register8_t ACSRB;        /* Analog Comparator Status Register B */
...
typedef enum EXINT_ISC1_enum
{
    ...
    EXINT_ISC1_VAL_0x01_gc = (0x01<<2), /* Reserved */
...
typedef enum EXINT_ISC0_enum
{
    ...
    EXINT_ISC0_VAL_0x01_gc = (0x01), /* Reserved */
...
#define DEVICEID (*(DEVICEID_t *) 0x0000) /* Device ID */
...
/* RX Start Interrupt Enable */
#define USART0_RXSIE_CLEAR_gc (0x00) /* RX Start Interrupt Enable - CLEAR */
#define USART0_RXSIE_SET_gc   (0x80) /* RX Start Interrupt Enable - SET */


/* RX Start */
#define USART0_RXS_CLEAR_gc (0x00) /* RX Start - CLEAR */
#define USART0_RXS_SET_gc   (0x40) /* RX Start - SET */
...
#define EXINT_ISC1_VAL_0x01_gc (0x01<<2) /* Reserved */
...
#define EXINT_ISC0_VAL_0x01_gc (0x01) /* Reserved */
...
#define AC_ACSRB         _SFR_MEM8 (0x004F) /* Analog Comparator Status Register B */
...
/* DEVICEID - Device ID (0x0000) */
#define DEVICEID_BASE    _SFR_MEM8 (0x0000) /* DEVICEID Base Address */
#define DEVICEID_DEVID0  _SFR_MEM8 (0x00F0) 
#define DEVICEID_DEVID1  _SFR_MEM8 (0x00F1) 
#define DEVICEID_DEVID2  _SFR_MEM8 (0x00F2) 
#define DEVICEID_DEVID3  _SFR_MEM8 (0x00F3) 
#define DEVICEID_DEVID4  _SFR_MEM8 (0x00F4) 
#define DEVICEID_DEVID5  _SFR_MEM8 (0x00F5) 
#define DEVICEID_DEVID6  _SFR_MEM8 (0x00F6) 
#define DEVICEID_DEVID7  _SFR_MEM8 (0x00F7) 
#define DEVICEID_DEVID8  _SFR_MEM8 (0x00F8) 
...
#define None_USART_START_vect_num  (26)                
#define None_USART_START_vect      _VECTOR(26)         /* USART Start Edge Interrupt */
