 ...
 *                                                                            * 
 *   .atpack File: ATmega1284P.atdf                                           * 
 *   .ATDF File:   atdf/ATmega1284P.atdf                                      * 
 *   Version:      2.0.12                                                     * 
 *   Date:         2019-04-26                                                 * 
 *   Device:       ATmega1284P                                                * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATmega1284P.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_ATmega1284P_H_INCLUDED
#  define _AVR_ATmega1284P_H_INCLUDED
...
{
    FUSE_BOOTSZ_512W_FE00_gc  = (0x03<<1), /* Boot Flash size=512 words Boot start address=$FE00 */
    FUSE_BOOTSZ_1024W_FC00_gc = (0x02<<1), /* Boot Flash size=1024 words Boot address=$FC00 */
    FUSE_BOOTSZ_2048W_F800_gc = (0x01<<1), /* Boot Flash size=2048 words Boot address=$F800 */
    FUSE_BOOTSZ_4096W_F000_gc = (0x00<<1), /* Boot Flash size=4096 words Boot address=$F000 */
} FUSE_BOOTSZ_t;
...
/* Select Boot Size */
#define FUSE_BOOTSZ_512W_FE00_gc  (0x03<<1) /* Boot Flash size=512 words Boot start address=$FE00 */
#define FUSE_BOOTSZ_1024W_FC00_gc (0x02<<1) /* Boot Flash size=1024 words Boot address=$FC00 */
#define FUSE_BOOTSZ_2048W_F800_gc (0x01<<1) /* Boot Flash size=2048 words Boot address=$F800 */
#define FUSE_BOOTSZ_4096W_F000_gc (0x00<<1) /* Boot Flash size=4096 words Boot address=$F000 */
...
#endif /* #ifdef _AVR_ATmega1284P_H_INCLUDED */
