 ...
 *                                                                            * 
 *   .atpack File: ATA5790.atdf                                               * 
 *   .ATDF File:   atdf/ATA5790.atdf                                          * 
 *   Version:      2.0.6                                                      * 
 *   Date:         2019-04-16                                                 * 
 *   Device:       ATA5790                                                    * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATA5790.h"
#else
...
#define None_T2COMINT_vect_num (14)                
#define None_T2COMINT_vect     _VECTOR(14)         /* Timer/Counter2 Compare Match Interrupt */
#define None_T2OVFINT_vect_num (15)                
#define None_T2OVFINT_vect     _VECTOR(15)         /* Timer/Counter2 Overflow Interrupt */
#define None_T1INT_vect_num    (16)                
#define None_T1INT_vect        _VECTOR(16)         /* Timer 1 Interval Interrupt */
#define None_SPISTC_vect_num   (17)                
#define None_SPISTC_vect       _VECTOR(17)         /* SPI Serial Transfer Complete Interrupt */
#define None_TMRXBINT_vect_num (18)                
#define None_TMRXBINT_vect     _VECTOR(18)         /* Timer Modulator SSI Receive Buffer Interrupt */
#define None_TMTXBINT_vect_num (19)                
#define None_TMTXBINT_vect     _VECTOR(19)         /* Timer Modulator SSI Transmit Buffer Interrupt */
#define None_TMTXCINT_vect_num (20)                
#define None_TMTXCINT_vect     _VECTOR(20)         /* Timer Modulator Transmit Complete Interrupt */
#define None_AESINT_vect_num   (21)                
#define None_AESINT_vect       _VECTOR(21)         /* AES Interrupt */
#define None_LFRSSINT_vect_num (22)                
#define None_LFRSSINT_vect     _VECTOR(22)         /* LF-Receiver RSSi measurement Interrupt */
#define None_LFSDINT_vect_num  (23)                
#define None_LFSDINT_vect      _VECTOR(23)         /* LF-Receiver Signal Detect Interrupt */
#define None_LFMDINT_vect_num  (24)                
#define None_LFMDINT_vect      _VECTOR(24)         /* LF-Receiver Manchester Decoder error Interrupt  */
#define None_EXCMINT_vect_num  (25)                
#define None_EXCMINT_vect      _VECTOR(25)         /* External Input Clock Monitoring Interrupt */
#define None_EXXMINT_vect_num  (26)                
#define None_EXXMINT_vect      _VECTOR(26)         /* External XTAL Oscillator Break Down Interrupt */
#define None_RTCINT_vect_num   (27)                
#define None_RTCINT_vect       _VECTOR(27)         /* Real Time Clock Interrupt */
#define None_EEREADY_vect_num  (28)                
#define None_EEREADY_vect      _VECTOR(28)         /* EEPROM Ready Interrupt */
#define None_SPMREADY_vect_num (29)                
#define None_SPMREADY_vect     _VECTOR(29)         /* Store Program Memory Ready  */
