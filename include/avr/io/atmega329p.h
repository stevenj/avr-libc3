 ...
 *                                                                            * 
 *   .atpack File: ATmega329P.atdf                                            * 
 *   .ATDF File:   atdf/ATmega329P.atdf                                       * 
 *   Version:      2.0.12                                                     * 
 *   Date:         2019-04-26                                                 * 
 *   Device:       ATmega329P                                                 * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATmega329P.h"
#else
...
/* Pin Change Mask Register pin 8 */
typedef enum EXINT_PCINT8_enum
{
    EXINT_PCINT8_CLEAR_gc = (0x00), /* Pin Change Mask Register pin 8 - CLEAR */
    EXINT_PCINT8_SET_gc   = (0x01), /* Pin Change Mask Register pin 8 - SET */
} EXINT_PCINT8_t;

/* Pin Change Mask Register pin 9 */
typedef enum EXINT_PCINT9_enum
{
    EXINT_PCINT9_CLEAR_gc = (0x00), /* Pin Change Mask Register pin 9 - CLEAR */
    EXINT_PCINT9_SET_gc   = (0x02), /* Pin Change Mask Register pin 9 - SET */
} EXINT_PCINT9_t;

/* Pin Change Mask Register pin 10 */
typedef enum EXINT_PCINT10_enum
{
    EXINT_PCINT10_CLEAR_gc = (0x00), /* Pin Change Mask Register pin 10 - CLEAR */
    EXINT_PCINT10_SET_gc   = (0x04), /* Pin Change Mask Register pin 10 - SET */
} EXINT_PCINT10_t;

/* Pin Change Mask Register pin 11 */
typedef enum EXINT_PCINT11_enum
{
    EXINT_PCINT11_CLEAR_gc = (0x00), /* Pin Change Mask Register pin 11 - CLEAR */
    EXINT_PCINT11_SET_gc   = (0x08), /* Pin Change Mask Register pin 11 - SET */
} EXINT_PCINT11_t;

/* Pin Change Mask Register pin 12 */
typedef enum EXINT_PCINT12_enum
{
    EXINT_PCINT12_CLEAR_gc = (0x00), /* Pin Change Mask Register pin 12 - CLEAR */
    EXINT_PCINT12_SET_gc   = (0x10), /* Pin Change Mask Register pin 12 - SET */
} EXINT_PCINT12_t;

/* Pin Change Mask Register pin 13 */
typedef enum EXINT_PCINT13_enum
{
    EXINT_PCINT13_CLEAR_gc = (0x00), /* Pin Change Mask Register pin 13 - CLEAR */
    EXINT_PCINT13_SET_gc   = (0x20), /* Pin Change Mask Register pin 13 - SET */
} EXINT_PCINT13_t;

/* Pin Change Mask Register pin 14 */
typedef enum EXINT_PCINT14_enum
{
    EXINT_PCINT14_CLEAR_gc = (0x00), /* Pin Change Mask Register pin 14 - CLEAR */
    EXINT_PCINT14_SET_gc   = (0x40), /* Pin Change Mask Register pin 14 - SET */
} EXINT_PCINT14_t;

/* Pin Change Mask Register pin 15 */
typedef enum EXINT_PCINT15_enum
{
    EXINT_PCINT15_CLEAR_gc = (0x00), /* Pin Change Mask Register pin 15 - CLEAR */
    EXINT_PCINT15_SET_gc   = (0x80), /* Pin Change Mask Register pin 15 - SET */
} EXINT_PCINT15_t;

/* Pin Change Mask Register pin 0 */
typedef enum EXINT_PCINT0_enum
{
    EXINT_PCINT0_CLEAR_gc = (0x00), /* Pin Change Mask Register pin 0 - CLEAR */
    EXINT_PCINT0_SET_gc   = (0x01), /* Pin Change Mask Register pin 0 - SET */
} EXINT_PCINT0_t;

/* Pin Change Mask Register pin 1 */
typedef enum EXINT_PCINT1_enum
{
    EXINT_PCINT1_CLEAR_gc = (0x00), /* Pin Change Mask Register pin 1 - CLEAR */
    EXINT_PCINT1_SET_gc   = (0x02), /* Pin Change Mask Register pin 1 - SET */
} EXINT_PCINT1_t;

/* Pin Change Mask Register pin 2 */
typedef enum EXINT_PCINT2_enum
{
    EXINT_PCINT2_CLEAR_gc = (0x00), /* Pin Change Mask Register pin 2 - CLEAR */
    EXINT_PCINT2_SET_gc   = (0x04), /* Pin Change Mask Register pin 2 - SET */
} EXINT_PCINT2_t;

/* Pin Change Mask Register pin 3 */
typedef enum EXINT_PCINT3_enum
{
    EXINT_PCINT3_CLEAR_gc = (0x00), /* Pin Change Mask Register pin 3 - CLEAR */
    EXINT_PCINT3_SET_gc   = (0x08), /* Pin Change Mask Register pin 3 - SET */
} EXINT_PCINT3_t;

/* Pin Change Mask Register pin 4 */
typedef enum EXINT_PCINT4_enum
{
    EXINT_PCINT4_CLEAR_gc = (0x00), /* Pin Change Mask Register pin 4 - CLEAR */
    EXINT_PCINT4_SET_gc   = (0x10), /* Pin Change Mask Register pin 4 - SET */
} EXINT_PCINT4_t;

/* Pin Change Mask Register pin 5 */
typedef enum EXINT_PCINT5_enum
{
    EXINT_PCINT5_CLEAR_gc = (0x00), /* Pin Change Mask Register pin 5 - CLEAR */
    EXINT_PCINT5_SET_gc   = (0x20), /* Pin Change Mask Register pin 5 - SET */
} EXINT_PCINT5_t;

/* Pin Change Mask Register pin 6 */
typedef enum EXINT_PCINT6_enum
{
    EXINT_PCINT6_CLEAR_gc = (0x00), /* Pin Change Mask Register pin 6 - CLEAR */
    EXINT_PCINT6_SET_gc   = (0x40), /* Pin Change Mask Register pin 6 - SET */
} EXINT_PCINT6_t;

/* Pin Change Mask Register pin 7 */
typedef enum EXINT_PCINT7_enum
{
    EXINT_PCINT7_CLEAR_gc = (0x00), /* Pin Change Mask Register pin 7 - CLEAR */
    EXINT_PCINT7_SET_gc   = (0x80), /* Pin Change Mask Register pin 7 - SET */
} EXINT_PCINT7_t;
...
{
    register8_t rsv_0x00[228]; /* RESERVED REGISTER BLOCK */
    register8_t LCDCRA;        /* LCD Control Register A */
    register8_t LCDCRB;        /* LCD Control and Status Register B */
    register8_t LCDFRR;        /* LCD Frame Rate Register */
    register8_t LCDCCR;        /* LCD Contrast Control Register */
    register8_t rsv_0xE8[4];   /* RESERVED REGISTER BLOCK */
    register8_t LCDDR0;        /* LCD Data Register 0 */
    register8_t LCDDR1;        /* LCD Data Register 1 */
    register8_t LCDDR2;        /* LCD Data Register 2 */
    register8_t LCDDR3;        /* LCD Data Register 3 */
    register8_t rsv_0xF0;      /* RESERVED REGISTER */
    register8_t LCDDR5;        /* LCD Data Register 5 */
    register8_t LCDDR6;        /* LCD Data Register 6 */
    register8_t LCDDR7;        /* LCD Data Register 7 */
    register8_t LCDDR8;        /* LCD Data Register 8 */
    register8_t rsv_0xF5;      /* RESERVED REGISTER */
    register8_t LCDDR10;       /* LCD Data Register 10 */
    register8_t LCDDR11;       /* LCD Data Register 11 */
    register8_t LCDDR12;       /* LCD Data Register 12 */
    register8_t LCDDR13;       /* LCD Data Register 13 */
    register8_t rsv_0xFA;      /* RESERVED REGISTER */
    register8_t LCDDR15;       /* LCD Data Register 15 */
    register8_t LCDDR16;       /* LCD Data Register 16 */
    register8_t LCDDR17;       /* LCD Data Register 17 */
    register8_t LCDDR18;       /* LCD Data Register 18 */
} LCD_t;


/* LCD memory bit segment */
typedef enum LCD_SEG324_enum
{
    LCD_SEG324_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG324_SET_gc   = (0x01), /* LCD memory bit segment - SET */
} LCD_SEG324_t;

/* LCD memory bit segment */
typedef enum LCD_SEG325_enum
{
    LCD_SEG325_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG325_SET_gc   = (0x02), /* LCD memory bit segment - SET */
} LCD_SEG325_t;

/* LCD memory bit segment */
typedef enum LCD_SEG326_enum
{
    LCD_SEG326_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG326_SET_gc   = (0x04), /* LCD memory bit segment - SET */
} LCD_SEG326_t;

/* LCD memory bit segment */
typedef enum LCD_SEG327_enum
{
    LCD_SEG327_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG327_SET_gc   = (0x08), /* LCD memory bit segment - SET */
} LCD_SEG327_t;

/* LCD memory bit segment */
typedef enum LCD_SEG328_enum
{
    LCD_SEG328_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG328_SET_gc   = (0x10), /* LCD memory bit segment - SET */
} LCD_SEG328_t;

/* LCD memory bit segment */
typedef enum LCD_SEG329_enum
{
    LCD_SEG329_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG329_SET_gc   = (0x20), /* LCD memory bit segment - SET */
} LCD_SEG329_t;

/* LCD memory bit segment */
typedef enum LCD_SEG330_enum
{
    LCD_SEG330_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG330_SET_gc   = (0x40), /* LCD memory bit segment - SET */
} LCD_SEG330_t;

/* LCD memory bit segment */
typedef enum LCD_SEG331_enum
{
    LCD_SEG331_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG331_SET_gc   = (0x80), /* LCD memory bit segment - SET */
} LCD_SEG331_t;

/* LCD memory bit segment */
typedef enum LCD_SEG316_enum
{
    LCD_SEG316_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG316_SET_gc   = (0x01), /* LCD memory bit segment - SET */
} LCD_SEG316_t;

/* LCD memory bit segment */
typedef enum LCD_SEG317_enum
{
    LCD_SEG317_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG317_SET_gc   = (0x02), /* LCD memory bit segment - SET */
} LCD_SEG317_t;

/* LCD memory bit segment */
typedef enum LCD_SEG318_enum
{
    LCD_SEG318_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG318_SET_gc   = (0x04), /* LCD memory bit segment - SET */
} LCD_SEG318_t;

/* LCD memory bit segment */
typedef enum LCD_SEG319_enum
{
    LCD_SEG319_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG319_SET_gc   = (0x08), /* LCD memory bit segment - SET */
} LCD_SEG319_t;

/* LCD memory bit segment */
typedef enum LCD_SEG320_enum
{
    LCD_SEG320_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG320_SET_gc   = (0x10), /* LCD memory bit segment - SET */
} LCD_SEG320_t;

/* LCD memory bit segment */
typedef enum LCD_SEG321_enum
{
    LCD_SEG321_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG321_SET_gc   = (0x20), /* LCD memory bit segment - SET */
} LCD_SEG321_t;

/* LCD memory bit segment */
typedef enum LCD_SEG322_enum
{
    LCD_SEG322_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG322_SET_gc   = (0x40), /* LCD memory bit segment - SET */
} LCD_SEG322_t;

/* LCD memory bit segment */
typedef enum LCD_SEG323_enum
{
    LCD_SEG323_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG323_SET_gc   = (0x80), /* LCD memory bit segment - SET */
} LCD_SEG323_t;

/* LCD memory bit segment */
typedef enum LCD_SEG308_enum
{
    LCD_SEG308_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG308_SET_gc   = (0x01), /* LCD memory bit segment - SET */
} LCD_SEG308_t;

/* LCD memory bit segment */
typedef enum LCD_SEG309_enum
{
    LCD_SEG309_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG309_SET_gc   = (0x02), /* LCD memory bit segment - SET */
} LCD_SEG309_t;

/* LCD memory bit segment */
typedef enum LCD_SEG310_enum
{
    LCD_SEG310_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG310_SET_gc   = (0x04), /* LCD memory bit segment - SET */
} LCD_SEG310_t;

/* LCD memory bit segment */
typedef enum LCD_SEG311_enum
{
    LCD_SEG311_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG311_SET_gc   = (0x08), /* LCD memory bit segment - SET */
} LCD_SEG311_t;

/* LCD memory bit segment */
typedef enum LCD_SEG312_enum
{
    LCD_SEG312_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG312_SET_gc   = (0x10), /* LCD memory bit segment - SET */
} LCD_SEG312_t;

/* LCD memory bit segment */
typedef enum LCD_SEG313_enum
{
    LCD_SEG313_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG313_SET_gc   = (0x20), /* LCD memory bit segment - SET */
} LCD_SEG313_t;

/* LCD memory bit segment */
typedef enum LCD_SEG314_enum
{
    LCD_SEG314_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG314_SET_gc   = (0x40), /* LCD memory bit segment - SET */
} LCD_SEG314_t;

/* LCD memory bit segment */
typedef enum LCD_SEG315_enum
{
    LCD_SEG315_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG315_SET_gc   = (0x80), /* LCD memory bit segment - SET */
} LCD_SEG315_t;

/* LCD memory bit segment */
typedef enum LCD_SEG300_enum
{
    LCD_SEG300_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG300_SET_gc   = (0x01), /* LCD memory bit segment - SET */
} LCD_SEG300_t;

/* LCD memory bit segment */
typedef enum LCD_SEG301_enum
{
    LCD_SEG301_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG301_SET_gc   = (0x02), /* LCD memory bit segment - SET */
} LCD_SEG301_t;

/* LCD memory bit segment */
typedef enum LCD_SEG302_enum
{
    LCD_SEG302_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG302_SET_gc   = (0x04), /* LCD memory bit segment - SET */
} LCD_SEG302_t;

/* LCD memory bit segment */
typedef enum LCD_SEG303_enum
{
    LCD_SEG303_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG303_SET_gc   = (0x08), /* LCD memory bit segment - SET */
} LCD_SEG303_t;

/* LCD memory bit segment */
typedef enum LCD_SEG304_enum
{
    LCD_SEG304_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG304_SET_gc   = (0x10), /* LCD memory bit segment - SET */
} LCD_SEG304_t;

/* LCD memory bit segment */
typedef enum LCD_SEG305_enum
{
    LCD_SEG305_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG305_SET_gc   = (0x20), /* LCD memory bit segment - SET */
} LCD_SEG305_t;

/* LCD memory bit segment */
typedef enum LCD_SEG306_enum
{
    LCD_SEG306_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG306_SET_gc   = (0x40), /* LCD memory bit segment - SET */
} LCD_SEG306_t;

/* LCD memory bit segment */
typedef enum LCD_SEG307_enum
{
    LCD_SEG307_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG307_SET_gc   = (0x80), /* LCD memory bit segment - SET */
} LCD_SEG307_t;

/* LCD memory bit segment */
typedef enum LCD_SEG224_enum
{
    LCD_SEG224_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG224_SET_gc   = (0x01), /* LCD memory bit segment - SET */
} LCD_SEG224_t;

/* LCD memory bit segment */
typedef enum LCD_SEG225_enum
{
    LCD_SEG225_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG225_SET_gc   = (0x02), /* LCD memory bit segment - SET */
} LCD_SEG225_t;

/* LCD memory bit segment */
typedef enum LCD_SEG226_enum
{
    LCD_SEG226_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG226_SET_gc   = (0x04), /* LCD memory bit segment - SET */
} LCD_SEG226_t;

/* LCD memory bit segment */
typedef enum LCD_SEG227_enum
{
    LCD_SEG227_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG227_SET_gc   = (0x08), /* LCD memory bit segment - SET */
} LCD_SEG227_t;

/* LCD memory bit segment */
typedef enum LCD_SEG228_enum
{
    LCD_SEG228_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG228_SET_gc   = (0x10), /* LCD memory bit segment - SET */
} LCD_SEG228_t;

/* LCD memory bit segment */
typedef enum LCD_SEG229_enum
{
    LCD_SEG229_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG229_SET_gc   = (0x20), /* LCD memory bit segment - SET */
} LCD_SEG229_t;

/* LCD memory bit segment */
typedef enum LCD_SEG230_enum
{
    LCD_SEG230_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG230_SET_gc   = (0x40), /* LCD memory bit segment - SET */
} LCD_SEG230_t;

/* LCD memory bit segment */
typedef enum LCD_SEG231_enum
{
    LCD_SEG231_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG231_SET_gc   = (0x80), /* LCD memory bit segment - SET */
} LCD_SEG231_t;

/* LCD memory bit segment */
typedef enum LCD_SEG216_enum
{
    LCD_SEG216_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG216_SET_gc   = (0x01), /* LCD memory bit segment - SET */
} LCD_SEG216_t;

/* LCD memory bit segment */
typedef enum LCD_SEG217_enum
{
    LCD_SEG217_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG217_SET_gc   = (0x02), /* LCD memory bit segment - SET */
} LCD_SEG217_t;

/* LCD memory bit segment */
typedef enum LCD_SEG218_enum
{
    LCD_SEG218_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG218_SET_gc   = (0x04), /* LCD memory bit segment - SET */
} LCD_SEG218_t;

/* LCD memory bit segment */
typedef enum LCD_SEG219_enum
{
    LCD_SEG219_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG219_SET_gc   = (0x08), /* LCD memory bit segment - SET */
} LCD_SEG219_t;

/* LCD memory bit segment */
typedef enum LCD_SEG220_enum
{
    LCD_SEG220_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG220_SET_gc   = (0x10), /* LCD memory bit segment - SET */
} LCD_SEG220_t;

/* LCD memory bit segment */
typedef enum LCD_SEG221_enum
{
    LCD_SEG221_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG221_SET_gc   = (0x20), /* LCD memory bit segment - SET */
} LCD_SEG221_t;

/* LCD memory bit segment */
typedef enum LCD_SEG222_enum
{
    LCD_SEG222_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG222_SET_gc   = (0x40), /* LCD memory bit segment - SET */
} LCD_SEG222_t;

/* LCD memory bit segment */
typedef enum LCD_SEG223_enum
{
    LCD_SEG223_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG223_SET_gc   = (0x80), /* LCD memory bit segment - SET */
} LCD_SEG223_t;

/* LCD memory bit segment */
typedef enum LCD_SEG208_enum
{
    LCD_SEG208_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG208_SET_gc   = (0x01), /* LCD memory bit segment - SET */
} LCD_SEG208_t;

/* LCD memory bit segment */
typedef enum LCD_SEG209_enum
{
    LCD_SEG209_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG209_SET_gc   = (0x02), /* LCD memory bit segment - SET */
} LCD_SEG209_t;

/* LCD memory bit segment */
typedef enum LCD_SEG210_enum
{
    LCD_SEG210_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG210_SET_gc   = (0x04), /* LCD memory bit segment - SET */
} LCD_SEG210_t;

/* LCD memory bit segment */
typedef enum LCD_SEG211_enum
{
    LCD_SEG211_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG211_SET_gc   = (0x08), /* LCD memory bit segment - SET */
} LCD_SEG211_t;

/* LCD memory bit segment */
typedef enum LCD_SEG212_enum
{
    LCD_SEG212_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG212_SET_gc   = (0x10), /* LCD memory bit segment - SET */
} LCD_SEG212_t;

/* LCD memory bit segment */
typedef enum LCD_SEG213_enum
{
    LCD_SEG213_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG213_SET_gc   = (0x20), /* LCD memory bit segment - SET */
} LCD_SEG213_t;

/* LCD memory bit segment */
typedef enum LCD_SEG214_enum
{
    LCD_SEG214_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG214_SET_gc   = (0x40), /* LCD memory bit segment - SET */
} LCD_SEG214_t;

/* LCD memory bit segment */
typedef enum LCD_SEG215_enum
{
    LCD_SEG215_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG215_SET_gc   = (0x80), /* LCD memory bit segment - SET */
} LCD_SEG215_t;

/* LCD memory bit segment */
typedef enum LCD_SEG200_enum
{
    LCD_SEG200_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG200_SET_gc   = (0x01), /* LCD memory bit segment - SET */
} LCD_SEG200_t;

/* LCD memory bit segment */
typedef enum LCD_SEG201_enum
{
    LCD_SEG201_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG201_SET_gc   = (0x02), /* LCD memory bit segment - SET */
} LCD_SEG201_t;

/* LCD memory bit segment */
typedef enum LCD_SEG202_enum
{
    LCD_SEG202_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG202_SET_gc   = (0x04), /* LCD memory bit segment - SET */
} LCD_SEG202_t;

/* LCD memory bit segment */
typedef enum LCD_SEG203_enum
{
    LCD_SEG203_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG203_SET_gc   = (0x08), /* LCD memory bit segment - SET */
} LCD_SEG203_t;

/* LCD memory bit segment */
typedef enum LCD_SEG204_enum
{
    LCD_SEG204_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG204_SET_gc   = (0x10), /* LCD memory bit segment - SET */
} LCD_SEG204_t;

/* LCD memory bit segment */
typedef enum LCD_SEG205_enum
{
    LCD_SEG205_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG205_SET_gc   = (0x20), /* LCD memory bit segment - SET */
} LCD_SEG205_t;

/* LCD memory bit segment */
typedef enum LCD_SEG206_enum
{
    LCD_SEG206_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG206_SET_gc   = (0x40), /* LCD memory bit segment - SET */
} LCD_SEG206_t;

/* LCD memory bit segment */
typedef enum LCD_SEG207_enum
{
    LCD_SEG207_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG207_SET_gc   = (0x80), /* LCD memory bit segment - SET */
} LCD_SEG207_t;

/* LCD memory bit segment */
typedef enum LCD_SEG124_enum
{
    LCD_SEG124_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG124_SET_gc   = (0x01), /* LCD memory bit segment - SET */
} LCD_SEG124_t;

/* LCD memory bit segment */
typedef enum LCD_SEG125_enum
{
    LCD_SEG125_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG125_SET_gc   = (0x02), /* LCD memory bit segment - SET */
} LCD_SEG125_t;

/* LCD memory bit segment */
typedef enum LCD_SEG126_enum
{
    LCD_SEG126_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG126_SET_gc   = (0x04), /* LCD memory bit segment - SET */
} LCD_SEG126_t;

/* LCD memory bit segment */
typedef enum LCD_SEG127_enum
{
    LCD_SEG127_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG127_SET_gc   = (0x08), /* LCD memory bit segment - SET */
} LCD_SEG127_t;

/* LCD memory bit segment */
typedef enum LCD_SEG128_enum
{
    LCD_SEG128_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG128_SET_gc   = (0x10), /* LCD memory bit segment - SET */
} LCD_SEG128_t;

/* LCD memory bit segment */
typedef enum LCD_SEG129_enum
{
    LCD_SEG129_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG129_SET_gc   = (0x20), /* LCD memory bit segment - SET */
} LCD_SEG129_t;

/* LCD memory bit segment */
typedef enum LCD_SEG130_enum
{
    LCD_SEG130_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG130_SET_gc   = (0x40), /* LCD memory bit segment - SET */
} LCD_SEG130_t;

/* LCD memory bit segment */
typedef enum LCD_SEG131_enum
{
    LCD_SEG131_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG131_SET_gc   = (0x80), /* LCD memory bit segment - SET */
} LCD_SEG131_t;

/* LCD memory bit segment */
typedef enum LCD_SEG116_enum
{
    LCD_SEG116_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG116_SET_gc   = (0x01), /* LCD memory bit segment - SET */
} LCD_SEG116_t;

/* LCD memory bit segment */
typedef enum LCD_SEG117_enum
{
    LCD_SEG117_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG117_SET_gc   = (0x02), /* LCD memory bit segment - SET */
} LCD_SEG117_t;

/* LCD memory bit segment */
typedef enum LCD_SEG118_enum
{
    LCD_SEG118_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG118_SET_gc   = (0x04), /* LCD memory bit segment - SET */
} LCD_SEG118_t;

/* LCD memory bit segment */
typedef enum LCD_SEG119_enum
{
    LCD_SEG119_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG119_SET_gc   = (0x08), /* LCD memory bit segment - SET */
} LCD_SEG119_t;

/* LCD memory bit segment */
typedef enum LCD_SEG120_enum
{
    LCD_SEG120_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG120_SET_gc   = (0x10), /* LCD memory bit segment - SET */
} LCD_SEG120_t;

/* LCD memory bit segment */
typedef enum LCD_SEG121_enum
{
    LCD_SEG121_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG121_SET_gc   = (0x20), /* LCD memory bit segment - SET */
} LCD_SEG121_t;

/* LCD memory bit segment */
typedef enum LCD_SEG122_enum
{
    LCD_SEG122_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG122_SET_gc   = (0x40), /* LCD memory bit segment - SET */
} LCD_SEG122_t;

/* LCD memory bit segment */
typedef enum LCD_SEG123_enum
{
    LCD_SEG123_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG123_SET_gc   = (0x80), /* LCD memory bit segment - SET */
} LCD_SEG123_t;

/* LCD memory bit segment */
typedef enum LCD_SEG108_enum
{
    LCD_SEG108_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG108_SET_gc   = (0x01), /* LCD memory bit segment - SET */
} LCD_SEG108_t;

/* LCD memory bit segment */
typedef enum LCD_SEG109_enum
{
    LCD_SEG109_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG109_SET_gc   = (0x02), /* LCD memory bit segment - SET */
} LCD_SEG109_t;

/* LCD memory bit segment */
typedef enum LCD_SEG110_enum
{
    LCD_SEG110_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG110_SET_gc   = (0x04), /* LCD memory bit segment - SET */
} LCD_SEG110_t;

/* LCD memory bit segment */
typedef enum LCD_SEG111_enum
{
    LCD_SEG111_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG111_SET_gc   = (0x08), /* LCD memory bit segment - SET */
} LCD_SEG111_t;

/* LCD memory bit segment */
typedef enum LCD_SEG112_enum
{
    LCD_SEG112_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG112_SET_gc   = (0x10), /* LCD memory bit segment - SET */
} LCD_SEG112_t;

/* LCD memory bit segment */
typedef enum LCD_SEG113_enum
{
    LCD_SEG113_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG113_SET_gc   = (0x20), /* LCD memory bit segment - SET */
} LCD_SEG113_t;

/* LCD memory bit segment */
typedef enum LCD_SEG114_enum
{
    LCD_SEG114_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG114_SET_gc   = (0x40), /* LCD memory bit segment - SET */
} LCD_SEG114_t;

/* LCD memory bit segment */
typedef enum LCD_SEG115_enum
{
    LCD_SEG115_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG115_SET_gc   = (0x80), /* LCD memory bit segment - SET */
} LCD_SEG115_t;

/* LCD memory bit segment */
typedef enum LCD_SEG100_enum
{
    LCD_SEG100_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG100_SET_gc   = (0x01), /* LCD memory bit segment - SET */
} LCD_SEG100_t;

/* LCD memory bit segment */
typedef enum LCD_SEG101_enum
{
    LCD_SEG101_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG101_SET_gc   = (0x02), /* LCD memory bit segment - SET */
} LCD_SEG101_t;

/* LCD memory bit segment */
typedef enum LCD_SEG102_enum
{
    LCD_SEG102_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG102_SET_gc   = (0x04), /* LCD memory bit segment - SET */
} LCD_SEG102_t;

/* LCD memory bit segment */
typedef enum LCD_SEG103_enum
{
    LCD_SEG103_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG103_SET_gc   = (0x08), /* LCD memory bit segment - SET */
} LCD_SEG103_t;

/* LCD memory bit segment */
typedef enum LCD_SEG104_enum
{
    LCD_SEG104_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG104_SET_gc   = (0x10), /* LCD memory bit segment - SET */
} LCD_SEG104_t;

/* LCD memory bit segment */
typedef enum LCD_SEG105_enum
{
    LCD_SEG105_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG105_SET_gc   = (0x20), /* LCD memory bit segment - SET */
} LCD_SEG105_t;

/* LCD memory bit segment */
typedef enum LCD_SEG106_enum
{
    LCD_SEG106_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG106_SET_gc   = (0x40), /* LCD memory bit segment - SET */
} LCD_SEG106_t;

/* LCD memory bit segment */
typedef enum LCD_SEG107_enum
{
    LCD_SEG107_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG107_SET_gc   = (0x80), /* LCD memory bit segment - SET */
} LCD_SEG107_t;

/* LCD memory bit segment */
typedef enum LCD_SEG024_enum
{
    LCD_SEG024_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG024_SET_gc   = (0x01), /* LCD memory bit segment - SET */
} LCD_SEG024_t;

/* LCD memory bit segment */
typedef enum LCD_SEG025_enum
{
    LCD_SEG025_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG025_SET_gc   = (0x02), /* LCD memory bit segment - SET */
} LCD_SEG025_t;

/* LCD memory bit segment */
typedef enum LCD_SEG026_enum
{
    LCD_SEG026_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG026_SET_gc   = (0x04), /* LCD memory bit segment - SET */
} LCD_SEG026_t;

/* LCD memory bit segment */
typedef enum LCD_SEG027_enum
{
    LCD_SEG027_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG027_SET_gc   = (0x08), /* LCD memory bit segment - SET */
} LCD_SEG027_t;

/* LCD memory bit segment */
typedef enum LCD_SEG028_enum
{
    LCD_SEG028_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG028_SET_gc   = (0x10), /* LCD memory bit segment - SET */
} LCD_SEG028_t;

/* LCD memory bit segment */
typedef enum LCD_SEG029_enum
{
    LCD_SEG029_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG029_SET_gc   = (0x20), /* LCD memory bit segment - SET */
} LCD_SEG029_t;

/* LCD memory bit segment */
typedef enum LCD_SEG030_enum
{
    LCD_SEG030_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG030_SET_gc   = (0x40), /* LCD memory bit segment - SET */
} LCD_SEG030_t;

/* LCD memory bit segment */
typedef enum LCD_SEG031_enum
{
    LCD_SEG031_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG031_SET_gc   = (0x80), /* LCD memory bit segment - SET */
} LCD_SEG031_t;

/* LCD memory bit segment */
typedef enum LCD_SEG016_enum
{
    LCD_SEG016_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG016_SET_gc   = (0x01), /* LCD memory bit segment - SET */
} LCD_SEG016_t;

/* LCD memory bit segment */
typedef enum LCD_SEG017_enum
{
    LCD_SEG017_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG017_SET_gc   = (0x02), /* LCD memory bit segment - SET */
} LCD_SEG017_t;

/* LCD memory bit segment */
typedef enum LCD_SEG018_enum
{
    LCD_SEG018_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG018_SET_gc   = (0x04), /* LCD memory bit segment - SET */
} LCD_SEG018_t;

/* LCD memory bit segment */
typedef enum LCD_SEG019_enum
{
    LCD_SEG019_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG019_SET_gc   = (0x08), /* LCD memory bit segment - SET */
} LCD_SEG019_t;

/* LCD memory bit segment */
typedef enum LCD_SEG020_enum
{
    LCD_SEG020_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG020_SET_gc   = (0x10), /* LCD memory bit segment - SET */
} LCD_SEG020_t;

/* LCD memory bit segment */
typedef enum LCD_SEG021_enum
{
    LCD_SEG021_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG021_SET_gc   = (0x20), /* LCD memory bit segment - SET */
} LCD_SEG021_t;

/* LCD memory bit segment */
typedef enum LCD_SEG022_enum
{
    LCD_SEG022_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG022_SET_gc   = (0x40), /* LCD memory bit segment - SET */
} LCD_SEG022_t;

/* LCD memory bit segment */
typedef enum LCD_SEG023_enum
{
    LCD_SEG023_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG023_SET_gc   = (0x80), /* LCD memory bit segment - SET */
} LCD_SEG023_t;

/* LCD memory bit segment */
typedef enum LCD_SEG008_enum
{
    LCD_SEG008_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG008_SET_gc   = (0x01), /* LCD memory bit segment - SET */
} LCD_SEG008_t;

/* LCD memory bit segment */
typedef enum LCD_SEG009_enum
{
    LCD_SEG009_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG009_SET_gc   = (0x02), /* LCD memory bit segment - SET */
} LCD_SEG009_t;

/* LCD memory bit segment */
typedef enum LCD_SEG010_enum
{
    LCD_SEG010_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG010_SET_gc   = (0x04), /* LCD memory bit segment - SET */
} LCD_SEG010_t;

/* LCD memory bit segment */
typedef enum LCD_SEG011_enum
{
    LCD_SEG011_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG011_SET_gc   = (0x08), /* LCD memory bit segment - SET */
} LCD_SEG011_t;

/* LCD memory bit segment */
typedef enum LCD_SEG012_enum
{
    LCD_SEG012_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG012_SET_gc   = (0x10), /* LCD memory bit segment - SET */
} LCD_SEG012_t;

/* LCD memory bit segment */
typedef enum LCD_SEG013_enum
{
    LCD_SEG013_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG013_SET_gc   = (0x20), /* LCD memory bit segment - SET */
} LCD_SEG013_t;

/* LCD memory bit segment */
typedef enum LCD_SEG014_enum
{
    LCD_SEG014_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG014_SET_gc   = (0x40), /* LCD memory bit segment - SET */
} LCD_SEG014_t;

/* LCD memory bit segment */
typedef enum LCD_SEG015_enum
{
    LCD_SEG015_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG015_SET_gc   = (0x80), /* LCD memory bit segment - SET */
} LCD_SEG015_t;

/* LCD memory bit segment */
typedef enum LCD_SEG000_enum
{
    LCD_SEG000_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG000_SET_gc   = (0x01), /* LCD memory bit segment - SET */
} LCD_SEG000_t;

/* LCD memory bit segment */
typedef enum LCD_SEG001_enum
{
    LCD_SEG001_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG001_SET_gc   = (0x02), /* LCD memory bit segment - SET */
} LCD_SEG001_t;

/* LCD memory bit segment */
typedef enum LCD_SEG002_enum
{
    LCD_SEG002_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG002_SET_gc   = (0x04), /* LCD memory bit segment - SET */
} LCD_SEG002_t;

/* LCD memory bit segment */
typedef enum LCD_SEG003_enum
{
    LCD_SEG003_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG003_SET_gc   = (0x08), /* LCD memory bit segment - SET */
} LCD_SEG003_t;

/* LCD memory bit segment */
typedef enum LCD_SEG004_enum
{
    LCD_SEG004_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG004_SET_gc   = (0x10), /* LCD memory bit segment - SET */
} LCD_SEG004_t;

/* LCD memory bit segment */
typedef enum LCD_SEG005_enum
{
    LCD_SEG005_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG005_SET_gc   = (0x20), /* LCD memory bit segment - SET */
} LCD_SEG005_t;

/* LCD memory bit segment */
typedef enum LCD_SEG006_enum
{
    LCD_SEG006_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG006_SET_gc   = (0x40), /* LCD memory bit segment - SET */
} LCD_SEG006_t;

/* LCD memory bit segment */
typedef enum LCD_SEG007_enum
{
    LCD_SEG007_CLEAR_gc = (0x00), /* LCD memory bit segment - CLEAR */
    LCD_SEG007_SET_gc   = (0x80), /* LCD memory bit segment - SET */
} LCD_SEG007_t;

/* LCD Contrast Control Register-LCDDC */
typedef enum LCD_LCDDC_enum
{
    LCD_LCDDC_VAL_0x00_gc = (0x00<<5), /* 300us */
    LCD_LCDDC_VAL_0x01_gc = (0x01<<5), /* 70us */
    LCD_LCDDC_VAL_0x02_gc = (0x02<<5), /* 150us */
    LCD_LCDDC_VAL_0x03_gc = (0x03<<5), /* 450us */
    LCD_LCDDC_VAL_0x04_gc = (0x04<<5), /* 575us */
    LCD_LCDDC_VAL_0x05_gc = (0x05<<5), /* 850us */
    LCD_LCDDC_VAL_0x06_gc = (0x06<<5), /* 1150us */
    LCD_LCDDC_VAL_0x07_gc = (0x07<<5), /* 50% of LCD clock */
} LCD_LCDDC_t;

/* LCD Maximum Drive Time */
typedef enum LCD_LCDMDT_enum
{
    LCD_LCDMDT_CLEAR_gc = (0x00), /* LCD Maximum Drive Time - CLEAR */
    LCD_LCDMDT_SET_gc   = (0x10), /* LCD Maximum Drive Time - SET */
} LCD_LCDMDT_t;

/* LCD Contrast Controls */
typedef enum LCD_LCDCC_enum
{
    LCD_LCDCC_VAL_0x00_gc = (0x00), /* 2.60V */
    LCD_LCDCC_VAL_0x01_gc = (0x01), /* 2.65V */
    LCD_LCDCC_VAL_0x02_gc = (0x02), /* 2.70V */
    LCD_LCDCC_VAL_0x03_gc = (0x03), /* 2.75V */
    LCD_LCDCC_VAL_0x04_gc = (0x04), /* 2.80V */
    LCD_LCDCC_VAL_0x05_gc = (0x05), /* 2.85V */
    LCD_LCDCC_VAL_0x06_gc = (0x06), /* 2.90V */
    LCD_LCDCC_VAL_0x07_gc = (0x07), /* 2.95V */
    LCD_LCDCC_VAL_0x08_gc = (0x08), /* 3.00V */
    LCD_LCDCC_VAL_0x09_gc = (0x09), /* 3.05V */
    LCD_LCDCC_VAL_0x0A_gc = (0x0A), /* 3.10V */
    LCD_LCDCC_VAL_0x0B_gc = (0x0B), /* 3.15V */
    LCD_LCDCC_VAL_0x0C_gc = (0x0C), /* 3.20V */
    LCD_LCDCC_VAL_0x0D_gc = (0x0D), /* 3.25V */
    LCD_LCDCC_VAL_0x0E_gc = (0x0E), /* 3.30V */
    LCD_LCDCC_VAL_0x0F_gc = (0x0F), /* 3.35V */
} LCD_LCDCC_t;

/* LCD Prescaler Selects */
typedef enum LCD_LCDPS_enum
{
    LCD_LCDPS_VAL_0x00_gc = (0x00<<4), /* ClkLCD/16 */
    LCD_LCDPS_VAL_0x01_gc = (0x01<<4), /* ClkLCD/64 */
    LCD_LCDPS_VAL_0x02_gc = (0x02<<4), /* ClkLCD/128 */
    LCD_LCDPS_VAL_0x03_gc = (0x03<<4), /* ClkLCD/256 */
    LCD_LCDPS_VAL_0x04_gc = (0x04<<4), /* ClkLCD/512 */
    LCD_LCDPS_VAL_0x05_gc = (0x05<<4), /* ClkLCD/1024 */
    LCD_LCDPS_VAL_0x06_gc = (0x06<<4), /* ClkLCD/2048 */
    LCD_LCDPS_VAL_0x07_gc = (0x07<<4), /* ClkLCD/4096 */
} LCD_LCDPS_t;

/* LCD Clock Dividers */
typedef enum LCD_LCDCD_enum
{
    LCD_LCDCD_VAL_0x00_gc = (0x00), /* 1 */
    LCD_LCDCD_VAL_0x01_gc = (0x01), /* 2 */
    LCD_LCDCD_VAL_0x02_gc = (0x02), /* 3 */
    LCD_LCDCD_VAL_0x03_gc = (0x03), /* 4 */
    LCD_LCDCD_VAL_0x04_gc = (0x04), /* 5 */
    LCD_LCDCD_VAL_0x05_gc = (0x05), /* 6 */
    LCD_LCDCD_VAL_0x06_gc = (0x06), /* 7 */
    LCD_LCDCD_VAL_0x07_gc = (0x07), /* 8 */
} LCD_LCDCD_t;

/* LCD CLock Select */
typedef enum LCD_LCDCS_enum
{
    LCD_LCDCS_CLEAR_gc = (0x00), /* LCD CLock Select - CLEAR */
    LCD_LCDCS_SET_gc   = (0x80), /* LCD CLock Select - SET */
} LCD_LCDCS_t;

/* LCD 1/2 Bias Select */
typedef enum LCD_LCD2B_enum
{
    LCD_LCD2B_CLEAR_gc = (0x00), /* LCD 1/2 Bias Select - CLEAR */
    LCD_LCD2B_SET_gc   = (0x40), /* LCD 1/2 Bias Select - SET */
} LCD_LCD2B_t;

/* LCD Mux Selects */
#define LCD_LCDCRB_LCDMUX_gc(x) ((x<<4) & 0x30)

/* LCD Port Masks */
typedef enum LCD_LCDPM_enum
{
    LCD_LCDPM_VAL_0x00_gc = (0x00), /* SEG0:12 */
    LCD_LCDPM_VAL_0x01_gc = (0x01), /* SEG0:14 */
    LCD_LCDPM_VAL_0x02_gc = (0x02), /* SEG0:15 */
    LCD_LCDPM_VAL_0x03_gc = (0x03), /* SEG0:18 */
    LCD_LCDPM_VAL_0x04_gc = (0x04), /* SEG0:20 */
    LCD_LCDPM_VAL_0x05_gc = (0x05), /* SEG0:22 */
    LCD_LCDPM_VAL_0x06_gc = (0x06), /* SEG0:23 */
    LCD_LCDPM_VAL_0x07_gc = (0x07), /* SEG0:24 */
    LCD_LCDPM_VAL_0x08_gc = (0x08), /* SEG0:26 */
    LCD_LCDPM_VAL_0x09_gc = (0x09), /* SEG0:28 */
    LCD_LCDPM_VAL_0x0A_gc = (0x0A), /* SEG0:30 */
    LCD_LCDPM_VAL_0x0B_gc = (0x0B), /* SEG0:32 */
    LCD_LCDPM_VAL_0x0C_gc = (0x0C), /* SEG0:34 */
    LCD_LCDPM_VAL_0x0D_gc = (0x0D), /* SEG0:36 */
    LCD_LCDPM_VAL_0x0E_gc = (0x0E), /* SEG0:38 */
    LCD_LCDPM_VAL_0x0F_gc = (0x0F), /* SEG0:39 */
} LCD_LCDPM_t;

/* LCD Enable */
typedef enum LCD_LCDEN_enum
{
    LCD_LCDEN_CLEAR_gc = (0x00), /* LCD Enable - CLEAR */
    LCD_LCDEN_SET_gc   = (0x80), /* LCD Enable - SET */
} LCD_LCDEN_t;

/* LCD A or B waveform */
typedef enum LCD_LCDAB_enum
{
    LCD_LCDAB_CLEAR_gc = (0x00), /* LCD A or B waveform - CLEAR */
    LCD_LCDAB_SET_gc   = (0x40), /* LCD A or B waveform - SET */
} LCD_LCDAB_t;

/* LCD Interrupt Flag */
typedef enum LCD_LCDIF_enum
{
    LCD_LCDIF_CLEAR_gc = (0x00), /* LCD Interrupt Flag - CLEAR */
    LCD_LCDIF_SET_gc   = (0x10), /* LCD Interrupt Flag - SET */
} LCD_LCDIF_t;

/* LCD Interrupt Enable */
typedef enum LCD_LCDIE_enum
{
    LCD_LCDIE_CLEAR_gc = (0x00), /* LCD Interrupt Enable - CLEAR */
    LCD_LCDIE_SET_gc   = (0x08), /* LCD Interrupt Enable - SET */
} LCD_LCDIE_t;

/* LCD Buffer Disable */
typedef enum LCD_LCDBD_enum
{
    LCD_LCDBD_CLEAR_gc = (0x00), /* LCD Buffer Disable - CLEAR */
    LCD_LCDBD_SET_gc   = (0x04), /* LCD Buffer Disable - SET */
} LCD_LCDBD_t;

/* LCD Contrast Control Disable */
typedef enum LCD_LCDCCD_enum
{
    LCD_LCDCCD_CLEAR_gc = (0x00), /* LCD Contrast Control Disable - CLEAR */
    LCD_LCDCCD_SET_gc   = (0x02), /* LCD Contrast Control Disable - SET */
} LCD_LCDCCD_t;

/* LCD Blanking */
typedef enum LCD_LCDBL_enum
{
    LCD_LCDBL_CLEAR_gc = (0x00), /* LCD Blanking - CLEAR */
    LCD_LCDBL_SET_gc   = (0x01), /* LCD Blanking - SET */
} LCD_LCDBL_t;
...
#define LCD       (*(LCD_t *) 0x0000)       /* Liquid Crystal Display */
...
/* Pin Change Mask Register pin 8 */
#define EXINT_PCINT8_CLEAR_gc (0x00) /* Pin Change Mask Register pin 8 - CLEAR */
#define EXINT_PCINT8_SET_gc   (0x01) /* Pin Change Mask Register pin 8 - SET */


/* Pin Change Mask Register pin 9 */
#define EXINT_PCINT9_CLEAR_gc (0x00) /* Pin Change Mask Register pin 9 - CLEAR */
#define EXINT_PCINT9_SET_gc   (0x02) /* Pin Change Mask Register pin 9 - SET */


/* Pin Change Mask Register pin 10 */
#define EXINT_PCINT10_CLEAR_gc (0x00) /* Pin Change Mask Register pin 10 - CLEAR */
#define EXINT_PCINT10_SET_gc   (0x04) /* Pin Change Mask Register pin 10 - SET */


/* Pin Change Mask Register pin 11 */
#define EXINT_PCINT11_CLEAR_gc (0x00) /* Pin Change Mask Register pin 11 - CLEAR */
#define EXINT_PCINT11_SET_gc   (0x08) /* Pin Change Mask Register pin 11 - SET */


/* Pin Change Mask Register pin 12 */
#define EXINT_PCINT12_CLEAR_gc (0x00) /* Pin Change Mask Register pin 12 - CLEAR */
#define EXINT_PCINT12_SET_gc   (0x10) /* Pin Change Mask Register pin 12 - SET */


/* Pin Change Mask Register pin 13 */
#define EXINT_PCINT13_CLEAR_gc (0x00) /* Pin Change Mask Register pin 13 - CLEAR */
#define EXINT_PCINT13_SET_gc   (0x20) /* Pin Change Mask Register pin 13 - SET */


/* Pin Change Mask Register pin 14 */
#define EXINT_PCINT14_CLEAR_gc (0x00) /* Pin Change Mask Register pin 14 - CLEAR */
#define EXINT_PCINT14_SET_gc   (0x40) /* Pin Change Mask Register pin 14 - SET */


/* Pin Change Mask Register pin 15 */
#define EXINT_PCINT15_CLEAR_gc (0x00) /* Pin Change Mask Register pin 15 - CLEAR */
#define EXINT_PCINT15_SET_gc   (0x80) /* Pin Change Mask Register pin 15 - SET */


/* Pin Change Mask Register pin 0 */
#define EXINT_PCINT0_CLEAR_gc (0x00) /* Pin Change Mask Register pin 0 - CLEAR */
#define EXINT_PCINT0_SET_gc   (0x01) /* Pin Change Mask Register pin 0 - SET */


/* Pin Change Mask Register pin 1 */
#define EXINT_PCINT1_CLEAR_gc (0x00) /* Pin Change Mask Register pin 1 - CLEAR */
#define EXINT_PCINT1_SET_gc   (0x02) /* Pin Change Mask Register pin 1 - SET */


/* Pin Change Mask Register pin 2 */
#define EXINT_PCINT2_CLEAR_gc (0x00) /* Pin Change Mask Register pin 2 - CLEAR */
#define EXINT_PCINT2_SET_gc   (0x04) /* Pin Change Mask Register pin 2 - SET */


/* Pin Change Mask Register pin 3 */
#define EXINT_PCINT3_CLEAR_gc (0x00) /* Pin Change Mask Register pin 3 - CLEAR */
#define EXINT_PCINT3_SET_gc   (0x08) /* Pin Change Mask Register pin 3 - SET */


/* Pin Change Mask Register pin 4 */
#define EXINT_PCINT4_CLEAR_gc (0x00) /* Pin Change Mask Register pin 4 - CLEAR */
#define EXINT_PCINT4_SET_gc   (0x10) /* Pin Change Mask Register pin 4 - SET */


/* Pin Change Mask Register pin 5 */
#define EXINT_PCINT5_CLEAR_gc (0x00) /* Pin Change Mask Register pin 5 - CLEAR */
#define EXINT_PCINT5_SET_gc   (0x20) /* Pin Change Mask Register pin 5 - SET */


/* Pin Change Mask Register pin 6 */
#define EXINT_PCINT6_CLEAR_gc (0x00) /* Pin Change Mask Register pin 6 - CLEAR */
#define EXINT_PCINT6_SET_gc   (0x40) /* Pin Change Mask Register pin 6 - SET */


/* Pin Change Mask Register pin 7 */
#define EXINT_PCINT7_CLEAR_gc (0x00) /* Pin Change Mask Register pin 7 - CLEAR */
#define EXINT_PCINT7_SET_gc   (0x80) /* Pin Change Mask Register pin 7 - SET */
...
/* LCD memory bit segment */
#define LCD_SEG324_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG324_SET_gc   (0x01) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG325_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG325_SET_gc   (0x02) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG326_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG326_SET_gc   (0x04) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG327_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG327_SET_gc   (0x08) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG328_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG328_SET_gc   (0x10) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG329_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG329_SET_gc   (0x20) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG330_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG330_SET_gc   (0x40) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG331_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG331_SET_gc   (0x80) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG316_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG316_SET_gc   (0x01) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG317_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG317_SET_gc   (0x02) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG318_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG318_SET_gc   (0x04) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG319_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG319_SET_gc   (0x08) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG320_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG320_SET_gc   (0x10) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG321_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG321_SET_gc   (0x20) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG322_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG322_SET_gc   (0x40) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG323_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG323_SET_gc   (0x80) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG308_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG308_SET_gc   (0x01) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG309_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG309_SET_gc   (0x02) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG310_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG310_SET_gc   (0x04) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG311_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG311_SET_gc   (0x08) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG312_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG312_SET_gc   (0x10) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG313_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG313_SET_gc   (0x20) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG314_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG314_SET_gc   (0x40) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG315_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG315_SET_gc   (0x80) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG300_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG300_SET_gc   (0x01) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG301_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG301_SET_gc   (0x02) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG302_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG302_SET_gc   (0x04) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG303_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG303_SET_gc   (0x08) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG304_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG304_SET_gc   (0x10) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG305_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG305_SET_gc   (0x20) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG306_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG306_SET_gc   (0x40) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG307_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG307_SET_gc   (0x80) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG224_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG224_SET_gc   (0x01) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG225_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG225_SET_gc   (0x02) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG226_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG226_SET_gc   (0x04) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG227_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG227_SET_gc   (0x08) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG228_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG228_SET_gc   (0x10) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG229_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG229_SET_gc   (0x20) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG230_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG230_SET_gc   (0x40) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG231_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG231_SET_gc   (0x80) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG216_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG216_SET_gc   (0x01) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG217_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG217_SET_gc   (0x02) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG218_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG218_SET_gc   (0x04) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG219_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG219_SET_gc   (0x08) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG220_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG220_SET_gc   (0x10) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG221_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG221_SET_gc   (0x20) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG222_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG222_SET_gc   (0x40) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG223_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG223_SET_gc   (0x80) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG208_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG208_SET_gc   (0x01) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG209_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG209_SET_gc   (0x02) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG210_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG210_SET_gc   (0x04) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG211_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG211_SET_gc   (0x08) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG212_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG212_SET_gc   (0x10) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG213_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG213_SET_gc   (0x20) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG214_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG214_SET_gc   (0x40) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG215_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG215_SET_gc   (0x80) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG200_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG200_SET_gc   (0x01) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG201_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG201_SET_gc   (0x02) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG202_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG202_SET_gc   (0x04) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG203_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG203_SET_gc   (0x08) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG204_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG204_SET_gc   (0x10) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG205_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG205_SET_gc   (0x20) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG206_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG206_SET_gc   (0x40) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG207_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG207_SET_gc   (0x80) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG124_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG124_SET_gc   (0x01) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG125_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG125_SET_gc   (0x02) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG126_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG126_SET_gc   (0x04) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG127_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG127_SET_gc   (0x08) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG128_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG128_SET_gc   (0x10) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG129_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG129_SET_gc   (0x20) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG130_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG130_SET_gc   (0x40) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG131_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG131_SET_gc   (0x80) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG116_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG116_SET_gc   (0x01) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG117_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG117_SET_gc   (0x02) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG118_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG118_SET_gc   (0x04) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG119_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG119_SET_gc   (0x08) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG120_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG120_SET_gc   (0x10) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG121_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG121_SET_gc   (0x20) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG122_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG122_SET_gc   (0x40) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG123_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG123_SET_gc   (0x80) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG108_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG108_SET_gc   (0x01) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG109_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG109_SET_gc   (0x02) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG110_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG110_SET_gc   (0x04) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG111_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG111_SET_gc   (0x08) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG112_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG112_SET_gc   (0x10) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG113_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG113_SET_gc   (0x20) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG114_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG114_SET_gc   (0x40) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG115_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG115_SET_gc   (0x80) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG100_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG100_SET_gc   (0x01) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG101_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG101_SET_gc   (0x02) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG102_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG102_SET_gc   (0x04) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG103_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG103_SET_gc   (0x08) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG104_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG104_SET_gc   (0x10) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG105_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG105_SET_gc   (0x20) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG106_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG106_SET_gc   (0x40) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG107_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG107_SET_gc   (0x80) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG024_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG024_SET_gc   (0x01) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG025_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG025_SET_gc   (0x02) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG026_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG026_SET_gc   (0x04) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG027_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG027_SET_gc   (0x08) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG028_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG028_SET_gc   (0x10) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG029_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG029_SET_gc   (0x20) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG030_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG030_SET_gc   (0x40) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG031_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG031_SET_gc   (0x80) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG016_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG016_SET_gc   (0x01) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG017_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG017_SET_gc   (0x02) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG018_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG018_SET_gc   (0x04) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG019_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG019_SET_gc   (0x08) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG020_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG020_SET_gc   (0x10) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG021_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG021_SET_gc   (0x20) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG022_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG022_SET_gc   (0x40) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG023_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG023_SET_gc   (0x80) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG008_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG008_SET_gc   (0x01) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG009_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG009_SET_gc   (0x02) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG010_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG010_SET_gc   (0x04) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG011_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG011_SET_gc   (0x08) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG012_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG012_SET_gc   (0x10) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG013_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG013_SET_gc   (0x20) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG014_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG014_SET_gc   (0x40) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG015_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG015_SET_gc   (0x80) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG000_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG000_SET_gc   (0x01) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG001_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG001_SET_gc   (0x02) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG002_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG002_SET_gc   (0x04) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG003_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG003_SET_gc   (0x08) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG004_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG004_SET_gc   (0x10) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG005_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG005_SET_gc   (0x20) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG006_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG006_SET_gc   (0x40) /* LCD memory bit segment - SET */


/* LCD memory bit segment */
#define LCD_SEG007_CLEAR_gc (0x00) /* LCD memory bit segment - CLEAR */
#define LCD_SEG007_SET_gc   (0x80) /* LCD memory bit segment - SET */


/* LCD Contrast Control Register-LCDDC */
#define LCD_LCDDC_VAL_0x00_gc (0x00<<5) /* 300us */
#define LCD_LCDDC_VAL_0x01_gc (0x01<<5) /* 70us */
#define LCD_LCDDC_VAL_0x02_gc (0x02<<5) /* 150us */
#define LCD_LCDDC_VAL_0x03_gc (0x03<<5) /* 450us */
#define LCD_LCDDC_VAL_0x04_gc (0x04<<5) /* 575us */
#define LCD_LCDDC_VAL_0x05_gc (0x05<<5) /* 850us */
#define LCD_LCDDC_VAL_0x06_gc (0x06<<5) /* 1150us */
#define LCD_LCDDC_VAL_0x07_gc (0x07<<5) /* 50% of LCD clock */


/* LCD Maximum Drive Time */
#define LCD_LCDMDT_CLEAR_gc (0x00) /* LCD Maximum Drive Time - CLEAR */
#define LCD_LCDMDT_SET_gc   (0x10) /* LCD Maximum Drive Time - SET */


/* LCD Contrast Controls */
#define LCD_LCDCC_VAL_0x00_gc (0x00) /* 2.60V */
#define LCD_LCDCC_VAL_0x01_gc (0x01) /* 2.65V */
#define LCD_LCDCC_VAL_0x02_gc (0x02) /* 2.70V */
#define LCD_LCDCC_VAL_0x03_gc (0x03) /* 2.75V */
#define LCD_LCDCC_VAL_0x04_gc (0x04) /* 2.80V */
#define LCD_LCDCC_VAL_0x05_gc (0x05) /* 2.85V */
#define LCD_LCDCC_VAL_0x06_gc (0x06) /* 2.90V */
#define LCD_LCDCC_VAL_0x07_gc (0x07) /* 2.95V */
#define LCD_LCDCC_VAL_0x08_gc (0x08) /* 3.00V */
#define LCD_LCDCC_VAL_0x09_gc (0x09) /* 3.05V */
#define LCD_LCDCC_VAL_0x0A_gc (0x0A) /* 3.10V */
#define LCD_LCDCC_VAL_0x0B_gc (0x0B) /* 3.15V */
#define LCD_LCDCC_VAL_0x0C_gc (0x0C) /* 3.20V */
#define LCD_LCDCC_VAL_0x0D_gc (0x0D) /* 3.25V */
#define LCD_LCDCC_VAL_0x0E_gc (0x0E) /* 3.30V */
#define LCD_LCDCC_VAL_0x0F_gc (0x0F) /* 3.35V */


/* LCD Prescaler Selects */
#define LCD_LCDPS_VAL_0x00_gc (0x00<<4) /* ClkLCD/16 */
#define LCD_LCDPS_VAL_0x01_gc (0x01<<4) /* ClkLCD/64 */
#define LCD_LCDPS_VAL_0x02_gc (0x02<<4) /* ClkLCD/128 */
#define LCD_LCDPS_VAL_0x03_gc (0x03<<4) /* ClkLCD/256 */
#define LCD_LCDPS_VAL_0x04_gc (0x04<<4) /* ClkLCD/512 */
#define LCD_LCDPS_VAL_0x05_gc (0x05<<4) /* ClkLCD/1024 */
#define LCD_LCDPS_VAL_0x06_gc (0x06<<4) /* ClkLCD/2048 */
#define LCD_LCDPS_VAL_0x07_gc (0x07<<4) /* ClkLCD/4096 */


/* LCD Clock Dividers */
#define LCD_LCDCD_VAL_0x00_gc (0x00) /* 1 */
#define LCD_LCDCD_VAL_0x01_gc (0x01) /* 2 */
#define LCD_LCDCD_VAL_0x02_gc (0x02) /* 3 */
#define LCD_LCDCD_VAL_0x03_gc (0x03) /* 4 */
#define LCD_LCDCD_VAL_0x04_gc (0x04) /* 5 */
#define LCD_LCDCD_VAL_0x05_gc (0x05) /* 6 */
#define LCD_LCDCD_VAL_0x06_gc (0x06) /* 7 */
#define LCD_LCDCD_VAL_0x07_gc (0x07) /* 8 */


/* LCD CLock Select */
#define LCD_LCDCS_CLEAR_gc (0x00) /* LCD CLock Select - CLEAR */
#define LCD_LCDCS_SET_gc   (0x80) /* LCD CLock Select - SET */


/* LCD 1/2 Bias Select */
#define LCD_LCD2B_CLEAR_gc (0x00) /* LCD 1/2 Bias Select - CLEAR */
#define LCD_LCD2B_SET_gc   (0x40) /* LCD 1/2 Bias Select - SET */
...
/* LCD Port Masks */
#define LCD_LCDPM_VAL_0x00_gc (0x00) /* SEG0:12 */
#define LCD_LCDPM_VAL_0x01_gc (0x01) /* SEG0:14 */
#define LCD_LCDPM_VAL_0x02_gc (0x02) /* SEG0:15 */
#define LCD_LCDPM_VAL_0x03_gc (0x03) /* SEG0:18 */
#define LCD_LCDPM_VAL_0x04_gc (0x04) /* SEG0:20 */
#define LCD_LCDPM_VAL_0x05_gc (0x05) /* SEG0:22 */
#define LCD_LCDPM_VAL_0x06_gc (0x06) /* SEG0:23 */
#define LCD_LCDPM_VAL_0x07_gc (0x07) /* SEG0:24 */
#define LCD_LCDPM_VAL_0x08_gc (0x08) /* SEG0:26 */
#define LCD_LCDPM_VAL_0x09_gc (0x09) /* SEG0:28 */
#define LCD_LCDPM_VAL_0x0A_gc (0x0A) /* SEG0:30 */
#define LCD_LCDPM_VAL_0x0B_gc (0x0B) /* SEG0:32 */
#define LCD_LCDPM_VAL_0x0C_gc (0x0C) /* SEG0:34 */
#define LCD_LCDPM_VAL_0x0D_gc (0x0D) /* SEG0:36 */
#define LCD_LCDPM_VAL_0x0E_gc (0x0E) /* SEG0:38 */
#define LCD_LCDPM_VAL_0x0F_gc (0x0F) /* SEG0:39 */


/* LCD Enable */
#define LCD_LCDEN_CLEAR_gc (0x00) /* LCD Enable - CLEAR */
#define LCD_LCDEN_SET_gc   (0x80) /* LCD Enable - SET */


/* LCD A or B waveform */
#define LCD_LCDAB_CLEAR_gc (0x00) /* LCD A or B waveform - CLEAR */
#define LCD_LCDAB_SET_gc   (0x40) /* LCD A or B waveform - SET */


/* LCD Interrupt Flag */
#define LCD_LCDIF_CLEAR_gc (0x00) /* LCD Interrupt Flag - CLEAR */
#define LCD_LCDIF_SET_gc   (0x10) /* LCD Interrupt Flag - SET */


/* LCD Interrupt Enable */
#define LCD_LCDIE_CLEAR_gc (0x00) /* LCD Interrupt Enable - CLEAR */
#define LCD_LCDIE_SET_gc   (0x08) /* LCD Interrupt Enable - SET */


/* LCD Buffer Disable */
#define LCD_LCDBD_CLEAR_gc (0x00) /* LCD Buffer Disable - CLEAR */
#define LCD_LCDBD_SET_gc   (0x04) /* LCD Buffer Disable - SET */


/* LCD Contrast Control Disable */
#define LCD_LCDCCD_CLEAR_gc (0x00) /* LCD Contrast Control Disable - CLEAR */
#define LCD_LCDCCD_SET_gc   (0x02) /* LCD Contrast Control Disable - SET */


/* LCD Blanking */
#define LCD_LCDBL_CLEAR_gc (0x00) /* LCD Blanking - CLEAR */
#define LCD_LCDBL_SET_gc   (0x01) /* LCD Blanking - SET */
...
/* LCD - Liquid Crystal Display (0x0000) */
#define LCD_BASE         _SFR_MEM8 (0x0000) /* LCD Base Address */
#define LCD_LCDCRA       _SFR_MEM8 (0x00E4) /* LCD Control Register A */
#define LCD_LCDCRB       _SFR_MEM8 (0x00E5) /* LCD Control and Status Register B */
#define LCD_LCDFRR       _SFR_MEM8 (0x00E6) /* LCD Frame Rate Register */
#define LCD_LCDCCR       _SFR_MEM8 (0x00E7) /* LCD Contrast Control Register */
#define LCD_LCDDR0       _SFR_MEM8 (0x00EC) /* LCD Data Register 0 */
#define LCD_LCDDR1       _SFR_MEM8 (0x00ED) /* LCD Data Register 1 */
#define LCD_LCDDR2       _SFR_MEM8 (0x00EE) /* LCD Data Register 2 */
#define LCD_LCDDR3       _SFR_MEM8 (0x00EF) /* LCD Data Register 3 */
#define LCD_LCDDR5       _SFR_MEM8 (0x00F1) /* LCD Data Register 5 */
#define LCD_LCDDR6       _SFR_MEM8 (0x00F2) /* LCD Data Register 6 */
#define LCD_LCDDR7       _SFR_MEM8 (0x00F3) /* LCD Data Register 7 */
#define LCD_LCDDR8       _SFR_MEM8 (0x00F4) /* LCD Data Register 8 */
#define LCD_LCDDR10      _SFR_MEM8 (0x00F6) /* LCD Data Register 10 */
#define LCD_LCDDR11      _SFR_MEM8 (0x00F7) /* LCD Data Register 11 */
#define LCD_LCDDR12      _SFR_MEM8 (0x00F8) /* LCD Data Register 12 */
#define LCD_LCDDR13      _SFR_MEM8 (0x00F9) /* LCD Data Register 13 */
#define LCD_LCDDR15      _SFR_MEM8 (0x00FB) /* LCD Data Register 15 */
#define LCD_LCDDR16      _SFR_MEM8 (0x00FC) /* LCD Data Register 16 */
#define LCD_LCDDR17      _SFR_MEM8 (0x00FD) /* LCD Data Register 17 */
#define LCD_LCDDR18      _SFR_MEM8 (0x00FE) /* LCD Data Register 18 */
...
#define None_LCD_vect_num          (22)                
#define None_LCD_vect              _VECTOR(22)         /* LCD Start of Frame */
