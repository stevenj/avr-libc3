 ...
 *                                                                            * 
 *   .atpack File: ATmega162.atdf                                             * 
 *   .ATDF File:   atdf/ATmega162.atdf                                        * 
 *   Version:      2.0.12                                                     * 
 *   Date:         2019-04-26                                                 * 
 *   Device:       ATmega162                                                  * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATmega162.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_ATmega162_H_INCLUDED
#  define _AVR_ATmega162_H_INCLUDED
...
#define OSCCAL _SFR_MEM8 (0x24) /* Oscillator Calibration Value */
...
#define EMCUCR _SFR_MEM8 (0x56) /* Extended MCU Control Register */
...
typedef enum FUSE_M161C_enum
{
    FUSE_M161C_CLEAR_gc = (0x00), /* ATmega161 compability mode - CLEAR */
    FUSE_M161C_SET_gc   = (0x10), /* ATmega161 compability mode - SET */
} FUSE_M161C_t;
...
typedef enum FUSE_BODLEVEL_enum
{
    ...
    FUSE_BODLEVEL_2V3_gc      = (0x03<<1), /* Brown-out detection at VCC=2.3 V */
...
{
    register8_t rsv_0x00[68]; /* RESERVED REGISTER BLOCK */
...
{
    register8_t rsv_0x00[124]; /* RESERVED REGISTER BLOCK */
    ...
    register8_t rsv_0x81[3];   /* RESERVED REGISTER BLOCK */
    _REGISTER16 (OCR3B);       /* Timer/Counte3 Output Compare Register B  Bytes */
...
typedef enum TC1_TICIE1_enum
{
    ...
    TC1_TICIE1_SET_gc   = (0x08), /* Timer/Counter1 Input Capture Interrupt Enable - SET */
} TC1_TICIE1_t;
...
typedef enum TC1_FOC1A_enum
{
    ...
    TC1_FOC1A_SET_gc   = (0x08), /* Force Output Compare for Channel A - SET */
} TC1_FOC1A_t;
...
typedef enum TC1_FOC1B_enum
{
    ...
    TC1_FOC1B_SET_gc   = (0x04), /* Force Output Compare for Channel B - SET */
} TC1_FOC1B_t;
...
typedef enum TC3_FOC3A_enum
{
    ...
    TC3_FOC3A_SET_gc   = (0x08), /* Force Output Compare for Channel A - SET */
} TC3_FOC3A_t;
...
typedef enum TC3_FOC3B_enum
{
    ...
    TC3_FOC3B_SET_gc   = (0x04), /* Force Output Compare for Channel B - SET */
} TC3_FOC3B_t;
...
typedef enum TC3_CS3_enum
{
    ...
    TC3_CS3_VAL_0x06_gc = (0x06), /* Running, CLK/16 */
    TC3_CS3_VAL_0x07_gc = (0x07), /* Running, CLK/32 */
} TC3_CS3_t;
...
typedef struct TC2_struct
{
    ...
    register8_t rsv_0x48[16]; /* RESERVED REGISTER BLOCK */
    register8_t TIFR;         /* Timer/Counter Interrupt Flag Register */
    register8_t TIMSK;        /* Timer/Counter Interrupt Mask Register */
} TC2_t;


/* Forde Output Compare */
typedef enum TC2_FOC2_enum
{
    TC2_FOC2_CLEAR_gc = (0x00), /* Forde Output Compare - CLEAR */
    TC2_FOC2_SET_gc   = (0x80), /* Forde Output Compare - SET */
} TC2_FOC2_t;
...
{
    TC2_WGM21_CLEAR_gc = (0x00), /* Pulse Width Modulator Select Bit 1 - CLEAR */
    TC2_WGM21_SET_gc   = (0x08), /* Pulse Width Modulator Select Bit 1 - SET */
} TC2_WGM21_t;
...
typedef enum TC2_OCIE2_enum
{
    ...
    TC2_OCIE2_SET_gc   = (0x10), /* Timer/Counter2 Output Compare Match Interrupt Enable - SET */
} TC2_OCIE2_t;
...
typedef enum TC2_TOIE2_enum
{
    ...
    TC2_TOIE2_SET_gc   = (0x04), /* Timer/Counter2 Overflow Interrupt Enable - SET */
} TC2_TOIE2_t;
...
typedef enum TC2_OCF2_enum
{
    ...
    TC2_OCF2_SET_gc   = (0x10), /* Output Compare Flag 2 - SET */
} TC2_OCF2_t;
...
typedef enum TC2_TOV2_enum
{
    ...
    TC2_TOV2_SET_gc   = (0x04), /* Timer/Counter2 Overflow Flag - SET */
} TC2_TOV2_t;

/* Asynchronous Timer 2 */
typedef enum TC2_AS2_enum
{
    TC2_AS2_CLEAR_gc = (0x00), /* Asynchronous Timer 2 - CLEAR */
    TC2_AS2_SET_gc   = (0x08), /* Asynchronous Timer 2 - SET */
} TC2_AS2_t;
...
typedef struct USART0_struct
{
    ...
    register8_t UBRR0H;       /* USART Baud Rate Register High Byte */
} USART0_t;
...
typedef struct USART1_struct
{
    ...
    register8_t rsv_0x24[56]; /* RESERVED REGISTER BLOCK */
    register8_t UCSR1C;       /* USART Control and Status Register C */
    register8_t rsv_0x5D[-1]; /* RESERVED REGISTER BLOCK */
    register8_t UBRR1H;       /* USART Baud Rate Register Highg Byte */
} USART1_t;
...
/* Register Select */
typedef enum USART0_URSEL0_enum
{
    USART0_URSEL0_CLEAR_gc = (0x00), /* Register Select - CLEAR */
    USART0_URSEL0_SET_gc   = (0x80), /* Register Select - SET */
} USART0_URSEL0_t;
...
/* USART Baud Rate Register High bits */
#define USART0_UBRR0H_UBRR0_gc(x) (x & 0x0F)
...
/* Register Select */
typedef enum USART1_URSEL1_enum
{
    USART1_URSEL1_CLEAR_gc = (0x00), /* Register Select - CLEAR */
    USART1_URSEL1_SET_gc   = (0x80), /* Register Select - SET */
} USART1_URSEL1_t;
...
/* Register Select */
typedef enum USART1_URSEL0_enum
{
    USART1_URSEL0_CLEAR_gc = (0x00), /* Register Select - CLEAR */
    USART1_URSEL0_SET_gc   = (0x80), /* Register Select - SET */
} USART1_URSEL0_t;

/* USART Baud Rate Register High bits */
#define USART1_UBRR1H_UBRR1_gc(x) (x & 0x0F)
...
typedef struct CPU_struct
{
    ...
    register8_t rsv_0x25[43]; /* RESERVED REGISTER BLOCK */
    register8_t SFIOR;        /* Special Function IO Register */
    register8_t rsv_0x51[3];  /* RESERVED REGISTER BLOCK */
    register8_t MCUCSR;       /* MCU Control And Status Register */
    register8_t MCUCR;        /* MCU Control Register */
    register8_t EMCUCR;       /* Extended MCU Control Register */
...
/* Sleep Mode Select */
typedef enum CPU_SM1_enum
{
    CPU_SM1_CLEAR_gc = (0x00), /* Sleep Mode Select - CLEAR */
    CPU_SM1_SET_gc   = (0x10), /* Sleep Mode Select - SET */
} CPU_SM1_t;
...
{
    CPU_SM2_CLEAR_gc = (0x00), /* Sleep Mode Select Bit 2 - CLEAR */
    CPU_SM2_SET_gc   = (0x20), /* Sleep Mode Select Bit 2 - SET */
} CPU_SM2_t;
...
typedef enum CPU_SM0_enum
{
    CPU_SM0_CLEAR_gc = (0x00), /* Sleep mode Select Bit 0 - CLEAR */
    CPU_SM0_SET_gc   = (0x80), /* Sleep mode Select Bit 0 - SET */
} CPU_SM0_t;
...
{
    CPU_SRW11_CLEAR_gc = (0x00), /* Wait State Select Bit 1 for Upper Sector - CLEAR */
    CPU_SRW11_SET_gc   = (0x02), /* Wait State Select Bit 1 for Upper Sector - SET */
} CPU_SRW11_t;

/* Interrupt Sense Control 2 */
typedef enum CPU_ISC2_enum
{
    CPU_ISC2_CLEAR_gc = (0x00), /* Interrupt Sense Control 2 - CLEAR */
    CPU_ISC2_SET_gc   = (0x01), /* Interrupt Sense Control 2 - SET */
} CPU_ISC2_t;
...
typedef enum CPU_TSM_enum
{
    CPU_TSM_CLEAR_gc = (0x00), /* Timer/Counter Synchronization Mode - CLEAR */
    CPU_TSM_SET_gc   = (0x80), /* Timer/Counter Synchronization Mode - SET */
} CPU_TSM_t;
...
typedef enum CPU_XMBK_enum
{
    ...
    CPU_XMBK_SET_gc   = (0x40), /* External Memory Bus Keeper Enable - SET */
} CPU_XMBK_t;

/* External Memory High Mask Bits */
#define CPU_SFIOR_XMM_gc(x) ((x<<3) & 0x38)
...
typedef enum CPU_PSR2_enum
{
    CPU_PSR2_CLEAR_gc = (0x00), /* Prescaler Reset Timer/Counter2 - CLEAR */
    CPU_PSR2_SET_gc   = (0x02), /* Prescaler Reset Timer/Counter2 - SET */
} CPU_PSR2_t;

/* Prescaler Reset Timer/Counter3, Timer/Counter1 and Timer/Counter0 */
typedef enum CPU_PSR310_enum
{
    CPU_PSR310_CLEAR_gc = (0x00), /* Prescaler Reset Timer/Counter3, Timer/Counter1 and Timer/Counter0 - CLEAR */
    CPU_PSR310_SET_gc   = (0x01), /* Prescaler Reset Timer/Counter3, Timer/Counter1 and Timer/Counter0 - SET */
} CPU_PSR310_t;
...
typedef struct JTAG_struct
{
    ...
    register8_t rsv_0x25[47]; /* RESERVED REGISTER BLOCK */
    register8_t MCUCSR;       /* MCU Control And Status Register */
} JTAG_t;
...
{
    BOOT_LOAD_RWWSRE_CLEAR_gc = (0x00), /* Read While Write secion read enable - CLEAR */
    BOOT_LOAD_RWWSRE_SET_gc   = (0x10), /* Read While Write secion read enable - SET */
} BOOT_LOAD_RWWSRE_t;
...
typedef struct TC0_struct
{
    ...
    register8_t OCR0;         /* Timer/Counter 0 Output Compare Register */
    register8_t TCNT0;        /* Timer/Counter 0 Register */
    register8_t TCCR0;        /* Timer/Counter 0 Control Register */
...
typedef enum TC0_OCIE0_enum
{
    ...
    TC0_OCIE0_SET_gc   = (0x01), /* Timer/Counter0 Output Compare Match Interrupt register - SET */
} TC0_OCIE0_t;
...
typedef enum TC0_OCF0_enum
{
    ...
    TC0_OCF0_SET_gc   = (0x01), /* Output Compare Flag 0 - SET */
} TC0_OCF0_t;
...
typedef struct EXINT_struct
{
    ...
    register8_t MCUCR;        /* MCU Control Register */
    register8_t EMCUCR;       /* Extended MCU Control Register */
    register8_t rsv_0x57[3];  /* RESERVED REGISTER BLOCK */
    register8_t GIFR;         /* General Interrupt Flag Register */
    register8_t GICR;         /* General Interrupt Control Register */
    register8_t rsv_0x5C[15]; /* RESERVED REGISTER BLOCK */
    register8_t PCMSK0;       /* Pin Change Enable Mask */
...
{
    EXINT_ISC2_CLEAR_gc = (0x00), /* Interrupt Sense Control 2 - CLEAR */
    EXINT_ISC2_SET_gc   = (0x01), /* Interrupt Sense Control 2 - SET */
} EXINT_ISC2_t;
...
typedef enum EXINT_INT1_enum
{
    EXINT_INT1_CLEAR_gc = (0x00), /* External Interrupt Request 1 Enable - CLEAR */
    EXINT_INT1_SET_gc   = (0x80), /* External Interrupt Request 1 Enable - SET */
} EXINT_INT1_t;

/* External Interrupt Request 2 Enable */
typedef enum EXINT_INT2_enum
{
    EXINT_INT2_CLEAR_gc = (0x00), /* External Interrupt Request 2 Enable - CLEAR */
    EXINT_INT2_SET_gc   = (0x20), /* External Interrupt Request 2 Enable - SET */
} EXINT_INT2_t;

/* Pin Change Interrupt Enables */
#define EXINT_GICR_PCIE_gc(x) ((x<<3) & 0x18)
...
typedef enum EXINT_INTF2_enum
{
    EXINT_INTF2_CLEAR_gc = (0x00), /* External Interrupt Flag 2 - CLEAR */
    EXINT_INTF2_SET_gc   = (0x20), /* External Interrupt Flag 2 - SET */
} EXINT_INTF2_t;

/* Pin Change Interrupt Flags */
#define EXINT_GIFR_PCIF_gc(x) ((x<<3) & 0x18)
/*
================================================================================
...
/* ATmega161 compability mode */
#define FUSE_M161C_CLEAR_gc (0x00) /* ATmega161 compability mode - CLEAR */
#define FUSE_M161C_SET_gc   (0x10) /* ATmega161 compability mode - SET */
...
#define FUSE_BODLEVEL_2V3_gc      (0x03<<1) /* Brown-out detection at VCC=2.3 V */
...
#define TC1_TICIE1_SET_gc   (0x08) /* Timer/Counter1 Input Capture Interrupt Enable - SET */
...
#define TC1_FOC1A_SET_gc   (0x08) /* Force Output Compare for Channel A - SET */


/* Force Output Compare for Channel B */
#define TC1_FOC1B_CLEAR_gc (0x00) /* Force Output Compare for Channel B - CLEAR */
#define TC1_FOC1B_SET_gc   (0x04) /* Force Output Compare for Channel B - SET */
...
#define TC3_FOC3A_SET_gc   (0x08) /* Force Output Compare for Channel A - SET */


/* Force Output Compare for Channel B */
#define TC3_FOC3B_CLEAR_gc (0x00) /* Force Output Compare for Channel B - CLEAR */
#define TC3_FOC3B_SET_gc   (0x04) /* Force Output Compare for Channel B - SET */
...
#define TC3_CS3_VAL_0x06_gc (0x06) /* Running, CLK/16 */
#define TC3_CS3_VAL_0x07_gc (0x07) /* Running, CLK/32 */
...
/* Forde Output Compare */
#define TC2_FOC2_CLEAR_gc (0x00) /* Forde Output Compare - CLEAR */
#define TC2_FOC2_SET_gc   (0x80) /* Forde Output Compare - SET */
...
/* Pulse Width Modulator Select Bit 1 */
#define TC2_WGM21_CLEAR_gc (0x00) /* Pulse Width Modulator Select Bit 1 - CLEAR */
#define TC2_WGM21_SET_gc   (0x08) /* Pulse Width Modulator Select Bit 1 - SET */
...
#define TC2_OCIE2_SET_gc   (0x10) /* Timer/Counter2 Output Compare Match Interrupt Enable - SET */


/* Timer/Counter2 Overflow Interrupt Enable */
#define TC2_TOIE2_CLEAR_gc (0x00) /* Timer/Counter2 Overflow Interrupt Enable - CLEAR */
#define TC2_TOIE2_SET_gc   (0x04) /* Timer/Counter2 Overflow Interrupt Enable - SET */


/* Output Compare Flag 2 */
#define TC2_OCF2_CLEAR_gc (0x00) /* Output Compare Flag 2 - CLEAR */
#define TC2_OCF2_SET_gc   (0x10) /* Output Compare Flag 2 - SET */


/* Timer/Counter2 Overflow Flag */
#define TC2_TOV2_CLEAR_gc (0x00) /* Timer/Counter2 Overflow Flag - CLEAR */
#define TC2_TOV2_SET_gc   (0x04) /* Timer/Counter2 Overflow Flag - SET */


/* Asynchronous Timer 2 */
#define TC2_AS2_CLEAR_gc (0x00) /* Asynchronous Timer 2 - CLEAR */
#define TC2_AS2_SET_gc   (0x08) /* Asynchronous Timer 2 - SET */
...
/* Register Select */
#define USART0_URSEL0_CLEAR_gc (0x00) /* Register Select - CLEAR */
#define USART0_URSEL0_SET_gc   (0x80) /* Register Select - SET */
...
/* Register Select */
/* USART0_URSEL0_CLEAR_gc ALREADY DEFINED */
/* USART0_URSEL0_SET_gc ALREADY DEFINED */
...
/* Register Select */
#define USART1_URSEL1_CLEAR_gc (0x00) /* Register Select - CLEAR */
#define USART1_URSEL1_SET_gc   (0x80) /* Register Select - SET */
...
/* Register Select */
#define USART1_URSEL0_CLEAR_gc (0x00) /* Register Select - CLEAR */
#define USART1_URSEL0_SET_gc   (0x80) /* Register Select - SET */
...
/* Sleep Mode Select */
#define CPU_SM1_CLEAR_gc (0x00) /* Sleep Mode Select - CLEAR */
#define CPU_SM1_SET_gc   (0x10) /* Sleep Mode Select - SET */
...
/* Sleep Mode Select Bit 2 */
#define CPU_SM2_CLEAR_gc (0x00) /* Sleep Mode Select Bit 2 - CLEAR */
#define CPU_SM2_SET_gc   (0x20) /* Sleep Mode Select Bit 2 - SET */
...
/* Sleep mode Select Bit 0 */
#define CPU_SM0_CLEAR_gc (0x00) /* Sleep mode Select Bit 0 - CLEAR */
#define CPU_SM0_SET_gc   (0x80) /* Sleep mode Select Bit 0 - SET */
...
/* Wait State Select Bit 1 for Upper Sector */
#define CPU_SRW11_CLEAR_gc (0x00) /* Wait State Select Bit 1 for Upper Sector - CLEAR */
#define CPU_SRW11_SET_gc   (0x02) /* Wait State Select Bit 1 for Upper Sector - SET */


/* Interrupt Sense Control 2 */
#define CPU_ISC2_CLEAR_gc (0x00) /* Interrupt Sense Control 2 - CLEAR */
#define CPU_ISC2_SET_gc   (0x01) /* Interrupt Sense Control 2 - SET */
...
/* Timer/Counter Synchronization Mode */
#define CPU_TSM_CLEAR_gc (0x00) /* Timer/Counter Synchronization Mode - CLEAR */
#define CPU_TSM_SET_gc   (0x80) /* Timer/Counter Synchronization Mode - SET */


/* External Memory Bus Keeper Enable */
#define CPU_XMBK_CLEAR_gc (0x00) /* External Memory Bus Keeper Enable - CLEAR */
#define CPU_XMBK_SET_gc   (0x40) /* External Memory Bus Keeper Enable - SET */
...
/* Prescaler Reset Timer/Counter2 */
#define CPU_PSR2_CLEAR_gc (0x00) /* Prescaler Reset Timer/Counter2 - CLEAR */
#define CPU_PSR2_SET_gc   (0x02) /* Prescaler Reset Timer/Counter2 - SET */


/* Prescaler Reset Timer/Counter3, Timer/Counter1 and Timer/Counter0 */
#define CPU_PSR310_CLEAR_gc (0x00) /* Prescaler Reset Timer/Counter3, Timer/Counter1 and Timer/Counter0 - CLEAR */
#define CPU_PSR310_SET_gc   (0x01) /* Prescaler Reset Timer/Counter3, Timer/Counter1 and Timer/Counter0 - SET */
...
/* Read While Write secion read enable */
#define BOOT_LOAD_RWWSRE_CLEAR_gc (0x00) /* Read While Write secion read enable - CLEAR */
#define BOOT_LOAD_RWWSRE_SET_gc   (0x10) /* Read While Write secion read enable - SET */
...
#define TC0_OCIE0_SET_gc   (0x01) /* Timer/Counter0 Output Compare Match Interrupt register - SET */
...
#define TC0_OCF0_SET_gc   (0x01) /* Output Compare Flag 0 - SET */
...
/* Interrupt Sense Control 2 */
#define EXINT_ISC2_CLEAR_gc (0x00) /* Interrupt Sense Control 2 - CLEAR */
#define EXINT_ISC2_SET_gc   (0x01) /* Interrupt Sense Control 2 - SET */
...
/* External Interrupt Request 1 Enable */
#define EXINT_INT1_CLEAR_gc (0x00) /* External Interrupt Request 1 Enable - CLEAR */
#define EXINT_INT1_SET_gc   (0x80) /* External Interrupt Request 1 Enable - SET */


/* External Interrupt Request 2 Enable */
#define EXINT_INT2_CLEAR_gc (0x00) /* External Interrupt Request 2 Enable - CLEAR */
#define EXINT_INT2_SET_gc   (0x20) /* External Interrupt Request 2 Enable - SET */
...
/* External Interrupt Flag 2 */
#define EXINT_INTF2_CLEAR_gc (0x00) /* External Interrupt Flag 2 - CLEAR */
#define EXINT_INTF2_SET_gc   (0x20) /* External Interrupt Flag 2 - SET */
...
/* WARNING: TC16_BASE ALREADY DEFINED as '_SFR_MEM16(0x0000)' NOT '_SFR_MEM8 (0x0000)' */
...
#define TC16_OCR3B      _SFR_MEM16(0x0084) /* Timer/Counte3 Output Compare Register B  Bytes */
#define TC16_OCR3BL     _SFR_MEM8 (0x0084) /* Timer/Counte3 Output Compare Register B  Bytes LOW BYTE */
#define TC16_OCR3BH     _SFR_MEM8 (0x0085) /* Timer/Counte3 Output Compare Register B  Bytes HIGH BYTE */
...
#define TC8_ASYNC_OCR2  _SFR_MEM8 (0x0042) /* Output Compare Register */
#define TC8_ASYNC_TCNT2 _SFR_MEM8 (0x0043) /* Timer/Counter Register */
#define TC8_ASYNC_ASSR  _SFR_MEM8 (0x0046) /* Asynchronous Status Register */
#define TC8_ASYNC_TCCR2 _SFR_MEM8 (0x0047) /* Timer/Counter Control Register */
...
#define USART00_UCSR0C  _SFR_MEM8 (0x0040) /* USART Control and Status Register C */
#define USART00_UBRR0H  _SFR_MEM8 (0x0040) /* USART Baud Rate Register High Byte */

/* USART1 - USART (0x0000) */
#define USART11_BASE    _SFR_MEM8 (0x0000) /* USART11 Base Address */
#define USART11_UBRR1L  _SFR_MEM8 (0x0020) /* USART Baud Rate Register Low Byte */
#define USART11_UCSR1B  _SFR_MEM8 (0x0021) /* USART Control and Status Register B */
#define USART11_UCSR1A  _SFR_MEM8 (0x0022) /* USART Control and Status Register A */
#define USART11_UDR1    _SFR_MEM8 (0x0023) /* USART I/O Data Register */
#define USART11_UCSR1C  _SFR_MEM8 (0x005C) /* USART Control and Status Register C */
#define USART11_UBRR1H  _SFR_MEM8 (0x005C) /* USART Baud Rate Register Highg Byte */
...
#define CPU_OSCCAL      _SFR_MEM8 (0x0024) /* Oscillator Calibration Value */
...
#define CPU_EMCUCR      _SFR_MEM8 (0x0056) /* Extended MCU Control Register */
...
#define JTAG_OCDR       _SFR_MEM8 (0x0024) /* On-Chip Debug Related Register in I/O Memory */
...
#define BOOT_LOAD_SPMCR _SFR_MEM8 (0x0057) /* Store Program Memory Control Register */
...
#define PORTEE_PINE     _SFR_MEM8 (0x0025) /* Input Pins, Port E */
#define PORTEE_DDRE     _SFR_MEM8 (0x0026) /* Data Direction Register, Port E */
#define PORTEE_PORTE    _SFR_MEM8 (0x0027) /* Data Register, Port E */

/* TC0 - Timer/Counter, 8-bit (0x0000) */
#define TC8_BASE        _SFR_MEM8 (0x0000) /* TC8 Base Address */
#define TC8_OCR0        _SFR_MEM8 (0x0051) /* Timer/Counter 0 Output Compare Register */
#define TC8_TCNT0       _SFR_MEM8 (0x0052) /* Timer/Counter 0 Register */
#define TC8_TCCR0       _SFR_MEM8 (0x0053) /* Timer/Counter 0 Control Register */
...
#define EXINT_EMCUCR    _SFR_MEM8 (0x0056) /* Extended MCU Control Register */
...
#define EXINT_PCMSK0    _SFR_MEM8 (0x006B) /* Pin Change Enable Mask */
...
#define None_TIMER3_CAPT_vect_num  (6)                 
#define None_TIMER3_CAPT_vect      _VECTOR(6)          /* Timer/Counter3 Capture Event */
#define None_TIMER3_COMPA_vect_num (7)                 
#define None_TIMER3_COMPA_vect     _VECTOR(7)          /* Timer/Counter3 Compare Match A */
#define None_TIMER3_COMPB_vect_num (8)                 
#define None_TIMER3_COMPB_vect     _VECTOR(8)          /* Timer/Counter3 Compare Match B */
#define None_TIMER3_OVF_vect_num   (9)                 
#define None_TIMER3_OVF_vect       _VECTOR(9)          /* Timer/Counter3 Overflow */
#define None_TIMER2_COMP_vect_num  (10)                
#define None_TIMER2_COMP_vect      _VECTOR(10)         /* Timer/Counter2 Compare Match */
...
#define None_TIMER1_COMPB_vect     _VECTOR(14)         /* Timer/Counter Compare Match B */
...
#define None_SPI_STC_vect_num      (18)                
#define None_SPI_STC_vect          _VECTOR(18)         /* SPI Serial Transfer Complete */
#define None_USART0_RXC_vect_num   (19)                
#define None_USART0_RXC_vect       _VECTOR(19)         /* USART0, Rx Complete */
...
#define None_USART1_UDRE_vect_num  (22)                
#define None_USART1_UDRE_vect      _VECTOR(22)         /* USART1, Data register Empty */
#define None_USART0_TXC_vect_num   (23)                
#define None_USART0_TXC_vect       _VECTOR(23)         /* USART0, Tx Complete */
#define None_USART1_TXC_vect_num   (24)                
#define None_USART1_TXC_vect       _VECTOR(24)         /* USART1, Tx Complete */
#define None_EE_RDY_vect_num       (25)                
#define None_EE_RDY_vect           _VECTOR(25)         /* EEPROM Ready */
#define None_ANA_COMP_vect_num     (26)                
#define None_ANA_COMP_vect         _VECTOR(26)         /* Analog Comparator */
#define None_SPM_RDY_vect_num      (27)                
#define None_SPM_RDY_vect          _VECTOR(27)         /* Store Program Memory Read */
...
#define XRAM_START          (0x0500)                               
#define XRAM_SIZE           (0xFB00)                               
...
/* Fuse offset 0x02 */
#define BODLEVEL0 (unsigned char)~_BV(1) /* Brownout detector trigger level bit 0 */
#define BODLEVEL1 (unsigned char)~_BV(2) /* Brownout detector trigger level bit 1 */
#define BODLEVEL2 (unsigned char)~_BV(3) /* Brownout detector trigger level bit 2 */
#define M161C     (unsigned char)~_BV(4) /* ATmega161 compability mode */
...
#endif /* #ifdef _AVR_ATmega162_H_INCLUDED */
