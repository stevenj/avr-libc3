 ...
 *                                                                            * 
 *   .atpack File: ATmega16A.atdf                                             * 
 *   .ATDF File:   atdf/ATmega16A.atdf                                        * 
 *   Version:      2.0.12                                                     * 
 *   Date:         2019-04-26                                                 * 
 *   Device:       ATmega16A                                                  * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATmega16A.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_ATmega16A_H_INCLUDED
#  define _AVR_ATmega16A_H_INCLUDED
...
#define SFIOR  _SFR_MEM8 (0x50) /* Special function I/O register */
...
typedef struct TC0_struct
{
    ...
    register8_t OCR0;         /* Output Compare 0 Register */
} TC0_t;
...
typedef struct EXINT_struct
{
    ...
    register8_t MCUCR;        /* General Interrupt Control Register */
...
typedef enum EXINT_ISC2_enum
{
    ...
    EXINT_ISC2_SET_gc   = (0x40), /* Interrupt Sense Control 2 - SET */
} EXINT_ISC2_t;
...
{
    register8_t rsv_0x00[80]; /* RESERVED REGISTER BLOCK */
    register8_t SFIOR;        /* Special function I/O register */
...
typedef enum CPU_SM_enum
{
    ...
    CPU_SM_VAL_0x04_gc = (0x08<<4), /* Reserved */
    CPU_SM_VAL_0x05_gc = (0x09<<4), /* Reserved */
    CPU_SM_STDBY_gc    = (0x0A<<4), /* Standby */
    CPU_SM_ESTDBY_gc   = (0x0B<<4), /* Extended Standby */
} CPU_SM_t;
...
typedef enum CPU_SE_enum
{
    ...
    CPU_SE_SET_gc   = (0x40), /* Sleep Enable - SET */
} CPU_SE_t;
...
{
    CPU_PSR2_CLEAR_gc = (0x00), /* Prescaler reset - CLEAR */
    CPU_PSR2_SET_gc   = (0x02), /* Prescaler reset - SET */
} CPU_PSR2_t;

/* Prescaler reset */
typedef enum CPU_PSR10_enum
{
    CPU_PSR10_CLEAR_gc = (0x00), /* Prescaler reset - CLEAR */
    CPU_PSR10_SET_gc   = (0x01), /* Prescaler reset - SET */
} CPU_PSR10_t;
...
typedef struct USART_struct
{
    ...
    register8_t UBRRL;        /* USART Baud Rate Register */
    ...
    register8_t UBRRH;        /* USART Baud Rate Register */
} USART_t;
...
/* USART Baud Rate bits */
#define USART_UBRRH_UBRR_gc(x) (x & 0x0F)
...
typedef struct ADC_struct
{
    ...
    register8_t rsv_0x28[40]; /* RESERVED REGISTER BLOCK */
    register8_t SFIOR;        /* Special Function IO Register */
} ADC_t;
...
{
    ADC_ADATE_CLEAR_gc = (0x00), /* ADC Auto Trigger - CLEAR */
    ADC_ADATE_SET_gc   = (0x20), /* ADC Auto Trigger - SET */
} ADC_ADATE_t;
...
#define EXINT_ISC2_SET_gc   (0x40) /* Interrupt Sense Control 2 - SET */
...
#define CPU_SM_VAL_0x04_gc (0x08<<4) /* Reserved */
#define CPU_SM_VAL_0x05_gc (0x09<<4) /* Reserved */
#define CPU_SM_STDBY_gc    (0x0A<<4) /* Standby */
#define CPU_SM_ESTDBY_gc   (0x0B<<4) /* Extended Standby */


/* Sleep Enable */
#define CPU_SE_CLEAR_gc (0x00) /* Sleep Enable - CLEAR */
#define CPU_SE_SET_gc   (0x40) /* Sleep Enable - SET */
...
/* Prescaler reset */
#define CPU_PSR2_CLEAR_gc (0x00) /* Prescaler reset - CLEAR */
#define CPU_PSR2_SET_gc   (0x02) /* Prescaler reset - SET */


/* Prescaler reset */
#define CPU_PSR10_CLEAR_gc (0x00) /* Prescaler reset - CLEAR */
#define CPU_PSR10_SET_gc   (0x01) /* Prescaler reset - SET */
...
/* ADC Auto Trigger */
#define ADC_ADATE_CLEAR_gc (0x00) /* ADC Auto Trigger - CLEAR */
#define ADC_ADATE_SET_gc   (0x20) /* ADC Auto Trigger - SET */
...
#define TC8_SFIOR        _SFR_MEM8 (0x0050) /* Special Function IO Register */
#define TC8_TCNT0        _SFR_MEM8 (0x0052) /* Timer/Counter 0 Register */
#define TC8_TCCR0        _SFR_MEM8 (0x0053) /* Timer/Counter Control Register */
...
#define TC8_OCR0         _SFR_MEM8 (0x005C) /* Output Compare 0 Register */
...
#define EXINT_MCUCSR     _SFR_MEM8 (0x0054) /* MCU Control And Status Register */
#define EXINT_MCUCR      _SFR_MEM8 (0x0055) /* General Interrupt Control Register */
...
#define CPU_SFIOR        _SFR_MEM8 (0x0050) /* Special function I/O register */
...
#define USART_UBRRL      _SFR_MEM8 (0x0029) /* USART Baud Rate Register */
...
#define USART_UBRRH      _SFR_MEM8 (0x0040) /* USART Baud Rate Register */
...
#define ADC_SFIOR        _SFR_MEM8 (0x0050) /* Special Function IO Register */
...
#define None_INT2_vect_num         (18)                
#define None_INT2_vect             _VECTOR(18)         /* External Interrupt Request 2 */
#define None_TIMER0_COMP_vect_num  (19)                
#define None_TIMER0_COMP_vect      _VECTOR(19)         /* Timer/Counter0 Compare Match */
#define None_SPM_RDY_vect_num      (20)                
#define None_SPM_RDY_vect          _VECTOR(20)         /* Store Program Memory Ready */
...
#endif /* #ifdef _AVR_ATmega16A_H_INCLUDED */
