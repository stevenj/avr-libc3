 ...
 *                                                                            * 
 *   .atpack File: ATxmega256D3.atdf                                          * 
 *   .ATDF File:   atdf/ATxmega256D3.atdf                                     * 
 *   Version:      2.0.9                                                      * 
 *   Date:         2019-07-11                                                 * 
 *   Device:       ATxmega256D3                                               * 
...
#  define _AVR_IOXXX_H_ "ioATxmega256D3.h"
#else
...
#define NVM_FUSES_FUSEBYTE1_WDPER_gc(x) (x & 0x0F)
...
#define NVM_FUSES_FUSEBYTE5_BODACT_gc(x) ((x<<4) & 0x30)
...
/* Timer Oscillator pin location */
#define NVM_FUSES_TOSCSEL_ALTERNATE_gc (0x00<<5) /* TOSC1/2 on separate pins */
#define NVM_FUSES_TOSCSEL_XTAL_gc      (0x01<<5) /* TOSC1/2 shared with XTAL */
...
#define PROD_SIGNATURES_PROD_SIGNATURES_RCOSC2M    _SFR_MEM8 (0x0000) /* RCOSC 2MHz Calibration Value B */
#define PROD_SIGNATURES_PROD_SIGNATURES_RCOSC2MA   _SFR_MEM8 (0x0001) /* RCOSC 2MHz Calibration Value A */
#define PROD_SIGNATURES_PROD_SIGNATURES_RCOSC32K   _SFR_MEM8 (0x0002) /* RCOSC 32kHz Calibration Value */
#define PROD_SIGNATURES_PROD_SIGNATURES_RCOSC32M   _SFR_MEM8 (0x0003) /* RCOSC 32MHz Calibration Value B */
#define PROD_SIGNATURES_PROD_SIGNATURES_RCOSC32MA  _SFR_MEM8 (0x0004) /* RCOSC 32MHz Calibration Value A */
...
#define PORTF_REMAP                                _SFR_MEM8 (0x06AE) /* Pin Remap Register (available for PORTC to PORTF only) */
...
#define _VECTORS_SIZE        (114 * _VECTOR_SIZE) /* Size of all vectors */
/*
================================================================================
Constants
================================================================================
