 ...
 *                                                                            * 
 *   .atpack File: ATmega32M1.atdf                                            * 
 *   .ATDF File:   atdf/ATmega32M1.atdf                                       * 
 *   Version:      2.0.12                                                     * 
 *   Date:         2019-04-26                                                 * 
 *   Device:       ATmega32M1                                                 * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATmega32M1.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_ATmega32M1_H_INCLUDED
#  define _AVR_ATmega32M1_H_INCLUDED
...
typedef struct PSC_struct
{
    ...
    _REGISTER16 (POCR0SB);     /* PSC Output Compare SB Register  */
    register8_t rsv_0xA5;      /* RESERVED REGISTER */
    _REGISTER16 (POCR1SA);     /* PSC Output Compare SA Register  */
...
#define PSC_POCR0SB     _SFR_MEM16(0x00A4) /* PSC Output Compare SB Register  */
#define PSC_POCR0SBL    _SFR_MEM8 (0x00A4) /* PSC Output Compare SB Register  LOW BYTE */
#define PSC_POCR0SBH    _SFR_MEM8 (0x00A5) /* PSC Output Compare SB Register  HIGH BYTE */
#define PSC_POCR1SA     _SFR_MEM16(0x00A6) /* PSC Output Compare SA Register  */
#define PSC_POCR1SAL    _SFR_MEM8 (0x00A6) /* PSC Output Compare SA Register  LOW BYTE */
#define PSC_POCR1SAH    _SFR_MEM8 (0x00A7) /* PSC Output Compare SA Register  HIGH BYTE */
...
#endif /* #ifdef _AVR_ATmega32M1_H_INCLUDED */
