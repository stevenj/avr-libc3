 ...
 *                                                                            * 
 *   .atpack File: ATtiny9.atdf                                               * 
 *   .ATDF File:   atdf/ATtiny9.atdf                                          * 
 *   Version:      2.0.10                                                     * 
 *   Date:         2019-04-25                                                 * 
 *   Device:       ATtiny9                                                    * 
 *   Architecture: AVR8L                                                      * 
...
#  define _AVR_IOXXX_H_ "ioATtiny9.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_ATtiny9_H_INCLUDED
#  define _AVR_ATtiny9_H_INCLUDED
...
#endif /* #ifdef _AVR_ATtiny9_H_INCLUDED */
