 ...
 *                                                                            * 
 *   .atpack File: ATtiny25.atdf                                              * 
 *   .ATDF File:   atdf/ATtiny25.atdf                                         * 
 *   Version:      2.0.10                                                     * 
 *   Date:         2019-04-25                                                 * 
 *   Device:       ATtiny25                                                   * 
 *   Architecture: AVR8                                                       * 
...
#  define _AVR_IOXXX_H_ "ioATtiny25.h"
#else
#  error "Attempt to include more than one <avr/ioXXX.h> file."
#endif

#ifndef _AVR_ATtiny25_H_INCLUDED
#  define _AVR_ATtiny25_H_INCLUDED
...
#define TC8_DTPS         _SFR_MEM8 (0x0043) /* Dead time prescaler register */
#define TC8_DT1B         _SFR_MEM8 (0x0044) /* Dead time value B */
#define TC8_DT1A         _SFR_MEM8 (0x0045) /* Dead time value register */
#define TC8_OCR1B        _SFR_MEM8 (0x004B) /* Output Compare Register */
/* TC8_GTCCR ALREADY DEFINED */
#define TC8_OCR1C        _SFR_MEM8 (0x004D) /* Output compare register */
#define TC8_OCR1A        _SFR_MEM8 (0x004E) /* Output Compare Register */
#define TC8_TCNT1        _SFR_MEM8 (0x004F) /* Timer/Counter Register */
#define TC8_TCCR1        _SFR_MEM8 (0x0050) /* Timer/Counter Control Register */
...
#endif /* #ifdef _AVR_ATtiny25_H_INCLUDED */
